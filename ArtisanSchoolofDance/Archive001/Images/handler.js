...
(function($){
  $.webcomNavigation = {
    ...
    getSFOptions : function() {
      ...
      return {
        ...
        onBeforeShow : function() { 
          ...
          self.setCurrentOptions(primaryUl.parents("div[className='primary-webcomMenu-offset']").parent("div").attr("id"));
          ...
          if (this.length > 0) {
            try {
              ...
              if (self.isFlyout) {
                ...
                this.parents("li:first").find("div[className^='" + prefix + "webcomMenu-']:first").css({ position : "relative", float : "left", top: "0px", left : "0px" });
              }
            }
            catch (e) {
              alert(e);
        ...
        onHide : function() {
         this.each(function() {
           var elem = $(this).parents("li:first").find("div[className*='webcomMenu-']:first")[0];
    ...
    updateRootDecorator : function(navNode, callback) {
      var menu = $(navNode);
      menu.parents("div[className*='webcomMenu-offset']:first").children("div[className*='webcomMenu-']").each(function() { callback($(this), menu); });
    },
    ...
    normalizeHeight : function(navElem, options) {
      ...
      lis.each(function() {
        var dm = $("div[className='" + prefix + "webcomMenuItem-middle']", this);
        var tmpH = dm.height();
        if (tmpH > maxDMH) {
          maxDMH = tmpH;
        }
        ...
        if (hasHeight && !dist.isSet) {
          dist.isSet = true;
          dist.height = 0;
          $(this).find("div[className*='" + prefix + "webcomMenuItem-']").each(function() {
        ...
        if (hasHeight) {
          $(this).find("div[className*='" + prefix + "webcomMenuItem-']").each(function() {
            ...
            if ((prefix + "webcomMenuItem-middle") == name) {
              ...
              this.style.paddingBottom = xt + "px";
              if (self.isIE6()) {
          ...
          var dm = $("div[className='" + prefix + "webcomMenuItem-middle']:first", this);
          tmpH = dm.height();
          ...
          if (tmpH < maxDMH) {
            ...
            dm[0].style.paddingBottom = xt + "px";
          }
        }
      });
    },
    ...
    calcSetButtonSize : function(navElem, options) {
      ...
      navElem.children("li").each(function() {
        ...
        var dm = $("div[className$='webcomMenuItem-middle']", item);
        ...
        if (!dist.isSet) {
          ...
          dist.width = 0;
          dist.height = 0;
          item.find("div[className*='webcomMenuItem-']").each(function() {
            var style = self.getCurrentStyle(this);
        ...
        dm[0].style.width = css["width"];
        li[0].style.width = bWidth+"px";
      });
    },
    ...
    initSelectedElements : function (navMenu) {
      $("li.selected", navMenu).parents("li[className*='webcomMenuItem']").addClass("selected");
    },
      ...
      return $(".primary-webcomMenu", elem).each(function() {
        ...
        $(".primary-webcomMenu", elem).superfish(self.getSFOptions())
          .find(">li:has(ul)").mouseover(function(){
            $("div[className='secondary-webcomMenu-offset']", this).bgIframe({opacity:true, src:''});
          });
      });
    }
  };
