...
OldEventCode = 26081 'Coachella 2004
EventCode = 59662 'Coachella 2005
RenewalName = "CVS RNW 2006" 'This goes into the IP Address field.  It should be a unique identifier for this load.  Maximum of 15 characters
...
Do Until rsTickets.EOF
	...
	If OldOrderNumber <> LastOldOrderNumber Then 'It's a new order.
		...
		spInsertOrderHeader.Parameters.Append spInsertOrderHeader.CreateParameter("IPAddress", 200, 1, 15, RenewalName) 'As Varchar and Input
		...
		Response.Write "New Order Number = " & OrderNumber & "<BR><BR>"
...
'			Surcharge = 0
			...
			If rsPrice("ItemType") = "SubFixedEvent" Then
				...
				Response.Write SQLChildPrice & "<BR><BR>"
				...
				Do Until rsChildPrice.EOF
					...
					ChildDiscountTypeNumber = 37 'Subscription DiscountTypeNumber
					...
					Response.Write SQLUpdateChildLine & "<BR><BR>"
