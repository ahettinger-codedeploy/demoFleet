...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<TD VALIGN=""top"" WIDTH=""33%"">" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2"">" & vbCrLf
			Response.Write "<B>VENUE INFORMATION</B><BR><BR>" & vbCrLf
			Response.Write "<B>Old Spanish Nights Tasting & Tapas</B><BR>" & vbCrLf
			Response.Write "De La Guerra Adobe Courtyard<BR>15 E. De La Guerra St<BR>Santa Barbara, CA 93108<BR><BR>" & vbCrLf
			Response.Write "<B>Sunset Rare & Reserve Wine Tasting</B><BR>" & vbCrLf
			Response.Write "Chase Palm Park Plaza (at the carousel)<BR>323 E. Cabrillo Blvd<BR>Santa Barbara, CA 93101<BR><BR>" & vbCrLf
			Response.Write "<B>Beachside Wine Fest</B><BR>" & vbCrLf
			Response.Write "Beachside Wine Fest<BR>236 E. Cabrillo Blvd<BR>Santa Barbara, CA 93101<BR><BR>" & vbCrLf
			Response.Write "<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""/Clients/CaliforniaWineFestival/ETicket/mbad.jpg"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
