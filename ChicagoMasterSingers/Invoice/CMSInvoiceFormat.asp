...
OrganizationNumber = 1978 'Organization Number
StreetAddress = "P.O. Box 1503" 'Street Address. If this is a 2 line street address use <BR> between the two lines
CityStateZip = "Barrington, IL 60011-1503" 'City State Zip Code
ClientDirectory = "ChicagoMasterSingers" 'Name of Client Directory where Invoice/InvoiceFormat.asp is located
PhoneNumber = "(877) TAL-KCMS" 'Customer Service Phone Number. If org doesn't have a number, use PhoneNumber = ""
