...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""2""><B>Take-off around sunrise.  Contact (435) 655-1389 the day before your flight to learn actual meeting time.</B></FONT><BR><BR>" & vbCrLf
		...
		'Begin Ad Space
            ...
            Else
    			Response.Write "<IMG SRC=""/Clients/CanyonlandsBallooning/ETicket/Images/ETicketAdTerms.gif"" HEIGHT=""200"">" & vbCrLf
            End If
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
