<%
    'CHANGE LOG
    'TTT 1/17/12 - Changed date range back to year 2009
%>
...
Response.Write "<OPTION VALUE=" & Year(StartDate) - 3 & ">" & Year(StartDate) - 3 & "</OPTION>" & vbCrLf
...
Response.Write "<OPTION VALUE=" & Year(EndDate) - 3 & ">" & Year(EndDate) - 3 & "</OPTION>" & vbCrLf
