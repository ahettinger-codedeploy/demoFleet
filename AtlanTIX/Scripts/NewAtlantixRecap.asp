...
Response.Write "<FORM ACTION=""NewAtlantixRecap.asp"" METHOD=""post"" NAME=""Report""><INPUT TYPE=""hidden"" NAME=""FormName"" VALUE=""DailyReport"">" & vbCrLf
...
Do Until rsEvents.EOF
	...
	TotalOperatingFee = TotalOperatingFee + (rsEvents("TicketCount") * 1.50 )
	TotalProducerIncome = TotalProducerIncome + ((rsEvents("FaceValue") - rsEvents("Discount")) - TotalOperatingFee)
	TotalServiceFee = TotalServiceFee + (rsEvents("ServiceFee") + TotalOperatingFee)
