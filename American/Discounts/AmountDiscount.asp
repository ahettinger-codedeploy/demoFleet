...
'Apply the discount to these seat types only
If SeatTypeCode = 22 Or SeatTypeCode = 102 Then  
...
If OrderTypeFlag = "Y" And AllowedSeatTypeFlag = "Y" And MaxDiscountsPerOrderPerEventOK = "Y" And MaxDiscountsPerOrderOK = "Y" And MaxDiscountSystemUsageOK = "Y" Then 'It's okay to apply to this order type and seat type.
