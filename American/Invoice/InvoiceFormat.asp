...
OrganizationNumber = 120 'Organization Number
StreetAddress = "Harold and Sylvia Greenberg Theatre<BR>American University<BR>4200 Wisconsin Ave, NW" 'Street Address. If this is a 2 line street address use <BR> between the two lines
CityStateZip = "Washington, D.C. 20016" 'City State Zip Code
...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">" & OrgName & "<BR>" & StreetAddress & "<BR>" & CityStateZip & "</TD><TD WIDTH=""300""><IMG SRC=""http://www.tix.com/images/TixLogo.gif""></TD></TR></TABLE>"
