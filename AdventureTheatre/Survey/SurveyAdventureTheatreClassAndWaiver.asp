...
'SSR 8/30/2011 - Survey Update

'SSR 6/1/2012 - Survey Update Removed bypass for comp orders

'SSR 9/5/2012 - Removed Error Log Messages
...
<br />
        ...
        For j = 1 To UBound(Question)
            ...
            Set rsOrderLineDetail = OBJdbConnection.Execute(SQLOrderLineDetail)  
                ...
                Else
                    FieldValue = ""
                    SQLInsertDetail = "INSERT OrderLineDetail (OrderNumber, LineNumber, SurveyNumber, FieldName, FieldValue) VALUES(" & Session("OrderNumber") & ", " & i & "," & SurveyNumber & ", 'Answer" & j & "', '" & FieldValue & "'  )"            
    ...
    For i = 1 To AvailOfferCount 
            ...
            Select Case j
             ...
             Case 4, 14
                ...
                SQLInsertDetail = "INSERT OrderLineDetail (OrderNumber, LineNumber, SurveyNumber, FieldName, FieldValue) VALUES(" & Session("OrderNumber") & ", " & i & "," & SurveyNumber & ", 'Answer" & j & "', '" & ProperDate & "'  )"            
                Set rsInsertDetail = OBJdbConnection.Execute(SQLInsertDetail)
             ...
             Case 5   
                ...
                'Insert Answer record for this line number.          
                SQLInsertDetail = "INSERT OrderLineDetail (OrderNumber, LineNumber, SurveyNumber, FieldName, FieldValue) VALUES(" & Session("OrderNumber") & ", " & i & "," & SurveyNumber & ", 'Answer" & j & "', '" & ChildAge & "'  )"            
                Set rsInsertDetail = OBJdbConnection.Execute(SQLInsertDetail) 
             ...
             Case Else
                ...
                'Insert Answer record for this line number.          
                SQLInsertDetail = "INSERT OrderLineDetail (OrderNumber, LineNumber, SurveyNumber, FieldName, FieldValue) VALUES(" & Session("OrderNumber") & ", " & i & "," & SurveyNumber & ", 'Answer" & j & "', '" & Clean(Request("Answer"&j&"_"&i)) & "'  )"            
                Set rsInsertDetail = OBJdbConnection.Execute(SQLInsertDetail)
