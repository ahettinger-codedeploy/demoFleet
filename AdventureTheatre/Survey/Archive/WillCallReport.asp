...
If Excel <> "Y" Then
	Response.Write "<FORM ACTION=""WillCallReport.asp"" METHOD=""post"" id=form1 name=Report onSubmit=""return ValidateForm()"">" & vbCrLf
	...
	'SSR 8/30/8 - Added option to include customer phone number
	If Request("IncludePhoneNumber") = "on" Then PhoneNumberChecked = " CHECKED"
	Response.Write "<TR><TD><INPUT TYPE=""checkbox"" NAME=""IncludePhoneNumber""" & PhoneNumberChecked & "></TD><TD><FONT FACE=verdana,arial,helvetica SIZE=2>Include Phone Number</FONT></TD></TR>" & vbCrLf
...
If Not rsSeat.EOF Then
	...
	'SSR - 8/29/08 - Added Phone Number Column
	If Clean(Request("IncludePhoneNumber")) = "on" Then
		PhoneNumberHeading = "<TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>Phone Number</B></FONT></TD>"
	Else
		PhoneNumberHeading = ""
	End If
	...
	Response.Write "<TR BGCOLOR=#008400><TD><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>Section</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>Row</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>Seat</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>Order Number</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>Order Date/Time</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>Customer Name</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>Status</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>Type</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>Price</B></FONT></TD>" & SurveyHeading & OrderNotesHeading & PhoneNumberHeading & "<TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>Delivery Method</B></FONT></TD>" & TicketCountHeading & "</TR>" & vbCrLf
	Do Until rsSeat.EOF
...
'SSR - 8/29/08 - Added Customer Phone Number
		If PhoneNumberHeading <> "" Then 'Add the column
			PhoneNumber = "<TD ALIGN=left VALIGN=TOP NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & vbCrLf
				
			SQLPhoneNumber = "SELECT DayPhone FROM Customer (NOLOCK) WHERE CustomerNumber = " & rsSeat("CustomerNumber") & ""
			Set rsPhoneNumber = OBJdbConnection2.Execute(SQLPhoneNumber)
			Do Until rsPhoneNumber.EOF
				PhoneNumber = PhoneNumber & FormatPhone(rsPhoneNumber("DayPhone"),"United States")
				rsPhoneNumber.MoveNext
			Loop
			rsPhoneNumber.Close
			Set rsPhoneNumber = nothing
				
			PhoneNumber = PhoneNumber & "</FONT></TD>" & vbCrLf
		End If
		...
		If Request("GroupCount") = "Y" Then
		    If ShipToName <> rsSeat("ShipFirstName") & " " & rsSeat("ShipLastName") Or OrderNo <> rsSeat("OrderNumber") Or _
		       ...
		       Status <> rsSeat("Status") Or SeatType <> rsSeat("SeatType") Or Price <> rsSeat("Price") - rsSeat("Discount") Then 
		        ...
		        Response.Write "<TR BGCOLOR=#EEEEEE ONMOUSEOVER=""bgOn(this,'#e1f0dc');"" ONMOUSEOUT=""bgOn(this,this.className);""><TD NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Section") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Row") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Seat") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("OrderNumber") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("OrderDate") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("ShipFirstName") & " " & rsSeat("ShipLastName") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Status") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("SeatType") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & FormatCurrency(rsSeat("Price")-rsSeat("Discount"),2)  & "</FONT></TD>" & SurveyDetail & OrderNotes & PhoneNumber & "<TD NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("ShipType") & "</FONT></TD>"
		    End If
		Else
		    Response.Write "<TR BGCOLOR=#EEEEEE ONMOUSEOVER=""bgOn(this,'#e1f0dc');"" ONMOUSEOUT=""bgOn(this,this.className);""><TD NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Section") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Row") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Seat") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("OrderNumber") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("OrderDate") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("ShipFirstName") & " " & rsSeat("ShipLastName") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Status") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("SeatType") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & FormatCurrency(rsSeat("Price")-rsSeat("Discount"),2)  & "</FONT></TD>" & SurveyDetail & OrderNotes & PhoneNumber & "<TD NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("ShipType") & "</FONT></TD></TR>" & vbCrLf
		End If
