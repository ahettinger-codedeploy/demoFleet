...
<TABLE CELLPADDING=10 CELLSPACING=5 WIDTH="100%" border=0>
	 <TR>
		...
		<TD>
			...
			<INPUT TYPE="checkbox" NAME="Answer1" VALUE="Outdoor Advertisement">&nbsp;Outdoor Advertisement<BR>
			<INPUT TYPE="checkbox" NAME="Answer1" VALUE="Gazette">&nbsp;Gazette<BR>
			<INPUT TYPE="checkbox" NAME="Answer1" VALUE="Family Fair or Festival">&nbsp;Family Fair or Festival<BR>
