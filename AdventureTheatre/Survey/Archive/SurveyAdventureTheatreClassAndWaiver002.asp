...
<FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">Please enter each student's information below:<BR><BR>
...
Do Until rsEvent.EOF
	...
	Do Until rsOrderLine.EOF
	    ...
	    'Student Number X header
	    Response.Write "<BR><BR><DIV style=""border-style: double; background: #E1E8F2"">Student Number " & rsOrderLine("LineNumber") & "</DIV><BR><BR>" & vbCrLf
