<%
    'CHANGE LOG
    'TTT 1/22/13 - Added SurveyNumber to OrderLineDetail
%>
...
<SCRIPT type=text/javascript src="/Clients/AdventureTheatre/Survey/Images/validatious.min.js"></SCRIPT>  
...
<FORM ACTION="<%= SurveyName %>" METHOD="post" NAME="SurveyForm" class=validate >
...
Do Until rsEvent.EOF
	...
	Response.Write "</TR>" & vbCrLf
		...
		Response.Write "<TD BGCOLOR=""#BAB6D9""><INPUT TYPE=""text"" SIZE=""40"" class=""Required"" NAME=""StudentFirstName" & TotalLines+1 & """ VALUE=""" & StudentFirstName & """></TD>" & vbCrLf
        Response.Write "</TR>" & vbCrLf
		...
		Response.Write "<TD BGCOLOR=""#BAB6D9""><INPUT TYPE=""text"" SIZE=""40"" class=""Required"" NAME=""StudentLastName" & TotalLines+1 & """ VALUE=""" & StudentLastName & """></TD>" & vbCrLf
	    Response.Write "</TR>" & vbCrLf 
	    Response.Write "<TR>" & vbCrLf
        Response.Write "<TD COLSPAN=""2"">&nbsp;</TD>" & vbCrLf
        Response.Write "</TR>" & vbCrLf
...
For i = 1 To Request("TotalLines")
    ...
    SQLInsertDetail = "INSERT OrderLineDetail (OrderNumber, LineNumber, SurveyNumber, FieldName, FieldValue) VALUES(" & Session("OrderNumber") & "," & LineNumber & "," & SurveyNumber & ", 'Referral', '" & Clean(Request("Referral")) & "')"
    ...
    'Waiver - Insert
    SQLInsertDetail = "INSERT OrderLineDetail (OrderNumber, LineNumber, SurveyNumber, FieldName, FieldValue) VALUES(" & Session("OrderNumber") & "," & LineNumber & "," & SurveyNumber & ", 'Waiver', '" & Clean(Request("Waiver")) & "')"
    Set rsInsertDetail = OBJdbConnection.Execute(SQLInsertDetail)
	...
	SQLInsertDetail = "INSERT OrderLineDetail (OrderNumber, LineNumber, SurveyNumber, FieldName, FieldValue) VALUES(" & Session("OrderNumber") & ", " & LineNumber & "," & SurveyNumber & ", 'StudentFirstName', '" & Clean(Request("StudentFirstName" & i)) & "')"
	Set rsInsertDetail = OBJdbConnection.Execute(SQLInsertDetail)
	...
	SQLInsertDetail = "INSERT OrderLineDetail (OrderNumber, LineNumber, SurveyNumber, FieldName, FieldValue) VALUES(" & Session("OrderNumber") & ", " & LineNumber & "," & SurveyNumber & ", 'StudentLastName', '" & Clean(Request("StudentLastName" & i)) & "')"
	Set rsInsertDetail = OBJdbConnection.Execute(SQLInsertDetail)	
