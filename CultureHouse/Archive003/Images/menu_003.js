...
var cssmw7 = {
	...
	ie6_li_mouseOver: function(e) {
		cssmw7.clearHoverLIs();
		cssmw7.setHovFocLI(this, "hoverLI");
		var doBlur = (cssmw7.focusLI && true);
		cssmw7.clearFocusLIs();
		if (doBlur) {
			cssmw7.blurFocus();
			cssmw7.clearFocus();
		}
		cssmw7.setLIAndChildNodes(this, "link", "hover");
	...
	ie6_li_mouseOut: function(e) {
		cssmw7.clearHoverLIs();
		var ul = this.getElementsByTagName('ul')[0];
		cssmw7.setLIAndChildNodes(this, "hover", "link");
	...
	a_focus: function(e) {
		...
		if (!li) return;
		cssmw7.clearFocusLIs();
		cssmw7.setHovFocLI(li, "focusLI");
		cssmw7.setLIAndChildNodes(li, "link", "hover");
		if (cssmw7.browser.isIE6) {
			var ul = cssmw7.localGetElementsByTagName(li, 'ul')[0];
			if(ul) ul.style.display = 'block';
		}
	},
	...
	a_blur: function(e) {
		...
		if (cssmw7.focusLI) {
			cssmw7.remHovFocLI(cssmw7.focusLI, "focusLI");
		}
		setTimeout("cssmw7.clearFocus();", 1);
	},
