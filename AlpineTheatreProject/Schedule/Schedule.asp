...
<%
'SSR 1/18/08 - Custom Schedule page. Changes "Tickets" column to indicate when events are sold out or off sale. 
	...
	Do While Not rsEvents.EOF
		...
		Set rsSoldOut = OBJdbConnection2.Execute(SQLSoldOut)
			...
			If rsSoldOut.EOF Then 'Event Status is sold out.
				EventStatus = "<FONT FACE=" & FontFace & " COLOR=" & TableCategoryBGColor & " SIZE=1>Sold Out</FONT>"
			...
			Else 'Event Status is on sale
				EventStatus = "<FONT FACE=" & FontFace & " COLOR=" & TableDataFontColor & " SIZE=1><A HREF=/Event.asp?Event=" & rsEvents("EventCode") & ">Tix & Info</A>&nbsp;</FONT>"
			End If
