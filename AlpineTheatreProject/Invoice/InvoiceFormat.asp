...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">Alpine Theatre Project<BR>PO Box 1959<BR>Whitefish, MT 59937</TD><TD WIDTH=""300""><IMG SRC=/PrivateLabel/AlpineTheatreProject/Invoice/Logo.gif HEIGHT=""120""></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from Alpine Theatre Project.&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us at info@alpinetheatreproject.org or call (406) 862-SHOW.<BR><BR>" & vbCrLf
