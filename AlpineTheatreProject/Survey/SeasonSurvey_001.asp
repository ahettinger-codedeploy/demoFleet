...
Sub CheckSeasonSubscription
    ...
    If Act1Tickets = 0 Or Act2Tickets = 0 Or Act3Tickets = 0 Then
        Call WarningPage("You need to buy at least one ticket from <u>each</u>: The Full Monty, Other Side of the Island, and Pete 'n' Keely.")
    Else
        ...
        If Act1Tickets = Act2Tickets And Act2Tickets = Act3Tickets And Act3Tickets = Act1Tickets Then
            ...
            Call SurveyForm
        Else
            Call WarningPage("The number of tickets for The Full Monty, Other Side of the Island, and Pete 'n' Keely need to be the same.<br>(ex: 1,1,1 or 2,2,2)")
        End If
    End If
End Sub
