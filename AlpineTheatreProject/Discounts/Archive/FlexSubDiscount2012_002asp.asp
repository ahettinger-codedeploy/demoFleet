...
'Purchase 1 ticket to each of the these three productions:

'Season Subscription Acts
'------------------------------------------
...
'Pricing
'--------
'Blue – 25% Off each ticket
'Gold – 20% Off each ticket
'Green – 10% Off each ticket

'Bonus Act
'---------------
'Act #74830 Legends: Stephen Sondheim

'Pricing
'------
'Blue – 20% Off each ticket
'Gold – 20% Off each ticket
'Green – 20% Off each ticket
...
'Restrictions
'-------------
'All tickets must be from the same price tier (color)
'All tickets must be the same ticket type
'Bonus Act discount only valid when purchased on same order with Season Subscription
'Discount is automatic
'Service Fees are not re-calculated
'DiscountCode: 2012Subscription
