...
'CHANGE LOG - Update
'SSR 5/25/2011
'Discount Code is now calculated at 20% for any valid season subscription.
'The discount is calculated on any subscription order, regardless of original order date.
...
'5/25/2011
'Discount/time frame changed: flat 20% for valid season subscriptions.
'regardless of the original orderdate
...
SeriesPercentage(1) = 20
SeriesPercentage(2) = 20
SeriesPercentage(3) = 20

DIM Date(3)
Date(1) = "6/20/2011" 'After 6/20/2011 discount expires
Date(2) = "4/2/2011"  'After 4/2/2011 discount drops 
Date(3) = "2/13/2011" 'After 2/13/2011 discount drops 
...
If CDate(OriginalDate) < CDate(Date(1)) Then  
	    ...
	    'Discount percentage no longer changes.
