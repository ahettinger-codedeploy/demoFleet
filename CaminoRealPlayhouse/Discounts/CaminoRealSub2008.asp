...
ActCodeList = "25715,25751,25753,25734,25752,25647,26034" 'ActCodes of Productions to include.
...
If AllowDiscount = "Y" Then 'It's okay to apply to this order.
	...
	If ActCount >= SeriesCount Then
		...
		If AppliedCount < NbrSubscriptions Then
			...
			Select Case ActCode
				Case 25715, 25751, 25753, 25734 'Price Tier A
					NewPrice = 19.17
				Case 26034
					NewPrice = 29.17
				Case 25752, 25647 'Price Tier B
					NewPrice = 19.16
			End Select
