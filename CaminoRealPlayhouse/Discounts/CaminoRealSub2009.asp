...
SeriesCount = 6 'Number of Productions in the Subscription
ActCodeList = "34883,34881,34882,34964,34880,34884" 'ActCodes of Productions to include.
...
If AllowDiscount = "Y" Then 'It's okay to apply to this order.
	...
	If ActCount >= SeriesCount Then
		...
		If AppliedCount < NbrSubscriptions Then
			...
			Select Case ActCode
				Case 34883,34881,34882,34964 'Price Tier A
					NewPrice = 19.17
				'Case 26034
					'NewPrice = 29.17
				Case 34880,34884 'Price Tier B
					NewPrice = 19.16
			End Select
