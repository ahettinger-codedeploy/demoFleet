<%
'CHANGE LOG
'SSR - 11/21/16 - Updated phone number
%>
...
OrganizationNumber = 4384 'Organization Number
StreetAddress = "311 East Palace Ave" 'Street Address. If this is a 2 line street address use <BR> between the two lines
CityStateZip = "Santa Fe, NM 87501" 'City State Zip Code
ClientDirectory = "ArtesiaArtsCouncil" 'Name of Client Directory where Invoice/InvoiceFormat.asp is located
PhoneNumber = "(505) 988-2282" 'Customer Service Phone Number. If org doesn't have a number, use PhoneNumber = ""
...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">" & OrgName & "<BR>" & StreetAddress & "<BR>" & CityStateZip & "</TD><TD WIDTH=""300""><IMG SRC=/clients/DesertChorale/Invoice/Logo.png HEIGHT=""120""></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from " & OrgName & ".&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, " & EmailAddress & " " & PhoneNumber & ".<BR><BR> <B>Refund and Exchange Policy</b><BR>The Santa Fe Desert Chorale does not refund patrons for tickets (either for personal circumstances or missing concerts). Patrons may receive tax deduction letters for tickets turned in for sale or gift to other patrons. Exchanges are not offered for Desert Chorale tickets. However, in some circumstances, patrons who are also donors to the Desert Chorale at the $250 level or higher may exchange tickets for different seats or different concert nights should seats be available. The Desert Chorale does not guarantee exchanges. Patrons who are not donors may exchange tickets for different seats or concert nights for a $10 fee per order should seats be available." & vbCrLf
