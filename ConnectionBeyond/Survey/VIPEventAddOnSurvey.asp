...
'EventCode: 293223 - Fort Mifflin Haunt Fest 2010: VIP Package

'they are offered two choices:

'(1) 293229 - VIP Meet and Greet with SJPR Founder Susan Bove And Medium Marisa Liza Pell (2:00 PM)
'(2) 297681 - VIP Meet and Greet with SJPR Founder Susan Bove And Medium Marisa Liza Pell (2:30 PM)
    ...
    <td>  
        ...
        <TR>
            ...
            If Not rsPackages.EOF Then
                ...
                <tr>
                    <td ALIGN="left" width="60%"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2"><B><U>Event Name</U></B></FONT></td> 
