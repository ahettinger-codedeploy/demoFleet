...
'===============================================
'Knowledge For Living (10/2/2010)
'Event Add On Survey

'Removed one offer event: Saturday, October 23, 2010 at 11:30 AM
'Removed VIP Package
...
CBEventCode = "292331"  'Fort Mifflin Haunt Fest 2010: Connection Beyond Package
Dim CBEventList(2)
CBEventList(1) = "293226" 'Connection Beyond Gallery with Medium Marisa Liza Pell
CBEventList(2) = "293227" 'Connection Beyond Gallery with Medium Marisa Liza Pell

DIM OfferEventList(3)
OfferEventList(1) = "293230" 'Fort Mifflin Haunt Fest 2010: Paranormal Package
OfferEventList(2) = "293231" 'Fort Mifflin Haunt Fest 2010: Connection Beyond Package
OfferEventList(3) = "293232" 'Fort Mifflin Haunt Fest 2010: Individual Psychic Readings
OfferSection =  "GA"
...
<tr bgcolor="<%=TableCategoryBGColor%>">
    <td>
        ...
        <BR>
        <FONT FACE="<%= FontFace %>" COLOR="<%=TableCategoryFontColor%>" SIZE="2">Would you like to add any of these events to your order?<br />To purchase enter ticket quantities below.
    </td>
</tr>
