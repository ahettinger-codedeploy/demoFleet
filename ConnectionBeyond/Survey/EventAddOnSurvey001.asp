...
<tr bgcolor="<%=TableCategoryBGColor%>">
    <td>
        ...
        <b>Fort Mifflin Haunt Fest 2010: VIP Package</b></FONT>
        <BR>
        <FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">This package has an event with two performance times:</FONT><br />
        <FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">Please select a performance time:</FONT><br />
    </td>
</tr>
<tr bgcolor="<%=TableDataBGColor%>">
    <td> 
        ...
        <INPUT TYPE="RADIO" NAME="EventCode" VALUE="293229"><FONT FACE="<%= FontFace %>" COLOR="<%=TableDataFontColor%>" SIZE="2">Saturday, October 23, 2010 at 2:00 PM</FONT><br />
        <INPUT TYPE="RADIO" NAME="EventCode" VALUE="297681"><FONT FACE="<%= FontFace %>" COLOR="<%=TableDataFontColor%>" SIZE="2">Saturday, October 23, 2010 at 2:30 PM</FONT><br />
...
<tr bgcolor="<%=TableCategoryBGColor%>">
    <td>
        ...
        <BR>
        <FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">Would you like to add any of these events to your order?<br />To purchase enter ticket quantities below.
    </td>
</tr>
<%
For i= 1 To 3
