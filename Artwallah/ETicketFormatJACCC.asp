...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<FONT FACE=""Verdana,Arial,Helvetica"" SIZE=""1"">" & Left(rsTix("TicketNumber"), 4) & "-" & Mid(rsTix("TicketNumber"), 5, 4) & "-" & Mid(rsTix("TicketNumber"), 9, 4) & "-" & Mid(rsTix("TicketNumber"), 13, 4) & "-" & Right(rsTix("TicketNumber"), Len(rsTix("TicketNumber")) - 16) & "<BR>" & rsTix("OrderNumber") & " - " & rsTix("ItemNumber") & "</FONT></TD>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			...
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""5""><B>" & UCASE(rsTix("ShortAct")) & "</B></FONT><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""5""><B>" & rsTix("SeatType") & "</B></FONT><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""3""><B>" & rsTix("Venue") & "</B><BR>" & vbCrLf
			...
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""3""><B>Section: " & rsTix("Section") & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Row: " & rsTix("Row") & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Seat: " & rsTix("Seat") & "</B></FONT><BR>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
		...
		'Begin Body Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2""><B>DRIVING DIRECTIONS</B></FONT><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">From Ventura County, Hollywood, San Fernando Valley<BR>Take the 101 South (Hollywood Freeway).  Exit at Los Angeles Street, go south and turn left at Second Street, at San Pedro Street turn right. JACCC on the left side.<BR><BR>" & vbCrLf
			Response.Write "From Pasadena<BR>Take the 110 (Pasadena Freeway) then the 5 South (Santa Ana Freeway) towards Santa Ana. Exit at Los Angeles Street, go south and turn left at Second Street, at San Pedro Street turn right. JACCC on the left side.<BR><BR>" & vbCrLf
			Response.Write "From Santa Monica, West Los Angeles, Beverly Hills<BR>Take the 10 (Santa Monica Freeway) East then the 110 (Pasadena Freeway) North.  When downtown, take the 5 towards Santa Ana Exit at Los Angeles Street, go south and turn left at Second Street, at San Pedro Street turn right. JACCC on the left.<BR><BR>" & vbCrLf
			Response.Write "From Orange County, San Diego<BR>Take the 5 North (Santa Ana Freeway) then the 101 North (Hollywood Freeway).  Exit Alameda Street and turn left, at Third Street turn right, at San Pedro Street turn right. JACCC on the right.<BR><BR>" & vbCrLf
			Response.Write "From Long Beach, South Bay<BR>Take 110 (Pasadena Freeway) North.  When downtown, take 5 towards Santa Ana.  Exit at Los Angeles Street, go south and turn left at Second Street, at San Pedro Street turn right. JACCC on the left.<BR><BR>" & vbCrLf
			Response.Write "From East Los Angeles, San Bernardino, Riverside<BR>Take 10 West (San Bernardino Freeway) or 60 West (Pomona Freeway).  When downtown, take the 101 North (Hollywood Freeway) Exit Alameda Street and turn left, at Third Street turn right, at San Pedro Street turn right. JACCC on the right side.<BR><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2""><B>PARKING</B></FONT><BR>" & vbCrLf
			Response.Write "Parking structure, Joe's Auto Parking Lot, 350 East Second Street, LosAngeles, CA 90012.<BR>Adjacent to the Aratani/Japan America Theatre.  There are several parking lots directly across from the JACCC.  Parking on the street is not recommended.<BR><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2"">" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG HEIGHT=1 SRC=""/Images/Clear.gif"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
