...
OrderConfirmationInfo = "<STYLE>div {page-break-before: always}</STYLE><div></div>" & vbCrLf
...
Do Until rsBeybladeConfirmation.EOF
	...
	Select Case rsBeybladeConfirmation("EventCode")
		Case 10600 'Red Competitor Ticket - Ages 8 - 14
			If OrderConfirmationInfo <> "<STYLE>div {page-break-before: always}</STYLE><div></div>" Then 'Add blank a blank line in between.
