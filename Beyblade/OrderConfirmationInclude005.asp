...
Do Until rsBeybladeConfirmation.EOF
	...
	Select Case rsBeybladeConfirmation("EventCode")
		Case 10600 'Red Competitor Ticket - Ages 8 - 14
			...
			End If
			OrderConfirmationInfo = OrderConfirmationInfo & "<TABLE><TR BGCOLOR=""#FF0000""><TD>&nbsp;</TD></TR><TR><TD ALIGN=""center""><FONT FACE=""verdana,arial,helvetica"" SIZE=""5""><B>BBA Blader Jam North American Championships- Competitor Ticket</B></FONT></TD></TR>"
		Case 10601 'Blue Competitor TIcket - Ages 15 and up
			If OrderConfirmationInfo <> "" Then 'Add blank a blank line in between.
				OrderConfirmationInfo = OrderConfirmationInfo & "<BR><BR>"
			End If
			OrderConfirmationInfo = OrderConfirmationInfo & "<TABLE><TR BGCOLOR=""#0000FF""><TD>&nbsp;</TD></TR><TR><TD ALIGN=""center""><FONT FACE=""verdana,arial,helvetica"" SIZE=""5""><B>15+ Blader Tournament- Competitor Ticket</B></FONT></TD></TR>"
	End Select		
