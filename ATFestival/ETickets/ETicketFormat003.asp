...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<IMG SRC=""/PrivateLabel/ATFestival/ETickets/Top logo.jpg"">" & vbCrLf
			...
			Response.Write "<IMG SRC=""/PrivateLabel/ATFestival/ETickets/Bottom Bar.jpg"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
		...
		'Begin Body Space
			...
			Response.Write "<IMG WIDTH=200 SRC=""/PrivateLabel/ATFestival/ETickets/Sreet map space 200x200.jpg""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""/PrivateLabel/ATFestival/ETickets/Bottom Big ad space copy.jpg"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
