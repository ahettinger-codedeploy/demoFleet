...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<IMG SRC=""/PrivateLabel/ATFestival/ETickets/ATFETICKETLOGO.jpg"" WIDTH=""220"" HEIGHT=""70"">" & vbCrLf
		...
		'Begin Body Space
			...
			'Begin Right Column
			Response.Write "<TD VALIGN=""top"" WIDTH=""60%"">" & vbCrLf
			...
			Response.Write "<IMG WIDTH=200 SRC=""/PrivateLabel/ATFestival/ETickets/parkingmap.gif20080513151338.jpg""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""/PrivateLabel/ATFestival/ETickets/sponsors2.GIF"">" & vbCrLf
			Response.Write "<BR><IMG SRC=""/PrivateLabel/ATFestival/ETickets/Your Ad Here.jpg20080513154857.jpg"" HEIGHT=150>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
