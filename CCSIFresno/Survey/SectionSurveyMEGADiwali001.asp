...
SectionList(5) = "3ORANGE" 	'General Seating
...
SectionList(5) = "General Seating"

'New discounted ticket price for each section

DIM SectionPrice(5)
SectionPrice(1) = 35 'Platinum Seating
SectionPrice(2) = 30 'Diamond Seating
SectionPrice(3) = 25 'Gold Seating
SectionPrice(4) = 20 'Silver Seating
SectionPrice(5) = 15 'General Seating
