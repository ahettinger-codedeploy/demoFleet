...
'SSR 10/29/2012 - Updated Survey - discounts by section color
...
'Exclude the "Show Only" ticket from the 2 ticket min requirement and 
...
ErrorLog("Req SecCount1: " & SectionCount(1) & "")
ErrorLog("Req SecCount2: " & SectionCount(2) & "")
ErrorLog("Req SecCount3: " & SectionCount(3) & "")
ErrorLog("Req SecCount4: " & SectionCount(4) & "")
ErrorLog("Warn?" & warn & "")
