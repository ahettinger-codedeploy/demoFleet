...
{
	background: <%=TableCategoryBGColor%> url('/clients/tix/images/image.asp?FirstHex=<%=TableCategoryBGColor%>&LastHex=<%=TableCategoryBGColor%>&Src=TopLeftCorner16.txt') left -1px no-repeat;
	text-align: right;
}
...
<tbody>
    <tr>
        ...
        <td class="data-left" colspan="2">There is a four-ticket minimum purchase in this section.  Please go Back to Shopping to add the additional tickets to your order.</td>
        <td class="data-right">&nbsp;</td>
    </tr>
    <tr>
