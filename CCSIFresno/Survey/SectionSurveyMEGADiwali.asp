...
'SSR 11/08/2012 - Updated Survey - box office orders excluded from survey

'SSR 11/05/2012 - Updated Survey - exclude some tickets from discount

'SSR 10/29/2012 - Updated Survey - discounts by section color, survey applies to box office orders too.

'SSR 10/26/2012 - Created Survey
...
'Central California Society of India -  11/08/2012

'Update: survey applies to offline orders only.


'--------------------------------------------------


'Central California Society of India -  11/05/2012

'New parameter: Exclude the "Show Only" ticket from the 2 ticket min requirement and 
'from the discounted pricing


'--------------------------------------------------


'Central California Society of India -  10/29/2012

'Update: survey applies to both online and offline orders.

'Ticket discounts have been updated to the following parameters.  

'Discount not given on the first 2 tickets. 

'The prices below are applied to 3rd (or more) tickets:
...
'Central California Society of India -  10/26/2012

'Require that min 2 tickets be purchased - per price tier

'The survey applies to online purchases only
...
'However, previous version of this survey was a ticket restriction - without any discount. 

'Added discount: the following prices will be applied to tickets which meet the minimum count:
