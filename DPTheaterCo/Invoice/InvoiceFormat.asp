...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">Dana Point Theater Co.<BR>P.O.Box 26<BR>Dana Point, CA 92629</TD><TD WIDTH=""300""><IMG SRC=/PrivateLabel/DPTheaterCo/Invoice/Logo1.gif HEIGHT=""120""></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from Dana Point Theater Company.&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us at info@dptheaterco.org or call (949) 291-5083.<BR><BR>" & vbCrLf
