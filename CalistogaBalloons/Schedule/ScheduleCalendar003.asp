...
function calendar(CurrentDate)
    ...
    NextLink = NextLink & "&CalendarMonth=" & NextMonth & "&CalendarYear=" & NextYear & CampaignNumberLink 
     ...
     calendar_html = calendar_html & _
                     "<tr><td class=""calendar-control"" align=""left""><a href=""" & PreviousLink & """><div style=""width:0; height:0; border-left: 0; border-right: 30px solid red; border-top: 20px solid transparent; border-bottom: 20px solid transparent;"">1</div>Previous Month</a></td><td align=""center""><B>" & _
