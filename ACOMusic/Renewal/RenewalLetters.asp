...
Do Until rsOrderLine.EOF ' Or LetterCount >= 1
	...
	If rsOrderLine("OrderNumber") <> LastOrderNumber Then 'It's different.  Print it.
		If TicketCount > 0 Then 'It's not the first one, print the footer.
	        ...
	        Response.Write "<TR><TD COLSPAN=""3""><FONT FACE=Calibri,Charcoal,Arial>Please make checks payable to Atlantic Classical Orchestra<BR><BR>I prefer to pay by:&nbsp;&nbsp;[&nbsp;&nbsp;] MasterCard&nbsp;&nbsp;&nbsp;[&nbsp;&nbsp;] Visa&nbsp;&nbsp;&nbsp;[&nbsp;&nbsp;] American Express<br /></FONT></TD></TR>" & vbCrLf
	        ...
	        Response.Write "<TABLE WIDTH=""750""><TR><TD ALIGN=""center""><FONT FACE=Calibri,Charcoal,Arial>SEND TO:<br /><b>ATLANTIC CLASSICAL ORCHESTRA</b><BR>Attn: Patron Services<BR>415 Avenue A, Suite 305<BR>Fort Pierce, FL 34950<BR><i>Phone Number: (772) 460-0850 or (866) 310-7521</i><BR><i>Fax Number: (772) 460-0851</i></TD></TR></TABLE>" & vbCrLf
		...
		If Not rsCustInfo.EOF Then
			...
			Response.Write "<CENTER>" & vbCrLf
			Response.Write "<BR><TABLE WIDTH=750><TR><TD WIDTH=""20"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top""><FONT FACE=Calibri,Charcoal,Arial><BR>Atlantic Classical Orchestra<BR>415 Avenue A, Suite 305<BR>Fort Pierce, FL 34950<BR><BR><BR><BR></TD><TD WIDTH=330><IMG SRC=""/PrivateLabel/ACOMusic/Renewal/Images/ACOLogo.png"" HEIGHT=""125""></TD></TR></TABLE>"
