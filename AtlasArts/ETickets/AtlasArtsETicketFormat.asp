...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><B>From Union Station:</B><BR>" & vbCrLf
			Response.Write "Head east on Massachusetts Avenue, go around around Stanton Park, then continue east on Maryland Avenue NE. Turn left on 13th Street NE. Turn right on H Street NE and the Atlas will be on your right.<BR><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">From 295/ Keniliworth Avenue Southbound:<BR>" & vbCrLf
			Response.Write "Exit at Benning Road. Continue west on Benning Road NE. Benning will end and become H Street NE at a large intersection with Bladensburg Road and H Street. Go two blocks east on H Street NE, the Atlas will be on your left.<BR><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			...
			Response.Write "<IMG WIDTH=200 SRC=""/PrivateLabel/AtlasArts/ETickets/TixMap.jpg""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""/PrivateLabel/AtlasArts/ETickets/TixAd.jpg"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
