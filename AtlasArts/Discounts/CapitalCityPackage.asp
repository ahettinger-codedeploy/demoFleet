...
SeriesCount = 5 'Number of Productions in the Subscription
ActCodeList = "30343,30346,30344,30347,28615" 'ActCodes of Productions to include.
	...
	If ActCount >= SeriesCount Then
		...
		If AppliedCount < NbrSubscriptions Then
			...
			Select Case SeatTypeCode
					Case 1,160 'General Admission
						NewPrice = 15
					Case 27,139 'Senior/Student
						NewPrice = 11
			End Select
		End If
