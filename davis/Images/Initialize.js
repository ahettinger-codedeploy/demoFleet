...
$(document).ready(function() {
    ...
    $('span.ui-show-detail').live('click', function() {
        var $this = $(this);
    ...
    $('span.ui-article-detail-close').live('click', function() {
        $this = $(this);
    ...
    $('#show-list-view').live('click', function() {
    ...
    $('#show-expanded-view').live('click', function(i) {
        $(this).addClass('ui-btn-toolbar-primary').removeClass('ui-btn-toolbar');
