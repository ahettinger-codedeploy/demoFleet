...
/*  Make BC Dates Pretty  */

// Get the number from the 3-char month of BC's output 
...
// Create a standard javascript date format
...
//You can use one of the 3 formats below...

// Output the date in this Short Month Name format :: Jan 1, 1990
function toShortMonthDate(jsDate){
	var shortMonth = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
	return shortMonth[jsDate.getMonth()] + " " + jsDate.getDate() + ", " + jsDate.getFullYear();
}
// Output the date in this Long Month Name format :: January 1, 1990
