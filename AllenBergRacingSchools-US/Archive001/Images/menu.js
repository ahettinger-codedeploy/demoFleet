...
function writeMenus(container) {
	...
	for (var i=0; i<container.menus.length; i++, countMenus++) {
		...
		if (lrs) {
			...
			content += ''+
			'<DIV ID="menuLayer'+ countMenus +'" STYLE="position:absolute;z-index:21000;left:10;top:'+ (i * 100) +';visibility:hidden;">\n'+
			'  <DIV ID="menuLite'+ countMenus +'" STYLE="position:absolute;z-index:21000;left:'+ menu.menuBorder +';top:'+ menu.menuBorder +';visibility:hide;" onMouseOut="mouseoutMenu();">\n'+
...
function onMenuItemOver(e, l) {
	...
	if (document.layers) {
		...
		if (l.hilite) {
			...
			l.hilite.zIndex = 21000;
			l.document.layers[1].zIndex = 21000;
		...
		l.zIndex = 21000;  // magic IE 4.5 mac happy doohicky.	jba
		if (l.Menu.bgImageOver) {
...
function moveXbyEventPos (x, imgname) {
	...
	&& (event.clientX >= 0 || event.offsetX >= 0)) {
		...
		if (typeof(document.images[imgname].x) != "undefined"
		&& document.images[imgname].x > 0) {
			if (typeof(document.images[imgname].offsetLeft) != "undefined") {
				return (x + document.images[imgname].x);
			} else {
				return (x + document.images[imgname].x - 1);
			}
		} else {
			if (typeof(document.images[imgname].offsetLeft) != "undefined"
			&& typeof(document.body.offsetLeft) != "undefined"
			&& (document.images[imgname].offsetLeft > 0 || document.body.offsetLeft > 0)) {
...
function moveYbyEventPos (y, imgname) {
	...
	&& (event.clientY >= 0 || event.offsetY >= 0)) {
		...
		if (typeof(document.images[imgname].y) != "undefined"
		&& document.images[imgname].y > 0) {
			if (typeof(document.images[imgname].offsetTop) != "undefined") {
				return (y + document.images[imgname].y);
			} else {
				return (y + document.images[imgname].y - 1);
			}
		} else {
			if (typeof(document.images[imgname].offsetTop) != "undefined"
			&& typeof(document.body.offsetTop) != "undefined" 
			&& (document.images[imgname].offsetTop > 0 || document.body.offsetTop > 0)) {
