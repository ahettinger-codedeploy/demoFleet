...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<TABLE WIDTH=""615"" HEIGHT=""240"" BORDER=""1"" BACKGROUND=""/Clients/AvitalTours/ETickets/ETicketBackground.gif"" BGCOLOR=""#FFD718"" CELLPADDING=""0"" CELLSPACING=""0"">" & vbCrLf
			Response.Write "<TR>" & vbCrLf
			...
			Response.Write "<IMG SRC=""/Clients/AvitalTours/ETickets/ETicketBottomBar.gif"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
		...
		'Begin Body Space
			...
			Response.Write "<BR>" & vbCrLf
			Response.Write "<B>Meeting Location:</B></FONT><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><BR>" & vbCrLf
			Response.Write "The Women’s Building<BR>3543 18th Street<BR>San Francisco, CA 94110<BR><BR>Via car we recommend parking at:<BR>1.    Mission & Bartlett Garage<BR>90 Bartlett Street between 21st & 22nd Street [Enter at 3255 21st Street]<BR>$2 per hour<BR>2.    California Parking Inc.<BR>2351 Mission between 19th & 20th Street<BR>$8 flat rate (Weeknights after 5pm); $15 flat rate (Saturdays)<BR><BR>Via Public Transportation: The Women’s Building is only 4 blocks from the 16th Street BART Station. From the station, walk south down Mission Street until 18th Street, turn right on 18th Street and walk 1.5 blocks. The Women’s Building, covered in murals, will be located on the left hand side of the street.<BR>" & vbCrLf
			'Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">From Route 95 North<BR>" & vbCrLf
			'Response.Write "Take Exit 27 which becomes Marrin St. Continue to George St. where you will turn left. The Ground Round will be on your right after crossing Cedar St.<BR>" & vbCrLf
			'Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			...
			Response.Write "<IMG WIDTH=200 SRC=""/Clients/AvitalTours/ETickets/Map.gif""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""/Clients/AvitalTours/ETickets/ETicketAd.gif"" HEIGHT=""200"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
