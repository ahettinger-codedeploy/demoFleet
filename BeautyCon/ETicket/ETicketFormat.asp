...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<TABLE WIDTH=""615"" HEIGHT=""240"" BORDER=""1"" BACKGROUND=""/clients/BeautyCon/Eticket/Images/BeautyCon_TicketBG.jpg"" BGCOLOR=""#FFD718"" CELLPADDING=""0"" CELLSPACING=""0"">" & vbCrLf
			Response.Write "<TR>" & vbCrLf
			...
			Response.Write "<IMG SRC=""/clients/BeautyCon/Eticket/Images/BeautyCon_logo.jpg"">" & vbCrLf
			...
			Response.Write "<IMG SRC=""/clients/BeautyCon/Eticket/Images/BeautyCon_BottomBar.jpg"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
		...
		'Begin Body Space
			...
			Response.Write "<IMG SRC=""/clients/BeautyCon/Eticket/Images/BeautyCON_MapImage.jpg"">" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
		...
		'Begin Ad Space
            ...
            Else
    			Response.Write "<IMG SRC=""/clients/BeautyCon/Eticket/Images/BeautyCon_Advertising.jpg"" >" & vbCrLf
            End If
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
