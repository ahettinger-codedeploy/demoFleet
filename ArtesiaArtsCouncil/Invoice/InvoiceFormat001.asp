...
OrganizationNumber = 2131
StreetAddress = "PO Box 782"
CityStateZip = "Artesia, NM  88211"
ClientDirectory = "ArtesiaArtsCouncil"
PhoneNumber = "(575) 746-4212"
Email = "dboneau@vtu.net"
...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">" & OrgName & "<BR>" & StreetAddress & "<BR>" & CityStateZip & "</TD><TD WIDTH=""300""><IMG SRC=/PrivateLabel/" & ClientDirectory & "/Invoice/Logo.jpg HEIGHT=""120""></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from " & OrgName & ".&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us at " & Email & " or call " & PhoneNumber & ".<BR><BR>" & vbCrLf
