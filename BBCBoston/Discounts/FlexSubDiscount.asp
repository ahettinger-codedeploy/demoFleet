...
ActCodeList = "31246,31249,31251" 'ActCodes of Productions which can be included in Season Subscription.
	...
	If ActCount >= SeriesCount Then
		...
		If AppliedCount < NbrSubscriptions Then		    
			 ...
			 'Enter Season Ticket pricing rules here.
				...
				'Percentage Discount
					NewPrice = round(CDbl(Clean(Request("Price"))) * (88/100), 2) '12% Discount
