...
'Red Chair Project - 8/20/09
'This survey counts the number of times a discount code has been used by the patron. 
'Discount code "RCA2" - Max: 2 tickets
'Discount code "RCA4" - Max: 4 tickets
'Discount code "RCACHAIR" - Max: 2 tickets
...
MemberEventCode = "265748,293267,293270,293274,293275,293276" 'Eventcode for which discount is valid
