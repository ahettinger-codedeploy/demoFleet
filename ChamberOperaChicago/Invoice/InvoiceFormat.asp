...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">Chamber Opera Chicago<BR>1920 N. Lincoln Ave.<BR>Chicago, IL 60614</TD><TD WIDTH=""300""><IMG SRC=/PrivateLabel/ChamberOperaChicago/Invoice/Logo.gif HEIGHT=""120""></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from Chamber Opera Chicago.&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us at chamberopera@aol.com or call (312) 951-7944.<BR><BR>" & vbCrLf
