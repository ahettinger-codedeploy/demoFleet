...
'OrganizationNumber = 4409 'Organization Number
'StreetAddress = "PO Box 2685" 'Street Address. If this is a 2 line street address use <BR> between the two lines
'CityStateZip = "Holland, MI  49423" 'City State Zip Code
...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">" & OrgName & "<BR>" & StreetAddress & "<BR>" & CityStateZip & "</TD><TD WIDTH=""300""><IMG SRC=/PrivateLabel/" & ClientDirectory & "/Invoice/hso-logo.jpg ></TD></TR></TABLE>"
