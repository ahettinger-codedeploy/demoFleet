...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""5""><B>" & rsTix("ShortAct") & "</B></FONT><BR>" & vbCrLf
		...
		'Begin Body Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">From the South (Lenoir / Hickory)<BR>" & vbCrLf
			Response.Write "Take US 321 North to Blowing Rock. The Center is located on the right approximately 1/4 mile beyond the Sunset Drive traffic light.<BR><BR>" & vbCrLf
			Response.Write "From the North (Boone / Wilkesboro)<BR>" & vbCrLf
			Response.Write "Take US 321 South to Blowing Rock. The Center is located on the left exactly one mile past the Blue Ridge Parkway entrance (you will pass through 2 traffic lights between the Parkway and the Center).<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			...
			Response.Write "<IMG SRC=""/PrivateLabel/BlowingRockStageCompany/ETicket/Map.gif""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG width=526 height=280 SRC=""/PrivateLabel/BlowingRockStageCompany/Eticket/Etix-hayes.JPG"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
