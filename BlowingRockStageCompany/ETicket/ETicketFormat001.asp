...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2"">From Boone (North):<BR>" & vbCrLf
			Response.Write "Take NC Hwy 321 South. Stay in Left Lane in Blowing Rock. Turn Right on Sunset Drive.<BR><BR>" & vbCrLf
			Response.Write "From I-40 (South)<BR>" & vbCrLf
			Response.Write "Take Exit 123 in Hickory (NC Hwy 321). Continue on 321 through Lenoir. In Blowing Rock turn Left on Sunset Theatre on left 3 Blocks Up<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			...
			Response.Write "<IMG SRC=""/PrivateLabel/BlowingRockStageCompany/ETicket/brscmap.gif""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG width=526 height=280 SRC=""/PrivateLabel/BlowingRockStageCompany/Eticket/eticketad.gif"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
