...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<IMG SRC=""/Clients/B-TheEvent/ETicket/Images/215x68btheevent.jpg"">" & vbCrLf
			...
			Response.Write "<IMG SRC=""/Clients/B-TheEvent/ETicket/Images/614x27-btheevent.jpg"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
		...
		'Begin Body Space
			...
			Response.Write "<IMG WIDTH=200 SRC=""/Clients/B-TheEvent/ETicket/Images/200x200btheevent.jpg""><BR>" & vbCrLf
			'Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""/Clients/B-TheEvent/ETicket/Images/535x290btheevent.jpg"" HEIGHT=""200"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
