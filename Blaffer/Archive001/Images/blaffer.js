...
nav1arr.push(['about_blaffer.html','SN_about','About the Museum']);
nav1arr.push(['director_letter.html','SN_director_letter','Director&rsquo;s Letter']);
nav1arr.push(['staff.html','SN_staff','Staff']);
nav1arr.push(['history.html','SN_history','History']);
nav1arr.push(['employment.html','SN_employment','Employment']);
nav1arr.push(['press_room.html','SN_press_room','Press Releases']);
nav1arr.push(['image_room.html','SN_image_room','Press Images']);
nav1arr.push(['blaffer_magazine.html','SN_blaffer_magazine','Blaffer Magazine']);
nav1arr.push(['interactive_media.html','SN_interactive_media','Interactive/Social Media']);

//
var nav3arr = new Array();
nav3arr.push(['exhibitions.html','SN_current_exhibitions','Current Exhibitions']);
nav3arr.push(['upcoming_exhibitions.html','SN_upcoming_exhibitions','Upcoming Exhibitions']);
nav3arr.push(['past_exhibitions_2011.html','SN_past_exhibitions','Past Exhibitions']);
nav3arr.push(['traveling_exhibitions.html','SN_traveling_exhibitions','Traveling Exhibitions']);
nav3arr.push(['catalogues.html','SN_catalogues','Catalogues']);
//
var nav4arr = new Array();
nav4arr.push(['support.html','SN_support','Donate']);
nav4arr.push(['individual_memberships.html','SN_individual_memberships','Become a Member!']);
nav4arr.push(['corporate_sponsorships.html','SN_corporate_sponsorships','Corporate Sponsorships']);
nav4arr.push(['social_events.html','SN_social_events','Social Events']);
nav4arr.push(['annual_fund.html','SN_annual_fund','Annual Fund']);
//
var nav5arr = new Array();
nav5arr.push(['programs.html','SN_art_focus','Art Focus']);
//nav5arr.push(['tours.html','SN_tours','Tours']);
nav5arr.push(['adult_programs.html','SN_adult_programs','Adult Programs']);
nav5arr.push(['youth_programs.html','SN_youth_programs','Youth Programs']);
nav5arr.push(['student_programs.html','SN_student_programs','Student Programs']);
nav5arr.push(['faculty_programs.html','SN_faculty_programs','Faculty Programs']);
nav5arr.push(['blaffer_alumni_group.html','SN_blaffer_alumni_group','Blaffer Alumni Group']);
//
var nav6arr = new Array();
nav6arr.push(['hours.html','SN_hours','Hours']);
//nav6arr.push(['directions.html','SN_directions','Directions']);
nav6arr.push(['guided_tours.html','SN_guided_tours','Guided Tours']);
//
/* Build the gallery */
	...
	if (fold != "") {
		...
		for (i = 0; i < captionArray.length; i ++) {
			...
			if (tc == 4) {
				...
				gs += '<td width="13"><img src="images/nodot.gif" alt=" " width="13" height="15" /></td>';
			}
		}
		if (tc < 4) {
			for (i = tc; i < 4; i ++) {
				gs += '<td width="56"><img src="images/nodot.gif" width="58" height="56" border="0"></td>';
				if (i < 4) {
					gs += '<td width="13"><img src="images/nodot.gif" alt=" " width="13" height="15" /></td>';
				}
			}
