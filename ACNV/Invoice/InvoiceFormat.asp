...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=700><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""300"" VALIGN=""top"">Arts Council of the North Valley<BR>PO Box 74326<BR>Phoenix, AZ 85087</TD><TD WIDTH=300><IMG SRC=/PrivateLabel/ACNV/Invoice/Logo.gif height=120></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from the Arts Council of the North Valley.&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us at tickets@acnv.org or call (623)516-ACNV(2268).<BR><BR>" & vbCrLf
