...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><TABLE WIDTH=700><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""300"" VALIGN=""top""><BR>Bach Week Festival<BR>PO Box 603<BR>Evanston, IL 60204-0603</TD><TD WIDTH=300><IMG SRC=/PrivateLabel/BachWeek/Invoice/Logo1.gif Height=120></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from Bach Week Festival.&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us at tickets@bachweek.org.<BR><BR>" & vbCrLf
