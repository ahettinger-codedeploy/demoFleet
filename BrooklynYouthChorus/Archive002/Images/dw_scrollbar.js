...
dw_Slidebar.prepSlide = function(barId, e) {
	/*if (!drag_noroll) { // keeps it from cancelling the autoscroll. negates below
		if (q_home) { clear_autoscroll(); } // set to clear autoscrolling on homepage
	drag_noroll = true;*/
...
dw_Slidebar.doDrag = function(e) {
    drag_noroll = true; // added for homepage rollovers
...
dw_Slidebar.endDrag = function() {
    drag_noroll = false; // added for homepage rollovers
	if ( !dw_Slidebar.current ) return; // avoid errors in ie if inappropriate selections
    var _this = dw_Slidebar.current;
    var bar = _this.bar;
