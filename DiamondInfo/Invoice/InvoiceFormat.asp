...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">Diamond Info<BR>1845 Southfield Rd<BR>Lincoln Park, MI 48146</TD><TD WIDTH=""300""><IMG SRC=/Images/clear.gif WIDTH=""300"" HEIGHT=""120""></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from Diamond Info.&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us at answers@diamondinfo.com.<BR><BR>" & vbCrLf
