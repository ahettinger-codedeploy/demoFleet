		...
		Do Until rsTix.EOF
			...
			TixCount = TixCount + 1
				...
				Else	
					...
					Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""3"">Doors open at " & Left(FormatDateTime(rsTix("EventDate"),vbLongTime),Len(FormatDateTime(rsTix("EventDate"),vbLongTime))-6) & Right(FormatDateTime(rsTix("EventDate"),vbLongTime),3) & "&nbsp;Show starts at 8:30 PM</FONT><BR>" & vbCrLf
