...
'SSR 11/14/13 - Added place holder format to print for event code #606234.
'SSR 12/01/14 - Added "Doors Open at [event time]" and "Show starts at 9PM"
'SSR 09/01/15 - Removed "Show starts at 8:30 PM"
%>
	...
	If Not rsTix.EOF Then
		...
		Do Until rsTix.EOF
			...
			TixCount = TixCount + 1
				...
				If rsTix("EventCode") =  606234 Then
				
					'Place Holder E-Ticket
				...
				Else	
					...
					Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""3"">" & FormatDateTime(rsTix("EventDate"), vbLongDate) & "<BR>" & vbCrLf
					Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""3"">Doors open at " & Left(FormatDateTime(rsTix("EventDate"),vbLongTime),Len(FormatDateTime(rsTix("EventDate"),vbLongTime))-6) & Right(FormatDateTime(rsTix("EventDate"),vbLongTime),3) & "&nbsp;</FONT><BR>" & vbCrLf
