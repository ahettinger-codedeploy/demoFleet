...
}else{if(Modul.getActiveModule()===this&&this.getIsNew()){jQuery.cookie("newlyAdded",null,{path:"/"})
}this.close(false,false,undefined,true);if(this.loadMainViewAfterSave){this.showLoading();var a=this;
this.reloadMainView(null,function(){a.hideLoading()})}jQuery(document).trigger("diy-editor-module-saved")
...
a["mod.admin"]=1;this.reloadMainView(a)}});counter.Counter=Counter;
