...
<! -- Table Body -- >
        <tbody>
            ...
            <tr>
                ...
                <td class="fieldcellradio"><input type="radio" name="Answer9_<%=OptionCount%>" id="Answer9_y<%=OptionCount%>" value="Yes">&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Answer9_<%=OptionCount%>" id="Answer9_n<%=OptionCount%>" value="No">&nbsp;&nbsp;No</td>
             </tr>
             <tr>     
            ...
            <tr>
                ...
                <td class="fieldcellradio"><input type="radio" name="Answer13_<%=OptionCount%>" id="Answer13_y<%=OptionCount%>" value="Yes">&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Answer13_<%=OptionCount%>" id="Answer13_n<%=OptionCount%>" value="No">&nbsp;&nbsp;No</td>
            </tr>
            <tr>      
