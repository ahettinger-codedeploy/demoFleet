...
var ttOffsetY      = 18;           // vertical offset                   
var ttBgColor      = '#e6ecff';
var ttBorderColor  = '#003399';
var ttFontColor    = '#000066';
var ttWidth;        
//if (typeof intOrgID != 'undefined'){
//	if (intOrgID == 65) ttWidth = '80%';
//		else ttWidth = 400;
//} else ttWidth = 400;	
...
function tt_EvY(t_e)
{
	...
	{	if (tt_objH > ylim) t_y += tt_offY;
		else t_y -= (tt_objH + 0x05);
		//t_y -= (tt_objH + 0x05);
		tt_dwn = false;		
	}
	else
...
function tt_Show(t_e, t_id, t_above, t_delay, t_fix, t_left, t_offx, t_offy, t_sticky)
{
	...
	if (window.dd && (window.DRAG || window.RESIZE) && (t_mf == DRAG || t_mf == RESIZE)) return;
