...
return pos;}
function PopUpDialogBB(controlName,sName,sFeatures,queryStringData,bHideCss,pid){this.ctl=controlName;this.name=sName;this.features=sFeatures;this.qsdata=queryStringData;this.Show=Show;this.GetURL=GetURL;this.HideCss=bHideCss;this.pid=pid||BLACKBAUD.api.pageInformation.pageId;function Show(){var url=this.GetURL();var popwin=BLACKBAUD.netcommunity.baseWindow.open(url,this.name,this.features);if(typeof(popwin)!="undefined"&&popwin)
{popwin.focus();}}
function GetURL()
