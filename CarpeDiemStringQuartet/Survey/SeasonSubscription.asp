...
SurveyNumber = 486
MemberEventCode = "157863,158021,158038"
...
SQLTicketPrice = "SELECT Price from OrderLine (NOLOCK) WHERE OrderNumber = " & Session("OrderNumber") & ""
Set rsTicketPrice = OBJdbConnection.Execute(SQLTicketPrice)

SubscriptionPrice = rsTicketPrice("Price")

Select Case SubscriptionPrice
	Case 133 
		DiscountAmount = 6
	Case 50
		DiscountAmount = 2.5
...
<%
If Session("UserNumber") = "" Then
	Response.Write "<CENTER><TABLE><TR><TD><FONT FACE=""" & FontFace & """ COLOR=""" & FontColor & """ SIZE=2>Your past ticket purchase has qualified you for a discount.<BR><BR><CENTER><FORM ACTION=""/Ship.asp"" METHOD=""POST"" id=form1 name=form1><INPUT TYPE=""submit"" VALUE=""Continue"" id=1 name=1></FORM></CENTER></TD></TR></TABLE></CENTER><BR><BR>" & vbCrLf
Else
	Response.Write "<CENTER><TABLE><TR><TD><FONT FACE=""" & FontFace & """ COLOR=""" & FontColor & """ SIZE=2>Your past ticket purchase has qualified you for a discount.<BR><BR><CENTER><FORM ACTION=""/Management/AdvanceShip.asp"" METHOD=""POST"" id=form1 name=form1><INPUT TYPE=""submit"" VALUE=""Continue"" id=1 name=1></FORM></CENTER></TD></TR></TABLE></CENTER><BR><BR>" & vbCrLf
End If
