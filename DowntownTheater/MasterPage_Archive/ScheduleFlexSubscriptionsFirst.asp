...
'SSR 4/14/2014 - Updated schedule page with 2014 subscriptions.
...
'First Floor Subscription Series

'Display events valid for first floor subscription series

'EventCode   EventName
'643651   	Dover Quartet & Alon Goldstein, piano  Darrow School   
'643653   	Axel Strauss, violin & Ilya Poletaev, piano  Darrow School   
'643654   	Jasper String Quartet  Darrow School    
'643655   	Gleb Ivanov, piano  Darrow School  
'643656   	rio Virado  Darrow School   
'643658   	Ji, piano  Darrow School   
'643659   	Paul Huang, violin & Louis Schwizgebel, piano  Darrow School 

'==================================================================

SubscriptionTitle = "First Floor Subscription Series"
SubscriptionHeader = "Build your own subscription:<BR>Please enter 1 ticket to 4 productions below</B><BR><B>2014 Season subscription discount will be calculated on the final payment page"
SchedulePage = "/Clients/TanneryPondConcerts/Schedule/ScheduleFlexSubscriptionsFirst.asp?OrganizationNumber=2964"
EventCodeList = "643651,643653,643654,643655,643656,643658,643659"
...
<FONT FACE="verdana,arial,helvetica" SIZE="3"><FONT COLOR="<%=HeadingFontColor%>"><B><%=SubscriptionTitle%></B></FONT><br />
<FONT FACE="verdana,arial,helvetica" SIZE="1"><B><%=SubscriptionHeader%></B><br />
...
If Not rsEvents.EOF Then
    ...
    Response.Write "<FORM ACTION=" & Schedulepage & " METHOD=post id=form1 name=EventForm><INPUT TYPE=hidden NAME=FormName VALUE=EventForm>" & vbCrLf
	...
	Do Until rsEvents.EOF
     ...
     ' If rsEvents("Map") = "general" Then
        QtyInfo = "<TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=1><INPUT TYPE=""hidden"" NAME=""EventCode"" VALUE=""" & rsEvents("EventCode") & """><INPUT TYPE=""text"" NAME=""SeatCount"" SIZE=""1"" autocomplete=""off""></FONT></TD>"
      'Else 
