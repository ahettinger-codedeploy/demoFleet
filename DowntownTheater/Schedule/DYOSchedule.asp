...
SubscriptionsDisplay = Clean(Request("SubscriptionsDisplay"))
If Clean(Request("OfflineOnly")) = "Y"
...
If SubscriptionsDisplay = True Then
...
If Not rsEvents.EOF Then
	...
	If SubscriptionVenueLocation  Then
	  %>
        <tr>
            <td class="data">&nbsp;</td>
            <td class="data"><A HREF=/Event.asp?Event="<%= rsEvents("EventCode") %>" id="EventLink_"<%= rsEvents("EventCode") %>" onmouseover="ttDelay=setTimeout('eventTooltip(\'/AJAX/EventInfo.asp?EventCode="<%= rsEvents("EventCode") %>"\', this)', 200);" onmouseout="clearTimeout(ttDelay);hideTooltip();"><B><%= rsEvents("Act") & ActSuffix %></B></td>
            ...
            <td class="data"><A HREF=/Event.asp?Event="<%= rsEvents("EventCode") %>" id="TixInfoLink_"<%= rsEvents("EventCode") %>" onmouseover="ttDelay=setTimeout('eventTooltip(\'/AJAX/EventInfo.asp?EventCode="<%= rsEvents("EventCode") %>"\', this)', 200);" onmouseout="clearTimeout(ttDelay);hideTooltip();">Tix & Info</A></td>
            <td class="data">&nbsp;</td>
        </tr>
        <tr>
            <td class="data" colspan="6"><hr /></td>
        </tr>            
      <%
	Else
	  %>
        <tr>
            <td class="data">&nbsp;</td>
            <td class="data" colspan="2"><A HREF=/Event.asp?Event="<%= rsEvents("EventCode") %>" id="EventLink_"<%= rsEvents("EventCode") %>" onmouseover="ttDelay=setTimeout('eventTooltip(\'/AJAX/EventInfo.asp?EventCode="<%= rsEvents("EventCode") %>"\', this)', 200);" onmouseout="clearTimeout(ttDelay);hideTooltip();"><B><%= rsEvents("Act") & ActSuffix %></B></td>            
            <td class="data"><A HREF=/Event.asp?Event="<%= rsEvents("EventCode") %>" id="TixInfoLink_"<%= rsEvents("EventCode") %>" onmouseover="ttDelay=setTimeout('eventTooltip(\'/AJAX/EventInfo.asp?EventCode="<%= rsEvents("EventCode") %>"\', this)', 200);" onmouseout="clearTimeout(ttDelay);hideTooltip();">Tix & Info</A></td>
            <td class="data">&nbsp;</td>
        </tr>
        <tr>
...
If EventDisplay Then
	...
	%>  
        ...
        <H3><%= EventTitle %></H3> 
        <table id="rounded-corner" summary="event list">
        <thead>
        <tr>
            <th scope="col" class="category-left">&nbsp;</th>
	    ...
	    If EventVenueLocation  Then
	      %>
	        <tr>
	            ...
	            <td  class="data"><A HREF=/Event.asp?Event=<%= rsEvents("EventCode") %> id="EventLink_<%= rsEvents("EventCode") %>" onmouseover="ttDelay=setTimeout('eventTooltip(\'/AJAX/EventInfo.asp?EventCode=<%= rsEvents("EventCode") %>\', this)', 200);" onmouseout="clearTimeout(ttDelay);hideTooltip();"><B><%= rsEvents("Act") & ActSuffix %></B></A></td>
	...
	Do While Not rsEvents.EOF
		...
		If LastActCode <> rsEvents("ActCode") Then
			...
			If rsDates("StartDate") <> rsDates("EndDate") Then 'Display date range
		        ...
		        <tr>
                    <td  class="data">&nbsp;</th>
                    <td  class="data"><B><A HREF=<%= Link & OrganizationString %> id="ProductionInfoLink_<%= rsEvents("ActCode") %>" onmouseover="ttDelay=setTimeout('eventTooltip(\'/AJAX/ProductionInfo.asp?ActCode=<%= rsEvents("ActCode") %>\', this)', 200);" onmouseout="clearTimeout(ttDelay);hideTooltip();"><%= rsEvents("Act") %></A></B></td>
                    <td  class="data"><br /><%= MonthName(Month(rsDates("StartDate")), true) %>&nbsp;&nbsp;<%= Day(rsDates("StartDate")) %>&nbsp;&#151;&nbsp;<%= MonthName(Month(rsDates("EndDate")), true) %>&nbsp;<%= Day(rsDates("EndDate")) %><br /><br /></th>
                    <td  class="data"><A HREF=<%= Link & OrganizationString %> id="TixInfoLink_<%= rsEvents("ActCode") %>" onmouseover="ttDelay=setTimeout('eventTooltip(\'/AJAX/ProductionInfo.asp?ActCode=<%= rsEvents("ActCode") %>\', this)', 200);" onmouseout="clearTimeout(ttDelay);hideTooltip();">Tix & Info</A></td>
                    <td  class="data">&nbsp;</th>
                </tr> 
                <tr>
                    <td colspan="5"><hr /></td>
			...
			Else 'Display Date
		        ...
		        <tr BGCOLOR=<%= TableDataBGColor %>>
                    <td  class="data">&nbsp;</td>
                    <td  class="data"><A HREF=<%= Link & OrganizationString %> id="A3" onmouseover="ttDelay=setTimeout('eventTooltip(\'/AJAX/ProductionInfo.asp?ActCode=<%= rsEvents("ActCode") %>\', this)', 200);" onmouseout="clearTimeout(ttDelay);hideTooltip();"><%= rsEvents("Act") %></A></td>
                    <td  class="data"><br /><%= MonthName(Month(rsDates("StartDate")), true) %> <%= Day(rsDates("StartDate")) %><br /><br /></td>
                    <td  class="data"><A HREF=<%= Link & OrganizationString %> id="A4" onmouseover="ttDelay=setTimeout('eventTooltip(\'/AJAX/ProductionInfo.asp?ActCode=<%= rsEvents("ActCode") %>\', this)', 200);" onmouseout="clearTimeout(ttDelay);hideTooltip();">Tix & Info</A></td>
                    <td  class="data">&nbsp;</td>
                </tr> 
                <tr>
                    <td colspan="5"><hr /></td>
	    ...
	    Else
	      %>
	        <tr>
	            <td  class="data">&nbsp;</td>
	        	<td  class="data"><%= DisplayDate %></td>
	            <td  class="data"><A HREF=/Event.asp?Event=<%= rsEvents("EventCode") %> id="A2" onmouseover="ttDelay=setTimeout('eventTooltip(\'/AJAX/EventInfo.asp?EventCode=<%= rsEvents("EventCode") %>\', this)', 200);" onmouseout="clearTimeout(ttDelay);hideTooltip();"><B><%= rsEvents("Act") & ActSuffix %></B></A></td>   	                 
	            <td class="data"><A HREF=/Event.asp?Event="<%= rsEvents("EventCode") %>" id="TixInfoLink_"<%= rsEvents("EventCode") %>" onmouseover="ttDelay=setTimeout('eventTooltip(\'/AJAX/EventInfo.asp?EventCode="<%= rsEvents("EventCode") %>"\', this)', 200);" onmouseout="clearTimeout(ttDelay);hideTooltip();">Tix & Info</A></td>
            </tr> 
            <tr>
                <td colspan="5"><hr /></td>
