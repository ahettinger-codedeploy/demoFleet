...
<a href="http://tannerypondconcerts.testtix.com/Clients/TanneryPondConcerts/Schedule/ScheduleFlexSubscriptions.asp?OrganizationNumber=2964">&#60;&#60;&nbsp;</a><FONT FACE="<%=FontFace%>" COLOR="<%=HeadingFontColor%>"><h3><%=SubscriptionTitle%></h3></FONT><br />
