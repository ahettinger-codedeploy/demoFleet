...
DonationTitle = "Donation/Membership"
SingleEventTitle = "Single Performance Tickets"

DonationLink = "http://www.downtowntheater.tix.com/Donation.asp?Organizationnumber=2266"  
...
Response.Write "<FONT FACE=" & FontFace & " COLOR=" & HeadingFontColor & "><H3>" & DonationTitle & "</H3></FONT>" & vbCrLf
...
<TABLE CELLSPACING="0" CELLPADDING="0" WIDTH="90%" BORDER="0">
	...
	<TR BGCOLOR="<%=TableCategoryBGColor%>">
	    <TD>&nbsp;&nbsp;</TD>
	    <TD>&nbsp;&nbsp;</TD>
	    <TD ALIGN="left"><FONT FACE="<%=FontFace%>" COLOR="<%=TableCategoryFontColor%>" SIZE="2"><B><%=DonationTitle%></B></FONT></TD>
	    <TD>&nbsp;&nbsp;</TD>
	    <TD ALIGN="left"><FONT FACE="<%=FontFace%>" COLOR="<%=TableCategoryFontColor%>" SIZE="2"><B>&nbsp;</B></FONT></TD>
	    <TD>&nbsp;&nbsp;</TD>
	    <TD ALIGN="left"><FONT FACE="<%=FontFace%>" COLOR="<%=TableCategoryFontColor%>" SIZE="2"><B>Additional Information</B></FONT></TD>
	</TR>
	<TR BGCOLOR="<%=TableCategoryBGColor%>">
	    <TD COLSPAN="7" HEIGHT="2"><IMG HEIGHT="1" SRC="/images/clear.gif" ALT=""></TD>
    </TR>
