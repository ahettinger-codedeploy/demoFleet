...
%>
        ...
        <tr>
            ...
            <th scope="col" class="category">Event Name</th>
            <th scope="col" class="category">Venue Location</th>
            <th scope="col" class="category">Buy Tickets</th>
            <th scope="col" class="category-right">&nbsp;</th>
        </tr>        
        </thead>
        <tbody> 
...
<%	
 ...
 %>
        <tr>
            ...
            <td class="data-left"><A HREF=/Event.asp?Event="<%= rsEvents("EventCode") %>" id="A3"<%= rsEvents("EventCode") %>"" onmouseover="ttDelay=setTimeout('eventTooltip(\'/AJAX/EventInfo.asp?EventCode="<%= rsEvents("EventCode") %>"\', this)', 200);" onmouseout="clearTimeout(ttDelay);hideTooltip();"><%= rsEvents("Act") & ActSuffix %></td>
            ...
            <td class="data-left"><A HREF=/Event.asp?Event="<%= rsEvents("EventCode") %>" id="A4"<%= rsEvents("EventCode") %>"" onmouseover="ttDelay=setTimeout('eventTooltip(\'/AJAX/EventInfo.asp?EventCode="<%= rsEvents("EventCode") %>"\', this)', 200);" onmouseout="clearTimeout(ttDelay);hideTooltip();">Tix & Info</A>&nbsp;</td>
            <td class="data-left">&nbsp;</td>
        </tr>
        <tr>
            <td class="data-left" colspan="6"><hr /></td>
...
%>
        <tr>
            <td class="data-left">&nbsp;</td>
            <td class="data-left"><%= DisplayDate%></td>
            <td class="data-left"><A HREF=/Event.asp?Event="<%= rsEvents("EventCode") %>" id="A5"<%= rsEvents("EventCode") %>"" onmouseover="ttDelay=setTimeout('eventTooltip(\'/AJAX/EventInfo.asp?EventCode="<%= rsEvents("EventCode") %>"\', this)', 200);" onmouseout="clearTimeout(ttDelay);hideTooltip();"><%= rsEvents("Act") & ActSuffix %></td>
