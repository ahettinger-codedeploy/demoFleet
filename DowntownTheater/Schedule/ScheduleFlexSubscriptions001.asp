...
Dim SeriesLink(2)
SeriesLink(1) = "ScheduleFirst.asp?OrganizationNumber=2266"  
SeriesLink(2) = "ScheduleSecond.asp?OrganizationNumber=2266"   
...
<TABLE CELLSPACING="0" CELLPADDING="0" WIDTH="90%" BORDER="0">
    <TR>
        <TD COLSPAN="7" HEIGHT="2" ALIGN="CENTER"><FONT FACE="<%=FontFace%>" COLOR="#fe0002"><H3><%=SubscriptionTitle%></H3></FONT></TD>
    </TR>
	<TR BGCOLOR="<%=TableCategoryBGColor%>">
	    <TD COLSPAN="7" HEIGHT="2"><IMG HEIGHT="1" SRC="/images/clear.gif" ALT=""></TD>
	</TR>
	<TR BGCOLOR="<%=TableCategoryBGColor%>">
	    <TD>&nbsp;&nbsp;</TD>
	    <TD>&nbsp;&nbsp;</TD>
	    <TD ALIGN="left"><FONT FACE="<%=FontFace%>" COLOR="<%=TableCategoryFontColor%>" SIZE="2"><B>Subscription Name</B></FONT></TD>
	    <TD>&nbsp;&nbsp;</TD>
