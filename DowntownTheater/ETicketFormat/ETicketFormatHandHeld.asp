...
%>
		...
		<title>Tix - E-Ticket</title>
        <link rel="stylesheet" type="text/css" href="/css/etickethandheld.css"  />
        <style type="text/css" media="screen and (min-width: 481px)">
        <!--
        @import url("/css/eticketlargescreen.css");
        -->
		.PageBreak {page-break-before: always}
        </style>
        <!--[if IE]><link rel="stylesheet" type="text/css" href="/css/eticketlargescreen.css"  media="screen" /><![endif]-->
        <link href="/css/etickethandheld.css" rel="stylesheet" type="text/css" media="handheld, only screen and (max-device-width: 480px)" />				
		...
		'Begin Ticket
            Response.Write "<A NAME=""Ticket_" & TixCount & """>" & vbCrLf
		...
		'End Ad Space
            ...
            HandheldETicket = HandheldETicket & "<table style=""height: 100%; width: 100%;"">" & vbCrLf
            HandheldETicket = HandheldETicket & "<tbody>" & vbCrLf
            HandheldETicket = HandheldETicket & "<tr>" & vbCrLf
            HandheldETicket = HandheldETicket & "<td align=""center"" colspan=""3"">" & vbCrLf
            HandheldETicket = HandheldETicket & "<a name=""Ticket_" & TixCount & """ id=""Ticket_" & TixCount & """></a>" & vbCrLf            
            HandheldETicket = HandheldETicket & "<img alt=""Barcode Image"" src=""/Barcode.asp?Barcode=" & rsTix("TicketNumber") & """><br />" & vbCrLf
            HandheldETicket = HandheldETicket & "<b>Order #: " & rsTix("OrderNumber") & "</b><br />" & vbCrLf
            HandheldETicket = HandheldETicket & "<b>Name: " & rsTix("ShipFirstName") & " " & rsTix("ShipLastName") & "</b><br /><br />" & vbCrLf
            HandheldETicket = HandheldETicket & "<b>" & rsTix("Act") & "</b><br />" & vbCrLf
            HandheldETicket = HandheldETicket & rsTix("Venue") & "<br />" & vbCrLf
            HandheldETicket = HandheldETicket & FormatDateTime(rsTix("EventDate"), vbLongDate) & "<br />" & vbCrLf
            HandheldETicket = HandheldETicket & FormatDateTime(rsTix("OrderDate"), vbShortTime) & "<br />" & vbCrLf
            HandheldETicket = HandheldETicket & rsTix("SeatType") & " " & FormatNumber(rsTix("Price"),2) & "<br />" & vbCrLf
            HandheldETicket = HandheldETicket & "Section: <b>" & rsTix("Section") & "</b><br />" & vbCrLf
            HandheldETicket = HandheldETicket & "Row: <b>" & rsTix("Row") & "</b><br />" & vbCrLf
            HandheldETicket = HandheldETicket & "Seat: <b>" & rsTix("Seat") & "</b><br />" & vbCrLf
            HandheldETicket = HandheldETicket & "</td>" & vbCrLf
            HandheldETicket = HandheldETicket & "</tr>" & vbCrLf
            HandheldETicket = HandheldETicket & "<tr><td colspan=""3""><br /><br /><br /></td></tr>" & vbCrLf
            HandheldETicket = HandheldETicket & "<tr>" & vbCrLf
            HandheldETicket = HandheldETicket & "<td align=""center"" width=""30%"">" & vbCrLf
            If TixCount > 1 Then
                'HandheldETicket = HandheldETicket & "<form action=""#Ticket_" & TixCount - 1 & """ Method=""post""><input type=""submit"" value=""Prev"" style=""background-color: #31418C; height: 50px; width: 80px;""></form>" & vbCrLf
                'HandheldETicket = HandheldETicket & "<a href=""#Ticket_" & TixCount - 1 & """>Previous</a>" & vbCrLf			
			    HandheldETicket = HandheldETicket & "<input type=""button"" onClick=""location.href='#Ticket_" & TixCount - 1 & "'"" value=""Prev"" style=""background-color: #31418C; height: 50px; width: 80px; font-size: medium; font-weight: bold;"">" & vbCrLf
            Else
                HandheldETicket = HandheldETicket & "&nbsp;" & vbCrLf
            End If
            HandheldETicket = HandheldETicket & "</td>" & vbCrLf
            HandheldETicket = HandheldETicket & "<td align=""center"" width=""40%"">" & vbCrLf
            HandheldETicket = HandheldETicket & "Ticket " & TixCount & " of " & TotalTix & vbCrLf
            HandheldETicket = HandheldETicket & "</td>" & vbCrLf
            HandheldETicket = HandheldETicket & "<td align=""center"" width=""30%"">" & vbCrLf
            If TixCount <> TotalTix Then
                'HandheldETicket = HandheldETicket & "<form action=""#Ticket_" & TixCount + 1 & """ Method=""post""><input type=""submit""  value=""Next"" style=""background-color: #008400; height: 50px; width: 80px;""></form>" & vbCrLf
			    'HandheldETicket = HandheldETicket & "<a href=""#Ticket_" & TixCount + 1 & """>Next</a>" & vbCrLf
			    HandheldETicket = HandheldETicket & "<input type=""button"" onClick=""location.href='#Ticket_" & TixCount + 1 & "'"" value=""Next"" style=""background-color: #008400; height: 50px; width: 80px; font-size: medium; font-weight: bold;"">" & vbCrLf
            Else
                HandheldETicket = HandheldETicket & "&nbsp;" & vbCrLf
            End If
            HandheldETicket = HandheldETicket & "</td>" & vbCrLf
            HandheldETicket = HandheldETicket & "</tr>" & vbCrLf
            HandheldETicket = HandheldETicket & "<tr><td colspan=""3""><br /><br /></td></tr>" & vbCrLf
            HandheldETicket = HandheldETicket & "</table>" & vbCrLf
