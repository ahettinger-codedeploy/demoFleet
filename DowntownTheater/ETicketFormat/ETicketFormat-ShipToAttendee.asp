...
'SSR 08/29/14 - Removed "Presents", removed "Section, Row, Seat", added white background as default
%>
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
           ...
           ' End If
			...
			Response.Write "<TABLE WIDTH=""615"" HEIGHT=""240"" BORDER=""1"" class=""ETicketBackground"" BGCOLOR=""#ffffff"" CELLPADDING=""0"" CELLSPACING=""0"">" & vbCrLf
			Response.Write "<TR>" & vbCrLf
