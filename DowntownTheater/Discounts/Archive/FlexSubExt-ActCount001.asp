...
SeriesPrice = Request.QueryString("FixedPrice")

SeriesArr = split(SeriesCount,",")
DiscArr = split(SeriesPrice,",")
...
Sub  ProcessDiscount
	...
	ElseIf FixedPrice <> "" Then
		If NewPrice > FixedPrice Then
			NewPrice = Round(CDbl(FixedPrice),2)
		End If
