...
CustomETicketLogo = "\Clients\USAntiqueShows\ETicket\Images\ETicketLogo.gif"

'----------------------

'Display Custom Background
'for default background set variable to blank
CustomETicketBackground = "\Clients\USAntiqueShows\ETicket\Images\ETicketBackground.gif"
...
'Reserved Seating vs General Admission Option
'----------------------------------------------
...
'--------------------
            ...
            'Attendee Name Query Goes here
                          
  		    If ShowAttendeeName Then	              
