...
'Options:  Poplulates the ETicketText(1), ETicketText(2), ETicketText(3) variables with the data pulled from TicketText1, TicketText2, TicketText3 fields in EventOptions table

DIM OptionName(3) , ETicketText(3)
...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""2"">ETicketText 1:" & ETicketText(1) & "<BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""2"">ETicketText 2:" & ETicketText(2) & "<BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""2"">ETicketText 3:" & ETicketText(3) & "<BR>" & vbCrLf
		...
		'Begin Body Space
			...
			Response.Write "Parking at Lincoln Garage<BR>BSU Lincoln Ave Garage is located across from the Student Union Building (SUB) at the corner of University Dr and Lincoln Ave.  Parking spaces are numbered throughout the structures. Customers without a Reserve Permit for the respective garage are to pre-pay for parking at any" & vbCrLf
			Response.Write "<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			...
			Response.Write "<BR>" & vbCrLf
			Response.Write "<B>PARKING INFORMATION</B><BR>" & vbCrLf
			Response.Write "pay-by-space unit on any level of the Garage. Garages are available 24 hours per day, 7 days a week and are always pay-by-space or permit only unless otherwise posted.  Make a note of your parking space number before you leave your car.  You will need to enter the number to pay for parking." & vbCrLf
			Response.Write "<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
