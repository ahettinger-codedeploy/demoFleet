...
<%
   ...
   response.write "current file name:  "& strTemp&" <BR><BR> "
   ...
   response.write "current folder path: "& strPath&" <BR><BR>  "

   ' build the page title
   strServerName = LCase(Request.ServerVariables("SERVER_NAME"))
   strTitle = ""& strPath &""
   
response.write "servername: "& strServerName&" <BR><BR>  "
...
newPath = strPath + "images"

 response.write "looking for: "& newPath&" <BR><BR>  "
 
Set objFSOFolder = Server.CreateObject("Scripting.FileSystemObject")  
IF objFSOFolder.FolderExists("images") Then  
Response.write("Images folder already exists")  
Else  
Response.write("Images folder not exists")  
End IF  
