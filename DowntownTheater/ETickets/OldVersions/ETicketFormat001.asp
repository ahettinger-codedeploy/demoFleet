...
'CHANGE LOG
'SSR 3/24/2011
'Updated format. Venue Code case select statement was missing quotes.
'This caused e-ticket format to print blank tickets.
...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'=====================================================
            ...
            'Change E-Ticket Ad based on VenueCode
            
            'Carson Vally Hotel Advertisement
            'eventcode   venuecode   act
            '----------- ----------- -------------------------------------------------------------------------------------------------------------
            '320294      9388        David John & The Comstock Cowboys, Ken Gardner, Cindy White and The Douglas High School Madrigal Singers
            '320295      9388        Dave Stamey, Saddle Cats, Jim King
            '320296      9388        Wylie & The Wild West, Paul Zarzyski, Richard Elloyan
            '320297      9388        Belinda Gail, Doris Daley, Paul Zarzyski, Cindy White
            '320301      9388        Weatherby/Golden, Cody & Kaye, Ken Gardner
            '320302      9388        Sourdough Slim, All Hat No Cattle, Paul Zarzyski
            '320303      9388        Sourdough Slim, Old West Trio, Cindy White
            '320304      9388        Belinda Gail, Cody & Kaye, Ken Gardner
            '320305      9388        Doris Daley, Saddle Cats, Jim King
                        
            
            'Holiday Inn Advertisement
            'eventcode   venuecode   act
            '----------- ----------- ------------------------------------------------------------------
            '321154      9428        Genoa Cowboy Poetry & Music Festival-Day Pass
            '321155      9428        Genoa Cowboy Poetry & Music Festival-Day Pass
            '321156      9428        Genoa Cowboy Poetry & Music Festival- Day Pass- 2 Day Package
            '321523      9302        Pacific Swing Hawaii  ??????
            '321533      9428        Genoa Cowboy Poetry & Music Festival-Day Pass (4-Pak)            
			
			Response.Write "<TABLE WIDTH=""620"" BORDER=""0"" CELLPADDING=""0"" CELLSPACING=""0"">" & vbCrLf
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			
			'Determine the advertising image based on venue code
			
			ErrorLog("VenueCode " & rsTix("VenueCode")& "")
			
			Select Case rsTix("VenueCode") 
			Case "9388","9429","9425","9428" 'Carson Vally Hotel Advertisement, COWBOY CORRAL, Genoa Town Hall, TOWN OF GENOA, NV
			    AdSpaceImage = "CarsonValleyInn_v2.jpg"
			Case 9428 'Holiday Inn Advertisement
				AdSpaceImage = "HolidayInn.jpg"
			Case Else 'Current Advertisting Image
				AdSpaceImage = "CowboyPoetry.jpg"	
	        End Select		
						
			Response.Write "<IMG SRC = ""/Clients/CowboyPoetryGenoa/ETickets/Images/" & AdSpaceImage & " "" WIDTH=""500"">" & vbCrLf
