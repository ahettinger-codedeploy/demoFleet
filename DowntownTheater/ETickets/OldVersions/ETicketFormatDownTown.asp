...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'=================
			...
			Response.Write "</FONT>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2"">" & vbCrLf
			Response.Write "<B>TICKET COUNT INFORMATION</B><BR>" & vbCrLf
			
			If TotalTix  = 1 Then
			    Response.Write "Ticket # " & TixCount & " of " & TotalTix & " ticket<BR>" & vbCrLf
			Else
			    Response.Write "Ticket # " & TixCount & " of " & TotalTix & " tickets<BR>" & vbCrLf
			End If
