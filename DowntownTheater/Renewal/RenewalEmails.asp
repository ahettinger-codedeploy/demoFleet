...
TemplateFileName = "Template_Email_JuniorTheater2016.asp"
...
DIM MsgFontFace
MsgFontFace = "'Helvetica Neue', Helvetica, Arial, sans-serif;"
...
If TestEMailAddress <> "" Then
	EMailReplyTo =  """Tix Technical Support"" <support@tix.com>"
...
Do Until rsOrderLine.EOF
	...
	'This is not the last order.
		...
		If TicketCount > 0 Then
			...
			objCDOSYSMail.ReplyTo = OrganizationName & " <" & EMailReplyTo & ">" 
			If TestEMailAddress <> "" Then
