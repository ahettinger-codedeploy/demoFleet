...
'SSR 07/19/2016 - Created season renewal letters script - based on 2015 version
...
Response.Write "<TABLE border cellpadding=""0"" cellspacing=""0"" style=""background-color:#bfbfbf; width:550px; margin-top:25px;"">" & vbCrLf
Response.Write "<TR>" & vbCrLf 
Response.Write "<TD align=""center"">" & vbCrLf  
