				...
				If EventList <> "" Then
					...
					If Not rsTickets.EOF Then 'There are some events.  List them
						...
						Do Until rsTickets.EOF
							...
							Response.Write "<TR BGCOLOR=""DDDDDD""><TD ALIGN=""center""><INPUT TYPE=""checkbox"" NAME=""EventCode"" VALUE=" & rsTickets("EventCode") & "></TD><TD>" & rsTickets("Act") & "</FONT></TD><TD>" & rsTickets("Venue") & "</TD><TD ALIGN=""center"" NOWRAP>" & DateAndTimeFormat(rsTickets("EventDate")) & "</TD><TD ALIGN=""center"">" & rsTickets("TicketCount") & "</TD></TR>" & vbCrLf
