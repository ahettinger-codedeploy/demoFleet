...
EMailOrganization = "2014 Heart of Dallas Bowl"
EMailURL = "heartofdallasbowl"
EMailReplyTo = "tickets@heartofdallasbowl.org"
EMailSubject = "2014 Heart of Dallas Bowl" 
EMailRenewalURL = "http://"& EmailURL &".tix.com/renew.aspx?np=sc"
OrganizationURL = "www.theheartofdallasbowl.org"
ChangeSeatURL = "http://www.theheartofdallasbowl.org"
EMailFontFace = "arial,helvetica"
TestEMailAddress = "sergio.rodriguez@tix.com;silvia.mahoney@tix.com"
'TestEMailAddress = "sergio.rodriguez@tix.com"

EMailMessageBody = ""
EMailMessageBody = EMailMessageBody & "<table border=""0""><tbody>" & vbCrLf
EMailMessageBody = EMailMessageBody & "<tr><td><FONT FACE=" & EMailFontFace & ">" & vbCrLf
'Start Content
EMailMessageBody = EMailMessageBody & "<p><FONT FACE=" & EMailFontFace & ">Your ticket package will be mailed out at the end of November. If you have any questions or need further details, please don’t hesitate to contact our office at (214) 389-4300.</p>" & vbCrLf
EMailMessageBody = EMailMessageBody & "<p><FONT FACE=" & EMailFontFace & ">Again, thank you for the continued support. The Heart of Dallas organization was created with the idea to showcase its sports and entertainment for the benefit of those in need here in our community. We look forward to hosting everyone on New Year’s Day!</p>" & vbCrLf
'End Content
'Start Saluation
EMailMessageBody = EMailMessageBody & "<p><FONT FACE=" & EMailFontFace & ">Best,</p>" & vbCrLf
EMailMessageBody = EMailMessageBody & "<p><FONT FACE=" & EMailFontFace & ">Brant Ringler<br>" & vbCrLf
EMailMessageBody = EMailMessageBody & "<FONT FACE=" & EMailFontFace & ">Executive Director<br>" & vbCrLf
EMailMessageBody = EMailMessageBody & "<FONT FACE=" & EMailFontFace & ">Heart of Dallas Bowl<br></p>" & vbCrLf
'End Saluation
...
ErrorLog("OrderNumber: "&rsOrderLine("OrderNumber")&"")
	...
	If rsOrderLine("OrderNumber") <> LastOrderNumber Then 'It's different.  Print it.
		If TicketCount > 0 Then 'It's not the first one, print the footer.
			...
			ErrorLog("EMailMessage: "&EMailMessage&"")
...
<%		
			...
			EMailMessage = EMailMessage & "<BR><TABLE CELLPADDING=""3"" WIDTH=""660""><TR><TD WIDTH=10>&nbsp;</TD><TD ALIGN=LEFT><FONT FACE=" & EMailFontFace & "><B>Order Number:&nbsp;" & rsOrderLine("OrderNumber") & "<BR>" & vbCrLf
			...
			EMailMessage = EMailMessage & "Renewal Code:&nbsp;" & RenewalCode & "</B></FONT></TD></TR></TABLE>" & vbCrLf
