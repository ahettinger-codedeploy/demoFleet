...
MsgRenewalURL = "http://RialtoCinemasElmwood.tix.com/renew.aspx"
MsgLogoPath = "http://www.tix.com/Clients/RialtoCinemasElmwood/Renewal/Elmwoodlogo.jpg"
...
/* inactive tabs hover */
.nav > li > a:hover, 
.nav > li > a:focus { border:1px solid #DDDDDD; color:red;}
			...
			<FONT FACE="verdana,arial,helvetica" COLOR="#008400">Subscription Renewal Letters</H4></FONT>
				...
				If EventList <> "" Then
					...
					If Not rsTickets.EOF Then 'There are some events.  List them
						...
						Response.Write "<BUTTON TYPE=""submit"">Print</BUTTON>" & vbCrLf
