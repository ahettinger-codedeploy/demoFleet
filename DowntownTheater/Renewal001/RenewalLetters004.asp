...
<body>
							...
							<div class="btn-group pull-right">
								<div class="btn-group">
									<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
										<span class="glyphicon glyphicon-th"></span> Logs
	...
	Sub DisplayLetters
		...
		If EventList <> "" Then
			...
			If Not rsTickets.EOF Then 'There are some events.  List them
				...
				Response.Write "<INPUT TYPE=""submit"" CLASS=""btn btn-outline btn-default"" VALUE=""Submit"">" & vbCrLf
	...
	If EventList <> "" Then
		...
		If Not rsTickets.EOF Then 'There are some events.  List them
			...
			Response.Write "<FORM ACTION=""?"" METHOD=""post"">" & vbCrLf
...
Do Until rsOrderLine.EOF
	...
	'This is not the last order.
		...
		If TicketCount > 0 Then
			...
			'response.write "id: " & OrderCount & " order number: " & LastOrderNumber & " first name: " & FName & "last name: " & LName & "email address: " & LastEmailAddress & "renewal number; " & RenewalCode & "date sent:>" & Now() & ""
...
If TicketCount > 0 Then	'Print the last footer
	...
	If TestEMailAddress = "" Then
		...
		'response.write "id: " & OrderCount & " order number: " & LastOrderNumber & " first name: " & FName & "last name: " & LName & "email address: " & LastEmailAddress & "renewal number; " & RenewalCode & "date sent:>" & DateSent & ""
...
response.write "<B>createLogFile</B><BR>"
response.write createLogFile
