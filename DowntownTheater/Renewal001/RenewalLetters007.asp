...
<!DOCTYPE html>
	...
	<html lang="en">
		...
		<link href="orbmm.css" rel="stylesheet" type="text/css">
		...
		html body.bootstrap div.container div.col-md-12 div.panel.panel-default.panel-fade div.panel-heading span.panel-title div.pull-left ul.nav.nav-tabs
		{
		margin-top: 1px;
		}
		
		html body.bootstrap div.container div.col-md-12 div.panel.panel-default.panel-fade div.panel-heading span.panel-title div.navbar-btn.navbar-right
		{
		margin: 0px;
		}
		</style>
		...
		color: black;
		border-color: white;
		background-color: rgba(122,180,159,.2) !important;
		...
		/* table - inactive column fade out effect */ 
		...
		.btn-default.btn-outline:hover 	{ color: #ffffff; border-color: #000000; background-color: #000000; border-width: 2px; -webkit-transition: all 0.75s; -moz-transition: all 0.75s; transition: all 0.75s; } 

		.btn-outline.btn-highlight	{ color: #676767; border-color: #676767; background-color: transparent; border-width: 2px;}
		
		.btn-danger.btn-outline:active,
		.btn-danger.btn-outline:focus, 
		.btn-danger.btn-outline 		{ color: #CF000F; border-color: #CF000F; background-color: transparent; border-width: 2px; -webkit-transition: all 0.25s; -moz-transition: all 0.25s; transition: all 0.25s;} 	
		.btn-danger.btn-outline:hover 	{ color: #ffffff; border-color: #CF000F; background-color: #CF000F; border-width: 2px; -webkit-transition: all 0.75s; -moz-transition: all 0.75s; transition: all 0.75s; } 

		/* options button */ 
		div#preferences-dropdown.dropdown button.btn.btn-nav.btn-default.dropdown-toggle
		{
		padding: 8px;
		}
				...
				<div class="col-md-12"> 
					...
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							...
							<span class="panel-title">
								...
								<div class="pull-right">
									...
									<div class="dropdown" id="preferences-dropdown">
										
										<button type="button" class="btn btn-nav btn-default dropdown-toggle" data-toggle="dropdown">
											<span class="glyphicon glyphicon-cog"></span>
											<span class="icon-label">Preferences</span>
										</button>
											...
											<div class="yamm-content">
												<div class="row">
													<ul class="col-sm-2 list-unstyled">
														...
														<li><a href="http://www.testtix.com/sergiotest/support/tixdashboard/codecleaner/index.asp">Code Cleaner</a></li>
														<li><a href="http://www.testtix.com/sergiotest/support/tixdashboard/email/index.asp">Email Editor</a></li>
														<li><a href="http://www.testtix.com/sergiotest/support/tixdashboard/subscriptionCreator/index.asp">Subscription Creator</a></li>
														<li><a href="http://www.testtix.com/sergiotest/support/tixdashboard/subscriptionReview/index.asp">Subscription Review</a></li>	
														<li><a href="http://www.testtix.com/sergiotest/support/tixdashboard/testorders/index.asp">Test Orders</a></li>					
													</ul>
													<ul class="col-sm-2 list-unstyled">
														<li>
														  <p><strong>Lab</strong></p>
														</li>
														<li><a href="http://www.testtix.com/sergiotest/support/tixdashboard/preview/index.asp">Preview</a></li>
														<li><a href="http://www.testtix.com/sergiotest/support/tixdashboard/userlist/userlist.asp">User List</a></li>
														<li><a href="http://www.testtix.com/sergiotest/support/tixdashboard/renewalLetters/renewalLetters.asp">Renewal Letters</a></li>
						...
						<div class="panel-body">
								...
								<span class="display-org"><%=OrgName%></span><BR>
