...
/* switch checkbox  - moved off the screen */ 
.switch-input { position: absolute; top: 0px; left: 0px; opacity: 0;}

/* switch body  - active background color (from label class) */ 
.switch { border-radius: 3px; margin: 0; position: relative; width: 103px; height: 32px; display: block; vertical-align: top; font-size: 15px; text-transform: uppercase; cursor: pointer; box-sizing: content-box; overflow: hidden; }

/* switch body  - disabled background color */ 
.switch-label { border-radius: 3px; margin: 0; position: relative; width: 103px; height: 32px; display: block; vertical-align: top; font-size: 15px; text-transform: uppercase; cursor: pointer; box-sizing: content-box; overflow: hidden; transition: all 0.15s ease-out 0s; background-color: #cccccc; 	}

/* switch body - toggle active - show active background on */
.switch-input:checked ~ .switch-label { background-color: transparent; }

/* toggle disabled - show square right */
.switch-handle { border-radius: 3px; background-color: #eeeeee;  width: 30px; height: 28px; position: absolute; top: 2px; left: 3px; transition: left 0.45s ease-out 0s; }

/* toggle active - show square left */
.switch-input:checked ~ .switch-handle { left: 70px; background-color: #ffffff;}

/* toggle active - show OFF text */
.switch-label:before { content: attr(data-off); right: 11px; color: #f1f1f1; }

/* toggle disabled - hide ON text */
.switch-input:checked ~ .switch-label:after {  opacity: 1; }

/* toggle active  - show ON text */
.switch-label:after { content: attr(data-on); left: 11px; color: #ffffff; opacity: 0; }

/* toggle active - hide OFF text */
				...
				<DIV class="panel-title">
					<NAV class="navbar" role="navigation">
						...
						<DIV class="nav-btn pull-right">
						  <BUTTON class="btn btn-large btn-default btn-options" type="button" data-placement="top" title="Options">
...
$(".email-select").selectBoxIt();
// Removes the first drop down option from the list
$(".email-select").data("selectBox-selectBoxIt").remove(0);
</script> 
...
Sub DisplayEmails
	...
	%>		
				...
				Select events and click below<BR>
				<BR>
				<input type="submit" id="email-submit" class="btn btn-info email-control" value="Submit" style="width:70px;"/> 
	...
	<DIV class="container-fluid effect1" id="panel-edit-inner">
		...
		<div class="well panel-well">
			...
			<ul class="nav nav-pills nav-stacked col-sm-3">
				<li class="label-primary active"><a  href="#tab1" data-toggle="tab">Email Testing</a></li>
						...
						<div class="panel-body">
							<form class="form-horizontal" role="form">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label pull-left">Test Mode</label>
									<div class="col-lg-9">
								...
								<div class="form-group">
									...
									<div class="col-sm-9" >
										<select class="form-control email-control email-select" name="TestEMailAddress">
