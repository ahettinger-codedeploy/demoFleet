...
Page = "Management"
SecurityFunction = "ClientInquiry"
ReportFileName = "index001.asp"
ReportTitle = "Client Inquiry"
...
<html>
	...
	<head>
		...
		<style>
		h3.modal-title {color: #FFFFFF; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);}
		form.mod  {margin: 0;}
		.modal-danger { background-color: #DA4F49; background-image: -moz-linear-gradient(center top , #EE5F5B, #BD362F); background-repeat: repeat-x; border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25); color: #FFFFFF; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); border-radius: 6px 6px 0 0;}
		.modal-success {background-color: #5BB75B; background-image: -moz-linear-gradient(center top , #62C462, #51A351); background-repeat: repeat-x; border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25); color: #FFFFFF; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); border-radius: 6px 6px 0 0;}
		.modal-inverse {background-color: #363636; background-image: -moz-linear-gradient(center top , #444444, #222222); background-repeat: repeat-x; border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25); color: #FFFFFF; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); border-radius: 6px 6px 0 0;}
		.modal-primary {background-color: #1E2A36; background-repeat: repeat-x; border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25); color: #FFFFFF; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); border-radius: 6px 6px 0 0; }
		</style>
		...
		<div class="container">
				...
				<div class="row">
						  ...
						  <div class="col-lg-12 page-header">
								<h3 id="forms">Email Renewal</h3>
								<button data-toggle="modal" href="#myModal" class="btn btn-primary pull-right" style="margin-top:-45px"><i class="icon-search"></i>&nbsp;&nbsp;Import Word Document</button>
						  </div>
				...
				<div id="modOutlook" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				
					<form class="mod form-horizontal" method="POST" action="importWord.asp">
				
						<div class="modal-header  modal-primary">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="icon-remove-sign"></i></button>
							<h3 class="modal-title" id="myModalLabel"> <i class="icon-windows icon-large"></i>&nbsp;Import Word Document</h3>
						</div>

						<div class="modal-body">
				
								<h4>Select the html file</h4>
...
Function replaceTextHTML(strText)
...
strText = Replace(strText, "<robert.edmison@tix.com>", " ")

replaceTextHTML = strText
...
function encodeHTML(strText)
   ...
   strText = Replace(strText, Chr(32), "&nbsp;") 
	...
	For I = 1 to 255
        strText = Replace(strText,Chr(I),"&#" & I & ";")
    next
...
function decodeHTML(strText)
    ...
    For I = 1 to 255
        strText = Replace(strText, "&#" & I & ";", Chr(I))
    next
...
Function removeOUTLOOK(strText)

    Dim TAGLIST
    TAGLIST = "<!--;P;HTML;O:P;O:LOCK;HEAD;XML;W:LSDEXCEPTION;W:ZOOM;W:;W:LATENTSTYLES;TITLE;STYLE;B;P;FONT;SPAN;LINK;O:;META;V:F;V:FORMULAS;V:IMAGEDATA;V:PATH;V:SHAPETYPE;V:SHAPE;V:STROKE;VAR;WBR;W:;XMP;"

    Const BLOCKTAGLIST = ";APPLET;EMBED;FRAMESET;HEAD;NOFRAMES;NOSCRIPT;OBJECT;SCRIPT;BODY;"
...
Function removeHTML(strText)
    ...
    TAGLIST = ";!--;!DOCTYPE;A;ACRONYM;ADDRESS;APPLET;AREA;BASE;BASEFONT;" &_
              "B;BR;BGSOUND;BIG;BLOCKQUOTE;BODY;BUTTON;CAPTION;CENTER;CITE;CODE;" &_
              "COL;COLGROUP;COMMENT;DEL;DFN;DIR;DIV;EM;EMBED;FIELDSET;" &_
              "FORM;FONT;FRAME;FRAMESET;HEAD;HTML;I;IFRAME;" &_
              "INPUT;INS;ISINDEX;KBD;LAYER;LAGEND;LINK;LISTING;M:;MAP;MARQUEE;" &_
              "MENU;META;NOBR;NOFRAMES;NOSCRIPT;OBJECT;O:;O:LOCK;O:P;OPTION;P;PARAM;PLAINTEXT;" &_
              "PRE;Q;S;SAMP;SCRIPT;SELECT;SPAN;STRIKE;STYLE;" &_
              "V:F;V:FORMULAS;V:IMAGEDATA;V:PATH;V:SHAPETYPE;V:SHAPE;V:STROKE;VAR;WBR;W:;XMP;"
...
Function removeSpecials(strText)
...
Function addBR(strReplace)

strReplace = Replace(strReplace, "</P>","<BR>")

strReplace = Replace(strReplace, "</p>","<BR>")

strReplace = Replace(strReplace, "robert.edmison@tix.com"," ")

strReplace = Replace(strReplace, "WordSection1","outlook")
...
Function addDL(strReplace)


strReplace = Replace(strReplace, "WordSection1","outlook")

strReplace = Replace(strReplace, "<b>From:                              </b>","<dl><dt><b>From:</b></dt><dd>")

strReplace = Replace(strReplace, "Sent:","</dd><dt><b>Sent:</b></dt><dd>")

strReplace = Replace(strReplace, "To:","</dd><dt><b>To:</b></dt><dd>")

strReplace = Replace(strReplace, "Subject:","</dd><dt><b>Subject:</b></dt><dd>")
...
function removeSpaces(strStarter)
...
removeSpaces = strStarter

End Function

'----------------------------

function regexSpaces(str)
...
'Remove the space between the end of a word and
'a punctuation mark
  regEx.Pattern = "\s(\!|\.|\?|\;|\,|\:)"
