...
EMailOrganization = Session("OrganizationName")
PrivateLabel =  Session("PrivateLabel")
              ...
              If EventList <> "" Then
                     ...
                     <FORM ACTION="" METHOD="post">
                           ...
                           <TABLE class="table table-data table-striped table-fade">
                                  <THEAD>
                                         <TR><TH data-toggle="tooltip" data-placement="top"><input type="checkbox" id="select_all"/></TH><TH>Production</TH><TH data-container="body">Venue</TH><TH>Date/Time</TH><TH>Ticket Quantity</TH></TR>
                                  </THEAD>
                                  <TFOOT>
                     ...
                     <%
                                  ...
                                  Do Until rsTickets.EOF
                                         Response.Write "<TR><TD><INPUT TYPE=""checkbox"" class=""table-check"" NAME=""EventCode"" VALUE=""" & rsTickets("EventCode") & """></TD><TD>" & rsTickets("Act") & "</TD><TD>" & rsTickets("Venue") & "</TD><TD>" & DateAndTimeFormat(rsTickets("EventDate")) & "</TD><TD>" & rsTickets("TicketCount") & "</TD></TR>" & vbCrLf
                                  rsTickets.MoveNext
                                  Loop
                     %>
                                  </TBODY>
...
<TBODY>
<TR><TD><INPUT TYPE="checkbox" NAME="EventCode" VALUE="588031" class="table-checkbox"></TD><TD>Season Subscription (Winter)</TD><TD>Downtown Theater</TD><TD>1/1/2015 12:00 PM</TD><TD>8</TD></TR>
<TR><TD><INPUT TYPE="checkbox" NAME="EventCode" VALUE="588031" class="table-checkbox"></TD><TD>Season Subscription (Spring)</TD><TD>Downtown Theater</TD><TD>1/1/2015 12:00 PM</TD><TD>8</TD></TR>
<TR><TD><INPUT TYPE="checkbox" NAME="EventCode" VALUE="588031" class="table-checkbox"></TD><TD>Season Subscription (Summer)</TD><TD>Downtown Theater</TD><TD>1/1/2015 12:00 PM</TD><TD>8</TD></TR>
<TR><TD><INPUT TYPE="checkbox" NAME="EventCode" VALUE="588031" class="table-checkbox"></TD><TD>Season Subscription (Fall)</TD><TD>Downtown Theater</TD><TD>1/1/2015 12:00 PM</TD><TD>8</TD></TR>
</TBODY>
</TABLE>
...
If Session("OrganizationName") = "" Then
	...
	Set rsThisOrg = OBJdbConnection.Execute(SQLThisOrg)
		   strResult = rsThisOrg("Organization") 
	rsThisOrg.Close
	Set rsThisOrg = Nothing

Else

strResult =  Session("OrganizationName")

End If

GetOrgName = strResult
...
If Session("PrivateLabel") = "" Then

	SQLVenueRefCheck = "SELECT VenueCode, OptionName, OptionValue FROM VenueOptions WITH (NOLOCK) WHERE VenueCode = (SELECT TOP 1 VenueCode FROM VenueOptions (NOLOCK) WHERE OptionName = 'OrganizationNumber' AND OptionValue = '" & Session("OrganizationNumber") & "') AND (OptionName = 'VenueReference')"
	Set rsVenueRefCheck = OBJdbConnection.Execute(SQLVenueRefCheck)
	If NOT rsVenueRefCheck.EOF Then
		   strResult = rsVenueRefCheck("OptionValue")
	End If
...
Else
	...
	strResult =  Session("PrivateLabel")

End If

GetPrivateLabel = strResult
...
PUBLIC FUNCTION replaceVar(strText)
              ...
              strNewText = Replace(strNewText, "[OrganizationNumber]", Session("OrganizationNumber"))
              strNewText = Replace(strNewText, "[OrganizationName]", Session("OrganizationName"))
