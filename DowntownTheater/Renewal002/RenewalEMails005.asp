...
ClientDirectory = "/Clients/RialtoCinemasCerrito/Renewal"

TemplateFileName = "CER_2015_NT_Hangmen_SSR_Email.asp"

LogoFileName = "CerritoLogo.jpg"

DIM RenewalURL
RenewalURL = "http://rialtocinemascerrito.tix.com/renew.aspx?"
...
DIM EMailSubject
EMailSubject = "Martin McDonagh's Smash Hit Hangmen - New National Theatre Live Offer!"
...
If TicketCount > 0 Then	'Print the last footer
	...
	If TestEMailAddress = "" Then
		...
		strReport = strReport & LastOrderNumber & " - " & LastEmailAddress & "|"		
		OrderCount = OrderCount + 1
...
strReport = strReport & "Order Count: " & OrderCount & "<BR>"
...
PUBLIC FUNCTION fnCreateReport(strText)

If strText <> "" Then

	DIM ServerName
	ServerName = "http://testtix.com"
	Response.Write "ServerName: " &  ServerName &"<BR><BR>"

	DIM FolderPath
	FolderPath = "clients/downtowntheater/renewals/reports"
	Response.Write "FolderPath: " &  FolderPath &"<BR><BR>"

	DIM FileName
	FileName = "season_renewals.txt"
	Response.Write "FileName: " &  FileName &"<BR><BR>"

	DIM FilePath
	FilePath = ServerName & "/" & FolderPath & "/" & FileName & "/"
	...
	Set txtFile = objFSO.CreateTextFile(FilePath, true)
