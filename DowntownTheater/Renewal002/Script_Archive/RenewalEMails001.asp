...
MsgLogoPath = "http://www.tix.com/images/clear.gif"
MsgFontFace = "Times, serif"

TemplateFileName = "Template_Email.asp"

DIM RenewalPage
RenewalPage = "http://" & PrivateLabel & ".tix.com/renew.aspx"
...
'TestEMailAddress = "info@roadcompany.com"
TestEmailCount = 1
...
Do Until rsOrderLine.EOF
	...
	'This is not the last order.
		...
		If TicketCount > 0 Then
			...
			EMailMessage = EMailMessage & InsertTemplate(TemplateFileName,"Footer") 
		...
		If Not rsCustInfo.EOF Then
			...
			If ReturnAddress1 = "Y" Then
				...
				ReturnAddress = ReturnAddress & "</TR>" & vbCrLf
				ReturnAddress = ReturnAddress & "<TR>" & vbCrLf
				ReturnAddress = ReturnAddress & "<TD COLSPAN=""2""><hr></TD>" & vbCrLf
				ReturnAddress = ReturnAddress & "</TR>" & vbCrLf
			...
			End If
				...
				ReturnAddress = ReturnAddress & "<FONT FACE=" & MsgFontFace & "><IMG SRC="" " & MsgLogoPath & " ""><BR><BR>" & vbCrLf
				ReturnAddress = ReturnAddress & "</TD><TR>" & vbCrLf
				
				ReturnAddress = ReturnAddress & "<TR><TD WIDTH=300>" & vbCrLf
			...
			EMailMessage = EMailMessage & InsertTemplate(TemplateFileName,"Header") 
									
			'Insert HTML Template - Masthead Content
			EMailMessage = EMailMessage & InsertTemplate(TemplateFileName,"Masthead") 
			
			'Insert HTML Template - Masthead Content
			EMailMessage = EMailMessage & InsertTemplate(TemplateFileName,"Body") 
...
PUBLIC FUNCTION replaceVar(strText)
		...
		RenewalPage = RenewalURL & "?o=" & RenewalOrderNumber & "&c=" & RenewalCode
		...
		strNewText = Replace(strNewText, "[RenewalPage]",RenewalPage)
