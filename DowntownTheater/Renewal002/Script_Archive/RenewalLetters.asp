...
<FONT FACE="verdana,arial,helvetica" COLOR="#008400"><H3>Subscription Renewal E-Mails</H3></FONT>
...
If EventList <> "" Then
	...
	If Not rsTickets.EOF Then 'There are some events.  List them
		Response.Write "<FORM ACTION="""" METHOD=""post""><INPUT TYPE=""hidden"" NAME=""FormName"" VALUE=""SendEmails"">" & vbCrLf
...
/* e-ticket settings: output to printer */ 
@page  
{ 
	/* printed page width - set to full width */
	* { width: 100%; margin: 0; float: none;}

	/* printed page margins - set to .5 inches */ 
	size: auto; 
	margin: 0.5in 0.35in ;  

	/* printed images & tables - prevent page break in the middle */ 
	img, table { page-break-inside: avoid; }
	table {width:100%;}
} 

/* e-ticket settings: display online*/ 
body  
{ 
	/* on screen margin: none */ 
	margin: 0px;  
} 
...
templateFileName = "\Clients\DowntownTheater\Renewal\templates\2015\EmailInclude.asp"
