...
RenewalURL = "http://downtowntheater.tix.com/renew.aspx?np=sc"
LogoPath = "http://www.tix.com/Clients/downtowntheater./Renewal/RialtoCinemasLogo.jpg"
MsgFontFace = "arial,helvetica"

TemplateFileName = "Template_Letter_Rialto2015.asp"
TemplateLocation = "\Clients\downtowntheater.\Renewal\template\"
								...
								<form class="form-horizontal" role="form">
									...
									<fieldset>
										...
										<div class="form-group">
											...
											<div class="col-lg-7">
												<input type="text" class="toggle-control form-control" id="textbox1" placeholder="Toggle Text"></input>
											</div>
										...
										<div class="form-group">
											...
											<label class="col-sm-3 control-label">Order Count</label>
				...
				<div class="panel-body" id="panel-display">
					...
					If EventList <> "" Then
						...
						If Not rsTickets.EOF Then 'There are some events.  List them
							...
							Response.Write "<p> <input type=""submit"" class=""btn btn-ghost btn-default toggle-submit toggle-control"" value=""Print"" style=""width:120px;""/> </p>" & vbCrLf
...
Do Until rsOrderLine.EOF ' Or LetterCount >= 1
	...
	'This is not the last order.
		...
		If TicketCount > 0 Then 
			...
			Response.Write "<TR><TD ALIGN=""right"" COLSPAN=""" & NumColumns - 1 & """>Order Total</TD><TD ALIGN=""right"">" & FormatCurrency(LastTotal,2) & "</TD></TR>" & vbCrLf
			
			If LastTender <> 0 Then
				Response.Write "<TR><TD ALIGN=""right"" COLSPAN=""" & NumColumns - 1 & """>Less Payments</TD><TD ALIGN=""right"">" & FormatCurrency(LastTender,2) & "</TD></TR>" & vbCrLf
				Response.Write "<TR><TD ALIGN=""right"" COLSPAN=""" & NumColumns - 1 & """>Balance Due</TD><TD ALIGN=""right"">" & FormatCurrency(LastTotal - LastTender,2) & "</TD></TR>" & vbCrLf
			End If
			
			If LastShipFee = 0 And LastOrderTypeNumber <> 5 Then
				Response.Write "<TR><TD ALIGN=""right"" COLSPAN=""" & NumColumns - 1 & """>[&nbsp;&nbsp;] ADD $1 for mailing</TD><TD ALIGN=""right"">&nbsp;&nbsp;</TD></TR>" & vbCrLf
				Response.Write "<TR><TD COLSPAN=""" & NumColumns - 1 & """>&nbsp;</TD><TD><HR></TD></TR>" & vbCrLf
			End If
		...
		If Not rsCustInfo.EOF Then
			...
			Response.Write InsertTemplate(TemplateFileName,"Masthead") 
			...
			Response.Write "<TD WIDTH=""50%""><B>Shipping Information</B></TD>" & vbCrLf
			Response.Write "<TD WIDTH=""50%""><B>Billing Information</B></TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "<TR>" & vbCrLf
			...
			Response.Write "</TD>" & vbCrLf
			Response.Write "<TD>" & vbCrLf
			Response.Write "" & rsCustInfo("FirstName") & " " & rsCustInfo("LastName") & "<BR>" & rsCustInfo("Address1") & "<BR>" & vbCrLf
			...
			Response.Write "<B>Order Number:</B>&nbsp;" & rsOrderLine("OrderNumber") & "" & vbCrLf
			Response.Write "</TD>" & vbCrLf
	...
	If LastEventCode <> rsOrderLine("EventCode") Or LastOrderNumber <> rsOrderLine("OrderNumber") Then
		...
		Response.Write "<TABLE WIDTH=""650"" cellpadding=""0"" cellspacing=""0""  border=""0"">" & vbCrLf
		Response.Write "<TR><TD><B>" & rsOrderLine("Act") & " at " & rsOrderLine("Venue") & "" & vbCrLf
		...
		NumColumns = 6
		ColumnHeading = "<TABLE WIDTH=""650"" cellpadding=""0"" cellspacing=""0"" border=""0""><TR><TD><B><U>Section</U></B></TD><TD ALIGN=center><B><U>Row</U></B></TD><TD ALIGN=center><B><U>Seat</U></B></TD><TD><B><U>Type</U></B></TD><TD ALIGN=right><B><U>Price</U></B></TD>"
...
If TicketCount > 0 Then	'Print the last footer
	...
	Response.Write "<TR><TD ALIGN=""right"" COLSPAN=""" & NumColumns - 1 & """>Total Order</TD><TD ALIGN=""right"">" & FormatCurrency(LastTotal,2) & "</TD></TR>" & vbCrLf
...
PUBLIC FUNCTION replaceVar(strText)
		...
		strNewText = Replace(strNewText, "[OrgName]", organizationName)
