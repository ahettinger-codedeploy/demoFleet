...
<div id="wrapper" class="row">
	<div class="col-lg-12">
		...
		<div class="tab-content" style="padding:10px;">
			...
			<FONT FACE="verdana,arial,helvetica" COLOR="#008400"><H4><%=OrgName%><BR></FONT>
			...
			<BR>
				...
				If EventList <> "" Then
					...
					If Not rsTickets.EOF Then 'There are some events.  List them
						...
						Response.Write "<TABLE border=1 class=""table table-striped table-bordered table-fade"">" & vbCrLf
...
Do Until rsOrderLine.EOF ' Or LetterCount >= 1
	...
	'This is not the last order.
		...
		If Not rsCustInfo.EOF Then
			...
			Response.Write "<TD WIDTH=""50%""><FONT FACE=""" & MsgFontFace & """><B>Shipping Information</B></TD>" & vbCrLf
			Response.Write "<TD WIDTH=""50%""><FONT FACE=""" & MsgFontFace & """><B>Billing Information</B></TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "<TR>" & vbCrLf
