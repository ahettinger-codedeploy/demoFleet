...
Sub SaveLogReport(logInfoList,logResults)
	...
	logFilePath = Server.MapPath("/Clients/DowntownTheater/Renewal/logs/")
	
	response.write "logFilePath: " & logFilePath & "<BR>"
	...
	If Not fnFileExists(logFilePath) Then
		response.write "logFilePath does not exisit: " & logFilePath & "<BR>"
