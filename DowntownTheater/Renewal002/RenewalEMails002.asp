...
DIM orgName
orgName = fnOrgName(Session("OrganizationNumber"))
...
DIM LogFolderPath
LogFolderPath = Server.MapPath(ClientDirectory & LogLocation)
				...
				<div class="panel-title">
					...
					<nav class="navbar" role="navigation">
						...
						<div class="navbar-header">
							<span class="navbar-brand"><%=orgName%></span>
						</div>
...
dim logInfoList
logInfoList = logInfoList & "<datesent>" & dtDate & "</datesent>"
logInfoList = logInfoList & "<ordercount>100</ordercount>"
logInfoList = logInfoList & "<replyto>egestas@loremac.com</replyto>"
logInfoList = logInfoList & "<subject>Renewal Today</subject>"
...
Do Until rsOrderLine.EOF
	...
	'This is not the last order.
		...
		If TicketCount > 0 Then
			...
			objCDOSYSMail.From = orgName & " <" & EMailReplyTo & ">" 
			...
			emaillist1 = emaillist1 & "<email><firstname>Ingrid</firstname><lastname>Sharpe</lastname><ordernumber>333333</ordernumber><email_address>sagittis.lobortis@risus.org</email_address><customernumber>151202</customernumber><renewalnumber>782694222</renewalnumber></email>"  
...
logResults = logResults & emaillist

'Call SaveLogReport(logInfoList,logResults)
...
strNewText = ""
	...
	Else
		...
		strNewText = "Sorry! Template File Not Found. File: " & TemplateFilePath & "<BR>"
...
PUBLIC FUNCTION replaceVar(strText)
		...
		strNewText = Replace(strNewText, "[OrgName]", OrgName)
...
PUBLIC FUNCTION fnOrgName(OrgNumbr)

DIM strResults

SQLSearch = "Select  Organization  FROM Organization (NOLOCK) WHERE OrganizationNumber = " &  OrgNumbr & ""
