		...
		<div class="panel panel-default" id="panel-parent">
			...
			If EventList <> "" Then
				...
				If Not rsTickets.EOF Then 'There are some events.  List them
					...
					Response.Write "<TR><TH>Print</TH><TH style=""text-align:left"">Event</TH><TH style=""text-align:left"">Venue</TH><TH>Date/Time</TH><TH>Quantity</TH></TR>" & vbCrLf
					Response.Write "</THEAD>" & vbCrLf
...
Do Until rsOrderLine.EOF
	...
	'This is not the last order.
		...
		If Not rsCustInfo.EOF Then
			...
			CustomerName = "<FONT FACE=" & MsgFontFace & ">" & PCase(rsCustInfo("ShipFirstName")) & " " & PCase(rsCustInfo("ShipLastName")) & "" & vbCrLf
...
strNewText = ""
	...
	Else
		...
		strNewText = "Sorry! Template File Not Found at: " & TemplateFilePath & ""
