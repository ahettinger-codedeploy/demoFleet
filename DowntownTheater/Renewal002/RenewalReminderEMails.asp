...
ClientDirectory = "/Clients/ThePower-Con/Renewals"

TemplateFileName = "Template_ETicketReminder.asp"

LogoFileName = "PowerCon_logo.png"

DIM RenewalURL
RenewalURL = "http://ThePower-Con.tix.com/renew.aspx?"
...
DIM EMailReplyTo
EMailReplyTo = "info@thepower-con.com"
...
'TestEMailAddress = "steve.moore@tix.com"
...
.header {font-family: verdana,arial,helvetica; color:#008400; font-size: 16px;}
</style>
		...
		<div class="panel panel-default" id="panel-parent">
				...
				<div class="panel-title">
					...
					<nav class="navbar" role="navigation">
						...
						<div class="navbar-header">
							<span class="navbar-brand"><%=organizationName%> 12:48</span>
						</div>
			...
			If EventList <> "" Then
				...
				If Not rsTickets.EOF Then 'There are some events.  List them
					...
					Response.Write "<TR><TH>Print</TH><TH style=""text-align:left"">Event Code</TH><TH style=""text-align:left"">Event Name</TH><TH style=""text-align:left"">Venue</TH><TH>Date/Time</TH><TH>Quantity</TH></TR>" & vbCrLf
					Response.Write "</THEAD>" & vbCrLf
...
Do Until rsOrderLine.EOF
	...
	'This is not the last order.
		...
		If Not rsCustInfo.EOF Then
			...
			ReturnAddress = ReturnAddress & "<IMG SRC=""https://www.testtix.com/Clients/DowntownTheater/Renewal/templates/images/PowerCon_logo.png""><BR><BR>" & vbCrLf
			...
			ETicketURL = "https://www.tix.com/Clients/ThePower-Con/ETicket/ETicketFormat_PackingList.asp?OrderNumber=" & rsOrderLine("OrderNumber") & "&TicketNumber=" & TicketNumber & ""
			...
			'OrderRenewal = OrderRenewal & "<FONT FACE=""" & MsgFontFace & """><B>Renewal Code:</B>&nbsp;" & rsCustInfo("CustomerNumber") & ItemNumber & "</FONT>" & vbCrLf
			'OrderRenewal = OrderRenewal & "</TD>" & vbCrLf
			'OrderRenewal = OrderRenewal & "</TR>" & vbCrLf
			'OrderRenewal = OrderRenewal & "<TR>" & vbCrLf
			'OrderRenewal = OrderRenewal & "<TD ALIGN=""left"">" & vbCrLf
			'OrderRenewal = OrderRenewal & "<FONT FACE=""" & MsgFontFace & """><B>Customer Number:</B>&nbsp;" & rsCustInfo("CustomerNumber") & "</FONT>" & vbCrLf
			'OrderRenewal = OrderRenewal & "</TD>" & vbCrLf
			'OrderRenewal = OrderRenewal & "<TD ALIGN=""right"">" & vbCrLf		
			'OrderRenewal = OrderRenewal & "<FONT FACE=""" & MsgFontFace & """><B>Item Number :</B>&nbsp;" & ItemNumber & "</FONT>" & vbCrLf
			'OrderRenewal = OrderRenewal & "</TD>" & vbCrLf
			'OrderRenewal = OrderRenewal & "</TR>" & vbCrLf
			'OrderRenewal = OrderRenewal & "</TABLE>" & vbCrLf
