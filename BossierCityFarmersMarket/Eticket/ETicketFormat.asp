...
'LSP 07/08/15 - Remove Row, Change Seat to Space, Remove Date & Time, Add Event comments to Date field
%>
...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""3""><B>" & rsTix("EventComments") &"</B></FONT><BR><BR>" & vbCrLf
			...
			If rsTix("Map") <> "general" Then
				Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""2""><B>Section: " & rsTix("Section") &   "&nbsp;&nbsp;&nbsp;&nbsp;Space: " & rsTix("Seat") & "</B></FONT><BR>" & vbCrLf
			Else
