...
'SSR 9/3/14 - 'Extended the Per Ticket Discount Script
			'New option to allow discounts based on a specific customer's past purchase history
			'Requires 2 Parameters:
			' &RequiredPastEvent=678679 - This is the required event
			' &SeriesCount=6 - This is the number of discounted tickets allowed for each ticket purchased from the required event
