...
Page = "Survey"
SurveyNumber = 1512
SurveyName = "PastEventDiscount2013.asp"
...
'------------------------
'EventCode  Name 
'589274 	2013 Subscription Package FLEX


'Required Ticket Type
'--------------------
'SeatCode  	Name 						Vouchers
'8049		Adult Package (six shows)	6
...
'ActCode    Act
'94012 	 	9 to 5
'94008 	 	NOT NOW DARLING
'94006 	 	SAID THE SPIDER TO THE SPY
'94011 	 	THE BUTLER DID IT
'94007 	 	THE HEIRS
'94028 	 	YOU SAY TOMATOES
...
DiscountTypeNumber = 81714
SeriesPercentage = 1.0 '100% Discount
MemberEventCode = 589274 'Requred event to purchase
...
Set rsFreeTickets = OBJdbConnection.Execute(SQLFreeTickets)
    ...
    If Not rsFreeTickets.EOF Then
        ...
        Select Case rsFreeTickets("SeatTypeCode")
            Case  SeriesSeatType(1), SeriesSeatType(2), SeriesSeatType(3)
                Count = SeriesCount(1)
         End Select
