...
function flash_plugin_check(skip) {
	var ie = document.all;
	...
	else if ((flash < 9 && (pc == 1 || opera == 1 || safari == 1 || chrome == 1 || ns == 1 || mac == 1)) || (flash == "mac4.5"))  
	{
		if(skip == '992')
			return false;
		else
...
function mac_ff_flash9 (live) {
	var ff = (navigator.userAgent.indexOf("Firefox") != -1) ? true : false;
	var flash = swfobject.getFlashPlayerVersion().major;
