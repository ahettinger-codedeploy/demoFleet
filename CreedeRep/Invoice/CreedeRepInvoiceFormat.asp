...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><TABLE WIDTH=750><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top""><BR><BR><BR>Creede Repertory Theatre<BR>124 N. Main Street<BR>PO Box 269<BR>Creede, CO 81130<BR></TD><TD><IMG SRC=/PrivateLabel/CreedeRep/Invoice/logo.gif><BR></TD></TR></TABLE>"
	...
	Response.Write "<TABLE WIDTH=""700""><TR><TD>&nbsp;</TD><TD><B>Order Date: " & rsCustInfo("OrderDate") & " </B><BR><BR>" & vbCrLf
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from Creede Repertory Theatre via www.TIX.com . The details of your order are listed below. For questions regarding this order, contact Creede Repertory Theatre via e-mail at crt@creederep.com or phone (719) 658-2540.<BR><BR>All Season Tickets will be held at the CRT Box Office. No tickets will be mailed. Season tickets are not valid for CRT Special Events or Concert Series.  Season tickets may be used for the following shows: Leading Ladies, To Fool the Eye, Pygmalion, Urinetown, Everything In the Garden and Bad Dates.<br><br><B>SEASON TICKETS DO NOT GUARANTEE SEATS TO A SPECIFIC PERFORMANCE. Please call early to reserve seats. Thank you.</B><BR><BR>" & vbCrLf
