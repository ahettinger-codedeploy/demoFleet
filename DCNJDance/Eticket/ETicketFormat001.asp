...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<B> DIRECTIONS to Voorhees for Dec 4th </b><br>" & vbCrLf
			Response.Write "Rte 87 West to Exit 17 - Rte 31 North<br>" & vbCrLf
			Response.Write "2 Miles take Right to County Rd 513 / Main St<br>" & vbCrLf
			Response.Write "You stay on Rte 513 until Voorhes but it turns 4 times in High Bridge<br>" & vbCrLf
			Response.Write "1 mile Right at Bridge St<br>" & vbCrLf
			Response.Write "390 ft Left at Main St.<br>" & vbCrLf
			Response.Write ".2 mile Right at Church St ft Left at Main St.<br>" & vbCrLf
			Response.Write "240 Left at Fairview Ave<br>" & vbCrLf
			Response.Write "Stay on County Rd 513 for 2 Miles<br>" & vbCrLf
			Response.Write "Voorhes HS is on Right<br>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			...
			Response.Write "<br>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">" & vbCrLf
			Response.Write "<B> DIRECTIONS to Bernards HS for Dec 11th </b><br>" & vbCrLf
			Response.Write "Bernards High School Performing Arts Center<br>" & vbCrLf
			Response.Write "Directions from Route 202 & 206<br>" & vbCrLf
			Response.Write "Take 202 N past Bernardsville train station, go through<br>" & vbCrLf
			Response.Write "traffic light and make a left turn on Church St. bear right<br>" & vbCrLf
			Response.Write "onto Wesley Ave. Make a Right at the high school<br>" & vbCrLf
			Response.Write "<br>" & vbCrLf
			Response.Write "From Route 287 Exit 26 - Mount Airy Rd<br>" & vbCrLf
			Response.Write "Follow Mt. Airy Road towards Benards Ville 525 through<br>" & vbCrLf
			Response.Write "traffic light make a right onto Olcott Ave.<br>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""/clients/DCNJDance/ETicket/Images/ad.png"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
