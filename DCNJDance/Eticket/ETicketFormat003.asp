...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<TABLE WIDTH=""615"" HEIGHT=""240"" BORDER=""1"" BACKGROUND=""/clients/DCNJDance/ETicket/Images/e_ticket_background_TRD.gif"" BGCOLOR=""#FFD718"" CELLPADDING=""0"" CELLSPACING=""0"">" & vbCrLf
			Response.Write "<TR>" & vbCrLf
			...
			Response.Write "<IMG SRC=""/clients/DCNJDance/ETicket/Images/e_ticket_logo_TRD.gif"">" & vbCrLf
		...
		'Begin Body Space
			...
			Select Case rsTix("EventCode") 
			    Case "417061","417546"
			        Directions = "directionVOORHEES.png"
				Case "417060", "417547"
			        Directions = "directionBERNARDS.png"	

				Case Else 'Default Advertisting Image
				    Directions = "directionBLANK.png"	
	        End Select		
						
			Response.Write "<IMG SRC = ""/Clients/DCNJDance/ETicket/Images/" & Directions & " "" >" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""/clients/DCNJDance/ETicket/Images/intensive_ad.png"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
