...
<%
'CHANGELOG
'9/18/2012 - SLM - Updated images and driving directions
'7/17/2013 - LSP - Update Directions
'7/18/2013 - LSP - Close tag
'7/25/2013 - SLM - Added new event to list
'8/1/2013 - SLM - Added new event to list
%>
...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""3""><B>E-TICKET MUST BE PRESENTED</B></FONT>" & vbCrLf 
			...
			ErrorLog("TixAct " & rsTix("Act")  & "")
	
	        Select Case rsTix("Act") 
				Case "75227"
			     Advisory = "Ticket may only be used from 4pm to 7pm. No refunds or exchanges granted"
			...
			Response.Write "<B>" & Advisory & "</B><BR>" & vbCrLf
		...
		'Directions
			Select Case rsTix("EventCode") 
				Case "589638","590773"
			        Directions = "<B>FROM CHICAGO AREA</b> (approximately 5 hours)Take I-80 West approx. 116 miles to I-74. Take I-74 East approx. 32 miles to US-34.Take US-34 West 45 approx. miles to IL-96.Take IL-96 South approx. 22 miles to Nauvoo.<BR><BR><B>FROM SPRINGFIELD (approximately 3 hours)</B>Take IL-97 West approx. 8 miles and stay straight onto IL-125Take IL-125 North approx. 37 miles until it becomes US-67.Take US-67 North approx. 35 miles to IL-110Take IL-110 West approx. 26 miles to US-136 Take IL-136 West approx. 13 miles to IL-96 Take IL-96 North approx. 12 miles to Nauvoo"
		        Case "590620"
			        Directions = "<B> From downtown Chicago:</b> Take the Dan Ryan Expressway (I-90 E, I-94 E) toward Indiana; take exit 57 at Garfield Blvd.; turn left onto W. Garfield Blvd.; after approximately one mile, Garfield becomes Morgan Drive; after a half mile, Morgan Drive becomes Payne Drive;  turn left onto Midway Plaisance Dr.; then immediately turn right onto S. Cottage Grove Ave.; turn immediately to the left onto East 60th Street.  915 E. 60th Street is on the right. This is the most direct route; there are several alternatives."
			    
				Case Else 'Default Advertisting Image
				   Directions = "<B>From Route I-55 North or South:</B><BR>From Springfield's Clear Lake Avenue Exit, #98 B: Proceed West on Clear Lake. Clear Lake will turn into Jefferson Street (one way West).<BR><BR>The Abraham Lincoln Presidential Library & Museum parking ramp is off 6th Street between Madison and Mason streets. The rate is $.75 cents per 1/2 hour or $1.50 per hour. The RV and bus parking lot is a flat rate of $5.00."	
	        End Select
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">" & Directions &""& vbCrLf
			...
			Response.Write "<IMG WIDTH=200 SRC=""/Clients/ALPLM/ETickets/alplm.jpg""><BR>" & vbCrLf
			'Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
	   ...
	   '     End Select		
		...
		'	Response.Write "<IMG SRC = ""/Clients/ALPLM/ETickets/Images/" & AdSpaceImage & " "" WIDTH=""500"">" & vbCrLf
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""1""><B>" & rsTix("ActComments") & "</B></FONT><BR>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
