...
'SSR 8/29/13 - Updated ticket format using current generic ETicket Script
'SLM 12/19/14 - Changed font size to accommodate longer production name
%>
...
'E-Ticket Background Image: 
ETicketBackground = "/Clients/ALPLM/ETickets/ALPLMETicketBackground.gif"

'E-Ticket Bottom Bar Image: 
ETicketBottomBar = "/Clients/ALPLM/ETickets/ALPLMETicketBottomBar.gif"

'E-Ticket Driving Directions: 
ETicketDrivingDirections = "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><B>DRIVING DIRECTIONS</B><BR><B>From Route I-55 North or South:</B><BR>From Springfield's Clear Lake Avenue Exit, #98 B: Proceed West on Clear Lake. Clear Lake will turn into Jefferson Street (one way West).<BR><BR>The Abraham Lincoln Presidential Library & Museum parking ramp is off 6th Street between Madison and Mason streets. The rate is $.75 cents per 1/2 hour or $1.50 per hour. The RV and bus parking lot is a flat rate of $5.00. </FONT>"

'E-Ticket Logo Image: 
ETicketLogo = "/Clients/ALPLM/ETickets/ALPLMETicketLogo.gif"

'E-Ticket Map Image: 
ETicketMap = "/Clients/ALPLM/ETickets/alplm.jpg"
...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
            ...
            Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""4""><B>E-TICKET MUST BE PRESENTED.</B></FONT>" & vbCrLf 
			...
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""4""><B>" & rsTix("Act") & "</B></FONT><BR>" & vbCrLf
		...
		'Begin Body Space
            ...
            Else
			    Response.Write "<IMG SRC="" "&ETicketMap&" "">" & vbCrLf
            End If
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
