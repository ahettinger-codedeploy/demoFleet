...
.tables td 
{ font-size: 13px; color: <%= HeadingFontColor %>; font-weight: normal; line-height: 25px; padding: 5px 10px; white-space: nowrap ! important; border-top: 1px solid rgb(254, 254, 254); border-bottom: 1px solid rgb(224, 224, 224); }
...
{ font-size: 13px; color: <%= HeadingFontColor %>; text-shadow: 0px 1px 0px rgb(255, 255, 255); background-color: rgb(248, 248, 248); }
...
<BR>
<BR>
<H6>Please indicate the sessions you are interested in attending:</H6><BR>
<center>
...
<%
    ...
    <tr>
        <td>
        <b>8:30&#32;&#45;&#32;10:00</b><input type="hidden" name="Question1_<%=counter%>" value="Thursday, October 11 (8:30&#32;&#45;&#32;10:00)" />
        </td>
    </tr> 
    <tr>
        <td>
        <input type="radio" name="Answer1_<%=counter%>" value="20th Century Chicago" />20th Century Chicago<BR>
        <input type="radio" name="Answer1_<%=counter%>" value="African American Experiences in 19th Century Illinois" />African American Experiences in 19th Century Illinois<BR>
        <input type="radio" name="Answer1_<%=counter%>" value="Poets, Ballads & Picture Books" />Poets, Ballads & Picture Books<br />
        <input type="radio" name="Answer1_<%=counter%>" value="Understanding Illinois Historic Cemeteries" />Understanding Illinois&#39; Historic Cemeteries*
        </td>
    </tr> 
    <tr>
        <td>10:15&#32;&#45;&#32;11:45<input type="hidden" name="Question2_<%=counter%>" value="Thursday, October 11 (10:15&#32;&#45;&#32;11:45)" />
    </td>
    </tr> 
    <tr>
        <td>
        <input type="radio" name="Answer2_<%=counter%>" value="Changes in the Community Composition in the Metro East, 1950&#45;2010" />Changes in the Community Composition in the Metro East, 1950&#45;2010<BR>
        <input type="radio" name="Answer2_<%=counter%>" value="Stephen A. Douglas and the Civil War" />Stephen A. Douglas and the Civil War<BR>
        <input type="radio" name="Answer2_<%=counter%>" value="20th Century Political Stories" />20th Century Political Stories<br />
        <input type="radio" name="Answer2_<%=counter%>" value="Urban History & Spatial Dynamics*" />Urban History & Spatial Dynamics*
        </td>
    </tr> 
    <tr>
        <td>1:45&#32;&#45;&#32;3:15<input type="hidden" name="Question3_<%=counter%>" value="Thursday, October 11 (1:45&#32;&#45;&#32;3:15)" />
    </td>
    </tr> 
    <tr>
        <td>
        <input type="radio" name="Answer3_<%=counter%>" value="Laws, Courts, and Lawyers" />Laws, Courts, and Lawyers<BR>
        <input type="radio" name="Answer3_<%=counter%>" value="Gilded Age Stories" />Gilded Age Stories<BR>
        <input type="radio" name="Answer3_<%=counter%>" value="Structures with Stories" />Structures with Stories<BR>
        <input type="radio" name="Answer3_<%=counter%>" value="Photographing Historic Trails*" />Photographing Historic Trails*<BR>
        </td>
    </tr> 
    <tr>
        <td>3:30&#32;&#45;&#32;5:00<input type="hidden" name="Question4_<%=counter%>" value="Thursday, October 11 (3:30&#32;&#45;&#32;5:00)" />
    </td>
    </tr> 
    <tr>
        <td>
        <input type="radio" name="Answer4_<%=counter%>" value="Centennial Retrospectives" />Centennial Retrospectives<BR>
        <input type="radio" name="Answer4_<%=counter%>" value="The Civil War Congress" />The Civil War Congress<BR>
        <input type="radio" name="Answer4_<%=counter%>" value="Significant New Books" />Significant New Books<BR>
        <input type="radio" name="Answer4_<%=counter%>" value="Engaging the Next Generation*" />Engaging the Next Generation*<BR>
        </td>
    </tr>  
    <%            
        End If
