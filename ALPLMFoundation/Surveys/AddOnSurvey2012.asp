...
%>
<tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>THURSDAY, OCTOBER 11</b></td></tr> 
<tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>8:30 - 10:15</b><input type="hidden" name="Question1_<%=counter%>" value="Thursday, October 11 (8:30 - 10:10)" /></td></tr> 
<tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><input type="radio" name="Answer1_<%=counter%>" value="20th Century Chicago" />20th Century Chicago<BR><input type="radio" name="Answer1_<%=counter%>" value="African American Experiences in 19th Century Illinois" />African American Experiences in 19th Century Illinois<BR><input type="radio" name="Answer1_<%=counter%>" value="Poets, Ballads & Picture Books" />Poets, Ballads & Picture Books<input type="radio" name="Answer1_<%=counter%>" value="Understanding Illinois’ Historic Cemeteries" />Understanding Illinois’ Historic Cemeteries*</td></tr> 
<tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>10:30 - Noon</b><input type="hidden" name="Question2_<%=counter%>" value="Thursday, October 11 (10:15–11:45)" /></FONT></td></tr> 
<tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><input type="radio" name="Answer2_<%=counter%>" value="Changes in the Community Composition in the Metro East, 1950–2010" />Changes in the Community Composition in the Metro East, 1950–2010<BR><input type="radio" name="Answer2_<%=counter%>" value="Stephen A. Douglas and the Civil War" />Stephen A. Douglas and the Civil War<BR><input type="radio" name="Answer2_<%=counter%>" value="20th Century Political Stories" />20th Century Political Stories<input type="radio" name="Answer2_<%=counter%>" value="Urban History & Spatial Dynamics*" />Urban History & Spatial Dynamics*</FONT></td></tr> 
...
<tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>3:30 - 5:00</b><input type="hidden" name="Question4_<%=counter%>" value="Thursday, September 29 (3:30 - 5:00)" /></FONT></td></tr> 
...
%>
<tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>FRIDAY, OCTOBER 12</b></FONT></td></tr><tr><td><b>8:30–10:00</b><input type="hidden" name="Question1_<%=counter%>" value="Friday, October 12 (8:30 - 10:00)" /></FONT></td></tr> 
<tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><input type="radio" name="Answer1_<%=counter%>" value="Examining the Past in Three Localities" />Examining the Past in Three Localities<BR><input type="radio" name="Answer1_<%=counter%>" value="The French in Illinois" />The French in Illinois<BR><input type="radio" name="Answer1_<%=counter%>" value="Illinois Race Riots" />Illinois Race Riots<BR><input type="radio" name="Answer1_<%=counter%>" value="Veterans History Project*" />Veterans History Project*<BR></FONT></td></tr> 
<tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>8:30–10:00</b><input type="hidden" name="Question1_<%=counter%>" value="Friday, October 12 (10:15–11:45)" /></FONT></td></tr> 
<tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><input type="radio" name="Answer2_<%=counter%>" value="20th Century Illinoisans in Congress" />20th Century Illinoisans in Congress<BR><input type="radio" name="Answer2_<%=counter%>" value="Lincoln in Politics and Law" />Lincoln in Politics and Law<BR><input type="radio" name="Answer2_<%=counter%>" value="Illinois Universities at Home and Abroad" />Illinois Universities at Home and Abroad<BR><input type="radio" name="Answer2_<%=counter%>" value="Visual Resources for Understanding Illinois*" />Visual Resources for Understanding Illinois*<BR></FONT></td></tr> 
<tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>8:30–10:00</b><input type="hidden" name="Question1_<%=counter%>" value="Friday, October 12 (1:45–3:15)" /></FONT></td></tr> 
<tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><input type="radio" name="Answer3_<%=counter%>" value="UIC Thirty Years After Consolidation" />UIC Thirty Years After Consolidation<BR><input type="radio" name="Answer3_<%=counter%>" value="Lincoln Kinship Matters" />Lincoln Kinship Matters<BR><input type="radio" name="Answer3_<%=counter%>" value="Women Who Built with Frank Lloyd Wright" />Women Who Built with Frank Lloyd Wright<BR><input type="radio" name="Answer3_<%=counter%>" value="The Coles County Perspective on the Matson Slave Trial*" />The Coles County Perspective on the Matson Slave Trial*<BR></FONT></td></tr> 
<tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>8:30–10:00</b><input type="hidden" name="Question1_<%=counter%>" value="Friday, October 12 (3:30–5:00)" /></FONT></td></tr> 
<tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><input type="radio" name="Answer4_<%=counter%>" value="Illinois Baseball Stories" />Illinois Baseball Stories<BR><input type="radio" name="Answer4_<%=counter%>" value="Illinois Civil War Soldier Experiences" />Illinois Civil War Soldier Experiences<BR><input type="radio" name="Answer4_<%=counter%>" value="Stories from Illinois State Historic Sites" />Stories from Illinois State Historic Sites<BR><input type="radio" name="Answer4_<%=counter%>" value="Teaching with Enhanced Living History Portrayal: Mary Surratt*" />Teaching with Enhanced Living History Portrayal: Mary Surratt*<BR></FONT></td></tr> 
<%        
        End If
