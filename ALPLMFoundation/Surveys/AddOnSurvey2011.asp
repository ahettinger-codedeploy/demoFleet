...
SQLTicketType = "SELECT OrderLine.SeatTypeCode, COUNT(*) AS TotalTix FROM OrderLine (NOLOCK) INNER JOIN Seat (NOLOCK) ON OrderLine.ItemNumber = Seat.ItemNumber WHERE OrderLine.OrderNumber = " & Session("OrderNumber") & " AND Seat.EventCode = 387476 GROUP BY OrderLine.SeatTypeCode ORDER BY OrderLine.SeatTypeCode"
...
<%
    ...
    If InStr(SeatTypeList,"3553") Or InStr(SeatTypeList,"3554") Or InStr(SeatTypeList,"3556") Or InStr(SeatTypeList,"5737") Then
        EventCodeList = EventCodeList & "387477,387478"            
    End If
    If InStr(SeatTypeList,"3553") Or InStr(SeatTypeList,"3555") Or InStr(SeatTypeList,"3556") Or InStr(SeatTypeList,"5737") Then
        ...
        End If
        EventCodeList = EventCodeList & "387479"            
    End If
...
<%
    SQLTicketType = "SELECT OrderLine.SeatTypeCode FROM OrderLine (NOLOCK) INNER JOIN Seat (NOLOCK) ON OrderLine.ItemNumber = Seat.ItemNumber WHERE OrderLine.OrderNumber = " & Session("OrderNumber") & " AND Seat.EventCode = 387476 ORDER BY OrderLine.LineNumber"
    Set rsTicketType = OBJdbConnection.Execute(SQLTicketType)
    counter = 1
    Do While Not rsTicketType.EOF
...
%>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>THURSDAY, SEPTEMBER 29</b></FONT></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>8:30 - 10:15</b></FONT><input type="hidden" name="Question1_<%=counter%>" value="Thursday, September 29 (8:30 - 10:15)" /></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><input type="radio" name="Answer1_<%=counter%>" value="The CCC and the Land of Lincoln: Interpreting a Layered History at Lincoln Log Cabin State Historic Site" />The CCC and the Land of Lincoln: Interpreting a Layered History at Lincoln Log Cabin State Historic Site<BR><input type="radio" name="Answer1_<%=counter%>" value="Workers Issues" />Workers Issues<BR><input type="radio" name="Answer1_<%=counter%>" value="Local History" />Local History</FONT></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>10:30 - Noon</b></FONT><input type="hidden" name="Question2_<%=counter%>" value="Thursday, September 29 (10:30 - Noon)" /></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><input type="radio" name="Answer2_<%=counter%>" value="Interpreting Indian Events in Illinois" />Interpreting Indian Events in Illinois<BR><input type="radio" name="Answer2_<%=counter%>" value="Slavery and Freedom in Illinois" />Slavery and Freedom in Illinois<BR><input type="radio" name="Answer2_<%=counter%>" value="Laws of Illinois—The Digital Collection*" />Laws of Illinois—The Digital Collection*</FONT></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>1:45 - 3:15</b></FONT><input type="hidden" name="Question3_<%=counter%>" value="Thursday, September 29 (1:45 - 3:15)" /></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><input type="radio" name="Answer3_<%=counter%>" value="Nineteenth Century Circuit Riding" />Nineteenth Century Circuit Riding<BR><input type="radio" name="Answer3_<%=counter%>" value="Religion in Lincoln Studies" />Religion in Lincoln Studies<BR><input type="radio" name="Answer3_<%=counter%>" value="Using Primary Sources to Teach the War of 1812*" />Using Primary Sources to Teach the War of 1812*</FONT></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>3:30 - 5:00</b></FONT><input type="hidden" name="Question4_<%=counter%>" value="Thursday, September 29 (3:30 - 5:00)" /></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><input type="radio" name="Answer4_<%=counter%>" value="Chicago" />Chicago<BR><input type="radio" name="Answer4_<%=counter%>" value="A History of the African American Studies Program at Western Illinois University" />A History of the African American Studies Program at Western Illinois University<BR><input type="radio" name="Answer4_<%=counter%>" value="Social Change" />Social Change</FONT><br /><br /></td></tr>
<%            
        End If
        'Friday, September 30
...
%>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>FRIDAY, SEPTEMBER 30</b></FONT></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>8:30 - 10:15</b></FONT><input type="hidden" name="Question5_<%=counter%>" value="Friday, September 30 (8:30 - 10:15)" /></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><input type="radio" name="Answer5_<%=counter%>" value="Lincoln’s Political Ideology and the Secession Crisis" />Lincoln’s Political Ideology and the Secession Crisis<BR><input type="radio" name="Answer5_<%=counter%>" value="Investigative Practice: Historical and Legal" />Investigative Practice: Historical and Legal<BR><input type="radio" name="Answer5_<%=counter%>" value="Commemoration and Memory" />Commemoration and Memory</FONT></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>10:30 - Noon</b></FONT><input type="hidden" name="Question6_<%=counter%>" value="Friday, September 30 (10:30 - Noon)" /></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><input type="radio" name="Answer6_<%=counter%>" value="New Directions in the Study of Slavery and Anti-Slavery in Illinois" />New Directions in the Study of Slavery and Anti-Slavery in Illinois<BR><input type="radio" name="Answer6_<%=counter%>" value="Institutional History" />Institutional History<BR><input type="radio" name="Answer6_<%=counter%>" value="Local History" />Local History<BR><input type="radio" name="Answer6_<%=counter%>" value="Examining the Unexplored Frontier of Prohibition*" />Examining the Unexplored Frontier of Prohibition*</FONT></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>1:45 - 3:15</b></FONT><input type="hidden" name="Question7_<%=counter%>" value="Friday, September 30 (1:45 - 3:15)" /></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><input type="radio" name="Answer7_<%=counter%>" value="Historical Archaeology" />Historical Archaeology<BR><input type="radio" name="Answer7_<%=counter%>" value="Illinois Sketches" />Illinois Sketches<BR><input type="radio" name="Answer7_<%=counter%>" value="The Illinois Student Historian Program*" />The Illinois Student Historian Program*</FONT></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><b>3:30 - 5:00</b></FONT><input type="hidden" name="Question8_<%=counter%>" value="Friday, September 30 (3:30 - 5:00)" /></td></tr>
    <tr><td><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="2"><input type="radio" name="Answer8_<%=counter%>" value="Mourning Customs and the Supernatural in History" />Mourning Customs and the Supernatural in History<BR><input type="radio" name="Answer8_<%=counter%>" value="Family History" />Family History<BR><input type="radio" name="Answer8_<%=counter%>" value="Architectural History" />Architectural History</FONT></td></tr>
<%        
        End If
