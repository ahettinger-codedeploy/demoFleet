...
SQLEP = "SELECT EP.EventCode, OL.ID, OL.OrderNumber FROM ALPLMFoundationEventPerformances AS EP (NOLOCK) INNER JOIN ALPLMFoundationOrderLineItems AS OL (NOLOCK) ON EP.ID = OL.Performance WHERE OL.ItemNumber IS NULL AND EP.EventType = 'general'"
