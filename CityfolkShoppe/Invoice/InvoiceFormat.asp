...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><TABLE WIDTH=750><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top""><BR>Cityfolk<BR>126 N. Main St. Suite 220<BR>Dayton, OH 45402<BR></TD><TD WIDTH=300><IMG SRC=/PrivateLabel/CityfolkShoppe/Invoice/Logo.jpg height=115><BR></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing from the Cityfolk Shoppe. For questions regarding this order, contact us at (937) 223-3655.</I></B><BR><BR>" & vbCrLf
