...
' 2011 Bell Helicopter Armed Forces Bowl Team Kick-off Luncheon
' 2011 Bell Helicopter Armed Forces Bowl Game Program
...
%>     
        ...
        <tr align="left" bgcolor="<%=TableDataBGColor%>">
            <td align="center">
                ...
                <%
                 If rsPackages("EventCode") = 306477 Then
                %>
                ...
                <tr>
                    ...
                    For j = 1 to OfferTicketCount
                        Select Case j
                            Case 1   
                            %><option value="<%=j%>"><%=j%></B>&nbsp;&nbsp;ticket</option><%
                            Case Else
