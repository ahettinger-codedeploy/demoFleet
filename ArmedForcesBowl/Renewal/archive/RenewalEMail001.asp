...
EMailOrganization1 = "<B>Lockheed Martin Armed Forces Bowl</B>"
EMailOrganization = EMailOrganization1
EMailReplyTo = "Trisha.M.Branch@espn.com"
EMailSubject = "Lockheed Martin Armed Forces Bowl Renewal Opportunity" 
...
EMailMessageBody = EMailMessageBody & "<p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height: normal;text-autospace:none'><span style='font-size:12.0pt;font-family:""Arial"",""sans-serif""'>Your ticket package will be mailed out toward the end of November.  If you have any questions or need further details, please don’t hesitate to contact our office at (817) 810-0012.</i></b></span></p>" & "<BR>" & vbCrLf
EMailMessageBody = EMailMessageBody & "<p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height: normal;text-autospace:none'><span style='font-size:12.0pt;font-family:""Arial"",""sans-serif""'>Again, thank you for the continued support of our community event that pays full tribute to our armed forces.  We look forward to seeing you on January 2nd for the 12th annual Lockheed Martin Armed Forces Bowl.</span></p>" & "<BR><BR>" & vbCrLf
