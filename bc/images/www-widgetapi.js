...
var sa=function(){if(na&&k.opera){var a;var b=k.opera.version;try{a=b()}catch(c){a=b}return a}a="";(b=qa())&&(a=b?b[1]:"");return C&&(b=ra(),null!=b&&b>parseFloat(a))?String(b):a}(),ta={};
