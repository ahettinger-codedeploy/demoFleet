...
(function(){
	...
	var page = {
		init: function () {
			...
			// FITVIDS
			jQuery('.portfolio-items:not(.carousel-items),.blog-items:not(.carousel-items),.single-portfolio,article.type-post,article.type-team,.wpb_video_widget,.infocus-item,.recent-posts,.sidebar').fitVids();
		...
		init:function() {
			...
			maps.each(function(index, element) {
				...
				google.maps.event.addListener(companyMarker, 'click', function() {
					window.open('http://maps.google.com/maps?q='+mapAddress);
				});
