...
If Excel <> "Y" Then 
	...
	Response.Write "<FORM ACTION=""CustomSurveyReport.asp"" METHOD=""post"" NAME=""Report"" onsubmit=""return ValidateForm()"">" & vbCrLf
...
'		                End If
			...
			'REE 3/16/7 - Added Output to Excel option
			If Excel <> "Y" Then
				Response.Write "<TR BGCOLOR=#DDDDDD><TD ALIGN=""center""><FONT FACE='verdana,arial,helvetica' SIZE=2><A HREF=""/Reports/OrderDetails.asp?OrderNumber=" & rsSurveyAnswers("OrderNumber") & """>" & rsSurveyAnswers("OrderNumber") & "</A></FONT></TD><TD ALIGN=""center""><FONT FACE='verdana,arial,helvetica' SIZE=2>" & rsSurveyAnswers("OrderDate") & "</FONT></TD><TD ALIGN=""left"" NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2><A HREF=""/Reports/CustomerDetails.asp?CustomerNumber=" & rsSurveyAnswers("CustomerNumber") & """>" & rsSurveyAnswers("FirstName") & " " & rsSurveyAnswers("LastName") & "</A></FONT></TD>"
			Else
				Response.Write "<TR BGCOLOR=#DDDDDD><TD ALIGN=""center""><FONT FACE='verdana,arial,helvetica' SIZE=2>" & rsSurveyAnswers("OrderNumber") & "</FONT></TD><TD ALIGN=""center""><FONT FACE='verdana,arial,helvetica' SIZE=2>" & rsSurveyAnswers("OrderDate") & "</FONT></TD><TD ALIGN=""left"" NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSurveyAnswers("FirstName") & " " & rsSurveyAnswers("LastName") & "</FONT></TD>"
			End If
