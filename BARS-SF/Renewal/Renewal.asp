<%
'CHANGE LOG
'SLM 8/6/16 -  Renewals for The Road Company Theatre 2017 season.  
%>
...
UserNumber = 11887 'BARS Box Office

'Set expiration date of order and the text to display in the IPAddress field.
OrderExpirationDate = "9/3/16"
RenewDescription = Left("BARS 2016/17", 15)
...
Dim EventArray(2, 1)
EventArray(0,0) = 779916
EventArray(0,1) = 897094

EventArray(1,0) = 780363
EventArray(1,1) = 897093

EventArray(2,0) = 779918
EventArray(2,1) = 897095
