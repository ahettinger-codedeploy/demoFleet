...
EMailOrganization = "Bay Area Rainbow Symphony"
EMailReplyTo = "tickets@bars-sf.org"
EMailPhone = "415.57.VIOLA (415.578.4652)"
EMailSubject = "BARS 2010-2011 Season: Renew Your Subscription & Save!" 
EMailRenewalURL = "http://bars-sf.tix.com/renew.asp"
MaxOrderNumber = 99999999
...
Do Until rsOrderLine.EOF Or LastOrderNumber > MaxOrderNumber
...
'			EMailMessage = EMailMessage & "<HR><TABLE CELLPADDING=""3"" WIDTH=""750""><TR><TD><B>Order Number:&nbsp;" & rsOrderLine("OrderNumber") & "<BR>Renewal Code:&nbsp;" & RenewalCode & "</B></TD></TR>" & vbCrLf
'			EMailMessage = EMailMessage & "<TR><TD><B>To renew, <A HREF=" & EMailRenewalURL & ">click here</A>.</B><BR></TD></TR></TABLE>" & vbCrLf
...
'		EMailMessage = EMailMessage & "<TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD><B>" & rsOrderLine("Act") & " at " & rsOrderLine("Venue")
'	
...
'
'		NumColumns = 6
'		ColumnHeading = "<TABLE WIDTH=""750"" BORDER=""0""><TR><TD WIDTH=""50"">&nbsp;</TD><TD><B><U>Section</U></B></TD><TD ALIGN=center><B><U>Row</U></B></TD><TD ALIGN=center><B><U>Seat</U></B></TD><TD><B><U>Type</U></B></TD><TD ALIGN=right><B><U>Price</U></B></TD>"
'		
'		FacilityCharge = 0
