...
If Not rsSeat.EOF Then
	...
	Response.Write "<TD><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>Email Address</B></FONT></TD>"
	...
	Do Until rsSeat.EOF
		...
		If CustomerNo <> rsSeat("CustomerNumber") Then
	        ...
	        Response.Write "<TD NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("EmailAddress") & "</FONT></TD>"
