...
mainMenuItem("webpage_files/rectangle_b1",".gif",20,66,loc+"../../indexX.php","","Home",2,2,"rectangle_plain");
mainMenuItem("webpage_files/rectangle_b2",".gif",20,69,"javascript:;","","Press",2,2,"rectangle_plain");
mainMenuItem("webpage_files/rectangle_b3",".gif",20,90,loc+"../../schedule.php","","Schedule",2,2,"rectangle_plain");
mainMenuItem("webpage_files/rectangle_b4",".gif",20,79,loc+"../Photos/index.php","","Points",2,2,"rectangle_plain");
mainMenuItem("webpage_files/rectangle_b5",".gif",20,125,"javascript:;","","Gallery",2,2,"rectangle_plain");
mainMenuItem("webpage_files/rectangle_b6",".gif",20,103,"javascript:;","","Driver Info",2,2,"rectangle_plain");
mainMenuItem("webpage_files/rectangle_b7",".gif",20,109,loc+"../../advertising.php","","Advertising",2,2,"rectangle_plain");
mainMenuItem("webpage_files/rectangle_b8",".gif",20,95,loc+"../../sponsors.php","","Sponsors",2,2,"rectangle_plain");
mainMenuItem("webpage_files/rectangle_b9",".gif",20,78,loc+"../../search.php","","Search",2,2,"rectangle_plain");
mainMenuItem("webpage_files/rectangle_b10",".gif",20,87,loc+"../../contact.php","","Contact",2,2,"rectangle_plain");
endMainMenu("",0,0);
...
submenuItem("Sportsman",loc+"../../Uploads/Sportsman.pdf","_blank","rectangle_plain");
...
submenuItem("History",loc+"../../history.php","","rectangle_plain");
