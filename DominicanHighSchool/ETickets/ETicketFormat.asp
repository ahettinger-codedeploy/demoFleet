	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Select Case rsTix("ActCode") 
		        Case 58403 'Hairspray
			        Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2"">" & vbCrLf 
                    Response.Write "<BR><B>Please join us for the upcoming Fine Arts Programs:</B><BR>" & vbCrLf
                    Response.Write "Spring Concert March 25th<BR>Inspirations May 5th, 6th and 7th<BR>Fine Arts Knight May 11th<BR>Pops Concert May 12th<BR>"
		...
		Select Case rsTix("ActCode") 
		    Case 58403 'Hairspray
    			...
    			Response.Write "<TR>" & vbCrLf
    			Response.Write "<TD ALIGN=""center"">" & vbCrLf
    			Response.Write "<IMG SRC=""Images/HAIRSPRAY_LOGO.gif"" ><BR>" & vbCrLf
    			Response.Write "<IMG SRC=""Images/DHSLogo_Color.gif"" HEIGHT =""100"" >" & vbCrLf
    			Response.Write "</TD>" & vbCrLf
    			Response.Write "</TR>" & vbCrLf
    			Response.Write "</TABLE>" & vbCrLf
