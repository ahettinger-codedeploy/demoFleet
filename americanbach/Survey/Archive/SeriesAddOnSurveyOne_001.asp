...
SeriesEventList = "354183,354180"
SeriesName = "FESTIVAL 2011 CHAMBER & MASTERWORKS SERIES "
...
SQLSubCheck = "SELECT LineNumber FROM OrderLine (NOLOCK) INNER JOIN Seat (NOLOCK) ON OrderLine.ItemNumber = Seat.ItemNumber INNER JOIN Event (NOLOCK) ON Event.EventCode = Seat.EventCode WHERE OrderLine.OrderNumber = " & Session("OrderNumber") & " AND Event.EventCode = " & SeriesEventList& ""
...
%>
    <tr>
        ...
        <br />
        <INPUT TYPE="RADIO" NAME="EventCode" VALUE="353368">Saturday, 7/23/2011 at 2:00 PM <br />
<%
End If
%>
        </td>
