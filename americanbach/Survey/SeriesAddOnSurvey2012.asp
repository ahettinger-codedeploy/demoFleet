...
'SSR 1/6/2011
'LSP 2/16/2012 chg line: 291 from "Saturday" to "Sunday"
...
Page = "Survey"
SurveyNumber = 1176
SurveyFileName = "SeriesAddOnSurvey2012.asp"
...
'432678	        2012 FESTIVAL CHAMBER, DISTINGUISHED ARTIST, & MASTERWORKS SERIES SUBSCRIPTION (6 concerts)
'432680	        2012 FESTIVAL SEASON PASS (9 concerts)


'Patron Must Choose One:
'EventCode      Date & Time                 Production Name
'432208         7/15/2012 2:00 PM           2012 Festival Masterworks Series: Bach's Mass in B Minor
'432209         7/22/2012 2:00 PM           2012 Festival Masterworks Series: Bach's Mass in B Minor
...
SeriesEventCode(1) = "432678"
SeriesEventCode(2) = "432680"

DIM SeriesName(2)
SeriesName(1) = "2012 FESTIVAL CHAMBER, DISTINGUISHED ARTIST, & MASTERWORKS SERIES SUBSCRIPTION (6 concerts)"
SeriesName(2) = "2012 FESTIVAL SEASON PASS (9 concerts)"
...
%>
    <tr>
        ...
        <b><i><%=rsPackages("Act")%></i></b><br />
        <%=rsPackages("ActComments")%><br />
        <br />
        <%=VenueAddress%><br />        

        <h3>Please select a performance time:</h3>
        <INPUT TYPE="RADIO" NAME="EventCode" VALUE="432209">Sunday, 7/15/2012 at 2:00 PM<br />
        <br />
        <INPUT TYPE="RADIO" NAME="EventCode" VALUE="432208">Sunday, 7/22/2012 at 2:00 PM <br />
        <br />
<%
End If
%>
