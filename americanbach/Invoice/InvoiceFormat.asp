...
<%
'CHANGE LOG
'SLM 05/23/2012 - Updated address
%>
...
OrganizationNumber = 2641'Organization Number
StreetAddress = "44 Page St. Suite 403" 'Street Address. If this is a 2 line street address use <BR> between the two lines
CityStateZip = "San Francisco, CA  94102-5975" 'City State Zip Code
ClientDirectory = "AmericanBach" 'Name of Client Directory where Invoice/InvoiceFormat.asp is located
PhoneNumber = "(415) 621-7900" 'Customer Service Phone Number. If org doesn't have a number, use PhoneNumber = ""
...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">" & OrgName & "<BR>" & StreetAddress & "<BR>" & CityStateZip & "</TD><TD WIDTH=""300""><IMG SRC=/PrivateLabel/" & ClientDirectory & "/Invoice/Logo.png HEIGHT=""120""></TD></TR></TABLE>"
