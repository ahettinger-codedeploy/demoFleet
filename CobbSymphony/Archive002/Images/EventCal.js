...
function start(calElementName) {
	...
	if( ec !== null && ec !== undefined)
	{
		...
		ec.addEvent(0000,06,1,'Your BirthDay 1','index.htm');
		...
		ec.addEvent(2008,07,27,'<img style="float:left; margin-right:5px" alt="" src="images/csopark_sm.jpg">CSO Pops Concert at<br>the KSU Amphitheater, 8:00pm','calendar_jul.htm');
