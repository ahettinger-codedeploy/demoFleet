...
function start(calElementName) {
	...
	if( ec !== null && ec !== undefined)
	{
		...
		ec.addEvent(2008,10,25,'<img style="float:left; margin-right:5px" alt="" src="images/rj_sm.jpg">MW #2 8:00 PM<br>Tchaikovsky’s Magnificent Fourth<br>Strauss: Concerto for Oboe and Orchestra<br>Robin Johnson, oboe<br>Golijov: Last Round<br>Tchaikovsky: Symphony No.4','calendar_oct.htm');
		ec.addEvent(2008,10,26,'<img style="float:left; margin-right:5px" alt="" src="images/rj_sm.jpg">MW #2 3:00 PM<br>Tchaikovsky’s Magnificent Fourth<br>Strauss: Concerto for Oboe and Orchestra<br>Robin Johnson, oboe<br>Golijov: Last Round<br>Tchaikovsky: Symphony No.4','calendar_oct.htm');
		ec.addEvent(2008,11,08,'<img style="float:left; margin-right:5px" alt="" src="images/fm_sm.jpg">Super Saturday’s at the MAC<br>Family Programming<br>10:00 and 11:30 AM<br>------------------------------<br><br><img style="float:right; margin-left:5px" alt="" src="images/ma_sm.jpg">WellStar Foundation Benefit Concert 8:00 PM<br>Prokofiev: Concerto for Cello and Orchestra','calendar_nov.htm');
		ec.addEvent(2008,11,09,'<img style="float:left; margin-right:5px" alt="" src="images/ma_sm.jpg">WellStar Foundation Benefit Concert 3:00 PM<br>Prokofiev: Concerto for Cello and Orchestra<br>Rodgers and Hammerstein: The Sound of Music<br>Weber: Phantom of the Opera','calendar_nov.htm');
		ec.addEvent(2008,12,06,'<img style="float:left; margin-right:5px" alt="" src="images/jfbc_sm.jpg">Holiday Pops Concert<br>3:00 PM Murray Arts Center<br>7:00 PM Johnson Ferry Baptist Church<br>------------------------------<br><img style="float:right; margin-left:5px" alt="" src="images/fm_sm.jpg">Super Saturday’s at the MAC - Family Programming<br>The Night Before Christmas<br>10:00 and 11:30 AM','calendar_dec.htm');
		ec.addEvent(2009,01,17,'<img style="float:left; margin-right:5px" alt="" src="images/fc_sm.jpg">Family Concert<br>1:00 and 3:00 PM<br>Murray Arts Center<br><br>Young Artists Competition Winner, soloist<br>Britten: Young Persons guide to the Orchestra<br>Arnold: Four Scottish Dances','calendar_jan.htm');
		ec.addEvent(2009,02,14,'<img style="float:left; margin-right:5px" alt="" src="images/tg_sm.jpg">MW #3 8:00 PM<br>Shostakovich: Concerto for Cello and Orchestra<br>Tina Guo, cello<br>Dvorak: Carnival Overture<br>Brahms: Symphony No.3','calendar_feb.htm');
		ec.addEvent(2009,02,15,'<img style="float:left; margin-right:5px" alt="" src="images/tg_sm.jpg">MW #3 3:00 PM<br>Shostakovich: Concerto for Cello and Orchestra<br>Tina Guo, cello<br>Dvorak: Carnival Overture<br>Brahms: Symphony No.3','calendar_feb.htm');
		...
		ec.addEvent(2009,03,28,'<img style="float:left; margin-right:5px" alt="" src="images/gb_sm.jpg">LIVE! CSO and The Georgia Ballet 2:00 and 7:00 PM<br>Jessica Peek-Sherwood, flute<br>Britten: Young Persons Guide to the Orchestra<br>Minkus: Pas de Quatre<br>Auber: Grand Pas Classique','calendar_mar.htm');
		ec.addEvent(2009,03,29,'<img style="float:left; margin-right:5px" alt="" src="images/gb_sm.jpg">LIVE! CSO and The Georgia Ballet 2:00 PM<br>Jessica Peek-Sherwood, flute<br>Britten: Young Persons Guide to the Orchestra<br>Minkus: Pas de Quatre<br>Auber: Grand Pas Classique','calendar_mar.htm');
		ec.addEvent(2009,04,04,'<img style="float:left; margin-right:5px" alt="" src="images/orch_sm.jpg">MW #4 8:00 PM<br>Carmina Burana<br>With the CSO Chorus<br>Mendelssohn: Symph No.4<br>------------------------------<br><img style="float:right; margin-left:5px" alt="" src="images/fm_sm.jpg">Super Saturday’s at the MAC - Family Programming<br>Heroes of Tomorrow<br>10:00 and 11:30 AM','calendar_apr.htm');
