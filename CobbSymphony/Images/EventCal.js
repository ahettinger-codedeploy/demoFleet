...
function start(calElementName) {
	...
	if( ec !== null && ec !== undefined)
	{
		...
		ec.addEvent(2010,12,04,'<img style="float:left; margin-right:5px" alt="" src="images/jfbc_sm.jpg">CSO Holiday Pops<br>3:00 PM Zion Babtist Church<br>7:30 PM Johnson Ferry Baptist Church','cso_10-11_season.htm');
		ec.addEvent(2010,12,05,'<img style="float:left; margin-right:5px; width: 45px; height: 55px" alt="" src="images/ornament.jpg">CSO Holiday Pops<br>7:30 PM Murray Arts Center','cso_10-11_season.htm');
		ec.addEvent(2011,01,15,'<img style="float:left; margin-right:5px; width:55px; height:40px" alt="" src="images/mallet.jpg">8:00 PM @ Murray Arts Center. See the World premiere of CSO trombonist Eric Alexander’s composition.','cso_10-11_season.htm');
		ec.addEvent(2011,02,05,'<img style="float:left; margin-right:5px; width:40px; height:55px" alt="" src="images/ss_sm.jpg">8:00 PM @ The Strand. Start the new year off right with a night of Sam Skelton and his Big Band!','cso_10-11_season.htm');
		ec.addEvent(2011,02,13,'<img style="float:left; margin-right:5px; width:50px; height:45px" alt="" src="images/gyso_Calvin_Miller.jpg">3:00, 5:30 & 7:30 PM @ Kennesaw State University. GYSO & Chorus presents concerts by their ensembles, choruses and orchestras!','cso_10-11_season.htm');
		ec.addEvent(2011,02,26,'<img style="float:left; margin-right:5px; width:50px; height:45px" alt="" src="images/noteworthy_runandsee_logo.jpg">9:00 AM Second Annual Noteworthy 5K Run/Walk. Second annual benefit run for the Georgia Symphony Orchestra','cso_10-11_season.htm');
		ec.addEvent(2011,03,05,'<img style="float:left; margin-right:5px; width:40px; height:55px" alt="" src="images/bryan%20black%20conducting.jpg">8:00 PM CSO Chamber Chorus @ First United Methodist Church. The World Beloved: A Bluegrass Mass, Carol Barnett.','cso_10-11_season.htm');
		ec.addEvent(2011,03,12,'<img style="float:left; margin-right:5px; width:40px; height:55px" alt="" src="images/Sergei_Rachmaninoff_LOC_33968_Cropped.jpg">8:00 PM Russian Giants @ Kennesaw State University. Dimitri Shostakovich’s Symphony No.1 paired with Rachmaninoff’s lyrical Symphony No.2','cso_10-11_season.htm');
		ec.addEvent(2011,03,13,'<img style="float:left; margin-right:5px; width:50px; height:45px" alt="" src="images/orch_sm.jpg">3:00 PM Russian Giants @ Kennesaw State University. Dimitri Shostakovich’s Symphony No.1 paired with Rachmaninoff’s lyrical Symphony No.2','cso_10-11_season.htm');
		ec.addEvent(2011,05,07,'<img style="float:left; margin-right:5px; width:55px; height:40px" alt="" src="images/CSO%20Mahler%2009.JPG">7:00 PM People’s Choice @ Murray Arts Center. After a year of voting, the CSO will present the music that you, the audience, has chosen: The CSO Chorus with Mozart’s Requiem.','cso_10-11_season.htm');
		ec.addEvent(2011,05,08,'<img style="float:left; margin-right:5px; width:50px; height:45px" alt="" src="images/cso2_sm.jpg">3:00 PM People’s Choice @ Murray Arts Center. After a year of voting, the CSO will present the music that you, the audience, has chosen: The CSO Chorus with Mozart’s Requiem.','cso_10-11_season.htm');
		ec.addEvent(2011,05,15,'<img style="float:left; margin-right:5px; width:50px; height:45px" alt="" src="images/gyso_Calvin_Miller.jpg">3:00, 5:30 & 7:30 PM @ Kennesaw State University. GYSO & Chorus presents concerts by their ensembles, choruses and orchestras!','cso_10-11_season.htm');
		ec.addEvent(2011,05,28,'<img style="float:left; margin-right:5px; " alt="" src="images/gso_jazz1_30.jpg">8:00 PM @ Marietta Square. Celebrate Spring with the GSO Jazz!','cso_10-11_season.htm');
		ec.addEvent(2011,06,26,'<img style="float:left; margin-right:5px; " alt="" src="images/gso_ksuconcert_30.jpg">8:00 PM @ KSU. Star-Spangled Spectacular Concert on the Green with Fireworks!','cso_10-11_season.htm');
		ec.addEvent(2011,07,02,'<img style="float:left; margin-right:5px; " alt="" src="images/FUMCnew_30.jpg">7:00 PM @ Marietta First United Methodist Church Amphitheater!','cso_10-11_season.htm');
		ec.start();
	}
}
