...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><BR><TABLE WIDTH=750><TR><TD WIDTH=""35"">&nbsp;</TD><TD WIDTH=""415"" VALIGN=""top"">Cobb Symphony Orchestra<BR>P.O. Box 680993<BR>Marietta, Georgia 30068-0017</TD><TD WIDTH=300 VALIGN=""top""><IMG SRC=/PrivateLabel/CobbSymphony/Invoice/Logo.gif height=150></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from the Cobb Symphony Orchestra.&nbsp;&nbsp;The details of your order are listed below.&nbsp;&nbsp;For questions regarding this order, contact the Cobb Symphony Orchestra via e-mail at ExecutiveDirector@CobbSymphony.com or by calling (770) 426-1509.<BR><BR>" & vbCrLf
