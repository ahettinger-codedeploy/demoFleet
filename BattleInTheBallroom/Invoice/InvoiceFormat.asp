...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">Roy Englebrecht Promotions<BR>P.O. Box 10205<BR>Newport Beach, CA 92658</TD><TD WIDTH=""300""><IMG SRC=/PrivateLabel/BattleInTheBallroom/Invoice/Logo.gif HEIGHT=""120""></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from Roy Englebrecht Promotions.&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us via e-email at boxing77@aol.com or call us at (949) 760-3131.<BR><BR>" & vbCrLf
