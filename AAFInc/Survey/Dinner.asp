...
SurveyNumber = 420
SurveyName = "Dinner.asp"
NumQuestions = 1

Dim Question(2)

Question(1) = "This ticket includes a buffet dinner.<BR>How many of your reservations require a vegetarian meal?"
...
<TABLE WIDTH="70%">
  ...
  <TR ALIGN="CENTER">
		<TD><INPUT TYPE="text" NAME="Answer1" SIZE=10></FONT>
    </TD>
  </TR>
  </TABLE>
  <br><br><br>
