...
Response.Write "<tr>" & vbCrLf
		...
		'Custom
           ...
           Response.Write "<th>Entree Choice</th>" & vbCrLf
		       Response.Write "<th>First Name</th>" & vbCrLf
			       Response.Write "<th>Last Name</th>" & vbCrLf
				       Response.Write "<th>Ticket Type</th>" & vbCrLf
        ...
        '-----------------
					...
					SQLOrderLineDetail = "SELECT FieldValue FROM OrderLineDetail WITH (ROWLOCK) WHERE OrderNumber = " & rsSeat("OrderNumber") & " AND LineNumber = " & rsSeat("LineNumber") & " AND FieldName = 'Entree Choice'"
					...
					SQLOrderLineDetail = "SELECT FieldValue FROM OrderLineDetail WITH (ROWLOCK) WHERE OrderNumber = " & rsSeat("OrderNumber") & " AND LineNumber = " & rsSeat("LineNumber") & " AND FieldName = 'First Name'"
					Set rsOrderLineDetail = OBJdbConnection.Execute(SQLOrderLineDetail) 
					...
					SQLOrderLineDetail = "SELECT FieldValue FROM OrderLineDetail WITH (ROWLOCK) WHERE OrderNumber = " & rsSeat("OrderNumber") & " AND LineNumber = " & rsSeat("LineNumber") & " AND FieldName = 'Last Name'"
					Set rsOrderLineDetail = OBJdbConnection.Execute(SQLOrderLineDetail) 
					...
					SQLOrderLineDetail = "SELECT FieldValue FROM OrderLineDetail WITH (ROWLOCK) WHERE OrderNumber = " & rsSeat("OrderNumber") & " AND LineNumber = " & rsSeat("LineNumber") & " AND FieldName = 'Ticket Type'"
					Set rsOrderLineDetail = OBJdbConnection.Execute(SQLOrderLineDetail) 
