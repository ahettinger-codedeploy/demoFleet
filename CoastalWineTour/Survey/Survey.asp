...
Question(1) = "How did you hear about the festival?"
...
<FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2"><FONT face="Geneva, Arial, Helvetica, san-serif">Please complete the following survey:</FONT><BR>
...
<TABLE CELLPADDING=10 CELLSPACING=5 WIDTH="100%" border=0>
	...
	<TR>
		<TD>
			...
			<INPUT TYPE="checkbox" NAME="Answer1" VALUE="Attended in the past">&nbsp;Attended in the past<BR>
			</FONT><BR>
		</TD>
		</TR>
