	...
	If rsOrderLine("OrderNumber") <> LastOrderNumber Then 'It's different.  Print it.
		If TicketCount > 0 Then 'It's not the first one, print the footer.
			...
			If LastShipFee <> 0 And LastOrderTypeNumber <> 5 Then
				Response.Write "<TR><TD WIDTH=""50"">&nbsp;</TD><TD ALIGN=""right"" COLSPAN=""" & NumColumns - 1 & """><FONT FACE=Impact,Charcoal,Arial>Processing Fee</TD><TD ALIGN=""right""><FONT FACE=Impact,Charcoal,Arial>" & FormatCurrency(LastShipFee,2) & "</TD></TR>" & vbCrLf
				Response.Write "<TR><TD WIDTH=""50"">&nbsp;</TD><TD COLSPAN=""" & NumColumns - 1 & """>&nbsp;</TD><TD><HR></TD></TR>" & vbCrLf
			End If
			...
			Response.Write "<TR><TD WIDTH=""50"">&nbsp;</TD><TD ALIGN=""right"" COLSPAN=""" & NumColumns - 1 & """><FONT FACE=Impact,Charcoal,Arial>Total Order</TD><TD ALIGN=""right""><FONT FACE=Impact,Charcoal,Arial>" & FormatCurrency(LastTotal,2) & "</TD></TR>" & vbCrLf
			If LastTender <> 0 Then
				Response.Write "<TR><TD WIDTH=""50"">&nbsp;</TD><TD ALIGN=""right"" COLSPAN=""" & NumColumns - 1 & """><FONT FACE=Impact,Charcoal,Arial>Less Payments</TD><TD ALIGN=""right""><FONT FACE=Impact,Charcoal,Arial>" & FormatCurrency(LastTender,2) & "</TD></TR>" & vbCrLf
				Response.Write "<TR><TD WIDTH=""50"">&nbsp;</TD><TD ALIGN=""right"" COLSPAN=""" & NumColumns - 1 & """><FONT FACE=Impact,Charcoal,Arial>Balance Due</TD><TD ALIGN=""right""><FONT FACE=Impact,Charcoal,Arial>" & FormatCurrency(LastTotal - LastTender,2) & "</TD></TR>" & vbCrLf
			End If
...
<%		
			...
			Response.Write "<BR><TABLE WIDTH=700><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""300"" VALIGN=""top""><FONT FACE=Impact,Charcoal,Arial><BR>Castrol Raceway<BR>7003 Girard Road<BR>Edmonton, AL, Canada<BR>T6B 2C4</TD><TD WIDTH=300>&nbsp;</TD></TR></TABLE>"
			Response.Write "<BR><TABLE WIDTH=750><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400""><FONT FACE=Impact,Charcoal,Arial><B>Shipping Information</B></TD><TD WIDTH=""300""><FONT FACE=Impact,Charcoal,Arial><B>Billing Information</B></TD></TR>"
			Response.Write "<TR><TD>&nbsp;</TD><TD><FONT FACE=Impact,Charcoal,Arial>" & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & "<BR>" & rsCustInfo("ShipAddress1") & "<BR>" & vbCrLf
			If rsCustInfo("ShipAddress2") <> "" Then
				Response.Write rsCustInfo("ShipAddress2") & "<BR>" & vbCrLf
			End If
			Response.Write rsCustInfo("ShipCity") & ", " & rsCustInfo("ShipState") & " " & rsCustInfo("ShipPostalCode") & "</TD><TD><FONT FACE=Impact,Charcoal,Arial>" & rsCustInfo("FirstName") & " " & rsCustInfo("LastName") & "<BR>" & rsCustInfo("Address1") & "<BR>" & vbCrLf
			...
			Response.Write "<IMG SRC=""/PrivateLabel/CastrolRaceway/Conversion/RockyMountainNationals.gif""><IMG SRC=""/PrivateLabel/CastrolRaceway/Conversion/SaveMySeat.gif""><IMG SRC=""/PrivateLabel/CastrolRaceway/Conversion/OilCityCup.gif""><BR>" & vbCrLf
			Response.Write "<BR><TABLE CELLPADDING=""3"" WIDTH=""700""><TR><TD><FONT FACE=Impact,Charcoal,Arial><B>Order Number:&nbsp;" & rsOrderLine("OrderNumber") & "<BR>" & vbCrLf
	...
	If LastEventCode <> rsOrderLine("EventCode") Or LastOrderNumber <> rsOrderLine("OrderNumber") Then
		Response.Write "<TABLE WIDTH=""675""><TR><TD WIDTH=""50"">&nbsp;</TD><TD><FONT FACE=Impact,Charcoal,Arial><B>" & rsOrderLine("Act") & " at " & rsOrderLine("Venue")
		...
		NumColumns = 6
		ColumnHeading = "<TABLE WIDTH=""675"" BORDER=""0""><TR><TD WIDTH=""50"">&nbsp;</TD><TD><FONT FACE=Impact,Charcoal,Arial><B><U>Section</U></B></TD><TD ALIGN=center><FONT FACE=Impact,Charcoal,Arial><B><U>Row</U></B></TD><TD ALIGN=center><FONT FACE=Impact,Charcoal,Arial><B><U>Seat</U></B></TD><TD><FONT FACE=Impact,Charcoal,Arial><B><U>Type</U></B></TD><TD ALIGN=right><FONT FACE=Impact,Charcoal,Arial><B><U>Price</U></B></TD>"

		FacilityCharge = 0
		If FacilityCharge <> 0 Then
			NumColumns = NumColumns + 1
			ColumnHeading = ColumnHeading + "<TD ALIGN=right><FONT FACE=Impact,Charcoal,Arial><B><U>Facility Charge</U></B></TD>"
			ColFacilityCharge = "Y"
		End If
		If rsNumColumns("ServiceFee") <> 0 Then
			NumColumns = NumColumns + 1
			ColumnHeading = ColumnHeading + "<TD ALIGN=right><FONT FACE=Impact,Charcoal,Arial><B><U>Service Fee</U></B></TD>"
			ColServiceFee = "Y"
		End If
		If rsNumColumns("Discount") <> 0 Then
			NumColumns = NumColumns + 1
			ColumnHeading = ColumnHeading + "<TD ALIGN=right><FONT FACE=Impact,Charcoal,Arial><B><U>Discount</U></B></TD>"
			ColDiscount = "Y"
		End If
		...
		ColumnHeading = ColumnHeading + "<TD ALIGN=right><FONT FACE=Impact,Charcoal,Arial><B><U>Amount</U></B></TD></TR>" & vbCrLf
	...
	LineDetail = "<TR><TD WIDTH=""50"">&nbsp;</TD><TD><FONT FACE=Impact,Charcoal,Arial>" & rsOrderLine("Section") & "</TD><TD ALIGN=center><FONT FACE=Impact,Charcoal,Arial>" & rsOrderLine("Row") & "</TD><TD ALIGN=center><FONT FACE=Impact,Charcoal,Arial>" & rsOrderLine("Seat") & "</TD><TD><FONT FACE=Impact,Charcoal,Arial>" & rsOrderLine("SeatType") & "</TD><TD ALIGN=right><FONT FACE=Impact,Charcoal,Arial>" & FormatCurrency(rsOrderLine("Price"),2) & "</TD>"
	
	If ColFacilityCharge = "Y" Then
		LineDetail = LineDetail & "<TD ALIGN=right><FONT FACE=Impact,Charcoal,Arial>" & FormatCurrency(FacilityCharge,2) & "</TD>"
	End If
	If ColServiceFee = "Y" Then
		LineDetail = LineDetail & "<TD ALIGN=right><FONT FACE=Impact,Charcoal,Arial>" & FormatCurrency(rsOrderLine("Surcharge"),2) & "</TD>"
	End If
	If ColDiscount = "Y" Then
		LineDetail = LineDetail & "<TD ALIGN=right><FONT FACE=Impact,Charcoal,Arial>" & FormatCurrency(rsOrderLine("Discount"),2) & "</TD>"
	End If
	
	LineDetail = LineDetail & "<TD ALIGN=right><FONT FACE=Impact,Charcoal,Arial>" & FormatCurrency(rsOrderLine("Price")+FacilityFee+rsOrderLine("Surcharge")-rsOrderLine("Discount"),2) & "</TD></TR>" & vbCrLf
