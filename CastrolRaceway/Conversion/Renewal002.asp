...
RenewDescription = Left("CASTROL 2007", 15)
...
'			Surcharge = 0
	...
	Else 'It failed
		...
		Response.Write "Import Failed - CustomerNumber = " & rsTickets("CustomerNumber") & " | SectionCode = " & rsTickets("SectionCode") & " | Row = " & rsTickets("Row") & " | Seat = " & rsTickets("Seat") & "<BR><BR>" & vbCrLf
