...
RenewalLetter = RenewalLetter & "<tr><td ALIGN=""center""><FONT FACE=Calibri,Charcoal,Arial><IMG SRC=""http://www.tix.com//PrivateLabel/CastrolRaceway/Conversion/RockyMountain_Kim.jpg""><IMG SRC=""http://www.tix.com//PrivateLabel/CastrolRaceway/Conversion/SaveMySeat.gif""><IMG SRC=""http://www.tix.com//PrivateLabel/CastrolRaceway/Conversion/OCC Logo.jpg""></FONT></td></tr>" & vbCrLf
...
RenewalLetter = RenewalLetter & "To Save Your Seat online, visit <A HREF=http://castrolraceway.tix.com/renew.asp>http://castrolraceway.tix.com/renew.asp</A>.  You will be prompted for your Order Number and Renewal Code which can be found on the attached Save My Seat form.<BR><BR>" & vbCrLf
