		...
		If Not rsCustInfo.EOF Then
                  ...
                  Set rsEventInfo = OBJdbConnection.Execute(SQLEventInfo)
                        ...
                        Do Until rsEventInfo.EOF
                              ...
                              EMailMessage = EMailMessage& "<table border=""0"" width=""745""> " & vbCrLf EMailMessage= EMailMessage& "<tr>" & vbCrLf 
                              ...
                              EMailMessage = EMailMessage & "<h2>SEE YOU AT THE RACES!</h2>" & vbCrLf
                              ...
                              EMailMessage = EMailMessage & "<a href=""" & EasyRenewalURL & """ target=""_blank"" style=""font-size: 13px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; background-color: #C20000; text-decoration: none; -webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px; padding: 12px 18px; border: 1px solid #C01F18; display: inline-block;"">" & vbCrLf 
