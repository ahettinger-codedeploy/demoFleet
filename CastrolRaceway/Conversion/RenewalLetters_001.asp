...
<%		
			...
			Response.Write "<BR><TABLE WIDTH=700><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""300"" VALIGN=""top""><BR>Castrol Raceway<BR>7003 Girard Road<BR>Edmonton, AL, Canada<BR>T6B 2C4</TD><TD WIDTH=300>&nbsp;</TD></TR></TABLE>"
			...
			Response.Write "<BR><TABLE CELLPADDING=""3"" WIDTH=""700""><TR><TD><B>Order Number:&nbsp;" & rsOrderLine("OrderNumber") & "<BR>" & vbCrLf
	...
	If LastEventCode <> rsOrderLine("EventCode") Or LastOrderNumber <> rsOrderLine("OrderNumber") Then
		Response.Write "<TABLE WIDTH=""675""><TR><TD WIDTH=""50"">&nbsp;</TD><TD><B>" & rsOrderLine("Act") & " at " & rsOrderLine("Venue")
		...
		NumColumns = 6
		ColumnHeading = "<TABLE WIDTH=""675"" BORDER=""0""><TR><TD WIDTH=""50"">&nbsp;</TD><TD><B><U>Section</U></B></TD><TD ALIGN=center><B><U>Row</U></B></TD><TD ALIGN=center><B><U>Seat</U></B></TD><TD><B><U>Type</U></B></TD><TD ALIGN=right><B><U>Price</U></B></TD>"
