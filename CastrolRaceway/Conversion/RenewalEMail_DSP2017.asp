		...
		If Not rsCustInfo.EOF Then
                  ...
                  Set rsEventInfo = OBJdbConnection.Execute(SQLEventInfo)
                        ...
                        Do Until rsEventInfo.EOF
                              ...
                              EMailMessage = EMailMessage& "<h1 style=""font-family:Calibri,Charcoal,Arial,sans-serif; font-weight:400;"">2017 RACE TO RENEW- Save My Seats</h1>" & vbCrLf 
                              EMailMessage = EMailMessage& "<img src=""https://snag.gy/VvASiM.jpg"" ""width=265px;"">" & vbCrLf 
                              EMailMessage = EMailMessage& "</td>" & vbCrLf 
                              EMailMessage = EMailMessage& "</tr>" & vbCrLf 
                              EMailMessage = EMailMessage& "<tr>" & vbCrLf 
                              EMailMessage = EMailMessage& "<td align=""center"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<h1 style=""font-family: Brush Script MT,cursive; color:red;""><font face=""Brush Script MT,cursive;"">Join us for our 20th Anniversary Season!</font></h1>" & vbCrLf 
                              EMailMessage = EMailMessage& "<h1 style=""font-family: Calibri,Charcoal,Arial,sans-serif; color:#000000;"">HOT AUGUST NIGHT</h1>" & vbCrLf 
                              EMailMessage = EMailMessage& "<h2 style=""font-family: Calibri,Charcoal,Arial,sans-serif;color:#000000;"">August 9, 2017</h2>" & vbCrLf 
                              EMailMessage = EMailMessage& "<p style=""font-family: Calibri,Charcoal,Arial,sans-serif;color:#000000;"">" & vbCrLf 
                              EMailMessage = EMailMessage& "Canada's longest running and largest single day Drag Event! Hot August Night is the largest Jet Car Event in Canada, showcasing the best of the best of Western Canada's extreme motorsports. Each year record breaking crowds can expect to see the skies light up with flames and smoke, and speeds approaching 300 MPH! Nitro Funny Cars, Alcohol Funny Cars and 200MPH Top Fuel Harleys are just the tip of the iceberg for this fan favorite Event." & vbCrLf 
                              EMailMessage = EMailMessage& "</p>" & vbCrLf 
                              EMailMessage = EMailMessage& "<h1 style=""font-family: Brush Script MT,cursive; color:red;""><font face=""Brush Script MT,cursive;"">Reserve seats for Canada's Largest Jet Car Show today!</font></h1>" & vbCrLf 
                              EMailMessage = EMailMessage& "<h1 style=""font-family: Calibri,Charcoal,Arial,sans-serif; color:#168433;"">HOT SPOT VIP EXPERIENCE</h1>" & vbCrLf 
                              EMailMessage = EMailMessage& "<h1 style=""font-family: Brush Script MT,cursive; color:#168433;""><font face=""Brush Script MT,cursive;"">The Ultimate Upgrade!</font></h1>" & vbCrLf 
                              EMailMessage = EMailMessage& "<p style=""font-family: Calibri,Charcoal,Arial,sans-serif;color:#000000;"">" & vbCrLf 
                              EMailMessage = EMailMessage& "Back with More fun, more food, and more incredible VIP entertainment! The All inclusive Event Experience: Members only hospitality lounge access, premium weekend seating, hot catered meals, unlimited beverages, exclusive gifts, private bar service, preferred parking, private autograph sessions, and much more!" & vbCrLf 
                              EMailMessage = EMailMessage& "</p>" & vbCrLf 
                              EMailMessage = EMailMessage& "<h1 style=""font-family: Calibri,Charcoal,Arial,sans-serif; font-weight:400; background-color: red;color: #ffffff;"">RACE TO RENEW YOUR TICKET ORDER TODAY</h1>" & vbCrLf 
                              EMailMessage = EMailMessage& "<h1 style=""font-family: Calibri,Charcoal,Arial,sans-serif; color:#168433;"">SAVE YOUR SEAT ONLINE</h1>" & vbCrLf 
                              EMailMessage = EMailMessage& "<p style=""font-family: Calibri,Charcoal,Arial,sans-serif;color:#000000;"">" & vbCrLf 
                              EMailMessage = EMailMessage& "Click the button below to quickly and easily renew your seats online." & vbCrLf 
                              EMailMessage = EMailMessage& "</p>" & vbCrLf 
                              EMailMessage = EMailMessage& "</td>" & vbCrLf 
                              EMailMessage = EMailMessage& "</tr>" & vbCrLf 
                              EMailMessage = EMailMessage& "</table>" & vbCrLf 
                              ...
                              EMailMessage = EMailMessage & "<tr>" & vbCrLf 
                              EMailMessage = EMailMessage & "<td align=""center"" style=""-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;"" bgcolor=""red"">" & vbCrLf 
                              EMailMessage = EMailMessage & "<a href=""" & EasyRenewalURL & """ target=""_blank"" style=""font-size: 1.5em; font-family: Calibri, Charcoal, Arial, sans-serif; color: #ffffff; background-color: red; text-decoration: none; -webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px; padding: 12px 18px; border: 1px solid red; display: inline-block;"">" & vbCrLf 
                              ...
                              EMailMessage = EMailMessage& "<tr>" & vbCrLf 
                              EMailMessage = EMailMessage& "<td align=""center"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<h1 style=""font-family: Calibri,Charcoal,Arial,sans-serif; color:#168433;"">RENEW / UPGRADE BY PHONE</h1>" & vbCrLf 
                              EMailMessage = EMailMessage& "<p style=""font-family: Calibri,Charcoal,Arial,sans-serif;color:#000000;"">" & vbCrLf 
                              EMailMessage = EMailMessage& "Contact the Castrol Raceway office directly at anytime (780) 461-5801, to renew your order over the phone or f you would like to upgrade your seats. You must contact the Castrol Raceway office to do so before the January 30 / 2016 cut-off date.  All upgrades will be processed on a first come-first serve basis." & vbCrLf 
                              EMailMessage = EMailMessage& "</p>" & vbCrLf 
                              EMailMessage = EMailMessage& "<h2 style=""font-family: Brush Script MT,cursive; color:red;""><font face=""Brush Script MT,cursive;"">" & vbCrLf 
                              EMailMessage = EMailMessage& "Thank you for choosing Castrol Raceway as your Place to Play !<BR>" & vbCrLf 
                              EMailMessage = EMailMessage& "We look forward to sharing our 20th Anniversary Season with you !" & vbCrLf 
                              EMailMessage = EMailMessage& "</font></h2>" & vbCrLf 
