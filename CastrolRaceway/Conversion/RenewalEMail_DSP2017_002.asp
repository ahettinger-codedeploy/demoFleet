...
'SLM 11/2/15 - Updated for 2016.
'SSR 11/17/15 - RenewalEmail014.asp was used for 2016 HAN and RMN emails
'SSR 10/10/16 - Updated for Pit Stall Event only.
'SSR 11/09/16 - Sent 2nd email blast
%>
...
EMailSubject = "Castrol Raceway 2017 Race Season Renewal" 
...
'TestEMailAddress = "tickets@castrolraceway.com"
TestEmailCount = 1
DPSEventList = "899970"
...
If EventList <> "" Then
	...
	If Not rsTickets.EOF Then 'There are some events.  List them
		If TestEMailAddress <> "" Then
    		Response.Write "<FONT FACE=""verdana,arial,helvetica"" SIZE=""2""><B>TEST MODE</B> - A Test email will be transmitted to: " & TestEMailAddress & "<BR><BR></FONT>" & vbCrLf
        End If
		Response.Write "<FORM ACTION=""RenewalEMail_DSP2017.asp"" METHOD=""post""><INPUT TYPE=""hidden"" NAME=""FormName"" VALUE=""PrintMenu"">" & vbCrLf
...
Do Until rsOrderLine.EOF
	...
	If rsOrderLine("OrderNumber") <> LastOrderNumber Then 'It's different.  Print it.
		...
		If Not rsCustInfo.EOF Then
                  ...
                  SQLEventInfo = "SELECT DISTINCT CASE WHEN Seat.EventCode IN (" & DPSEventList & ") THEN 'DPS' END AS LetterFormat FROM OrderHeader (NOLOCK) INNER JOIN Seat (NOLOCK) ON OrderHeader.OrderNumber = Seat.OrderNumber WHERE OrderHeader.OrderNumber = " & rsOrderLine("OrderNumber")
                  Set rsEventInfo = OBJdbConnection.Execute(SQLEventInfo)
                 
                        Do Until rsEventInfo.EOF
       
                              EMailMessage = "<CENTER>" & vbCrLf
                              
                              EMailMessage = EMailMessage& "<table border=""0"" width=""745""> " & vbCrLf 
                              EMailMessage = EMailMessage& "<tr>" & vbCrLf 
                              EMailMessage = EMailMessage& "<td align=""center"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<FONT FACE=""Calibri,Charcoal,Arial,sans-serif"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<h1 style=""font-weight:400;"">2017 RACE TO RENEW- Save My Seats</h1>" & vbCrLf 
                              EMailMessage = EMailMessage& "<img src=""https://snag.gy/xo5CzP.jpg"">" & vbCrLf 
                              ...
                              EMailMessage = EMailMessage& "<td align=""center"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<FONT FACE=""Calibri,Charcoal,Arial,sans-serif"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<h1>Celebrating 20 Years of SPEED</h1>" & vbCrLf 
                              EMailMessage = EMailMessage& "<p>" & vbCrLf 
                              EMailMessage = EMailMessage& "It's OFFICIAL! Castrol Raceway has partnered with the National Hot Rod Association to bring you the best Drag Racing North America has to offer- The <B>Rocky Mountain Nationals featuring the NHRA Canadian Open</B>. Join us for our 20th Anniversary Season and 15th Rocky Mountain Nationals event for the best Nitro Charged professional Drag Racing along with North Americas most hardcore Class Competition." & vbCrLf 
                              EMailMessage = EMailMessage& "</p>" & vbCrLf 
                              EMailMessage = EMailMessage& "</FONT>" & vbCrLf 
                              EMailMessage = EMailMessage& "</td>" & vbCrLf 
                              EMailMessage = EMailMessage& "</tr>" & vbCrLf 
                              ...
                              EMailMessage = EMailMessage& "<tr>" & vbCrLf 
                              EMailMessage = EMailMessage& "<td align=""center"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<img src=""https://snag.gy/k1qZsb.jpg"">" & vbCrLf 
                              EMailMessage = EMailMessage& "</td>" & vbCrLf 
                              EMailMessage = EMailMessage& "<td align=""center"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<FONT FACE=""Calibri,Charcoal,Arial,sans-serif"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<H3 style=""color:red;"">The Rocky Mountain Nationals featuring NHRA Canadian Open July 14-16, 2016.</H3>" & vbCrLf 
                              EMailMessage = EMailMessage& "</FONT>" & vbCrLf 
                              EMailMessage = EMailMessage& "</td>" & vbCrLf 
                              EMailMessage = EMailMessage& "</tr>" & vbCrLf 
                              EMailMessage = EMailMessage& "</table>" & vbCrLf 
                              ...
                              EMailMessage = EMailMessage& "<td align=""center"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<FONT FACE=""Calibri,Charcoal,Arial,sans-serif"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<H2 style=""color:#1F497D;"">Just in time for the Holidays- Give the Gift of Speed</H2>" & vbCrLf 
                              EMailMessage = EMailMessage& "</FONT>" & vbCrLf 
                              EMailMessage = EMailMessage& "</td>" & vbCrLf 
                              EMailMessage = EMailMessage& "</tr>" & vbCrLf 
                              EMailMessage = EMailMessage& "</table>" & vbCrLf 
                              ...
                              EMailMessage = EMailMessage& "<td align=""center"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<FONT FACE=""Calibri,Charcoal,Arial,sans-serif"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<h1 style=""font-weight:400; background-color: red;color: #ffffff;"">RACE TO RENEW YOUR TICKET ORDER TODAY</h1>" & vbCrLf 
                              EMailMessage = EMailMessage& "</FONT>" & vbCrLf 
                              EMailMessage = EMailMessage& "</td>" & vbCrLf 
                              EMailMessage = EMailMessage& "</tr>" & vbCrLf 
                              EMailMessage = EMailMessage& "</table>" & vbCrLf 
                              ...
                              EMailMessage = EMailMessage& "<tr>" & vbCrLf 
                              EMailMessage = EMailMessage& "<td align=""center"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<img src=""https://snag.gy/rUh7jD.jpg"">" & vbCrLf 
                              EMailMessage = EMailMessage& "</td>" & vbCrLf 
                              EMailMessage = EMailMessage& "<td align=""left"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<FONT FACE=""Calibri,Charcoal,Arial,sans-serif"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<p>" & vbCrLf 
                              EMailMessage = EMailMessage& "<B style=""color:#1F497D;font-size: 1.5em;"">The Ultimate Upgrade: Thunder Alley</B><BR>" & vbCrLf 
                              EMailMessage = EMailMessage& "<B style=""color:#000000;font-size: 1.15em;"">Back with More fun, more food, and more incredible VIP entertainment- the Thunder Alley VIP Weekend Experience!</B><BR>" & vbCrLf 
                              EMailMessage = EMailMessage& "<span style=""color:#33333;font-size: 1.05em;"">The All inclusive Event Experience: Members only hospitality lounge access, premium weekend seating, hot catered meals, unlimited beverages, exclusive gifts, private bar service, preferred parking, private autograph sessions, and much more.</span>" & vbCrLf 
                              EMailMessage = EMailMessage& "</p>" & vbCrLf 
                              EMailMessage = EMailMessage& "</FONT>" & vbCrLf 
                              EMailMessage = EMailMessage& "</td>" & vbCrLf 
                              EMailMessage = EMailMessage& "</tr>" & vbCrLf 
                              ...
                              EMailMessage = EMailMessage& "<table border=""0"" width=""745"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<tr>" & vbCrLf 
                              EMailMessage = EMailMessage& "<td align=""center""  style=""border-top:1px solid double red;"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<FONT FACE=""Calibri,Charcoal,Arial,sans-serif"">" & vbCrLf 
                              EMailMessage = EMailMessage& "<div style=""height: 1px; border-top: 1px solid black;""></div>" & vbCrLf 
                              EMailMessage = EMailMessage& "<div style=""height: 1px; border-top: 2px solid black;""></div>" & vbCrLf 
                              EMailMessage = EMailMessage& "<h1 style=""font-weight:400;"">QUICK & EASY: SAVE YOUR SEAT ONLINE</h1>" & vbCrLf 
                              EMailMessage = EMailMessage& "</FONT>" & vbCrLf 
                              EMailMessage = EMailMessage& "</td>" & vbCrLf 
                              EMailMessage = EMailMessage& "</tr>" & vbCrLf 
                              EMailMessage = EMailMessage& "</table>" & vbCrLf 
                              ...
                              Set rsItemNumber = OBJdbConnection.Execute(SQLItemNumber)
                                    ...
                                    EasyRenewalURL = EMailRenewalURL & "o=" & RenewalOrder & "&c=" & RenewalCode & ""
                              rsItemNumber.Close
                              Set rsItemNumber = nothing
 
                              EMailMessage = EMailMessage  & "<center>" & vbCrLf 
                              EMailMessage = EMailMessage & "<br><br>" & vbCrLf 
                              EMailMessage = EMailMessage & "<table border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbCrLf 
                              EMailMessage = EMailMessage & "<tr>" & vbCrLf 
                              EMailMessage = EMailMessage & "<td align=""center"" style=""-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;"" bgcolor=""#C01F18"">" & vbCrLf 
                              EMailMessage = EMailMessage & "<a href=""" & EasyRenewalURL & """ target=""_blank"" style=""font-size: 1.5em; font-family: Calibri, Charcoal, Arial, sans-serif; color: #ffffff; background-color: #C20000; text-decoration: none; -webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px; padding: 12px 18px; border: 1px solid #C01F18; display: inline-block;"">" & vbCrLf 
                              EMailMessage = EMailMessage & "CLICK TO RENEW" & vbCrLf 
                              EMailMessage = EMailMessage & "</a>" & vbCrLf 
                              EMailMessage = EMailMessage & "</td>" & vbCrLf 
                              EMailMessage = EMailMessage & "</tr>" & vbCrLf 
                              EMailMessage = EMailMessage & "</table>" & vbCrLf 
                              EMailMessage = EMailMessage & "<br><br>" & vbCrLf 
                              ...
                              EMailMessage = EMailMessage& "<div style=""height: 1px; border-top: 1px solid black;""></div>" & vbCrLf 
                              EMailMessage = EMailMessage& "<div style=""height: 1px; border-top: 2px solid black;""></div>" & vbCrLf 
                              EMailMessage = EMailMessage& "<h2 style=""font-weight:400; text-align:center;"">RENEW BY PHONE/Seat Upgrade </h2>" & vbCrLf 
                              EMailMessage = EMailMessage& "<p style=""color:#33333;font-size: 1.05em;"">" & vbCrLf 
                              EMailMessage = EMailMessage& "Contact the Castrol Raceway office directly at anytime (780) 461-5801, to renew your order over the phone or If you would like to upgrade your seats. You must contact the Castrol Raceway office to do so before the January 30, 2017 cutoff date. All upgrades will be processed on a first come-first serve basis.</H2>" & vbCrLf 
                              EMailMessage = EMailMessage& "</p>" & vbCrLf 
                              EMailMessage = EMailMessage& "<p style=""color:#33333;font-size: 1.05em;"">" & vbCrLf 
                              EMailMessage = EMailMessage& "Thank you for choosing Castrol Raceway as your Place to Play, we look forward to sharing an exciting 20th Anniversary Season with you.<BR>" & vbCrLf 
                              EMailMessage = EMailMessage& "<BR>" & vbCrLf 
                              EMailMessage = EMailMessage& "Our kindest regards,<BR>" & vbCrLf 
                              EMailMessage = EMailMessage& "Rob & Kimberly Reeves <BR>" & vbCrLf 
                              EMailMessage = EMailMessage& "Castrol Raceway<BR>" & vbCrLf 
                              EMailMessage = EMailMessage& "</p>" & vbCrLf 
                              EMailMessage = EMailMessage& "<div style=""height: 1px; border-top: 1px solid black;""></div>" & vbCrLf 
                              EMailMessage = EMailMessage& "<div style=""height: 1px; border-top: 2px solid black;""></div>" & vbCrLf 
                              EMailMessage = EMailMessage& "</FONT>" & vbCrLf 
                              ...
                              EMailMessage = EMailMessage & "</td></tr></table>" & vbCrLf 
		    ...
		    Set rsEventInfo = nothing
                  ...
                  EMailMessage = EMailMessage & "<BR><TABLE WIDTH=""745""><tr><td style=""background:none; border:inset 4px #333333; border-width:4px 0 0 0; height:1px; width:100%; margin:0px 0px 0px 0px; padding-top:1px;padding-bottom:1px;""><IMG SRC=""http://www.tix.com/Images/Clear.gif"" WIDTH=""1"" HEIGHT=""1""></td></tr></table>" & vbCrLf
                  ...
                  EMailMessage = EMailMessage & "<TABLE CELLPADDING=""3"" WIDTH=""745""><TR><TD><FONT FACE=Calibri,Charcoal,Arial>" & vbCrLf 
 
                  EMailMessage = EMailMessage & "<BR><B>Order Number:&nbsp;" & rsOrderLine("OrderNumber") & "</B><BR>" & vbCrLf
 
			EMailMessage = EMailMessage & "<B>Renewal Code:&nbsp;" & RenewalCode & "</B><BR></TD></TR></TABLE>" & vbCrLf
