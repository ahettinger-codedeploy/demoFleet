...
Select Case OldEventCode
	Case 119323 'Previous event
		LookupNewEventCode = 160101

End Select

End Function

OldEventCodeList = "119323"
...
RenewDescription = Left("CASTROL 2009", 15)
...
SQLTickets = "SELECT LYSeat.OrderNumber, LYSeat.EventCode, LYSeat.SectionCode, LYSeat.Row, LYSeat.Seat, OrderLine.SeatTypeCode, OrderLine.ShipFirstName, OrderLine.ShipLastName, OrderLine.ShipAddress1, OrderLine.ShipAddress2, OrderLine.ShipCity, OrderLine.ShipState, OrderLine.ShipCountry, OrderLine.ShipPostalCode, OrderHeader.CustomerNumber, OrderHeader.OrderTypeNumber FROM Seat AS LYSeat (NOLOCK) INNER JOIN Seat AS TYSeat (NOLOCK) ON LYSeat.SectionCode = TYSeat.SectionCode AND LYSeat.Row = TYSeat.Row AND LYSeat.Seat = TYSeat.Seat INNER JOIN OrderLIne (NOLOCK) ON LYSeat.ItemNumber = OrderLine.ItemNumber INNER JOIN OrderHeader (NOLOCK) ON OrderLine.OrderNumber = OrderHeader.OrderNumber WHERE LYSeat.EventCode = 119323 AND TYSeat.EventCode = 160101 AND LYSeat.StatusCode = 'S' AND TYSeat.StatusCode = 'A'"
