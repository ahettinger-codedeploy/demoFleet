...
RenewalLetter = RenewalLetter & "<tr><td ALIGN=""center""><IMG SRC=""/PrivateLabel/CastrolRaceway/Conversion/RockyMountainNationals.gif""><IMG SRC=""/PrivateLabel/CastrolRaceway/Conversion/SaveMySeat.gif""><IMG SRC=""/PrivateLabel/CastrolRaceway/Conversion/OilCityCup.gif""></td></tr>" & vbCrLf
RenewalLetter = RenewalLetter & "<tr><td><BR><B>SAVE MY SEAT<BR>ONLY UNTIL NOVEMBER 30, 2009!!</B><BR></td></tr>" & vbCrLf
RenewalLetter = RenewalLetter & "<tr><td><BR>" & MonthName(Month(Now())) & " " & Day(Now()) & ", " & Year(Now()) & "<br><br></td></tr>" & vbCrLf
