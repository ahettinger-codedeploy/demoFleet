...
Select Case OldEventCode
	Case 224766 ' NITRO JAM MOTORHOME CAMPING
		LookupNewEventCode = 301200
	Case 224769 ' NITRO JAM SAVE! WEEKEND PASS ROCKY MOUNTAIN NATIONALS
		LookupNewEventCode = 301196
	Case 224763 ' NITRO JAM FRIDAY ROCKY MOUNTAIN NATIONALS
		LookupNewEventCode = 301197
	Case 224764 ' NITRO JAM SATURDAY ROCKY MOUNTAIN NATIONALS
		LookupNewEventCode = 301198
	Case 224765 ' NITRO JAM SUNDAY ROCKY MOUNTAIN NATIONALS
		LookupNewEventCode = 301199
	Case 224770 ' World of Outlaws OCC Motor Homes
		LookupNewEventCode = 301201
	Case 224776 ' Oil City Cup - 2 Day Pass
		LookupNewEventCode = 301202
	Case 224771 ' World of Outlaws Oil City Cup - Saturday
		LookupNewEventCode = 301203
	Case 224772 'World of Outlaws Oil City Cup - Sunday
		LookupNewEventCode = 301205
End Select

End Function

OldEventCodeList = "224766,224769,224763,224764,224765,224770,224776,224771,224772"

'Select a date according to the client, either near the beginning of the season or after the season is complete.
OrderExpirationDate = "11/1/2010"
'Previous year's season event code
'Text which is placed in the IP Address field for identification purposes.
RenewDescription = Left("CASTROL 2011", 15)

Surcharge = 1.50
ShipCode = 18
ShipFee = 7
OrderNumber = 999999
StartAtOldOrderNumber = 0
