...
EMailSubject = "Castrol Raceway 2016 Race Season Renewal" 
...
Do Until rsOrderLine.EOF
	...
	If rsOrderLine("OrderNumber") <> LastOrderNumber Then 'It's different.  Print it.
		...
		If Not rsCustInfo.EOF Then
			...
			EMailMessage = EMailMessage & "<tr><td><FONT FACE=Calibri,Charcoal,Arial><br />If you are mailing in your renewal form to Castrol Raceway, please fill out the payment information below.<BR><BR>" & vbCrLf
