...
<%		
			...
			Response.Write "<BR><TABLE WIDTH=700><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""300"" VALIGN=""top""><FONT FACE=Calibri,Charcoal,Arial><BR>Castrol Raceway<BR>7003 Girard Road<BR>Edmonton, AL, Canada<BR>T6B 2C4</TD><TD WIDTH=300>&nbsp;</TD></TR></TABLE>"
			Response.Write "<BR><TABLE WIDTH=750><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400""><FONT FACE=Calibri,Charcoal,Arial><B>Shipping Information</B></TD><TD WIDTH=""300""><FONT FACE=Calibri,Charcoal,Arial><B>Billing Information</B></TD></TR>"
			...
			Response.Write "<IMG SRC=""/PrivateLabel/CastrolRaceway/Conversion/RockyMountain_Kim.jpg""><IMG SRC=""/PrivateLabel/CastrolRaceway/Conversion/SaveMySeat.gif""><IMG SRC=""/PrivateLabel/CastrolRaceway/Conversion/OCC Logo.jpg""><BR>" & vbCrLf
			Response.Write "<BR><TABLE CELLPADDING=""3"" WIDTH=""675""><TR><TD WIDTH=""10"">&nbsp;</TD><TD><FONT FACE=Calibri,Charcoal,Arial><B>Order Number:&nbsp;" & rsOrderLine("OrderNumber") & "<BR>" & vbCrLf
	...
	If LastEventCode <> rsOrderLine("EventCode") Or LastOrderNumber <> rsOrderLine("OrderNumber") Then
		Response.Write "<TABLE WIDTH=""675""><TR><TD WIDTH=""30"">&nbsp;</TD><TD><FONT FACE=Calibri,Charcoal,Arial><B>" & rsOrderLine("Act") & " at " & rsOrderLine("Venue")
