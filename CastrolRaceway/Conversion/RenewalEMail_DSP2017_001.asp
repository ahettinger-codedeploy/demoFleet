		...
		If Not rsCustInfo.EOF Then
                  ...
                  Set rsEventInfo = OBJdbConnection.Execute(SQLEventInfo)
                        ...
                        Do Until rsEventInfo.EOF
                              ...
                              EMailMessage = EMailMessage & "<tr><td align=""left"" style=""background-color:#F8F8F8;""><FONT FACE=Calibri,Charcoal,Arial>" & vbCrLf
                              EMailMessage = EMailMessage & "<CENTER><IMG SRC=""http://www.tix.com/PrivateLabel/CastrolRaceway/Conversion/CastrolRaceway.png"" WIDTH=""175""><BR>" & vbCrLf
                              EMailMessage = EMailMessage & "<h2 align=""center"">CASTROL RACEWAY<BR>2017 PITSTALL RENEWAL PROGRAM</h2>" & vbCrLf 

                              EMailMessage = EMailMessage & "<h3 align=""center"">WELCOME BACK !<BR> " & vbCrLf
                              EMailMessage = EMailMessage & "The 2016 race season has come to a close.<BR>" & vbCrLf
                              EMailMessage = EMailMessage & "Were planning for our 20th year<BR>" & vbCrLf
                              EMailMessage = EMailMessage & "at Canada's Premier Motor Sport Complex !</h3>" & vbCrLf

                              EMailMessage = EMailMessage & "<h3 align=""center"">Book your Pitstall and Season Pass now for the 2017 season. <BR>" & vbCrLf
                              EMailMessage = EMailMessage & "It's going to be a great one!</h3>" & vbCrLf

                              EMailMessage = EMailMessage & "<p>All the pieces are in place for another exceptional season except one- <BR>" & vbCrLf
                              EMailMessage = EMailMessage & "<h3>YOU!</h3>" & vbCrLf
                              EMailMessage = EMailMessage & "Its our race participants like you who make Castrol Raceway a success.<br>" & vbCrLf
                              EMailMessage = EMailMessage & "It is our pleasure to provide the best possible experience <br>" & vbCrLf
                              EMailMessage = EMailMessage & "for each competitor at our facility.<br>" & vbCrLf
                              EMailMessage = EMailMessage & "<strong>YOU are our Castrol Race Family!</strong></p> " & vbCrLf

                              EMailMessage = EMailMessage & "<p align=""center""> Our family loves racing and wants to keep it alive in Edmonton.<BR>" & vbCrLf
                              EMailMessage = EMailMessage & "As a family owned business, we run on passion.<BR>" & vbCrLf
                              EMailMessage = EMailMessage & "Our competitors understand that passion.<BR>" & vbCrLf
                              EMailMessage = EMailMessage & "<h3>We look forward to having join us again in <br>" & vbCrLf
                              EMailMessage = EMailMessage & "2017!</h3></p> " & vbCrLf

                              EMailMessage = EMailMessage & "<p align=""center""> Order online or contact the Castrol Raceway office (780) 461-5801 <BR>" & vbCrLf
                              EMailMessage = EMailMessage & "to renew or request changes your pit stall subscription. <BR>" & vbCrLf
                              EMailMessage = EMailMessage & "<strong>You must contact the Castrol Raceway office <BR>" & vbCrLf
                              EMailMessage = EMailMessage & "before the Dec. 1/2016 cut-off date.</strong></p>" & vbCrLf
		    ...
		    Set rsEventInfo = nothing
                  ...
                  EMailMessage = EMailMessage & "<TABLE WIDTH=""745""><tr><td style=""background:none; border:inset 4px #333333; border-width:4px 0 0 0; height:1px; width:100%; margin:0px 0px 0px 0px; padding-top:1px;padding-bottom:1px;""><IMG SRC=""http://www.tix.com/Images/Clear.gif"" WIDTH=""1"" HEIGHT=""1""></td></tr></table>" & vbCrLf
