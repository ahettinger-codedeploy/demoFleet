...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">Black Dog Radio Productions, Inc<BR>506 N.Clark St Suite 200N<BR>Chicago IL 60610 </TD><TD WIDTH=""300""><IMG SRC=/PrivateLabel/35Words/Invoice/Logo.gif HEIGHT=""120""></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from Black Dog Radio Productions.&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us at info@35words.com or call (773) 851-9878.<BR><BR>" & vbCrLf
