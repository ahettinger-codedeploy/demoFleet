	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
		   ...
		   'Response.Write "<TD VALIGN=""top"" WIDTH=""33%"">" & vbCrLf
			    ...
			    Response.Write "Travel north on U.S. 1 to Douglas Road," & vbCrLf
			    Response.Write "Turn right and proceed to 4055 SW 37 Avenue" & vbCrLf
			    Response.Write "<br/>" & vbCrLf
			    Response.Write "FROM THE NORTH" & vbCrLf
			    Response.Write "Travel south U.S. 1 to Douglas Road" & vbCrLf
			    Response.Write "Turn Left and proceed to 4055 SW 37 Avenue" & vbCrLf
			    Response.Write "<br />" & vbCrLf
