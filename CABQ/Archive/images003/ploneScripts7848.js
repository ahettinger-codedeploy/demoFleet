...
// http://www.cabq.gov/sustainability/portal_javascripts/event-registration.js?original=1
...
// http://www.cabq.gov/sustainability/portal_javascripts/register_function.js?original=1
...
/* - cssQuery.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/cssQuery.js?original=1
...
// http://www.cabq.gov/sustainability/portal_javascripts/plone_javascript_variables.js?original=1
var portal_url='http://www.cabq.gov/sustainability';var form_modified_message='Your form has not been saved. All changes you have made will be lost.';var form_resubmit_message='Your already clicked the submit button. Do you really want to submit this form again?';var external_links_open_new_window=false;var external_links_in_content_only=true;

/* - nodeutilities.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/nodeutilities.js?original=1
...
/* - cookie_functions.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/cookie_functions.js?original=1
...
/* - fullscreenmode.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/fullscreenmode.js?original=1
...
/* - select_all.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/select_all.js?original=1
...
/* - dropdown.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/dropdown.js?original=1
...
/* - dragdropreorder.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/dragdropreorder.js?original=1
var ploneDnDReorder={}
...
// http://www.cabq.gov/sustainability/portal_javascripts/mark_special_links.js?original=1
function scanforlinks(){if(!W3CDOM){return false}
contentarea=getContentArea();if(!contentarea){return false}
var offsiteLink="http://www.cabq.gov/about/offsite.html";var offsiteIcon="http://www.cabq.gov/images/globe.gif";var offsiteText="Leaving www.cabq.gov, click for disclaimer";var offsiteClass="externallink";var pdfLink="http://www.cabq.gov/about/pdf.html";var pdfIcon="http://www.cabq.gov/images/aboutpdf.gif";var pdfText="About PDF Files";var pdfClass="aboutpdf";links=contentarea.getElementsByTagName('a');for(i=0;i<links.length;i++){if((links[i].getAttribute('href'))&&(links[i].className.indexOf('link-plain')==-1)){var linkval=links[i].getAttribute('href');var linksToCurrentHost=linkval.toLowerCase().indexOf(window.location.protocol+'//'+window.location.host)==0;var linksToCabq=linkval.toLowerCase().match("cabq.gov")=="cabq.gov";if(linksToCurrentHost||linksToCabq){} else if(linkval.indexOf('http:')!=0){protocols=['mailto','ftp','news','irc','h323','sip','callto','https','feed','webcal'];for(p=0;p<protocols.length;p++){if(linkval.indexOf(protocols[p]+':')==0){wrapNode(links[i],'span','link-'+protocols[p]);break}}} else{if(links[i].getElementsByTagName('img').length==0){var a=document.createElement('a');a.href=offsiteLink;a.className=offsiteClass;a.title=offsiteText;var img=document.createElement('img');img.src=offsiteIcon;img.alt=offsiteText;a.appendChild(img);links[i].parentNode.insertBefore(a,links[i].nextSibling)}}
...
// http://www.cabq.gov/sustainability/portal_javascripts/collapsiblesections.js?original=1
...
// http://www.cabq.gov/sustainability/portal_javascripts/highlightsearchterms.js?original=1
...
/* - se-highlight.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/se-highlight.js?original=1
...
// http://www.cabq.gov/sustainability/portal_javascripts/first_input_focus.js?original=1
...
// http://www.cabq.gov/sustainability/portal_javascripts/folder_contents_filter.js?original=1
...
// http://www.cabq.gov/sustainability/portal_javascripts/folder_contents_hideAddItems.js?original=1
...
/* - styleswitcher.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/styleswitcher.js?original=1
function setActiveStyleSheet(title,reset){if(!W3CDOM){return false};var i,a,main;for(i=0;(a=document.getElementsByTagName("link")[i]);i++){if(a.getAttribute("rel").indexOf("style")!=-1&&a.getAttribute("title")){a.disabled=true;if(a.getAttribute("title")==title){a.disabled=false}}}
if(reset==1){createCookie("wstyle",title,365)}};
function setStyle(){var style=readCookie("wstyle");if(style!=null){setActiveStyleSheet(style,0)}};registerPloneFunction(setStyle);

/* - table_sorter.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/table_sorter.js?original=1
...
// http://www.cabq.gov/sustainability/portal_javascripts/calendar_formfield.js?original=1
...
/* - calendarpopup.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/calendarpopup.js?original=1
function showDay(date){document.getElementById('day'+date).style.visibility='visible';return true}
function hideDay(date){document.getElementById('day'+date).style.visibility='hidden';return true}


/* - ie5fixes.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/ie5fixes.js?original=1
...
/* - formUnload.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/formUnload.js?original=1
...
/* - sarissa.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/sarissa.js?original=1
...
/* - login.js - */
// http://www.cabq.gov/sustainability/portal_javascripts/login.js?original=1
...
// http://www.cabq.gov/sustainability/portal_javascripts/formsubmithelpers.js?original=1
