...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "South on I-25 past the Big-I, exit east at Avenida Cesar Chavez.  Head east on Avenida Cesar Chavez.  After crossing University Boulevard, the parking lot for the tour is located on the right, just past University Stadium.<BR><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
