...
'=============================================
'Bay Street Players (10/5/2010)

'Dinner Event Add On Survey displays for any event
'to which the survey is attached
'Only 1 restauarant choice given
'Any number of offer tickets allowed
...
TableCategoryFont = "verdana,arial,helvetica"
TableCategoryFontColor = "FFFFFF"
TableColumnHeadingBGColor = "99CC99"
TableDataFont = "verdana,arial,helvetica"
...
%>             
        <TABLE CELLPADDING=10 CELLSPACING=25 WIDTH="600" border=0>
        <tr bgcolor="<%=TableCategoryBGColor%>">
            <td align="left">
                <FONT FACE="verdana,arial,helvetica" COLOR="<%=TableCategoryFontColor%>" SIZE="4">
                <b>SPECIAL OFFER</b></FONT>
                <BR>
            </td>
        </tr>
            ...
            <table width="40%" border="0" CELLPADDING="0" CELLSPACING="3">
                <tr>    
                    <td ALIGN="left"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2"><B><U>Ticket Type</U></B></FONT></td>
                    <td ALIGN="center"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2"><B><U>Price</U></B></FONT></td>
                    <td ALIGN="center"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2"><B><U>Quantity</U></B></FONT></td>
                </tr>
                <tr>
                    <td ALIGN="left"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2"><%=OfferSeatType%></td>
