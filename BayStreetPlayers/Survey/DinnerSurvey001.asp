...
'Dinner Event Add On Survey

'Survey will offer the option to purchase any number of tickets for the offer event
...
<TABLE CELLPADDING=10 CELLSPACING=25 WIDTH="400" border=0>
...
<tr bgcolor="<%=TableDataBGColor%>">
    <td align="left">
        ...
        <BR>
        <INPUT TYPE="radio" NAME="EventCode" VALUE="260545"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">Fanelli's Italian Grill</FONT> <FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">$30.00</FONT>
        <BR>
        <FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">Quantity: </FONT><INPUT TYPE="text" NAME="Quantity" SIZE="5">
        <BR>
    </td>
</tr>
</TABLE>    
