...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<TABLE WIDTH=""615"" HEIGHT=""240"" BORDER=""1"" class=""ETicketBackground"" BACKGROUND="" " &  ETicketBackground & " "" BGCOLOR=""#FFD718"" CELLPADDING=""0"" CELLSPACING=""0"">" & vbCrLf
			Response.Write "<TR>" & vbCrLf
		...
		'Begin Body Space
			...
			'Begin Left Column
			Response.Write "<TD VALIGN=""top"" WIDTH = ""30%"">" & vbCrLf
			...
			'Begin Middle Column
			Response.Write "<TD VALIGN=""top"" WIDTH=""70%"" COLSPAN=""2"">" & vbCrLf
			
			Response.Write "<DIV VALIGN=""top"" STYLE=""float: left; width: 230px; min-height:100px;"">" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2"">" & vbCrLf
			...
			Response.Write "<DIV STYLE=""float:right; width: 190px; min-height:100px;text-align: right;"">" & vbCrLf
           ...
           'ETicket MapPath
            ...
            If Not IsNull(rsTix("ETicketDrivingDirections")) Then
				...
				Response.Write "<DIV VALIGN=""top"" STYLE=""float: left;margin-top:15px;"">" & vbCrLf
				Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2"">" & vbCrLf
            ...
            Else
				...
				Response.Write "<B>Traveling South from Sacramento:</B>" & vbCrLf
				Response.Write "<ol style=""padding-left:10px;"">" & vbCrLf
				Response.Write "<li>Capital City Fwy becomes CA-99 South. Go 7.5 miles on CA-99.</li>" & vbCrLf
				Response.Write "<li>Take the Calvine Road exit and cross over the freeway heading EAST.</li> " & vbCrLf 
				Response.Write "<li>Continue east (straight) on Calvine Road for 3.4 miles.</li>" & vbCrLf
				Response.Write "<li>Turn left at the signal (north) onto Kingsbridge Drive (You will pass large radio towers on your left before you reach Kingsbridge).</li>" & vbCrLf
				Response.Write "<li>Go 0.2 miles on Kingsbridge until you reach the first stoplight that goes right only and into the parking lot.  This is the closest parking lot (there are others nearby).</li> " & vbCrLf 
				Response.Write "<li>The Performing Arts Center is to the rear of this parking lot.</li> " & vbCrLf 
				Response.Write "</ol>" & vbCrLf
				Response.Write "<ul style=""padding-left:10px;"">" & vbCrLf
				Response.Write "<li>Patrons entrance is to the left.</li>" & vbCrLf 
				Response.Write "<li>Performers entrance is to the far right.</li> " & vbCrLf
