...
'Adult subscription is 10% off 
'Senior subscription is 10% off 
'Student subscription is 10% off 
...
'Adult subscription price is 15% off 
'Senior subscription price is 15% off 
'Student subscription price is 15% off  
...
'Each Adult subscription is 25% off 
'Each Student subscription is 25% off 
'Additional Student subscriptions are 25% off 
'Additional single tickets are $1.00 off
...
'Determine if this is a Family Pack Discount
If AdultSubCount => (FamilyPackQuantity * .50) And StudentSubCount  => (FamilyPackQuantity * .50) Then    
    FamilyPack = "Y"
End If
...
If FullSubscription = "Y" And FamilyPack = "Y" Then    	
            ...
            'ADULT - FAMILY PACK DISCOUNT
	            ...
	            'AdultSubs in pairs, with equal number of StudentSubs to qualify for discount	             
	            If AdultSubCount > StudentSubCount Then
                    AdultFamCount = (AdultSubCount - (AdultSubCount - StudentSubCount)) - ((AdultSubCount - (AdultSubCount - StudentSubCount)) MOD 2)  
                ElseIf AdultSubCount < StudentSubcount Then
                    AdultFamCount = (AdultSubCount - (AdultSubCount MOD 2))
                Else
                    AdultFamCount = AdultSubCount
                End If
		        ...
		        If AppliedAdultCount < AdultSubCount  Then	
						...
						Case 1' Adult	
						    ...
						    If Remainder > 0 Then
							    ...
							    End If
							Else
							    'Adult Family Pack Max Limit
							    If AppliedAdultCount < AdultFamCount Then
								    NewPrice = round(CDbl(Clean(Request("Price"))) * (1-CDbl(FamilyPackPercentage)/100), 2)	
								Else
								    NewPrice = round(CDbl(Clean(Request("Price"))) * (1-CDbl(FullSubPercentage)/100), 2)
								End If	   
