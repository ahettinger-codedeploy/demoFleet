...
OrganizationNumber = 4060 'Organization Number
StreetAddress = "P.O.Box 504" 'Street Address. If this is a 2 line street address use <BR> between the two lines
CityStateZip = "Beaufort, SC 29901<BR><BR>" 'City State Zip Code
ClientDirectory = "BeaufortOrchestra" 'Name of Client Directory where Invoice/InvoiceFormat.asp is located
PhoneNumber = "" 'Customer Service Phone Number. If org doesn't have a number, use PhoneNumber = ""
...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">" & OrgName & "<BR>" & StreetAddress & "<BR>" & CityStateZip &  "</TD><TD WIDTH=""300""></TD></TR></TABLE>"
