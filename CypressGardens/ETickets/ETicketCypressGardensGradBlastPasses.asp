...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "</TD>" & vbCrLf
			Response.Write "<TD VALIGN=""top"">" & vbCrLf
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""5""><B>""Grad Blast"" w/ Paula DeAnda</B></FONT><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""3""><B>Admission valid only on May 4, 2007&nbsp;&nbsp;&nbsp;7pm-Midnight</B></FONT><BR><BR>" & vbCrLf
			...
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""4""><B>Open to 8th Graders Only</B></FONT><BR>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
			Response.Write "</TD>" & vbCrLf	
