...
If IPAddress = "127.0.0.1" Then 'The request is from Tix
	...
	Select Case ActCode
		...
		Case 13736, 13737 'Cypress Gardens 2007 Passport
			TicketCode = 14
		Case 26888 'Latin Festival
			TicketCode = 6001
		Case 29618 'Girl Scout Admission
			TicketCode = 813
		Case 29619 'Girl Scott Express Meal Option
			TicketCode = 814
		Case 29834 '2008 Hot Water Jet Ski Tournament
			TicketCode = 815
		Case Else
			TicketCode = 0
	End Select
	...
	If TicketCode <> 0 Then 'Use Wild Adventures Database
		...
		If ReturnCode <> 0 Or Len(TicketNumber) < 2 Then 'Error
			...
			objCDOSYSMail.To = "jmullen@cypressgardens.com"
