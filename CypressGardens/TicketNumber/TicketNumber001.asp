...
If IPAddress = "127.0.0.1" Then 'The request is from Tix
	...
	Select Case ActCode
		...
		Case 9662, 10508 'Cypress Gardens Platinum
			TicketCode = 11
		Case 9663, 10507 'Cypress Gardens Gold
			TicketCode = 1116
		Case 9664, 9665 'Cypress Gardens Passport
			TicketCode = 4001
	...
	If TicketCode <> 0 Then 'Use Wild Adventures Database
		...
		dbCypressGardens.Open "Provider=SQLOLEDB; Data Source=172.31.2.34; Initial Catalog=TIX_TICKETS; Network=DBMSSOCN; User ID=tix; Password=qwaszxTT"
		...
		spGetTicket.Commandtext = "sp_GetUpdateTicket"
		...
		If ReturnCode <> 0 Or Len(TicketNumber) < 2 Then 'Error
			...
			objCDOSYSMail.To = "cyoumans@wild-adventure.com"
			objCDOSYSMail.CC = "mdrawyer@wild-adventure.com;cgreene@wild-adventure.com"
