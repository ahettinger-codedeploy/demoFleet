<%
'CHANGE LOG
'JAI 3/30/12 - New script for CMSD, based off generic Renewal.asp
%>
...
OrderExpirationDate = "9/1/13"
RenewDescription = Left("CMSD 12/13", 15)
...
EventArray(0,0) = 446015
EventArray(0,1) = 460260

EventArray(1,0) = 446016
EventArray(1,1) = 460261
...
Response.Write "End " & RenewDescription & " - " & Now() & "<BR>"
...
Do While Not rsNewTickets.EOF
	...
	If AppliedFlag = "Y" Then 'Calculate discount amount					
        ...
        Response.Write "Apply Discount: " & SQLUpdateOrderLine & vbCrLf
