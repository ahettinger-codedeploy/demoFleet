...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">Chamber Music Now!<BR>618 S. 19th Street<BR>Philadelphia, PA 19146</TD><TD WIDTH=""300""><IMG SRC=/PrivateLabel/ChamberMusicNow/Invoice/Logo.gif HEIGHT=""120""></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from Chamber Music Now!&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us at cmnevents@gmail.com or call (215) 605-9988 (ask for Richard Belcastro).<BR><BR>" & vbCrLf
