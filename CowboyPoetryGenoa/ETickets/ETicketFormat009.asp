...
'RAS 4/20/11 - Removed error log debugging entry in Ad space section
%>
...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'=====================================================
			...
			Case "9388","11433 ","11438","9428" 'Carson Vally Hotel Advertisement, COWBOY CORRAL, Genoa Town Hall, TOWN OF GENOA, NV
