...
'Centerpiece Presentation: 		843589
...
DIM CenterEvent
CenterEvent = "843589" 'Centerpiece Presentation
...
If AllowDiscount = "Y" Then 'It's okay to apply to this order.
	...
	If RegularCount > 0 Then
		...
		'ErrorLog("RegularCount Applied:" & Int(rsDiscCount("LineCount")) & "")
			...
			If NOT rsDiscCount.EOF	Then
				...
				If EventCode <> VIPEvent AND EventCode <> OpenEvent AND EventCode <> CloseEvent AND EventCode <> CenterEvent Then
					...
					Else
						If AddDisc Then
							NewPrice = fnMemberPrice
							'ErrorLog("Is AddDisc True? give memberprice: " & fnMemberPrice & "-" & AddDisc & "")
						End If
					End If	
	...
	'ErrorLog("Price: " & Price & "  - NewPrice: " & NewPrice & "")
	...
	If Price > NewPrice Then
		...
		'ErrorLog("Price: " & Price & "  - NewPrice: " & NewPrice & " - Surcharge : " & Surcharge & "")
...
Public Function fnMemberPrice
	...
	'This function looks for the Member ticket on the same event to determine what the member discount should be.
	'If a member ticket is not found, there is no discount.
	...
	Set rsMemberPrice  = OBJdbConnection.Execute(SQLMemberPrice )
		If Not rsMemberPrice.EOF Then
			strResults = rsMemberPrice("Price")
			'ErrorLog("MemberPrice: " & 	strResults & "")
		Else
			'strResults = Clean(Request("Price"))
			strResults = round(CDbl(Clean(Request("Price"))))
		End If
	rsMemberPrice.Close
