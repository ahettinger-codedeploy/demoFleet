...
DIM CloseEvent
CloseEvent = "843877" 'Closing Night

DIM CenterNight
CenterNight = "843588" 'Centerpiece Presentation
	...
	If RegularCount > 0 Then
		...
		Set rsDiscCount = OBJdbConnection.Execute(SQLDiscCount)
			...
			If NOT rsDiscCount.EOF	Then
				...
				If EventCode <> VIPEvent AND EventCode <> OpenEvent AND EventCode <> CloseEvent AND EventCode <> CenterEvent AND EventCode <> WeekEvent Then
