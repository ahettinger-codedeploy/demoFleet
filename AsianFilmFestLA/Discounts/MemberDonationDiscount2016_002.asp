...
'CHANGE LOG
'SSR - 02/19/16 - Created customer past donation  discount script
'SSR - 02/22/16 - Updated to include expiration date
...
'EVENTS							EVENT CODES
'---------------------------------------------
'Opening Night VIP: 			844779
'Opening Night: 				843591
'Centerpiece: 					843588
'Closing Night: 				843877
'Regular EventS:				All Others except (84008)
...
'Opening Night VIP: 2 general admission tickets discounted by 100%
'Closing Night:     2 general admission tickets discounted by 100%
'All Events:        Unlimited general admission tickets discounted down to the membership price
...
'VIP All-Access Pass
'------------
'AVAILABLE FOR BOX OFFICE USE ONLY
'All Events:        1 general admission ticket discounted  to 100% for each event
'Excluded:			Regular Opening Night Event
'All Events:        Unlimited general admission tickets discounted down to the membership price
...
'Opening Night:  	1  general admission ticket  discounted by 100%
'Closing Night:  	1  general admission ticket  discounted by 100%
'All Events:        Unlimited general admission tickets discounted down to the membership price
...
'Discounts will only be applied
'to this ticket type:
'General Admission 
DIM RequiredSeatType
RequiredSeatType = "42850"

'Discount amount is determined
'per event by the price assigned to this 
'ticket type:
'Membership (w/ ID)
DIM MemberSeatCode 
...
'Combined List of Non-Regular Event Codes
DIM SpecialEvents
SpecialEvents = VIPEvent & "," & OpenEvent & "," & CloseEvent & "," & CenterNight
...
'Determine the Patron's Customer Number
DIM CustomerNumber
...
If AllowDiscount = "Y" Then
	...
	If MemberDisc Then
		...
		ErrorLog("EventCode: " & EventCode & "- Price: " & Price & " - NewPrice: " & NewPrice & "")
