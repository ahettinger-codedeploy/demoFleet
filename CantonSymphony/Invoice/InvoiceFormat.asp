...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><TABLE WIDTH=750><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top""><BR>Canton Symphony Orchestra<BR>2331 17th Street NW<BR>Canton  OH  44708 <BR></TD><TD WIDTH=300><IMG SRC=/PrivateLabel/CantonSymphony/Invoice/logo.jpg height=95><BR></TD></TR></TABLE>"
	...
	End If
	Response.Write rsCustInfo("City") & ", " & rsCustInfo("State") & " " & rsCustInfo("PostalCode") & "<BR>" & vbCrLf
	Response.Write FormatPhone(rsCustInfo("NightPhone"), "United States") & "</TD></TR></TABLE><BR><HR>" & vbCrLf
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from Canton Symphony Orchestra.&nbsp;&nbsp;The details of your order are listed below.&nbsp;&nbsp;For questions regarding this order, contact Canton Symphony Orchestra via e-mail at boxoffice@cantonsymphony.org or by calling (330) 452-2094.<BR><BR>" & vbCrLf
