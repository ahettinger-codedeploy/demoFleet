...
OrderExpirationDate = "6/1/2009"

'Previous year's season event code
OldEventCode = 127092 'Canton Symphony Season 2008
'This year's event code
EventCode = 175085 'Canton Symphony Season 2009

'Text which is placed in the IP Address field for identification purposes.
RenewDescription = Left("Canton Sym 2009", 15)
...
'			Surcharge = 0
	...
	Else
		...
		Response.Write "Import Failed - CustomerNumber = " & rsTickets("CustomerNumber") & " | SectionCode = " & rsTickets("SectionCode") & " | Row = " & rsTickets("Row") & " | Seat = " & rsTickets("Seat") & "<BR>" & vbCrLf
