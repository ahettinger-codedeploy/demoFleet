...
<OBJECT id=UserControl1 style="LEFT: 0px; TOP: 0px" codeBase=Project1.CAB#version=1,0,0,0 
	classid=CLSID:AA4D2DFF-EC4A-4CC5-BBAF-D818ABD03DF7 VIEWASTEXT>
    <PARAM NAME="CommPort" VALUE="1">
    <PARAM NAME="Settings" VALUE="9600,N,8,1">
    <PARAM NAME="Output" VALUE="ATDT">
	</OBJECT>
</BODY>
</HTML>
