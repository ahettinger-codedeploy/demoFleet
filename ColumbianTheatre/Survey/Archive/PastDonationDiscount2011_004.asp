...
ErrorLog("FamilyDonationFound " & FamilyDonationFound & "")
...
ErrorLog(" DiscountFound " &  DiscountFound & "")
...
'If there are any other discounts, bypass this survey
If DiscountFound Then
    Call Continue

'If a family donation is found process that first discount    
ElseIf FamilyDonationFound Then 
Call ApplyFamilyDiscount

'If a donation is found process that discount    
...
If ApplyFamily Then
    ...
    If CInt(AvailableTicketCount) > 0 Then 'it is okay to give discounted tickets 
        ...
        If Not rsLineNo.EOF Then
            ...
            ErrorLog("Family Line Number  " & rsLineNo("LineNumber")& "")
...
ErrorLog("FamilyTicketCount  " & FamilyTicketCount & "")

ErrorLog("FamilyDiscountApplied  " & FamilyDiscountApplied & "")
...
ErrorLog("FamilyDiscountMessage  " & FamilyDiscountMessage & "")
