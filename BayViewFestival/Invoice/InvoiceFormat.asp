...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">Bay View Music Festival<BR>6111 Evanston Avenue<BR>Indianapolis, Indiana 46220</TD><TD WIDTH=""300""><IMG SRC=/PrivateLabel/BayViewFestival/Invoice/Logo.jpg HEIGHT=""120""></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from Bay View Music Festival.&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us at chrisludwa@yahoo.com or call (231) 347-4210.<BR><BR>" & vbCrLf
