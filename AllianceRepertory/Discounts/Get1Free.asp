...
If NbrTickets > 1 Then 'Need to have more than one ticket on order
	...
	If rsDiscCount("LineCount") = 0 Then 'No discount applied yet
		NewPrice = 0
		DiscountAmount = Price - NewPrice
		'JAI - 2/9/5 - Added ItemType to CalcCustomerFee
		Surcharge = CalcCustomerFee(OrganizationNumber, OrderTypeNumber, NewPrice, EventCode, ItemType)
		AppliedFlag = "Y"
	End If
	rsDiscCount.Close
