...
function getCheckedValue(radioObj) {
	...
	<%
	'adjust the table colors for box office users
	If Session("UserNumber")<> "" Then
	...
	<style>
	/* ::::: adjust the layout of the attendee survey ::::: */
	.table { width: 70%; font-family: Helvetica,Arial,sans-serif; font-size: small; }
	.table thead tr th { color: <%=TableCategoryFontColor%>; background: none repeat scroll 0% 0% <%=TableCategoryBGColor%>; padding-top: 2px; padding-bottom: 2px; }
	.table tbody tr td { color: <%=TableDataFontColor%>; background: none repeat scroll 0% 0% <%=TableDataBGColor%>; padding-top: 10px; padding-bottom: 10px; }
	.table tbody tr td:first-child { text-align: right; font-weight: bold; color: <%=TableDataFontColor%>; }
	.table tbody tr td:last-child { text-align: left; font-weight: normal; color: <%=TableDataFontColor%>; }
	.table hr { margin: 17px 0px 18px; height: 0px; clear: both; border-right: 0px solid <%=TableDataFontColor%>; border-left: 0px solid <%=TableCategoryBGColor%>; -moz-border-top-colors: none; -moz-border-right-colors: none; -moz-border-bottom-colors: none; -moz-border-left-colors: none; border-image: none; border-width: 1px 0px; border-style: solid; border-color: rgb(221, 221, 221) rgb(221, 221, 221) rgb(255, 255, 255); }
	.table small { color: <%=TableDataFontColor%>; }
	.table sx { margin: 17px 0px 18px; height: 0px; clear: both; border-style: solid; border-color: <%=TableDataFontColor%>; -moz-border-top-colors: none; -moz-border-right-colors: none; -moz-border-bottom-colors: none; -moz-border-left-colors: none; border-image: none; border-width: 1px 0px 0px; }
	</style>
	
	<style>
	/* ::::: tix fix ::::: */
	input.placeholder  {width: 50px;  }
	.TixManagementContent { padding-top: 20px; margin-top: -15px; }
	.white ul.mega-menu li a { padding: 12px 38px 7px 25px ! important; }
	</style>
