...
SQLSurveyList = "SELECT Event.EventDate, Event.EventCode, Survey.SurveyNumber, Survey.SurveyDescription, Act.Act FROM Survey (NOLOCK) INNER JOIN Event (NOLOCK) ON Survey.SurveyNumber = Event.SurveyNumber INNER JOIN Act (NOLOCK) ON Event.ActCode = Act.ActCode WHERE Event.EventDate > GETDATE()-" & ArchiveDays & " AND Survey.OrganizationNumber = " & Session("OrganizationNumber") & " ORDER BY Event.EventDate, Act.Act"
...
%>
	<tr>
        ...
        <td><%=rsSurveyList("SurveyDescription")%></td>
 ...
 End If
        ...
        '-----------------
                ...
                For k = 1 to MaxQuestions
                    ...
                    Select Case ThisSurveyNum

                    Case 600 'Name Badge Survey
                    ...
                    Case 598 'VIP Survey
                            ...
                            SQLSurveyInfo = "SELECT TOP 1 Answer FROM SurveyAnswers (NOLOCK) LEFT JOIN SurveyQuestion (NOLOCK) ON SurveyAnswers.SurveyNumber = SurveyQuestion.SurveyNumber AND SurveyAnswers.AnswerNumber = SurveyQuestion.QuestionNumber  WHERE OrderNumber = " & rsSeat("OrderNumber") & " AND AnswerNumber = " & k & " AND QuestionNumber IS NOT NULL ORDER BY SurveyDate Desc"
