...
Page = "TicketBatchPrintBarberShop"
...
If Not rsTickets.EOF Then 'There are some events.  List them
	Response.Write "<FORM ACTION=""TicketBatchPrintBarberShop.asp"" METHOD=""post""><INPUT TYPE=""hidden"" NAME=""FormName"" VALUE=""PrintMenu"">" & vbCrLf
...
<BODY onLoad="PrintTickets()">
		...
		Response.Write "<FORM ACTION=""TicketBatchPrintBarberShop.asp"" METHOD=""post"" NAME=""TicketPrintForm""><INPUT TYPE=""hidden"" NAME=""FormName"" VALUE=""PrintEvent"">" & vbCrLf
...
<FORM ACTION="TicketBatchPrintBarberShop.asp" METHOD="post" NAME="OKPrint"><INPUT TYPE="hidden" NAME="FormName" VALUE="OKPrint">
<TABLE CELLPADDING="5">
<%
...
Response.Write "<TABLE CELLPADDING=""10""><TR><TD><INPUT TYPE=""submit"" VALUE=""Yes"" NAME=""Button""></FORM></TD><TD><FORM ACTION=""TicketBatchPrintBarberShop.asp"" METHOD=""post"" NAME=""NoPrint""><INPUT TYPE=""hidden"" NAME=""FormName"" VALUE=""NoPrint""><INPUT TYPE=""submit"" VALUE=""No""></FORM></TD></TR></TABLE>" & vbCrLf
