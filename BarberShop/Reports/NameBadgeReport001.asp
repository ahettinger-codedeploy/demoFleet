...
Response.Write "<FONT FACE=verdana,arial,helvetica COLOR=#008400><H3>Attendee Detail Report</H3></FONT>"& vbCrLf

If Excel <> "Y" Then
%>

	<FONT FACE=verdana,arial,helvetica SIZE=2>
	<FORM ACTION="NameBadgeReport.asp" METHOD="post" id=form1 name=Report onSubmit="return ValidateForm()">
	<SELECT NAME="Events">
<%
	...
	'Report was only displaying events which had gathered information from custom survey. Modified to allow display of all events
...
'	Response.Write "<INPUT TYPE=checkbox NAME=Open" & OpenChecked & ">Open" & vbCrLf
	...
	Response.Write "<TD><INPUT TYPE=""checkbox"" NAME=""IncludeAttendee""" & AttendeeChecked & "></TD><TD><FONT FACE=verdana,arial,helvetica SIZE=2>Include Attendee Information</FONT></TD></TR><TR>" & vbCrLf
...
If Request("Events") <> "" Then
	...
	If Not rsSeat.EOF Then
		...
		If Not rsCustomerClass.EOF Then 'Add Column for Customer Class
			If Excel <> "Y" Then
				CustomerClassHeading = "<TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B><A class=sort HREF=NameBadgeReport.asp?SortMethod=CustomerClass&Events=" & Request("Events") & "&Hold=" & Request("Hold") & "&Reserved=" & Request("Reserved") & "&Open=" & Request("Open") & "&Sold=" & Request("Sold") & "&Available=" & Request("Available") & "&IncludeOrderNotes=" & Request("IncludeOrderNotes") & "#Anc_Sort>&nbsp;Customer Class&nbsp;</A></B></FONT></TD>"
			Else
		...
		If Clean(Request("IncludeAttendee")) = "on" Then
			AttendeeHeading = "<TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B><A class=sort HREF=NameBadgeReport.asp?SortMethod=AttendeeName&Events=" & Request("Events") & "&Hold=" & Request("Hold") & "&Reserved=" & Request("Reserved") & "&Open=" & Request("Open") & "&Sold=" & Request("Sold") &  "&Available=" & Request("Available") & "&IncludeOrderNotes=" & Request("IncludeOrderNotes") & "#Anc_Sort>&nbsp;Attendee Name&nbsp;</A></B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>City</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>State</B></FONT></TD"
		Else
			AttendeeHeading = ""
		End If
		...
		If Excel <> "Y" Then
			...
			Response.Write "<TR BGCOLOR=#008400><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B><A class=sort HREF=NameBadgeReport.asp?SortMethod=Section&Events=" & Request("Events") & "&Hold=" & Request("Hold") & "&Reserved=" & Request("Reserved") & "&Open=" & Request("Open") &  "&Sold=" & Request("Sold") &  "&Available=" & Request("Available") & "&IncludeOrderNotes=" & Request("IncludeOrderNotes") & "&IncludeAttendee=" & Request("IncludeAttendee") & "#Anc_Sort>&nbsp;Section&nbsp;</A></B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>&nbsp;Row&nbsp;</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>&nbsp;Seat&nbsp;</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B><A class=sort HREF=NameBadgeReport.asp?SortMethod=OrderNumber&Events=" & Request("Events") & "&Hold=" & Request("Hold") & "&Reserved=" & Request("Reserved") & "&Open=" & Request("Open") & "&Sold=" & Request("Sold") &  "&Available=" & Request("Available") & "&IncludeOrderNotes=" & Request("IncludeOrderNotes") & "#Anc_Sort>&nbsp;Order Number&nbsp;</A></B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>&nbsp;Order Date/Time&nbsp;</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B><A class=sort HREF=NameBadgeReport.asp?SortMethod=CustomerName&Events=" & Request("Events") & "&Hold=" & Request("Hold") & "&Reserved=" & Request("Reserved") & "&Open=" & Request("Open") & "&Sold=" & Request("Sold") &  "&Available=" & Request("Available") & "&IncludeOrderNotes=" & Request("IncludeOrderNotes") & "#Anc_Sort>&nbsp;Bill To Name&nbsp;</A></B></FONT></TD>" & CustomerClassHeading & "<TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>&nbsp;Status&nbsp;</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>&nbsp;Ticket Type&nbsp;</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B>Net Price</B></FONT></TD><TD ALIGN=center><FONT FACE=verdana,arial,helvetica SIZE=2 COLOR=#FFFFFF><B><A class=sort HREF=NameBadgeReport.asp?SortMethod=OrderType&Events=" & Request("Events") & "&Hold=" & Request("Hold") & "&Reserved=" & Request("Reserved") & "&Open=" & Request("Open") & "&Sold=" & Request("Sold") &  "&Available=" & Request("Available") & "&IncludeOrderNotes=" & Request("IncludeOrderNotes") & "#Anc_Sort>&nbsp;Order Type&nbsp;</A></B></FONT></TD>" & SurveyHeading & OrderNotesHeading & AttendeeHeading & "</TR>" & vbCrLf
			LineBreak = "<BR>"
		Else
		...
		Do Until rsSeat.EOF
			...
			'SSR - 9/5/08 - Added Attendee Information
			If AttendeeHeading <> "" Then 'Add the column
			Attendee = "<TD ALIGN=left NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>&nbsp;" & rsSeat("AttendeeLastName") & ",&nbsp;" & rsSeat("AttendeeFirstName") & "&nbsp;</FONT></TD><TD ALIGN=left NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>&nbsp;" & rsSeat("AttendeeCity") & "&nbsp;</FONT></TD><TD ALIGN=left NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>&nbsp;" & rsSeat("AttendeeState") & "&nbsp;</FONT></TD>"
			End If
