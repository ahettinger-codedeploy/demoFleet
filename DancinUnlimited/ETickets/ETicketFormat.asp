...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><B>From Route 50 (Fairfax County)</B><BR>" & vbCrLf
			Response.Write "Take Route 50 East to Route 236/Little River Turnpike. Follow Little River Turnpike East & turn right at traffic light onto Wakefield Chapel Road. Turn left at the second campus entrance. Please park only in the Parking Garage. Theater is next to parking garage.<BR><BR>" & vbCrLf
			...
			Response.Write "<IMG WIDTH=200 SRC=""/PrivateLabel/DancinUnlimited/ETickets/map.jpg""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""/PrivateLabel/DancinUnlimited/ETickets/JATDF2011.jpg"" HEIGHT=""225"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
