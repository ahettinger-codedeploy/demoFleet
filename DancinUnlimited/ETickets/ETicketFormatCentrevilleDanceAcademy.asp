...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "Take exit 49 to merge onto I-66 West toward Front Royal/Manassas.  Take exit 52 for US-29 toward Centreville.  Turn left at Lee Hwy/US-29 North.  Turn right at Centrewood Drive.  Turn right at Centreville Square. Centreville Dance Academy is on right across parking lot from Giant Food. Please arrive 10 minutes early to register.<BR><BR>" & vbCrLf
			...
			Response.Write "<IMG WIDTH=200 SRC=""/PrivateLabel/DancinUnlimited/ETickets/MapCentrevilleDanceAcademy.jpg""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
