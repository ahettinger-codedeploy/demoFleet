...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "Take exit 39 for River Rd/MD-190.  Take exit 39A for River Rd West/MD-190 West toward Potomac.  Follow MD-190 West/River Rd for about 3.6 miles.  Turn left at Falls Rd.  Turn right into parking lot.  Potomac Dance Center is inside the mall. Please arrive 10 minutes early to register.<BR><BR>" & vbCrLf
			...
			Response.Write "<IMG WIDTH=200 SRC=""/PrivateLabel/DancinUnlimited/ETickets/MapPotomacDance.jpg""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
