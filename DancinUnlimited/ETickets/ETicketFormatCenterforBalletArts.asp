...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><B>From the Capital Beltway/I-495:</B><BR>" & vbCrLf
			Response.Write "Take exit 49 to merge onto I-66 West toward Front Royal/Manassas.  Take exit 57A for Lee Jackson Memorial Hwy/US-50 East toward Fairfax.  Turn right at Waples Mill Rd.  Turn left at Lee Hwy/US-29 (North).  Turn right into Fairfax Centre (Chili’s Restaurant).  Center for Ballet Arts is in the back lower level of the shopping center – 11215-H Lee Hwy.  Please arrive 10 minutes early to register.<BR><BR>" & vbCrLf
			...
			Response.Write "<IMG WIDTH=200 SRC=""/PrivateLabel/DancinUnlimited/ETickets/MapCenterforBalletArts.jpg""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
