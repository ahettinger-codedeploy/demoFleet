...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><B>From the Capitol Beltway/I-495 (Outer Loop):</B><BR>" & vbCrLf
			Response.Write "Take exit 43-44 for Georgetown Pike/VA-193 West. Follow signs for Great Falls Virginia/VA-193 and merge onto Georgetown Pike/VA-193 West.  Follow Georgetown Pike/VA-193 West for about 6.2 Miles. Turn left onto Walker Rd and travel 0.2 miles to 760-C Walker Rd. <BR><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><B>From the Capitol Beltway/I-495 (Inner Loop):</B><BR>" & vbCrLf
			Response.Write "Take exit 47 for Leesburg Pike West/VA-7 West towards Leesburg. Follow Leesburg Pike West/VA-7 West for about 6.7 miles. Turn right onto Colvin Run Rd and travel 0.5 miles. Turn right onto Walker Rd and travel 1.8 miles to 760-C Walker Rd.<BR><BR>" & vbCrLf
			...
			Response.Write "<IMG WIDTH=200 SRC=""/PrivateLabel/DancinUnlimited/ETickets/MapSchoolforTheatricalDance.jpg""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
