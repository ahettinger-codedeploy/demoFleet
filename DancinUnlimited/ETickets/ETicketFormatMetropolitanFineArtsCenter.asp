...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><B>From the Capitol Beltway/I-495:</B><BR>" & vbCrLf
			Response.Write "Take exit 57A for I-95 South toward Richmond.  Continue on I-95 South for about 5.7 miles.  Take exit 163 for VA-642 toward Lorton.  Turn right at Lorton Rd/VA-642.  Turn right at Silverbrook Rd/VA-600.  Follow Silverbrook Rd/VA-600 for about 2.5 miles.  Turn left into shopping center (CVS Pharmacy).  Metropolitan Fine Arts Center is straight ahead (Music & Arts).  Please arrive 10 minutes early to register.<BR><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><B>In Fairfax from Braddock Rd/VA-620:</B><BR>" & vbCrLf
			Response.Write "Turn onto Ox Rd/VA-123 South and go about 7.5 miles.  Turn left at Silverbrook Rd/VA-600 and go about 1.5 miles.  Turn left into shopping center (CVS Pharmacy).  Metropolitan Fine Arts Center is straight ahead (Music & Arts).  Please arrive 10 minutes early to register.<BR><BR>" & vbCrLf
			'Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><B>From Route 66</B><BR>" & vbCrLf
			'Response.Write "Take the exit for the Capitol Beltway (I-495 - towards Richmond). Follow Beltway directions below.<BR><BR>" & vbCrLf
			'Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><B>From the Beltway (I-495)</B><BR>" & vbCrLf
			'Response.Write "Take exit 52-A, Route 236/Little River Turnpike West towards Fairfax. On Route 236/Little River Turnpike turn left at the third traffic light onto Wakefield Chapel Road. Turn left at the second campus entrance. Please park only in the Parking Garage. Theater is next to parking garage.<BR><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			...
			Response.Write "<IMG WIDTH=200 SRC=""/PrivateLabel/DancinUnlimited/ETickets/MapMetropolitanFineArtsCenter.jpg""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""/PrivateLabel/DancinUnlimited/ETickets/JonLehrerTicketImage.jpg"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
