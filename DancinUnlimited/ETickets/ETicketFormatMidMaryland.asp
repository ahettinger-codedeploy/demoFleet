...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><B></B><BR>" & vbCrLf
			Response.Write "Take the Capital Beltway/I-495Capital Beltway/I-495 North.  Take exit for I-270 North.  Follow I-270 North for approximately 30 miles.  Continue onto US-40 West.  Take the US-340 exit toward US-15 South.  Turn left at South Jefferson St/US-340 West.  Take the MD-351/MD-180 exit.  Turn left at Jefferson Pike/MD-180.  Mid Maryland Performing Arts Center is 1.2 miles on the right.  Please arrive 10 minutes early to register.<BR><BR>" & vbCrLf
			'Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><B>From I-95</B><BR>" & vbCrLf
			'Response.Write "Take the exit for I-495 towards Tyson Corner. Follow Beltway directions below.<BR><BR>" & vbCrLf
			...
			Response.Write "<IMG WIDTH=200 SRC=""/PrivateLabel/DancinUnlimited/ETickets/MapMidMarylandDance.jpg""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
