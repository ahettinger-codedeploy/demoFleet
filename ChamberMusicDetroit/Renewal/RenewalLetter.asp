<%
'CHANGE LOG
'JAI 4/3/12 - New script for CMSD
'JAI 4/3/12 - Sort by Customer Name
%>
...
If EventList <> "" Then
	...
	If Not rsTickets.EOF Then 'There are some events.  List them
		Response.Write "<FORM ACTION=""RenewalLetter.asp"" METHOD=""post""><INPUT TYPE=""hidden"" NAME=""FormName"" VALUE=""PrintMenu"">" & vbCrLf
...
SQLOrderLine = SQLOrderLine & SQLWhere & ") AND OrderLine.StatusCode = 'R' AND OrganizationVenue.OrganizationNumber = " & Session("OrganizationNumber") & " AND OrganizationAct.OrganizationNumber = " & Session("OrganizationNumber") & " AND OrderLine.ItemType IN ('Seat', 'SubFixedEvent') ORDER BY OrderLine.ShipLastName, OrderLine.ShipFirstName, OrderLine.OrderNumber, Seat.EventCode, Seat.SectionCode, RowSort, SeatSort DESC"
...
Do Until rsOrderLine.EOF
	...
	If rsOrderLine("OrderNumber") <> LastOrderNumber Then 'It's different.  Print it.
		If TicketCount > 0 Then 'It's not the first one, print the footer.
			...
			Response.Write "<TR><TD WIDTH=""50"">&nbsp;</TD><TD ALIGN=""right"" COLSPAN=""" & NumColumns - 1 & """>Subtotal</TD><TD ALIGN=""right"">" & FormatCurrency(LastTotal,2) & "</TD></TR>" & vbCrLf
			Response.Write "<TR><TD WIDTH=""50"">&nbsp;</TD><TD ALIGN=""right"" COLSPAN=""" & NumColumns - 1 & """>Tax deductible contribution</TD><TD ALIGN=""right"">__________</TD></TR>" & vbCrLf
			Response.Write "<TR><TD WIDTH=""50"">&nbsp;</TD><TD ALIGN=""right"" COLSPAN=""" & NumColumns - 1 & """>Total</TD><TD ALIGN=""right"">__________</TD></TR>" & vbCrLf
	        ...
	        Response.Write "<TABLE WIDTH=""750""><TR valign=""BOTTOM""><TD><BR>_____________________________________________________</TD><TD>____________</TD></TR>" & vbCrLf
	        Response.Write "<TR valign=""BOTTOM""><TD>(Card Number)<BR></TD><TD>(CVV2 (3-4 digit code))</TD></TR></TABLE>" & vbCrLf
	        Response.Write "<TABLE WIDTH=""750""><TR valign=""BOTTOM""><TD>_________________&nbsp;&nbsp;</TD><TD>___________________________________&nbsp;&nbsp;</TD><TD>___________________________________</TD></TR>" & vbCrLf
	        Response.Write "<TR valign=""BOTTOM""><TD>(Expiration Date)</TD><TD>(Name as it appears on card)</TD><TD>(Signature)</TD></TR></TABLE><BR>" & vbCrLf
	        Response.Write "<TABLE WIDTH=""750""><TR><TD ALIGN=""center"">SEND TO:<BR>Chamber Music Society of Detroit<BR>31731 Northwestern Highway<BR>Suite 259-W<BR>Farmington Hills, MI 48334<BR><I>Phone Number: (248) 855-6070<BR>Fax Number: (248) 737-9981</I></TD></TR></TABLE>" & vbCrLf
		...
		If Not rsCustInfo.EOF Then
			Response.Write "<TABLE WIDTH=750><TR><TD WIDTH=300><IMG SRC=""/Clients/ChamberMusicDetroit/Renewal/Images/CMDLogo.jpg""></TD></TR></TABLE>"
			...
			Response.Write "<TABLE CELLPADDING=""3"" WIDTH=""600""><TR><TD><B>Order Number:&nbsp;" & rsOrderLine("OrderNumber") & "</B></TD><TD ALIGN=""right""><B>Online Renewal Code:&nbsp;" & RenewalCode & "</B></TD></TR></TABLE>" & vbCrLf
	...
	If LastEventCode <> rsOrderLine("EventCode") Or LastOrderNumber <> rsOrderLine("OrderNumber") Then
		Response.Write "<TABLE WIDTH=""600""><TR><TD NOWRAP><B>" & rsOrderLine("Act") & " at " & rsOrderLine("Venue")
