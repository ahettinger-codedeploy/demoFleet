...
EMailOrganization1 = "Steve Wogaman, Chamber Music Society of Detroit"
EMailOrganization2 = ""
EMailOrganization = EMailOrganization1 & " " & EMailOrganization2
EMailReplyTo = "tickets@ChamberMusicDetroit.org"
EMailSubject = "Now Available: Renew your Subscriptions Online!" 
EMailRenewalURL = "http://ChamberMusicDetroit.tix.com/renew.aspx?np=sc"
ChangeSeatURL = "http://www.ChamberMusicDetroit.com"
'TagLine = ""
EMailFontFace = "times new roman"
...
EMailMessageBody = EMailMessageBody & "<p>If you have any questions or would like to change your seats, please call us at 248-855-6070 and we will be happy to help you.</span></p>" & vbCrLf
EMailMessageBody = EMailMessageBody & "<p>Please take advantage of the many benefits of subscribing, renew your seats today and enjoy another season of the world's greatest music!</span></p>" & vbCrLf

EMailMessageBody = EMailMessageBody & "<IMG SRC=""http://www.tix.com/Clients/ChamberMusicDetroit/Renewal/Images/WogSig.jpg""><BR>" & vbCrLf
EMailMessageBody = EMailMessageBody & "Steve Wogaman" & vbCrLf
'EMailMessageBody = EMailMessageBody & TagLine & "<BR>" & vbCrLf
...
Do Until rsOrderLine.EOF
	...
	If rsOrderLine("OrderNumber") <> LastOrderNumber Then 'It's different.  Print it.
		If TicketCount > 0 Then 'It's not the first one, print the footer.
			...
			If TestEMailAddress <> "" And OrderCount >= 3 Then
				Exit Do
			End If
