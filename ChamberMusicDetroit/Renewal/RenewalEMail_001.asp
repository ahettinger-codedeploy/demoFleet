...
'JAI 3/19/13 - Added BeginAfterOrderNumber check.  Leave at 0 if you want all orders processed.
BeginAfterOrderNumber = 14526595

'JAI 6/24/9 - Specify organization ReplyTo e-mail address and the e-mail subject
EMailOrganization1 = "Chamber Music Detroit"
EMailOrganization2 = ""
EMailOrganization = EMailOrganization1 & " " & EMailOrganization2
EMailReplyTo = "Tickets@ChamberMusicDetroit.org"
EMailSubject = "Chamber Music Society of Detroit - Renew Now" 
EMailRenewalURL = "http://ChamberMusicDetroit" & EMailOrganization2 & ".tix.com/renew.aspx?np=sc"
...
EMailMessageBody = ""
EMailMessageBody = EMailMessageBody & "<table border=""0"" width=""700""><tbody>" & vbCrLf
...
Next
SQLWhere = SQLWhere & ")"
If BeginAfterOrderNumber <> 0 Then
    SQLWhere = SQLWhere & " AND OrderLine.OrderNumber > " & BeginAfterOrderNumber
End If
