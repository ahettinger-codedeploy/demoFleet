...
'Include only these sections for the discount
If SECTIONCODE="MAINA" Or SECTIONCODE="MAINB" Or SECTIONCODE="MAINC" Or SECTIONCODE="BALCA" Or SECTIONCODE="BALCB" Or SECTIONCODE="BALCC" Then  
