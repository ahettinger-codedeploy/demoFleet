...
document.write('-96b8-444553540000" codebase="https://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0"');
document.write('id="master_nav2" width="173" heig');
document.write('ht="1000" align="middle"><param name="allowScriptAccess" value="always" /');
document.write('><param name="movie" value="/PrivateLabel/ChoctawColiseum/Images/master_nav2.swf" />');
...
document.write('"/PrivateLabel/ChoctawColiseum/Images/master_nav2.swf" FlashVars="MenuAt='+parseURL()+'" menu="false" quality="high" scale="noscale" salign="lt" w');
