...
'Buy Min 1 Adult Get Max 4 Child Discounted
...
'Buy 1 or more Adult tickets get 1-4 Child tickets discounted
'Max number of discounted child tickets
...
If NbrTickets >= AdultMin Then 
	...
	Set rsDiscCount = OBJdbConnection.Execute(SQLDiscCount)
		...
		If Fix(rsDiscCount("LineCount")) < (ChildMax) Then 'Apply the discount
