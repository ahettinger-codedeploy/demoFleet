...
'SSR 09/10/14 - Updated E-Ticket format to display a default text message in ad space if there is no ad image URL found.
%>
...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write PCase(rsTix("Address1")) & "<BR>" & vbCrLf
			If rsTix("Address2") <> "" Then
				Response.Write PCase(rsTix("Address2")) & "<BR>" & vbCrLf
			End If
			Response.Write PCase(rsTix("City")) & ", " & UCase(rsTix("State")) & " " & rsTix("PostalCode") & "<BR>" & vbCrLf
			Response.Write "<BR>" & vbCrLf
			...
			Response.Write PCase(rsTix("ShipAddress1")) & "<BR>" & vbCrLf
			If rsTix("ShipAddress2") <> "" Then
				Response.Write PCase(rsTix("ShipAddress2")) & "<BR>" & vbCrLf
			End If
			Response.Write PCase(rsTix("ShipCity")) & ", " & UCase(rsTix("ShipState")) & " " & rsTix("ShipPostalCode") & "<BR>" & vbCrLf
			Response.Write "<BR>" & vbCrLf
			...
			Response.Write PCase(rsTix("Venue")) & "<BR>" & vbCrLf
			Response.Write PCase(rsTix("VenueAddress1")) & "<BR>" & vbCrLf
			If rsTix("VenueAddress2") <> "" Then
				Response.Write PCase(rsTix("VenueAddress2")) & "<BR>" & vbCrLf
			End If
			Response.Write PCase(rsTix("VenueCity")) & ", " & UCase(rsTix("VenueState")) & " " & rsTix("VenuePostalCode") & "<BR>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
				...
				Else
					Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2"">" & vbCrLf
					Response.Write "<B>This ticket enables you to take advantage of discounts available at several Bragg Creek establishments. Visit our website www.braggcreekperformingarts.com for details. Thank you for supporting live entertainment presented by Bragg Creek Performing Arts</b>" & vbCrLf
					Response.Write "</FONT>" & vbCrLf
				End If
