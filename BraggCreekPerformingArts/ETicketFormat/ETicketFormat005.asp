	...
	If Not rsTix.EOF Then
		...
		'Begin Ad Space
          ...
          '  Else
           ...
           ' End If
		   Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2"">" & vbCrLf
			Response.Write "<B>Show this ticket at the Bavarian Inn, Bragg Creek on concert day to receive a free glass of Presecco Or show this ticket pre concert on concert day for a half price appetizer (limit one per person) at The Italian Farmhouse, Bragg Creek</b>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
