...
'==============================
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD>" & vbCrLf
			Response.Write "Extra Value with your CHRIS VELAN ticket enjoy a Special Discount offer with The Bavarian Inn We have an exciting new partnership with The Bavarian Inn in Bragg Creek. Just purchase and print your ticket to experience Chris Velans concert on November 24 then take that same ticket on down to our friends at the Bavarian Inn to receive a 15% discount on all menu items. Offer valid as many times as you wish between November 1 and 23, 2012 so tantalize your senses and engage your taste buds. Compliment your meal with your choice of either a glass of Taittinger Champagne or Fonseca Port included with your meal. Reservations recommended: www.thebavarianinn.com or 403-949-3611. This offer cannot be combined with any other promotion or discount offered during this period. " & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TBODY>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf 
