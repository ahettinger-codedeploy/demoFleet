...
If Not IsNumeric(Request("DepartureActCode")) Or Request("DepartureActCode") = "" Then
    DepartureActCode = 53603
    ReturnActCode = 53602
Else
    If Request("DepartureActCode") = 53603 Then
        DepartureActCode = 53603
        ReturnActCode = 53602
    Else
        DepartureActCode = 53602
        ReturnActCode = 53603
    End If        
End If 

If DepartureActCode = 53603 Then
...
End If    
%>
<form action="EventSelectionCatalinaFlyer.asp" method="post">
<table width="700" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2">
        ...
        <%
        SQLAct = "SELECT ActCode, Act FROM Act (NOLOCK) WHERE ActCode IN (53603, 53602) ORDER BY Act DESC"
...
If ReturnDate < DepartureDate Then        
    Message = "Please select a Return Date after Departure Date."
    Call DisplayForm(Message)
    Exit Sub
End If
...
For EventNum = 1 To UBound(arrEventCodes)
