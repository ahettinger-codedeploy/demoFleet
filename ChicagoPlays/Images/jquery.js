...
jQuery.SelectBox = function(selectobj, options) {
	...
	function setupInput(options) {
		...
		//	$input.css("height", '17px');
			...
			//$input.css("textIndent", '10px');

			//$input.css("padding", '5px 0px 5px 0px');

			//$input.css("background", '#fff');

		    //$input.css("border", '1px solid #448A92');
	...
	function getSelectOptions(parentid) {
		...
		ul.style.background='#E9E9E9'

		ul.style.position='absolute';

		ul.style.width=$select.css("width")
		
		/*added  for scroll ishit:20100826*/
...
//		ul.style.paddingLeft ='10px';
		...
		//ul.style.border ='1px solid #A23832';
