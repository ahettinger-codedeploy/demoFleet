!function(exports, global) {
    function pcGenerateEmoteRegex(regex) {
    ...
    global["true"] = exports, function() {
        PureChat = function(socketUrl, userId, domainId, authToken, identifyStatus, errorStatus, restrictTransports, poppedOut, emailMD5Hash, reconnectLimit) {
            ...
            }, this.chatServerEvents = [ "message", "joined", "left", "roomdestroyed", "userDestroyed", "typing", "reidentify", "userdeleted", "chat-counts", "opInvite", "roomchanged", "roomclosed", "rooms", "onlineOperatorStatus", "opStatus", "serverNotice", "roomdetailschanged", "userSettings:change", "canned-responses:changed", "canned-responses:added", "canned-responses:deleted", "userOnboarding:change", "operator:refresh" ], 
    ...
    var global$ = window.$, $ = window.$pureChatJquery;
    (function() {
        function n(n) {
    ...
    var PureChatRegExp = {
        linkify: /(www\.)?(?=[a-zA-Z0-9])(([-a-zA-Z0-9@:%_\+~#?&//=]){1,256}\.)+(za|guru|co|il|no|gq|ar|gl|ly|co|be|fr|in|biz|xxx|mobi|me|com|my|ru|me|net|edu|gov|io|us|org|info|tv|mobi|au|nz|uk|br|de|sh|es|dk|se|fi|nl|ca|sg|eu|py|it|mx)\b(:[0-9]{2,})?([?/#]([-a-zA-Z0-9@:%_\+.~#!?&//=\[\]]|[^\x00-\x7F])*)?/gi,
        tagRemoval: /<.+?>/g
    }, PureChatEmoticons = {
        regex: {
        ...
        parse: function(message) {
            if (message) for (var r in PureChatEmoticons.regex) message = message.replace(PureChatEmoticons.regex[r], '$1<div class="emoticon ' + PureChatEmoticons.imageMappings[r] + '" title="' + r + '"></div>');
            return message;
        }
    };
    ...
    purechatApp.module("Constants", function(Constants) {
        ...
        $.throttle = function(delay, no_trailing, callback, debounce_mode) {
            ...
            return message ? (message = message.replace(/&amp;/g, "&"), linkifiedMessage = message.replace(PureChatRegExp.linkify, function(url) {
        ...
        return 1 == reason ? "Available" : 2 == reason ? "NoOperators" : 3 == reason ? "ServerDowntime" : 4 == reason ? "AccountActivity" : 5 == reason ? "ChatQuotaExceeded" : 6 == reason ? "WidgetDisabled" : 7 == reason ? "IpIsbanned" : "";
        ...
        global["true"] = exports;
        var _ = global._;
        this.templates = this.templates || {}, this.templates.ChatConnecting = function() {
            var __p = "";
            ...
            1 != o.get("room").roomType) {
                ...
                isOperatorRoom || o.visitorIPAddressId > -1 && (__p += '<a href="#" data-chatid="' + (null == (__t = o.roomId) ? "" : __t) + "\" data-request='ban:ip' data-request-params=\"" + (null == (__t = banArgString) ? "" : __t) + '"><i class="fa fa-ban"></i><span class="tip">Ban IP</span></a>');
            }
            return __p += '<a href="#" data-command="removeWidget"><i class="fa fa-times"></i><span class="tip">Close</span></a></div></div><textarea class="purechat-send-form-message" name="purechat-send-form-message" disabled="disabled" /></form></div>';
            ...
            var __t, __p = "";
            if (_.escape, Array.prototype.join, "note" == o.type) __p += '<p class="purechat-message-note important" data-username="' + (null == (__t = o.username) ? "" : __t) + '" data-resourcekey="' + (null == (__t = o.resourceKey || "") ? "" : __t) + '">' + (null == (__t = o.message) ? "" : __t) + "</p>"; else if ("separator" == o.type) __p += '<p class="purechat-message-note important separator" data-username="' + (null == (__t = o.username) ? "" : __t) + '" data-resourcekey="' + (null == (__t = o.resourceKey || "") ? "" : __t) + '">' + (null == (__t = o.message) ? "" : __t) + "<hr/></p>"; else if ("message" == o.type && o.message) {
            ...
            var personalAvUrl = o.pureServerUrl + "/content/images/Avatars/operator-avatar.png";
            ...
            o.isInEditorMode && (__p += '<a class="purechat-edit-button" data-editorfor=".purechat-name"><i class="pcfont edit"></i></a>'), 
            ...
            o.UserWidgetSettings.get("Email") ? __p += '<a href="mailto:' + (null == (__t = o.UserWidgetSettings.get("Email")) ? "" : __t) + '" target="_blank" class="purechat-send-email" data-tooltiptext="Send email to ' + (null == (__t = o.UserWidgetSettings.get("Email")) ? "" : __t) + '"><i class="pcfont email"></i></a>' : o.isInEditorMode && (__p += '<a href="#" target="_blank" class="purechat-linked-in faded" data-tooltiptext="Add an email address to give people another method of contacting you"><i class="pcfont email"></i></a>'), 
            o.isInEditorMode && (__p += '<a class="purechat-edit-button" data-editorfor=".purechat-social-buttons"><i class="pcfont edit"></i></a>'), 
            ...
            o.isInEditorMode && (__p += '<a class="purechat-edit-button" data-editorfor=".purechat-website"><i class="pcfont edit"></i></a>'), 
            ...
            o.isInEditorMode && (__p += '<a class="purechat-edit-button" data-editorfor=".purechat-phone"><i class="pcfont edit"></i></a>'), 
            ...
            o.isInEditorMode && (__p += '<a class="purechat-edit-button" data-editorfor=".purechat-location"><i class="pcfont edit"></i></a>'), 
            ...
            o.isInEditorMode && (__p += '<a class="purechat-edit-button" data-editorfor=".purechat-bio"><i class="pcfont edit"></i></a>'), 
            ...
            return Array.prototype.join, o.EmailForm ? __p += '<div class="purechat-enterinfo-container"><p data-resourcekey="noOperators_email_message">' + (null == (__t = purechatApp.Utils.linkify(_.escape(o.getResource("noOperators_email_message")))) ? "" : __t) + "</p></div>" : (o.AskForName || o.AskForEmail || o.AskForQuestion) && (__p += '<div class="purechat-enterinfo-container"><p data-resourcekey="label_initial">' + (null == (__t = purechatApp.Utils.linkify(o.getResource("label_initial"))) ? "" : __t) + "</p></div>"), 
            ...
            o.EmailForm && o.UnavailableAskForPhone && (__p += '<p class="alert alert-error init-error please-enterunavailablephone" style="display: none;">' + __e(o.getResource("error_enterPhoneNumber")) + '</p><label for="purechat-unavailablephone-input">' + __e(o.getResource("noOperators_placeholder_phone")) + '</label><input type="text" class="purechat-unavailablephone-input" id="purechat-unavailablephone-input" name="purechat-unavailablephone-input" maxlength="30" value="' + (null == (__t = o.InitialVisitorPhoneNumber) ? "" : __t) + '" />'), 
        ...
        }, this.templates.UnsupportedBrowser = function() {
            var __p = "";
            ...
            __p += '<div class="purechat-menu btn-toolbar">', mobile || o.get("isDirectAccess") || !o.get("ShowMinimizeWidgetButton") || (__p += '<button type="button" data-trigger="superMinimize" class="btn btn-mini actions purechat-super-minimize-link-button" style="display: none;"><i class="pc-icon-caret-down"></i></button>'), 
            ...
            var __t, __p = "", __e = _.escape;
            return Array.prototype.join, __p += '<div class="purechat-expanded"><div class="purechat-widget-inner purechat-clearfix"><div class="purechat-widget-header"><div class="purechat-menu btn-toolbar"><button data-trigger="restartChat" class="btn btn-mini btn-restart" title="Start a new chat"><i class="pc-icon-repeat" title="Start a new chat"></i></button><button data-trigger="closeChat" class="btn btn-mini btn-close" title="Close chat session"><i class="pc-icon-remove"></i></button></div><div class="purechat-widget-title"><span class="purechat-widget-room-avatar" style="display: none;"></span><span class="purechat-widget-title-link"></span></div></div><div class="purechat-content"></div>', 
            o.get("RemoveBranding") || (__p += '<div class="purechat-poweredby-container"><span class="purechat-poweredby">' + __e(o.getResource("poweredby")) + ' </span><a target="_blank" href="' + (null == (__t = o.poweredByUrl()) ? "" : __t) + '">Pure Chat</a></div>'), 
            o.showPlaySoundCheckbox() && (__p += '<a href="#" class="purechat-toggle-audio-notifications purechat-bottom-left ' + (null == (__t = o.get("RemoveBranding") ? "kill-positioning" : "") ? "" : __t) + '"><i class="fa ' + (null == (__t = o.playSoundOnNewMessage() ? "pc-icon-unmute" : "pc-icon-mute") ? "" : __t) + '"></i></a>'), 
            __p += "</div></div>";
        }, this.templates.WidgetDirectAccessMobile = function(o) {
            var __t, __p = "", __e = _.escape;
            return Array.prototype.join, __p += '<div class="purechat-expanded"><div class="purechat-collapsed-outer"><div class="purechat-widget-inner purechat-clearfix"><div class="purechat-widget-content-wrapper"><div class="purechat-widget-header"><div class="purechat-menu btn-toolbar"><button data-trigger="restartChat" class="btn btn-mini btn-restart" title="Start a new chat"><i class="pc-icon-repeat" title="Start a new chat"></i></button><button data-trigger="closeChat" class="btn btn-mini btn-close" title="Close chat session"><i class="pc-icon-remove"></i></button></div><div class="purechat-widget-title"><span class="purechat-widget-room-avatar" style="display: none;"></span><span class="purechat-widget-title-link"></span></div></div><div class="purechat-content-wrapper"><div class="purechat-content"></div>', 
            o.get("RemoveBranding") || (__p += '<div class="purechat-poweredby-container"><span class="purechat-poweredby">' + __e(o.getResource("poweredby")) + ' </span><a target="_blank" href="' + (null == (__t = o.poweredByUrl()) ? "" : __t) + '">PureChat</a></div>'), 
            o.showPlaySoundCheckbox() && (__p += '<a href="#" class="purechat-toggle-audio-notifications purechat-bottom-left"><i class="fa ' + (null == (__t = o.playSoundOnNewMessage() ? "pc-icon-unmute" : "pc-icon-mute") ? "" : __t) + '"></i></a>'), 
            ...
            __p += o.get("RequestFromMobileDevice") && o.get("AllowWidgetOnMobile") ? '<span class="purechat-widget-title-link">PureChat</span>' : '<span class="purechat-widget-title-link">PureChat</span>&nbsp;<span class="purechat-widget-room-avatar" style="display: none;"></span>', 
        ...
        return this;
    }()), purechatApp.module("Api.Models", function(Models, App, Backbone) {
        Models.ApiModel = Backbone.Model.extend({
            ...
            mappings: {
                widget: {
                    position: "Position",
                    widgetLayoutType: "CollapsedStyle",
                    ...
                    imageScale: "Scale",
                    imageOnTop: "ImageTop",
                    collapsedWidgetImageUrl: "CollapsedWidgetImageUrl",
            ...
            set: function(propName, propVal) {
                if (Backbone.Model.prototype.set.apply(this, arguments), "object" == typeof propName) for (var prop in propName) this.set(prop, propName[prop]); else {
                    var pName;
                    this.regexs.propAccess.widget.test(propName) ? (pName = propName.split(this.regexs.propAccess.widget), 
                    pName = pName.length > 1 ? pName[1] : null, pName && this.mappings.widget[pName] && (this.mappings.widget[pName] == this.mappings.widget.collapsedWidgetImageUrl ? (this.widgetSettings().set(this.mappings.widget[pName], propVal, {
                        silent: !0
                    }), this.viewController.widgetLayout.updateImageSource()) : this.widgetSettings().set(this.mappings.widget[pName], propVal, {
                        silent: !1
                    }), this.widgetSettings().trigger("api:change:" + this.mappings.widget[pName]))) : this.regexs.propAccess.visitor.test(propName) && (pName = propName.split(this.regexs.propAccess.visitor), 
                    pName = pName.length > 1 ? pName[1] : null, pName && this.mappings.visitor[pName] && (this.chatModel().set(this.mappings.visitor[pName], propVal, {
                        silent: !1
                    }), this.chatModel().trigger("api:change:" + this.mappings.visitor[pName])));
                }
            },
            performWidgetAction: function(actionName, args) {
                switch (actionName) {
                  case "expand":
                    return this.viewController.widgetLayout.expand.apply(this.viewController.widgetLayout, args);

                  case "collapse":
                    return this.viewController.widgetLayout.onCollapse.apply(this.viewController.widgetLayout, args);

                  case "minimize":
                    return this.chatModel().get("expanded") && this.viewController.widgetLayout.onCollapse(), 
                    this.viewController.widgetLayout.onSuperMinimize.apply(this.viewController.widgetLayout, args);
                }
            },
            performChatAction: function(actionName, args) {
                switch (actionName) {
                  case "start":
                    return this.dataController().startChat.apply(this.dataController(), args);
                }
            },
            action: function(actionName) {
                var fncName, args = Array.prototype.slice.call(arguments, 1);
                return this.regexs.actions.widget.test(actionName) ? (fncName = actionName.split(this.regexs.actions.widget), 
                fncName = fncName.length > 1 ? fncName[1] : null, this.performWidgetAction.call(this, fncName, args)) : this.regexs.actions.chat.test(actionName) ? (fncName = actionName.split(this.regexs.actions.chat), 
                fncName = fncName.length > 1 ? fncName[1] : null, this.performChatAction.call(this, fncName, args)) : null;
            },
            get: function(propName) {
                if (this.regexs.propAccess.widget.test(propName)) {
                    if (pName = propName.split(this.regexs.propAccess.widget), pName = pName.length > 1 ? pName[1] : null, 
                    pName && this.mappings.widget[pName] && this.widgetSettings) return this.widgetSettings().get(this.mappings.widget[pName]);
                } else if (this.regexs.propAccess.visitor.test(propName) && (pName = propName.split(this.regexs.propAccess.visitor), 
                pName = pName.length > 1 ? pName[1] : null, pName && this.mappings.visitor[pName] && this.chatModel)) return this.chatModel().get(this.mappings.visitor[pName]);
                return null;
            },
            on: function(evtName) {
                (this.regexs.events.chat.test(evtName) || this.regexs.events.widget.test(evtName)) && Backbone.Model.prototype.on.apply(this, arguments);
            },
            off: function(evtName) {
                (this.regexs.events.chat.test(evtName) || this.regexs.events.widget.test(evtName)) && Backbone.Model.prototype.off.apply(this, arguments);
            },
            ...
            unbindEvents: function() {
                for (var evt in this.events) Backbone.Model.prototype.off.apply(this, evt, this.events[evt]);
            },
            bindEvents: function() {
                for (var evt in this.events) Backbone.Model.prototype.on.apply(this, evt, this.events[evt]);
            },
            initialize: function() {
                this.bindEvents();
            },
            onDestroy: function() {
                this.unbindEvents(), Backbone.Model.prototype.off.apply(this);
            }
        }), Models.addInitializer(function() {}), Models.addFinalizer(function() {});
        ...
        Models.Chat = Backbone.RelationalModel.extend({
            ...
            restartChat: function() {
                this.set("visitorQuestion", null), this.get("operators").reset(), this.get("messages").reset(), 
            ...
            initialize: function(models, options) {
                var self = this;
                this.proxy = options.collection, this.listenTo(this.proxy, "add", function(model, collection) {
                    var data = model.toJSON(), last = null;
                    collection.every(function(next) {
                        if (next.cid == model.cid) {
                            if (null == last || "message" != last.get("type") || "message" != next.get("type") || last.get("userId") != next.get("userId")) {
                                var addedModel = self.add(data);
                                return model.set("relatedCid", addedModel.cid), !1;
                            }
                            ...
                            if (group) {
                                ...
                                group.set("message", message), group.set("time", next.get("time")), model.set("relatedCid", last.get("relatedCid"));
                            }
                        }
                        return last = next, !0;
                    });
            ...
            comparator: function(a, b) {
                ...
                return 0 == sort ? a.cid < b.cid ? -1 : 1 : sort;
            }
            ...
            getOperatorTypingText: function(resourceManger) {
                ...
                if (typingOperators && 0 !== typingOperators.length) {
                    ...
                    return _.each(typingOperators, function(next, index) {
                        ...
                        typingMessage = "<span data-resourcekey='chat_typing'>" + typingMessage + _.escape(resourceManger.getResource("chat_typing", {
            ...
            getResource: function(key, data) {
                ...
                if (data) {
                    ...
                    return format += "", self.compiledResources || (self.compiledResources = {}), self.compiledResources[format] || (self.compiledResources[format] = pc_.template(format, null, {
                        interpolate: /\{(.+?)\}/g
        ...
        Views.WidgetLayout = Marionette.LayoutView.extend({
            ...
            hideRoomHostAvatar: function() {
                ...
                this.ui.purechatTitleImage.show(), (this.$el.hasClass("purechat-top") || this.settings.get("poppedOut")) && this.$el.removeClass("purechat-adjust-for-avatar");
            },
            showRoomHostAvatar: function(url, isExpanded) {
                "undefined" != typeof isExpanded && (url && isExpanded ? (this.ui.roomAvatarUrl.css({
                    "background-image": "url(" + url + ")"
                }).show(), this.ui.title.addClass("purechat-has-room-avatar"), this.ui.purechatTitleImage.hide(), 
                (this.$el.hasClass("purechat-top") || this.settings.get("poppedOut")) && this.$el.addClass("purechat-adjust-for-avatar")) : this.hideRoomHostAvatar());
            },
            ...
            showPersonalDetailsOnMobile: function() {
                var self = this;
                return this.$el.find(".purechat-personal-details-container").removeClass("purechat-hide"), 
                setTimeout(function() {
            ...
            resetPoweredBy: function() {
                var isMobile = this.settings.get("RequestFromMobileDevice") && this.settings.get("AllowWidgetOnMobile");
                this.settings.get("RemoveBranding") || this.settings.get("isOperator") || isMobile || (this.ui.poweredBy.html(this._originalPoweredBy), 
            ...
            updatePoweredBy: function(content) {
                var isMobile = this.settings.get("RequestFromMobileDevice") && this.settings.get("AllowWidgetOnMobile");
                this.settings.get("isOperator") || !content || this.settings.get("RemoveBranding") || isMobile || (this.ui.poweredBy.html(content), 
            ...
            repositionWidget: function() {
                ...
                for (var i in positionClasses) this.$el.removeClass(positionClasses[i]);
                this.model.get("isPoppedOut") || this.settings.get("isDirectAccess") || this.$el.addClass(this.settings.get("WidgetType") == app.Constants.WidgetType.Button ? positionClasses[9999] : positionClasses[this.settings.get("Position")]);
            },
            chooseWidgetTemplate: function() {
                var isMobile = this.settings.get("RequestFromMobileDevice") && this.settings.get("AllowWidgetOnMobile"), isMobilePCP = this.settings.get("RequestFromMobileDevice") && this.settings.get("isPersonalChat");
                this.settings.get("isDirectAccess") ? (this.template = isMobile ? "WidgetDirectAccessMobile" : "WidgetDirectAccess", 
                this.$el.addClass("purechat-widget purechat-hosted-widget")) : isMobile && this.settings.get("isDemo") ? this.template = "WidgetDirectAccessMobile" : this.settings.get("isOperator") ? (this.template = "WidgetOperator", 
                ...
                this.$el.addClass("purechat-widget hide"), isMobile && !isMobilePCP && this.$el.removeClass().addClass("purechat-mobile-widget-button"));
            },
            showHideMinimizeButton: function() {
                this.settings.get("ShowMinimizeWidgetButton") ? this.ui.superMinimizeButton.show() : this.ui.superMinimizeButton.hide();
            },
            ...
            initialize: function() {
                ...
                this.chooseWidgetTemplate(), this.repositionWidget(), this.bindWidgetSettingsChanges(), 
            ...
            updateImageSource: function() {
                ...
                if (this.ui.collapseImage) {
                    var img = new Image();
                    img.src = this.options.widgetSettings.get("CollapsedWidgetImageUrl"), img.onload = function() {
                        self.options.widgetSettings.set({
                            ImageHeight: img.naturalHeight,
                            ImageWidth: img.naturalWidth
                        }, {
                            silent: !0
                        }), self.ui.collapseImage.attr("src", self.options.widgetSettings.get("CollapsedWidgetImageUrl")), 
                        self.updateImageTransform(), setTimeout(function() {
                            delete img;
                        }, 0);
                    };
                }
            ...
            updateImageTransform: function() {
                this.options.widgetSettings.set("Scale", Math.min(100, this.options.widgetSettings.get("Scale")), {
                    silent: !0
            ...
            hideAdditionalDetails: function() {
                ...
                this.$el.find(".additional-details").removeClass("purechat-hide"), this.$el.find(".purechat-widget-inner").removeClass("expanded"), 
                this.$el.css({
            ...
            showAdditionalDetails: function() {
                ...
                context.$el.find(".purechat-widget-inner").addClass("expanded"), slidingPanel.find(".purechat-widget-header").css({
                    ...
                    top: headerHeight
                }), slidingPanel.removeClass("collapsed").addClass("expanded"), spinner.addClass("purechat-hide");
            },
            ...
            onRender: function() {
                ...
                }) : ($("#background-image").addClass("purechat-hide"), $("body").css({
            ...
            onExpand: function(e, externalArgs) {
                var isCollapseCommand = externalArgs.collapse, superMinimize = externalArgs.superMinimize, self = this, isPoppedOrHosted = self.options.widgetSettings.get("poppedOut") || self.options.widgetSettings.get("isDirectAccess"), performPopout = !self.settings.get("isDemo") && (!self.settings.get("isDirectAccess") && self.settings.get("ForcePopout") && !self.model.get("isPoppedOut") || self.settings.get("usePrototypeFallback")), isMobile = self.options.widgetSettings.get("RequestFromMobileDevice") && self.options.widgetSettings.get("AllowWidgetOnMobile");
                if (!isMobile && !performPopout || isPoppedOrHosted || self.options.widgetSettings.get("widgetWasPoppedOut")) self.options.widgetSettings.get("dataController").checkChatAvailable().done(function(result) {
                    self.model.set("operatorsAvailable", result.available), isCollapseCommand || superMinimize || self.expand();
                }); else {
                    var viewController = self.options.viewController, dataController = self.options.viewController.getDataController();
                    ...
                    self.options.widgetSettings.set("widgetWasPoppedOut", !0);
                }
            },
            ...
            expandMobile: function(firstLoad, callback) {
                ...
                $(window).off("resize.RepositionWidget"), elem.removeClass("slide-out-of-way").css({
                    left: 0
                }), this.ui.expandMobileButton.hide(), (callback || function() {}).call(self);
            },
            expand: function(firstLoad, inRoomOnLoad, args) {
                ...
                var completeFnc = function() {
                    var defFnc = function() {
                        ...
                        self.settings.get("RequestFromMobileDevice") || self.options.widgetSettings.get("isDemo") || (textbox.length > 0 ? textbox.trigger("focus") : self.$el.find("textarea:first").trigger("focus")), 
                    ...
                    defFnc(), self.model.set({
                        expanded: !0
                    }), args && args.expandSource && (localStorage.expandSource = args.expandSource), 
                    self.trigger("expanded"), self.triggerResizedEvent();
                };
                window.localStorage.superMinimize = !1, self.settings.get("isDemo") || (localStorage.expanded = !0), 
            ...
            collapseMobile: function(firstLoad, callback) {
                ...
                if (!self.settings.get("isDirectAccess") && !this.options.widgetSettings.get("isPersonalChat") && !self.model.get("isPoppedOut")) {
                    ...
                    this.options.widgetSettings.get("killForPreview") || this.options.widgetSettings.get("RequestFromMobileDevice") || this.options.widgetSettings.get("AllowWidgetOnMobile") || this.options.widgetSettings.get("isPersonalChat") || (elem.addClass("slide-out-of-way").css({
            ...
            onCollapse: function(firstLoad) {
                ...
                if (!this.settings.get("isPersonalChat")) {
                    ...
                    this.showHideMinimizeButton(), self.$el.find(".btn-toolbar .btn-collapse, .purechat-widget-content").hide(), 
            ...
            startChatSubmit: function(e) {
                ...
                if (!this.submitDelay) {
                    ...
                    } else if ("email" == formType && this.model.get("UnavailableAskForPhone")) {
                        if (0 == phoneNumberVal.length) return this.ui.unavailablePhoneError.show(), self.options.viewController.triggerResizedEvent(), 
                        !1;
                        this.ui.unavailablePhoneError.hide(), self.options.viewController.triggerResizedEvent(), 
                        this.ui.unavailablePhoneNumber.val(phoneNumberVal);
                    }
                    if (askForQuestion && (null === initialQuestion || "" == $.trim(initialQuestion))) return this.ui.questionError.show(), 
                    ...
                    userDisplayName = userDisplayName || self.options.viewController.getPublicApi().get("visitor_name") || this.model.get("InitialVisitorName") || "Visitor", 
            ...
            onRender: function() {
                (this.options.settings.get("isPersonalChat") || this.isMobile()) && (this.$el.find("#purechat-name-submit").addClass("button"), 
            ...
            templateHelpers: function() {
                ...
                return {
                    ...
                    personalAvatarUrl: function() {
                        return "undefined" != typeof personalAvatarUrl ? personalAvatarUrl : "/content/images/avatars/1avatar-operator-skinny.png";
                    },
            ...
            initialize: function() {
                var self = this;
                this._originalOnRender = this.onRender, this.onRender = function() {
                    self._originalOnRender(), self.isMobile() && self.$el.removeClass("purechat-start-chat-form");
                };
            },
            onRender: function() {
                this.isMobile() && this.$el.addClass("mobile"), this.isPersonalChat() && this.$el.addClass("personal"), 
                this.options.settings.get("isPersonalChat") && this.options.settings.get("isInEditorMode") && this.$el.find("textarea.purechat-send-form-message").prop("disabled", !0);
            }
            ...
            onRender: function() {
                ...
                this.$el.addClass("message" != typeClass.toLowerCase() ? typeClass : ""), this.$el.addClass(this.model.get("isClosedChat") ? "closed" : "");
            }
            ...
            templateHelpers: function() {
                var settings = this.options.settings, options = {
                    isPersonalChat: function() {
                        return settings.get("isPersonalChat") || !1;
                    },
                    isMobile: function() {
                        return settings.get("RequestFromMobileDevice") && settings.get("AllowWidgetOnMobile");
                    }
                };
                return options;
            },
            ...
            listChanged: function(model) {
                var self = this;
                this.showMessages || (this.showMessages = setTimeout(function() {
                    self.ui.messageListContainer.show();
                }, 100)), model.get("isClosedChat") || 0 == self.scrollBottom || 0 != self.ui.displayContainer.scrollTop() || (self.scrollBottom = self.ui.displayContainer[0].scrollHeight - self.ui.displayContainer.height()), 
                model.get("isClosedChat") || this.model.get("userId") != model.get("userId") || (self.scrollBottom = 0), 
                self.scrollBottom <= 20 && (self.scrollBottom = 0), (0 == self.scrollBottom || model.get("isClosedChat")) && (self.scrollTimeout && (clearTimeout(self.scrollTimeout), 
                self.scrollTimeout = null), self.scrollTimeout = setTimeout(function() {
                    self.scrollTimeout = null, self.updateScroll();
                }, 0));
            },
            ...
            onDestroy: function() {
                $(window).off("resize.ScrollToTopMobile"), this.$el.find(".purechat-message-display-container").off("scroll");
            },
            updatePreviousVisibility: function() {
                this.model.get("HasMoreTransactions") ? this.ui.showPrevious.show() : this.ui.showPrevious.hide();
            },
            onRender: function() {
                window.test = this;
                var self = this;
                if (self.ui.messageListContainer.hide(), this.ui.displayContainer.on("scroll.displayContainer", function() {
                ...
                }), this.options.settings.get("isInvisible") && (this.ui.textInput.attr("disabled", "disabled"), 
                ...
                this.options.settings.get("isPersonalChat") && (this.$el.find(".btn-close").css("display", "inline-block"), 
            ...
            typing: function(userId, userDisplayName, isTyping) {
                ...
                isTyping && this.options.settings.get("isPersonalChat") && this.options.settings.get("isInEditorMode") && (this.ui.userStatus.find('[data-resourcekey="chat_typing"]').attr("data-username", _.escape(userDisplayName)), 
            ...
            initialize: function() {
                ...
                this._proxyCollection = new Backbone.Collection(), this.collection = new app.Models.MessageCollectionMessagesGrouped(null, {
                    collection: this._proxyCollection
                });
            },
            onRender: function() {
    ...
    PCWidgetState = marionette.Controller.extend({
        ...
        States.PCStateInactive = PCWidgetState.extend({
            ...
            onEnter: function() {
                ...
                var self = inactiveInstance = this, widgetSettings = self.getWidgetSettings(), doneFnc = function(result) {
                    ...
                    result.available || ("WidgetDisabled" == result.reason || "ChatQuotaExceeded" == result.reason || "IpIsbanned" == result.reason) && self.getWidgetSettings().set("UnavailableBehavior", 1), 
                            ...
                            if (!self.submittingChat) if (inRoom) self.getChatModel().set("state", app.Constants.WidgetStates.Activating); else {
                                self.submittingChat = !0, data.origin = self.chatModel.get("origin");
                                {
                                    self.getDataController().startChat(data).done(function(chatConnectionInfo) {
                                        ...
                                        self.status.chatInfo = chatConnectionInfo, self.status.initialData = data, self.getChatModel().set({
            ...
            onExpanded: function() {
                ...
                window._pcDisableAvailabilityPings || this.startAvailabilityPolling());
            },
    ...
    }, purechatApp.Models), purechatApp.module("Controllers.States", function(States, app, Backbone, Marionette, $, _) {
        States.PCStateChatting = PCWidgetState.extend({
            ...
            onEnter: function() {
                ...
                chatModel.set({
                    ...
                    model: chatModel,
                    collection: new app.Models.MessageCollectionMessagesGrouped(null, {
                        collection: self.getChatModel().get("messages")
                    }),
                    settings: self.getWidgetSettings()
                }), self.getWidgetView().content.show(self.messageView), self.listenTo(self.messageView, "showPrevious", function() {
                    if (self.chatModel.get("PreviousTranscriptId")) {
                        var previousChatDeferred = self.getDataController().getPreviousChat({
                            chatId: self.chatModel.get("PreviousTranscriptId")
                        });
                ...
                var isMobile = self.options.get("RequestFromMobileDevice") && (self.options.get("poppedOut") || self.options.get("isDirectAccess")), loading = [ self.getDataController().connectToChatServer(this) ];
                if (this.options.get("room") && 1 != this.options.get("room").roomType && !this.options.get("room").isDemo) {
                    var previousChatDeferred = self.getDataController().getPreviousChat({
                        chatId: this.options.get("room") ? this.options.get("room").id : -1
                    });
                    loading.push(previousChatDeferred);
                }
                $.when.apply($, loading).done(function(connectionResult, previousChatResult) {
                    previousChatResult && self.appendPreviousChatResults(previousChatResult), self.clearConnectingTimeout();
                    try {
                        if (!self.chatModel.get("isOperator") && ("undefined" == typeof self.chatModel.get("operators") || 0 == self.chatModel.get("operators").length)) {
                            var d = new Date();
                            d.setTime(0), self.chatModel.get("messages").add({
                                date: d,
                        ...
                        self.options.get("isDemo") || self.getWidgetView().$el.find(".purechat-send-form-message").trigger("focus"), 
                        self.getWidgetView().trigger("resized"), app.execute("poweredby:reset");
                    } catch (exception) {
            ...
            appendPreviousChatResults: function(previousChatResult, delayIncrement) {
                var self = this;
                previousChatResult && previousChatResult.forEach(function(next) {
                    ...
                    var lastTimeString = null, lastMessage = null, currentDelay = 0;
                    if (next.Records.forEach(function(nextMessage) {
                        function triggerOnMessage() {
                            1 == nextMessage.Type ? self.onJoined(nextMessage.UserId, nextMessage.Name, -1, nextMessage.Name, nextMessage.DateCreatedJsTicks / 1e3, !0, !0) : 2 == nextMessage.Type ? self.onLeft(nextMessage.UserId, nextMessage.Name, -1, nextMessage.Name, nextMessage.DateCreatedJsTicks / 1e3, !0, !0) : self.onMessage(nextMessage.UserId, nextMessage.Name, -1, nextMessage.Name, nextMessage.DateCreatedJsTicks / 1e3, nextMessage.Message, !0, 0, 0, nextMessage.AvatarUrl, nextMessage.UserId > 0, 0, 0, !0);
                        }
                        delayIncrement ? (setTimeout(triggerOnMessage, currentDelay), currentDelay += delayIncrement) : triggerOnMessage(), 
                        lastTimeString = nextMessage.DateCreatedString + " at " + nextMessage.TimeCreatedString, 
                        lastMessage = nextMessage;
                    }), null != lastTimeString) {
                        var date = new Date();
                        date.setTime(lastMessage.DateCreatedJsTicks), delayIncrement ? (setTimeout(addSeparator, currentDelay), 
                        currentDelay += delayIncrement) : addSeparator();
                    }
                    self.chatModel.set("PreviousTranscriptId", next.Id), next.PreviousTranscriptId ? self.chatModel.set("HasMoreTransactions", !0) : self.chatModel.set("HasMoreTransactions", !1);
                });
            },
            onExit: function() {
            ...
            onMessage: function(userId, userDisplayName, roomId, roomDisplayName, time, message, isHistory, timeElapsed, protocolVersion, senderAvatarUrl, fromOperator, roomUtcOffset, messageId, isClosedChat) {
                ...
                if (this.chatModel.get("isOperator") && userId != this.chatModel.get("userId") && notifier.notify("New message!"), 
                ...
                if (this.chatModel.get("userId") != userId && 0 == this.chatModel.get("isOperator") && 1 == this.chatModel.get("isWidget") && 0 == this.chatModel.get("expanded") && 0 == isHistory && this.getWidgetView().flashNotification(message), 
                this.isUserAlone && !this.chatModel.get("isOperator") && !isHistory && message != this.chatModel.get("Question") && !this.chatModel.get("noOperatorMessageSeen")) {
                    var date = new Date();
                    date.setTime(1e3 * time + 1), this.chatModel.get("messages").add({
                        date: date,
                        type: "note",
                        message: _.escape(this.getResource("chat_noOperatorMessage")),
                        resourceKey: "chat_noOperatorMessage",
                        isClosedChat: isClosedChat
                    }), this.chatModel.set("noOperatorMessageSeen", !0);
                }
                $("body").trigger("ChatMessageAdded"), this.flashMobileNotificationIcon();
            },
            ...
            onJoined: function(userId, userDisplayName, roomId, roomDisplayName, time, isHistory, isClosedChat) {
                if (this.chatModel.get("isOperator") || userId != this.chatModel.get("userId")) {
                    ...
                    date.setTime(1e3 * time), this.chatModel.get("messages").add({
                        ...
                        type: "note",
                        important: !0,
                        message: _.escape(this.getResource("chat_joinMessage", {
                            displayName: userDisplayName
                        })),
                        username: userDisplayName,
                ...
                userId != this.chatModel.get("userId") && (this.isUserAlone = !1, this.chatModel.get("operators").add({
                ...
                }), "chat_nowChattingWith") : this.isUserAlone = !0);
            },
            onLeft: function(userId, userDisplayName, roomId, roomDisplayName, time, isHistory, isClosedChat) {
                ...
                userId != this.chatModel.get("userId") && (this.chatModel.get("operators").remove(userId), 
        ...
        States.PCStateClosed = PCWidgetState.extend({
            ...
            handleRoomClose: function(response, room) {
                ...
                }, isOperator = self.options.get("isOperator"), closeMessage = isOperator ? new app.Views.ClosedOperatorView(closedViewParams) : new app.Views.ClosedMessage(closedViewParams);
                ...
                }), self.getWidgetView().content.show(closeMessage), isOperator && closeMessage.renderMessageList(), 
                self.getWidgetView().hideRoomHostAvatar(), self.chatModel.set({
                ...
                _.isFunction(self.getDataController().unbindHandlerEvents) && self.getDataController().unbindHandlerEvents();
            },
            onEnter: function() {
                PCWidgetState.prototype.onEnter.apply(this, arguments);
    ...
    }, purechatApp.Models), purechatApp.module("Controllers", function(Controllers, app, Backbone, Marionette, $, _) {
        var BaseDataController = Marionette.Controller.extend({
            ...
            initialize: function() {
                ...
                this._originalGetWidgetSettings = this.getWidgetSettings, this.getWidgetSettings = function() {
                    var deferred = $.Deferred();
                    return self._originalGetWidgetSettings.apply(self, arguments).done(function(response) {
                        response.widgetConfig && response.widgetConfig.AllowWidgetOnMobile && response.widgetConfig.RequestFromMobileDevice && (localStorage.expanded = !1), 
            ...
            newMessage: function(message) {
                ...
                seconds = 10 > seconds ? "0" + seconds : seconds, Marionette.getOption(this, "chatModel").get("messages").add({
                    ...
                    date: now,
                    avatarUrl: "/content/images/avatars/visitor-avatar-thick.png"
                });
            },
            ...
            restartChat: function() {
                return this.connectionInfo.clearLocalStorage(), $.Deferred().resolve();
            },
            newMessage: function(message) {
            ...
            checkChatAvailable: function(accountId) {
                ...
                badBrowser) setTimeout(function() {
                    ...
                    }, url = Marionette.getOption(this, "pureServerUrl") + "/VisitorWidget/ChatAvailable/" + urlOptions.accountId + "/" + urlOptions.widgetId + "/_PCcb?externalRequest=false";
                    $.ajax({
            ...
            submitEmailForm: function(data) {
                data.widgetId = Marionette.getOption(this, "widgetId"), data.startPage = data.origin || window.location.toString() || "unknown", 
            ...
            startChat: function(data) {
                var self = this, d = $.Deferred(), escapedUserDisplayName = data.visitorName, url = Marionette.getOption(this, "pureServerUrl") + "/VisitorWidget/Chat/" + Marionette.getOption(this, "widgetId") + "?visitorName=" + encodeURIComponent(escapedUserDisplayName) + "&origin=" + encodeURIComponent(data.origin || window.location.toString() || "unknown") + "&expandSource=" + (window.localStorage.getItem("expandSource") || "") + "&acquisitionSource=" + (localStorage.acquisitionSource || "Direct");
            ...
            unbindHandlerEvents: function() {
                BaseDataController.prototype.unbindHandlerEvents.apply(this, arguments), this.unbindHandlerEventsImpl && this.unbindHandlerEventsImpl();
            },
            bindEvents: function(handler) {
                var self = this;
    ...
    purechatApp.module("Controllers", function(Controllers, app, Backbone, Marionette, $) {
        ...
        var PureChatController = Marionette.Controller.extend({
            ...
            popoutChatOnExpand: function(dataController, settings, chatModel, state, goToMobile) {
                ...
                var url = settings.pureServerUrl + "/VisitorWidget/ChatWindow?widgetId=" + settings.widgetId + "&userId=" + dataController.connectionInfo.get("userId") + "&displayName=" + dataController.connectionInfo.get("visitorName") + "&authToken=" + dataController.connectionInfo.get("authToken") + "&roomId=" + dataController.connectionInfo.get("roomId") + "&chatId=" + dataController.connectionInfo.get("chatId") + "&origin=" + encodeURIComponent(chatModel ? chatModel.get("origin") : "");
                window.openedWindow = goToMobile ? window.open(url, "_blank") : window.open(url, "purechatwindow", "menubar=no, location=no, resizable=yes, scrollbars=no, status=no, width=480, height=640");
            },
            registerPublicApiEvents: function() {
                var self = this;
                this._publicApi || (this._publicApi = new app.Api.Models.ApiModel(), this._publicApi.setViewController(this)), 
                self.on("state:changed", function(e) {
                    ...
                    self.widgetLayout.on("widget:resized", function(e) {
                        self.getPublicApi().trigger("resized", {
                            widgetId: self.getChatModel().id
                        }), self.getPublicApi().trigger("widget:resize", {
                            widgetId: self.options.get("Id"),
                            width: e.width,
                            height: e.height
                        });
                    }), self.widgetLayout.on("expanded", function() {
                        self.getPublicApi().trigger("widget:expand", {
                            widgetId: self.options.get("Id")
                        });
                    }), self.options.on("change:Position", function() {
                        self.widgetLayout.repositionWidget();
                    }), self.widgetLayout.on("collapsed", function() {
                        self.getPublicApi().trigger("widget:collapse", {
                            widgetId: self.options.get("Id")
                        });
                    }), self.widgetLayout.on("minimized", function() {
                        self.getPublicApi().trigger("widget:minimize", {
                            widgetId: self.options.get("Id")
                        });
                    }), self.getChatModel().on("widget:available", function() {
                        self.getPublicApi().trigger("widget:available", {
                            widgetId: self.options.get("Id")
                        });
                    }), self.getChatModel().on("widget:unavailable", function() {
                        self.getPublicApi().trigger("widget:unavailable", {
                            widgetId: self.options.get("Id")
                        });
            ...
            triggerResizedEvent: function() {
                var self = this;
                self.resizeTrigger && clearTimeout(self.resizeTrigger), self.resizeTrigger = setTimeout(function() {
                    if (self.resizeTrigger = null, self.widgetLayout && self.widgetLayout.$el) {
                        ...
                        self.widgetLayout.trigger("resized", {
                            ...
                            height: 390,
                            width: width
                        }), self.resizeTrigger2 && clearTimeout(self.resizeTrigger2), self.resizeTrigger2 = setTimeout(function() {
            ...
            initialize: function(options) {
                function socketIOLoadComplete() {
                    ...
                    chatModel.on("change:operatorsAvailable", function(model, available) {
                        ...
                        expandButtons.removeClass("purechat-button-hidden"), expandButtons.removeAttr("disabled"), 
                        chatModel.trigger("widget:available")) : (0 === self.options.get("UnavailableBehavior") && (expandButtons.removeClass("purechat-button-available"), 
                ...
                if (self.setChatModel(chatModel), this.registerPublicApiEvents(), options.get("isDemo") && (chatModel.set("operatorsAvailable", !0), 
            ...
            onDestroy: function() {
                ...
                dataController.unbindHandlerEvents(), dataController.chatServerConnection = null, 
                dataController.destroy(), this.widgetLayout.destroy(), this.state.destroy(), this.state = null, 
                this.widgetLayout = null, this.setDataController(null), this.setChatModel(null), 
                this.resizeTrigger && (clearTimeout(this.resizeTrigger), this.resizeTrigger = null), 
                this.resizeTrigger2 && (clearTimeout(this.resizeTrigger2), this.resizeTrigger2 = null), 
                this.options && (this.options.attributes.dataController = null, this.options.attributes.renderInto = null, 
                this.options._previousAttributes.dataController = null, this.options._previousAttributes.renderInto = null, 
                this.options = null), this.unbindAppLevelCommands();
            },
    ...
    }, purechatApp.Models), _PCWidget = function(connectionSettings) {
    ...
    }, purechatApp.module("Triggers", function(Triggers, app, Backbone, Marionette, $, _) {
        ...
        var DismissSettings = Backbone.Model.extend({
            ...
            initialize: function(purechatController) {
                ...
                this.enabled) {
                    ...
                    this.purechatController.widgetLayout.on("collapsed", this.onCollapse), self.startTesting(), 
            ...
            onCollapse: function() {
                ...
                BaseControllerSettings.dismissSettings.save(), this.purechatController.widgetLayout.off("collapsed", this.onCollapse);
            },
            ...
            triggerEvent: function(delay) {
                ...
                this.purechatController.getDataController().checkChatAvailable().done(function(result) {
                    result.available && (self.removeEventListeners(), setTimeout(function() {
                        self.purechatController.chatModel.get("expanded") || (self.stopTesting(), self.purechatController.widgetLayout.expand(!1, !1, {
        ...
        Triggers.BaseControllerSettings = BaseControllerSettings, Triggers.addInitializer(function() {}), 
        Triggers.addFinalizer(function() {});
    }), purechatApp.module("Triggers", function(Triggers) {
        ...
        Triggers.TimeBasedTrigger = TimeBasedTrigger, Triggers.addInitializer(function() {}), 
        Triggers.addFinalizer(function() {});
    }), purechatApp.module("Triggers", function(Triggers) {
        ...
        Triggers.UrlBasedTrigger = UrlBasedTrigger, Triggers.addInitializer(function() {}), 
        Triggers.addFinalizer(function() {});
    }), purechatApp.module("Notifications", function(Notifications, App, Backbone, Marionette) {
