...
'Map Image
DrivingMap = "/Clients/BoernePerformingArts/ETicket/Images/ETicketMAP2.jpg"


'----------------------

'Act Specific Advertisment
...
RequiredAct(1) = "72669" 'VIENNA BOYS CHOIR
AdImage(1) = "Images/AdImage001.jpg" 'Advertisement 1

RequiredAct(2) = "72668" 'TAO: The Art of the Drum
AdImage(2) =  "Images/AdImage002.jpg"  'Advertisement 2

RequiredAct(3) = "72667" 'BOWFIRE 
AdImage(3) =  "Images/AdImage003.jpg"  'Advertisement 3
...
'-----------	
			...
			Response.Write "<IMG SRC="" " & DrivingMap & " "" WIDTH=""200"" >" & vbCrLf
...
'-------------------
			...
			Response.Write "<TD colspan=""3"" ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC = " & AdSpaceImage & " "" WIDTH=""400"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf				
