            ...
            <div align="center">
              ...
              <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="37">&nbsp;</td>
                  <td width="725">
                    <img src="/Clients/CrosswordGold/Images/tiger_time_ticket_2.jpg" alt="Crossword Gold Ticket" />
                    <div style="position:relative; top:-150px; left:0px; width:100%"><center><font face="Arial, Helvetica, sans-serif" size="5"><b><%= rsTix("TicketNumber") %></b></font></center></div> 
                  </td>                      
                  <td width="38">&nbsp;</td>
                </tr>
              </table>
