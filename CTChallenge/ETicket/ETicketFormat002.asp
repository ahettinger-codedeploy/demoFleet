...
Dim FileLocation(3)
FileLocation(1) = "/images/ETicketBackgroundGray.gif"
FileLocation(2) = "/images/ETicketLogoGray.gif"
FileLocation(3) = "/images/ETicketBottomBarGray.gif"

	ClientFolder = "/Clients/"&ThisPrivateLabel&"/ETicket/Images"
...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<TABLE BORDER=""1"" CELLPADDING=""0"" CELLSPACING=""0"" WIDTH=""620"">" & vbCrLf
			...
			Response.Write "<TABLE WIDTH=""615"" HEIGHT=""240"" BORDER=""0"" BACKGROUND="""&FileLocation(1)&""" CELLPADDING=""0"" CELLSPACING=""0"">" & vbCrLf
			Response.Write "<TR>" & vbCrLf
		...
		'Begin Body Space
            ...
            If Not IsNull(rsTix("ETicketMapPath")) Then
    			Response.Write "<IMG SRC=""" & rsTix("ETicketMapPath") & """ WIDTH=""200px"">" & vbCrLf
            End If
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
