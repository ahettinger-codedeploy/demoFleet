...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<IMG SRC=""/Clients/CTChallenge/ETicket/Images/CTClogofore-ticket.jpg"">" & vbCrLf
			...
			Response.Write "<IMG SRC=""/Clients/CTChallenge/ETicket/Images/BottomBar.jpg"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
		...
		'Begin Body Space
			...
			Response.Write "<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "<FONT FACE=""Arial"" Size=""1"">" & vbCrLf
			Response.Write "<B>DIRECTIONS</B><BR>" & vbCrLf
			Response.Write "<B>From I-95 northbound: </b><BR> Take exit 21.  Left off ramp under highway onto Mill Plain Rd.  Go half mile and take right onto Unquowa Rd.  Entrance to school will be on the right.<BR><BR>" & vbCrLf
			Response.Write "<B>From I-95 southbound: </B><BR> Take exit 21.  Right off ramp onto Mill Plain Rd.  Go half mile and take right onto Unquowa Rd.  Entrance to school will be on the right.<BR><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "<FONT FACE=""Arial"" Size=""1"">" & vbCrLf
			Response.Write "<B>Schedule</b><BR>" & vbCrLf
			Response.Write "5:30pm:  Reception for cancer survivors in cafeteria<BR>6:30pm:  Auditorium doors open. <BR>7:00-8:00pm:  Mark Herzlich presentation"  & vbCrLf
			Response.Write "</font>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			...
			Response.Write "<BR>" & vbCrLf
			Response.Write "<IMG Src=""/Clients/CTChallenge/Eticket/Images/map.jpg"">" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""http://www.tix.com/Images/ETicketTixLogo.gif"" HEIGHT=""200"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
