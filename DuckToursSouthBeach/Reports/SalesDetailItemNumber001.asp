...
SecurityFunction = "SalesDetailReport"
ReportFileName = "SalesDetailItemNumber.asp"
...
If Request("EventCode") <> "" Then
	...
	If Not rsOrderLine.EOF Then
		...
		ColumnHeading = ColumnHeading & "<TD NOWRAP ALIGN=""center"">Item&nbsp;Number&nbsp;</TD>" 'Column 1
	...
	Do Until rsOrderLine.EOF
		...
		End If
		Detail = Detail & "<TD NOWRAP ALIGN=""right"">" & rsOrderLine("ItemNumber") & "</TD>" 'Column 1
		If Excel <> "Y" Then
		...
		If Excel <> "Y" Then
    		Detail = Detail & "<TD NOWRAP><A HREF=""/Reports/CustomerDetails.asp?CustomerNumber=" & rsOrderLine("CustomerNumber") & """ TITLE=""Click here to go to Customer Details for " & rsOrderLine("BillingFirstName") & " " & rsOrderLine("BillingLastName") & """ onmouseover=""ttDelay=setTimeout('eventTooltip(\'/Include/AttendeeInfoInclude.asp?OrderNumber=" & rsOrderLine("OrderNumber") & "\', this)', 200);"" onmouseout=""clearTimeout(ttDelay);hideTooltip();"">" & rsOrderLine("ShipFirstName") & "</A></TD>" 'Column 5
    		Detail = Detail & "<TD NOWRAP><A HREF=""/Reports/CustomerDetails.asp?CustomerNumber=" & rsOrderLine("CustomerNumber") & """ TITLE=""Click here to go to Customer Details for " & rsOrderLine("BillingFirstName") & " " & rsOrderLine("BillingLastName") & """ onmouseover=""ttDelay=setTimeout('eventTooltip(\'/Include/AttendeeInfoInclude.asp?OrderNumber=" & rsOrderLine("OrderNumber") & "\', this)', 200);"" onmouseout=""clearTimeout(ttDelay);hideTooltip();"">" & rsOrderLine("ShipLastName") & "</A></TD>" 'Column 5
        Else
	...
	If FirstRecord <> "Y" Then
		...
		SubtotalData = SubtotalData & "<TD colspan=25>" & FormatNumber(SubtotalTicketCount,0) & "</TD>" 'Column 3
...
If Request("DonationItemNumber") <> "" Then 'There were donation/memberships selected.
	...
	Do Until rsOrderLine.EOF
	    ...
	    If Excel <> "Y" Then
		    Detail = Detail & "<TD NOWRAP><A HREF=""/Reports/CustomerDetails.asp?CustomerNumber=" & rsOrderLine("CustomerNumber") & """ TITLE=""Click here to go to Customer Details for " & rsOrderLine("FirstName") & " " & rsOrderLine("LastName") & """ onmouseover=""ttDelay=setTimeout('eventTooltip(\'/Include/CustomerInfoInclude.asp?CustomerNumber=" & rsOrderLine("CustomerNumber") & "\', this)', 200);"" onmouseout=""clearTimeout(ttDelay);hideTooltip();"">" & rsOrderLine("FirstName") & "</A></TD>" 'Column 4
		    Detail = Detail & "<TD NOWRAP><A HREF=""/Reports/CustomerDetails.asp?CustomerNumber=" & rsOrderLine("CustomerNumber") & """ TITLE=""Click here to go to Customer Details for " & rsOrderLine("FirstName") & " " & rsOrderLine("LastName") & """ onmouseover=""ttDelay=setTimeout('eventTooltip(\'/Include/CustomerInfoInclude.asp?CustomerNumber=" & rsOrderLine("CustomerNumber") & "\', this)', 200);"" onmouseout=""clearTimeout(ttDelay);hideTooltip();"">" & rsOrderLine("LastName") & "</A></TD>" 'Column 4
        Else
	...
	If FirstRecord <> "Y" Then 
		...
		SubtotalData = SubtotalData & "<TD colspan=24>" & FormatNumber(SubtotalDonationCount,0) & "</TD>"
...
If Request("OrderProcessingFees") = "Y" Then 'There were Order Processing Fees selected.
	...
	If Not rsOrderLine.EOF Then
		...
		SubtotalData = SubtotalData & "<TD>Total</TD>" 
		SubtotalData = SubtotalData & "<TD ALIGN=right>Sold Count:</TD>" 
		SubtotalData = SubtotalData & "<TD colspan=26>" & FormatNumber(SubtotalOrderCount,0) & "</TD>" 
...
Detail = Detail & "<TD style=""text-align:left"" colspan=25>" & FormatNumber(TotalItemCount,0) & "</TD>" 'Column 3
