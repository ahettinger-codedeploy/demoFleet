...
If Not rsEvents.EOF Then
			...
			Response.Write "<TR STYLE=""border-width: 0px"" BGCOLOR=#008400><TD COLSPAN=3><FONT FACE='verdana,arial,helvetica' SIZE=2 COLOR=#FFFFFF><B>" & rsEvents("EventName") & "</B></FONT></TD><TD ALIGN=""right""><FONT FACE='verdana,arial,helvetica' SIZE=2 COLOR=#FFFFFF><B>" & FormatDateTime(rsEvents("EventDate"), vbShortDate) & "</B></FONT></TD></TR>" & vbCrLf
