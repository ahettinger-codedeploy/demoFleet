...
'Required Event
RequiredEventList = "310389,310390"

OfferCount = 4
Dim OfferEvent(4)
OfferEvent(1) =  308730   'Desert Classic Concours d’Elegance 2011 - Opening Night Reception   
OfferEvent(2) =  308731   'Desert Classic Concours d'Elegance-2011 
OfferEvent(3) =  310391   'The Tour - Car and Driver Fee 
OfferEvent(4) =  310392   'The Tour - Passenger Fee 
...
Set rsRequiredTicketCount = OBJdbConnection.Execute(SQLRequiredTicketCount)
    ...
    If Not rsRequiredTicketCount.EOF Then  
            ...
            SQLOfferTicketCount = "SELECT Count(ItemNumber) AS TicketCount FROM Seat (NOLOCK) WHERE Seat.EventCode IN (308046,308023,308910) AND Seat.SectionCode = 'GA' AND Seat.StatusCode = 'A'"
            Set rsOfferTicketCount = OBJdbConnection.Execute(SQLOfferTicketCount)
            
                If Not rsOfferTicketCount.EOF Then	    
                    AvailOfferCount = AvailOfferCount + rsOfferTicketCount("TicketCount")           
                End If
...
If Not rsRequiredCheck.EOF Then	
        ...
        <table bgcolor = "#ffffff"  width="500" cellpadding="5" cellspacing="5" border="0">
        <! -- Table Column Headings -- >
        <tr bgcolor="#000000"align="center">
            <th scope="col"><FONT FACE="<%= FontFace %>" COLOR="#33ccff" SIZE="4"><B>Special Offers</FONT></th>
        </tr>
        <tr>
            <td>        
            <%
	        ...
	        For i = 1 to OfferCount
                ...
                %>     
                    <table bgcolor = "#f1f1f1" width="500" cellpadding="5" cellspacing="5" border="0">
                     <tr>
                        <td align="center">
                        ...
                        <FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2"><B><%=rsVenueDetail("Venue")%></B></FONT><br />
                            ...
                            <tr>
                                ...
                                <td ALIGN="center"><FONT FACE=verdana,arial,helvetica COLOR=#000000 SIZE=2><B><U>Quantity</U></B></FONT></td>
                            </tr>                                
                            <%                               
                            ...
                            If Not rsSeatType.EOF Then                      
                                ...
                                %>                             
                                <tr>
                                    <td ALIGN="left"><FONT FACE=verdana,arial,helvetica COLOR=#000000 SIZE=2><%=rsSeatType("SeatType")%></FONT>
                                    </td>
                                    <td ALIGN="left"><FONT FACE=verdana,arial,helvetica COLOR=#000000 SIZE=2><%=FormatCurrency(rsSeatType("Price"),2)%></FONT>
                                    </td>
