	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">" & vbCrLf
			    ...
			    Case "478389","478390","478391","478392","478393","478394"
			        Directions1 = "From I-182 take exit 9 (Road 68)<BR>Turn south onto Road 68<BR> Take the 2nd right onto W Argent St.<BR> Turn right at Road 80 <BR>Follow pink flamingos"
					
			    Case "478395","478396","478397","478398","478399","478400"
				    Directions1 = "From I-182 take exit 12B<BR>Turn onto 20th Ave., head North <BR>Turn left onto campus, at light (Sun Willows Blvd)<BR>Follow road around campus<BR>At stop sign turn right<BR>P-building is the three story concrete building on the right<BR>Follow pink flamingos"
		...
		Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2"">" & vbCrLf
			...
			Response.Write "<IMG SRC = ""/Clients/ColumbiaBasin/ETicket/Images/" & Map1 & " "">" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2"">" & vbCrLf
			Response.Write "<B>Thank You!</B><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "<IMG SRC=""/clients/ColumbiaBasin/ETicket/Images/NewCBClogomonocompact.jpg "" HEIGHT=""200"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
