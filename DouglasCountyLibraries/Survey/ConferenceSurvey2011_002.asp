...
Page = "Survey"
SurveyNumber = 1092
SurveyName = "ConferenceSurvey2011.asp"

'============================================================

'Douglas County Libraries Foundation (8/23/2011)
'Event Add On Survey
...
'69261      Agent #1             24 events
'69262      Agent #2             12 events
'69263      Agent #3             24 events
...
'Survey - Second Page
'--------------------
'If a customer buys any ticket type to 
'Douglas County Libraries Writers Conference
'they are offered a meal selection 

'===================================================

'Survey Variables

RequiredEvent = 389476 'Douglas County Libraries Writers Conference 
RequiredSeatType = 4568 'Conference plus Agent Pitch Session
RequiredCount = 1

OfferActList = "69261,69262,69263" 'Agent #1, #2, #3
OfferSeatType = 4579 'Agent Pitch Session
OfferSection =  "GA" 'General Admission

Lunch01 = "Lunch Option #1"
Lunch02 = "Lunch Option #2"
Lunch03 = "Lunch Option #3"
Lunch04 = "Lunch Option #4"
Lunch05 = "Lunch Option #5"
Lunch06 = "Lunch Option #6"

LunchDescription01="<b>Lunch Option #1</b><Br>Entree<br>Side Dish<br>Dessert<br>Beverage<br>Mint<br>"
LunchDescription02="<b>Lunch Option #2</b><bR>Entree<br>Side Dish<br>Dessert<br>Beverage<br>Mint<br>"
LunchDescription03="<b>Lunch Option #3</b><bR>Entree<br>Side Dish<br>Dessert<br>Beverage<br>Mint<br>"
LunchDescription04="<b>Lunch Option #4</b><bR>Entree<br>Side Dish<br>Dessert<br>Beverage<br>Mint<br>"
LunchDescription05="<b>Lunch Option #5</b><bR>Entree<br>Side Dish<br>Dessert<br>Beverage<br>Mint<br>"
LunchDescription06="<b>Lunch Option #6</b><br>Entree<br>Side Dish<br>Dessert<br>Beverage<br>Mint<br>"
...
<tr>
    ...
    <%= LunchDescription01 %><br /><br />
    </td>
   <td align="left">
    <FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="1">
    <%= LunchDescription02 %><br /><br />
    </td>
</tr>
<tr>
    <td align="left">
    <FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="1">
    <%= LunchDescription03 %><br /><br />
    </td>
    <td align="left">
    <FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="1">
    <%= LunchDescription04 %><br /><br />
    </td>
</tr>
<tr>
    <td align="left">
    <FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="1">
    <%= LunchDescription05 %><br /><br />
    </td>
    <td align="left">
    <FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="1">
    <%= LunchDescription06 %><br /><br />
    </td>
</tr>
</table>
<Br />
...
<tr>
    ...
    <td >
        ...
        <option value="<%=Lunch05%>" class=""><%=Lunch05%></option>
        <option value="<%=Lunch06%>" class=""><%=Lunch06%></option>
        </select>
        <br />
        <br />
    </td>
...
<tr bgcolor="<%=TableCategoryBGColor%>">
    <td colspan="3" align="center">
    <FONT FACE="<%= FontFace %>" COLOR="<%=TableCategoryFontColor%>" SIZE="4">
    <B>Available Agent Pitch Sessions</B></FONT><br />
    <FONT FACE="<%= FontFace %>" COLOR="<%= TableCategoryFontColor%>" SIZE="2">
    Please select from the list below</FONT><br />
    </td>
</tr>
<%
...
%>
<tr>
    <td rowspan=2 width="5%" valign="middle" align="center"><FONT FACE="<%= FontFace %>" COLOR="<%= HeadingFontColor %>" SIZE="3"><br /><h3><%=i%></h3><br />
    </td>
...
%>
        <OPTION VALUE="<%=rsPackages("EventCode")%>"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">Agent Pitch Session at <%=Left(FormatDateTime(rsPackages("EventDate"),vbLongTime),Len(FormatDateTime(rsPackages("EventDate"),vbLongTime))-6) & Right(FormatDateTime(rsPackages("EventDate"),vbLongTime),3)%>&nbsp;with&nbsp;<%= rsPackages("Act") %></OPTION>
<%
        End If    
...
'---------------------------
    ...
    'SQLEventList = "SELECT OrderLine.LineNumber, OrderLine.OrderNumber, OrderLine.SeatTypeCode, Event.EventCode, Event.EventDate, Act.Act FROM OrderLine (NOLOCK) INNER JOIN Seat (NOLOCK) ON OrderLine.ItemNumber = Seat.ItemNumber INNER JOIN Event (NOLOCK) ON Seat.EventCode = Event.EventCode INNER JOIN Act (NOLOCK) On Event.ActCode = Act.ActCode WHERE OrderLine.SeatTypeCode = " & RequiredSeatType & " AND OrderLine.OrderNumber = " & Session("OrderNumber") & " "
    'Set rsEventList = OBJdbConnection.Execute(SQLEventList)

    'If Not rsEventList.EOF Then
        
        'Do While Not rsEventList.EOF 
             
        'SQLInsertSurvey = "INSERT SurveyAnswers(SurveyNumber, OrderNumber, CustomerNumber, SurveyDate, AnswerNumber, Answer, Question) VALUES(" & CleanNumeric(SurveyNumber) & ", " & rsEventList("OrderNumber") & ", " & CleanNumeric(Session("CustomerNumber")) & ", '" & Now() & "', " & rsEventList("LineNumber") & ", " & rsEventList("EventCode") & ", " & rsEventList("EventCode") & " "
        'Set rsInsertSurvey = OBJdbConnection.Execute(SQLInsertSurvey)	    

		
        'rsEventList.movenext         
        'Loop   
