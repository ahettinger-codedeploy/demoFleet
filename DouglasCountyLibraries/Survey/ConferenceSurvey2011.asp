...
Lunch01 = "Turkey Sandwich Box Lunch"
Lunch02 = "Harvest Veggie Sandwich Box Lunch"
Lunch03 = "Spring Mix Salad with Chicken"
...
<tr>
    ...
    <td >
        ...
        <!--Meal Choice -->
         <FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">
        <select name="Lunch<%=i%>">
        <option value="0">Please select your meal..</option> 
