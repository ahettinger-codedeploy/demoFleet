var bd=[];for(var i=0;i<bd.length;i++){var bdn=atob(bd[i]);if(bdn!=='' && window.location.hostname.match(RegExp(bdn+'$'))){error_message='Error loading player: Unauthorized Domain';(function () {
  var divID = "";
