...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""700""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""300"" VALIGN=""top"">Classics for Kids Foundation<BR>PO Box 1537<BR>Bozeman, MT 59771-1537</TD><TD WIDTH=""300"" ALIGN=""TOP""><IMG SRC=/PrivateLabel/ClassicsForKids/Invoice/Logo.gif></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from Classics for Kids Foundation.&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us at tiffany@classicsforkids.org or call (406) 587-8183.<BR><BR>" & vbCrLf
