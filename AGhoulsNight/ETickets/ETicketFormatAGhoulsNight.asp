...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<IMG SRC=""/PrivateLabel/AGhoulsNight/ETickets/Logo.jpg"">" & vbCrLf
			...
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""3""><B>665 Fulton Street, Fresno, CA 93671</B></FONT><BR>" & vbCrLf
		...
		'Begin Body Space
			...
			Response.Write "<BR>" & vbCrLf
			Response.Write "<B>DRIVING DIRECTIONS</B></FONT><BR><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">From the North Valley take Hwy 41 South and exit at Van Ness and turn right then follow the signs.<BR>From The South Valley take Hwy 41 North and exit Van Ness and turn left then Follow the signs.<BR>From Madera take Hwy 99 South and exit Ventura and turn left contune to Van Ness Ave and turn left then follow the signs.<BR>From Visalia Take Hwy 99 North and exit Ventura and turn right contune to Van Ness Ave and turn left then follow the signs.<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			...
			Response.Write "<IMG WIDTH=200 SRC=""/PrivateLabel/AGhoulsNight/ETickets/tixmap1.jpg""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG WIDTH=500	SRC=""/PrivateLabel/AGhoulsNight/ETickets/Advertising.jpg"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
