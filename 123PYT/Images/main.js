...
KLAUS.mobileMenu = function(){
	...
	$('#menu-nav-mobile li:has(">ul") > a > i').click(function(){
...
// =========== Calendar ============ //
$(document).ready(function() { 
	$( '<i class="fa fa-chevron-left"></i>' ).insertBefore( '.my-calendar-prev a' );
	$( '<i class="fa fa-chevron-right"></i>' ).insertAfter( '.my-calendar-next a' );
}); 
...
$('.gallery-thumb').each(function() {
	...
	$(this).prepend('<div class="album-title">' + $(this).find('a:first-child').attr('title') + '</div>');
});
});