...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<B>From Exit 87</B> - Turn Right at Walgreens - Go Past McDonalds - Up Hill - Turn RIGHT into GHOST OUTPOST.  We SHARE the parking lot with them.<BR><BR><b>From Exit 89</b> - Turn Left at Danny's Diner / Lake Delton Fire Dept.  Go approximately 2 miles.  Just after Top Secret (Upside Down White House) Turn Left into DEER PARK.  We SHARE the parking lost with them.<BR><BR><B>From Exit 92</b> - Turn Right at Danny'y Diner / Lake Delton Fire Dept. Go approximately 2 miles.  Just after Top Secret (Upside Down White House) Turn Left into DEER PARK.  We SHARE the parking lost with them.<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""/Images/ETicketTixLogo.gif"" HEIGHT=""100"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
