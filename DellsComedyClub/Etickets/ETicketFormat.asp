...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<B>From Exit 87</B>– Go thru First Stop Light There will be a Mobil Gas Station On The Corner – after a large Open Area of Undeveloped Land you will see a SIGN FOR DELLS BEACH CLUB – Turn in there and register in the Hurricanes Buffet. <BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">" & vbCrLf
			Response.Write "10% off the Next Morning’s Hurricanes Breakfast Buffet – with over 40 items on the buffet including a custom omelet bar, bacon, sausage, ham, French toast, waffles, pancakes, biscuits and gravy, scrambled eggs, hash browns, fresh fruit, salad bar and so much more.<br><Br>Each Saturday Night we have entertainment in the Thirsty Pelican Bar (Live band or DJ) and/or Bikini Beach Beer Garden with a Live Band or DJ and enjoy dancing in our 10 ft Foam Bubble Party (Weather Permitting).  By purchasing the show you have free admission to either bar.  You must be 21+ to stay for the Bar Entertainment." & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
