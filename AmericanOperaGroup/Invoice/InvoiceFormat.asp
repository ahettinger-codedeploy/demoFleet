...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><TABLE WIDTH=700><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top""><BR>American Opera Group<BR>122 Austin Blvd.<BR>#2<BR>Oak Park, IL 60302</TD><TD WIDTH=300><IMG SRC=""/PrivateLabel/AmericanOperaGroup/Invoice/AOGLOGO.jpg"" WIDTH=300></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from the American Opera Group and www.tix.com.&nbsp;&nbsp;The details of your order are listed below.&nbsp;&nbsp;For questions regarding this order, contact our ticket staff via e-mail at info@americanoperagroup.org or by calling (708) 434-0485.<BR><BR>" & vbCrLf
