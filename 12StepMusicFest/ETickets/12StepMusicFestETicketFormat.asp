...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			If rsTix("SeatTypeCode")="2436" Then
				Response.Write "Entry begins Thursday November 6, 2008 at 12pm." & vbCrLf
			Elseif rsTix("SeatTypeCode")="2437" Then
				Response.Write "Entry begins Friday November 7, 2008 at 9am." & vbCrLf
			Elseif rsTix("SeatTypeCode")="2434" Then
				Response.Write "Entry begins Thursday November 6, 2008 at 12pm." & vbCrLf
			Elseif rsTix("SeatTypeCode")="2435" Then
				Response.Write "Entry begins Friday November 7, 2008 at 9am." & vbCrLf
			End If
			...
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""2""><B>Section: " & rsTix("Section") & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Row: " & rsTix("Row") & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Seat: " & rsTix("Seat") & "</B></FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
