$(document).ready(function(){
  ...
  $('.overlay-button').click(function(){
	...
	var loader = '<div id="loader-overlay" class="ui-front loader ui-widget-overlay ' + loadertheme + ' opacity-' + loaderopacity + '"><img src="/Images/spinner/loader-' + loaderstyle + '.gif" alt="" /></div>';
	...
	$('.refresh-button').click(function(ev){
		...
		var loader = '<div id="refresh-overlay" class="ui-front loader ui-widget-overlay ' + loaderTheme + ' opacity-' + loaderOpacity + '"><img src="/Images/spinner/loader-' + loaderStyle + '.gif" alt="" /></div>';
