...
'SSR 7/21/16 - Changed wording from 'renewal link' to 'renewal button'
'SSR 7/21/16 - Added footer
'SSR 7/22/16 - Added HR to footer
...
RenewalLetter = RenewalLetter & "Simply click on the Season Ticket Renewal button and enter your Order Number and Renewal Code from the attached invoice " & vbCrLf 
RenewalLetter = RenewalLetter & "</p> " & vbCrLf 
RenewalLetter = RenewalLetter & "</td> " & vbCrLf 
...
RenewalLetter = RenewalLetter & "</tr> " & vbCrLf 
RenewalLetter = RenewalLetter & "<tr> " & vbCrLf 
RenewalLetter = RenewalLetter & "<td  style=""border-bottom: 2px solid #999999;""> " & vbCrLf
RenewalLetter = RenewalLetter & "<p> " & vbCrLf 
...
RenewalLetter = RenewalLetter & "<p style=""font-size:8pt; color#999999;"">  " & vbCrLf
RenewalLetter = RenewalLetter & "801.298.1302 (p) | 801.298.4784 (f) | CenterPointTheatre.org<BR> " & vbCrLf
RenewalLetter = RenewalLetter & "PO Box 62, 525 North 400 West Centerville, UT 84014 " & vbCrLf
RenewalLetter = RenewalLetter & "</p> " & vbCrLf
RenewalLetter = RenewalLetter & "</td> " & vbCrLf
RenewalLetter = RenewalLetter & "</tr> " & vbCrLf
RenewalLetter = RenewalLetter & "</tbody> " & vbCrLf 
