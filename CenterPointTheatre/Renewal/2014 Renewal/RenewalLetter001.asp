...
SendTo = "CenterPoint Legacy Theatre<br />PO Box 62<br />Centerville, UT 84014<br /><i>Phone Number: (801) 298-1302<br />Fax Number: (801) 298-4784</i>"
...
<STYLE>
    ...
    .signature
    {
        font-family: Comic Sans MS, Cambria, Arial, Helvetica;
    }
</STYLE>
...
Do Until rsOrderLine.EOF
	...
	If rsOrderLine("OrderNumber") <> LastOrderNumber Then 'It's different.  Print it.
		...
		If Not rsCustInfo.EOF Then
            ...
            Response.Write "<table width=750><tr><td align=""center"" colspan=""2""><img src=" & LogoImage & " width=""350""><br /><b>PO Box 62, Centerville, UT  84014 - www.CenterPointTheatre.org</b><br /></td></tr></table><br />" & vbCrLf
			...
			Response.Write "<TR><TD><B>Order Number:&nbsp;" & rsOrderLine("OrderNumber") & "<BR>Renewal Code:&nbsp;" & RenewalCode & "</B></TD></TR>" & vbCrLf
...
Response.Write "<TABLE WIDTH=""750""><TR><TD ALIGN=""center"">SEND TO:<BR>" & SendTo & "</TD></TR></TABLE>" & vbCrLf
