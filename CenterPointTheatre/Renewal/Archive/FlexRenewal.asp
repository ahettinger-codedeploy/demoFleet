<%
'CHANGE LOG
'SLM 7/14/15 -  Renewals for Centerpoint Legacy Theatre 2015 Flex Passes.  
'SLM 7/13/16 -  Renewals for Centerpoint Legacy Theatre 2016 Flex Passes.  
%>
...
RenewDescription = Left("CTRPOINT2017FLEX", 15)
...
Dim EventArray(2, 1)
EventArray(0,0) = 776489
EventArray(0,1) = 891315

EventArray(1,0) = 845571
EventArray(1,1) = 891315

EventArray(2,0) = 852211
EventArray(2,1) = 891315
...
Case 64137 'Individual
	LookupNewSeatTypeCode = 64134 'Adult
Case Else
