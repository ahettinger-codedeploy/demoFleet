...
SendTo = "<table border=""0"" cellpadding=""0"" cellspacing=""5"" WIDTH=""100%""  bgcolor=""#eeeeee""> <tr> <td colspan=""3"" align=""center""><B>SEASON TICKETS.</B>Guaranteed Same Seating for Every Show!</td> </tr> <tr> <td>&nbsp;</td> </tr> <tr> <td></td> <td><B>Tu/We/Mat</B></td> <td><B>Mo/Th/Fr/Sa</B></td> </tr> <tr> <td>Main Level Adult</td> <td>$106.00</td> <td>$118.00</td> </tr> <tr> <td>Main Level Senior/Student</td> <td>$99.00</td> <td>$110.00</td> </tr> <tr> <td>Balcony Level Adult</td> <td>$81.00</td> <td>$93.00</td> </tr> <tr> <td>Balcony Level Senior/Student</td> <td>$75.00</td> <td>$86.00</td> </tr> </table>"
...
<FONT FACE="verdana,arial,helvetica" COLOR="#008400"><H3>Fixed Subscription</H3></FONT>
...
If EventList <> "" Then
	...
	If Not rsTickets.EOF Then 'There are some events.  List them
		Response.Write "<FORM ACTION=""RenewalLetter_Fixed.asp"" METHOD=""post""><INPUT TYPE=""hidden"" NAME=""FormName"" VALUE=""PrintMenu"">" & vbCrLf
...
<STYLE>
    ...
    .signature
    {
        font-family: Mistral, Cambria, Arial, Helvetica;
        font-size: 26px;
    }
</STYLE>
<STYLE>
...
Do Until rsOrderLine.EOF
	...
	If rsOrderLine("OrderNumber") <> LastOrderNumber Then 'It's different.  Print it.
		...
		If Not rsCustInfo.EOF Then
            ...
            %>
            <!--#INCLUDE FILE="RenewalLetterInclude_Fixed.asp"-->
            <%		
