...
RenewalLetter = RenewalLetter & "<td valign=""top"" align=""center""><span style=""font-size:20px;"">You must complete<BR>your renewal by<BR><span style=""color:red;"">September 5th, 2015.</span></span></td>"
...
RenewalLetter = RenewalLetter & "<table width=""750""><tr><td>" & vbCrLf & vbCrLf

RenewalLetter = RenewalLetter & "Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ",<br><br>" & vbCrLf
RenewalLetter = RenewalLetter & "<p>We hope you are as excited for our 2016 season as we are! Much thought and deliberation was taken in selecting these wonderful shows and we can’t wait for you to revisit some classics and experience some new favorites this coming year!</p>" & vbCrLf
...
RenewalLetter = RenewalLetter & "<td width=""10%"" align=""center"" valign=""middle"">Or</td>" & vbCrLf
...
RenewalLetter = RenewalLetter & "<p> If you would like to change your 2016 subscription to a Traditional Subscription, please contact the box office to complete your renewal. </p>" & vbCrLf
RenewalLetter = RenewalLetter & "<p> Please address all other renewal questions to the box office staff.</p>" & vbCrLf
RenewalLetter = RenewalLetter & "<p>Thank you for your past support of CenterPoint Legacy Theatre as a Season Subscriber. We look forward to having you join us again for our 2016 Season!<BR>" & vbCrLf
...
RenewalLetter = RenewalLetter & "</p>" & vbCrLf
RenewalLetter = RenewalLetter & "<p>" & vbCrLf
RenewalLetter = RenewalLetter & "*<b>Exchanges: After you have renewed your current subscription, you will have an opportunity to make adjustments, add subscriptions or exchange to Traditional Season Subscriptions starting September 14th." & vbCrLf
RenewalLetter = RenewalLetter & "</p>" & vbCrLf
