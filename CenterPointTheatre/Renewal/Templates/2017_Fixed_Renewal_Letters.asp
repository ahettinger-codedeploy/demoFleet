...
RenewalLetter = RenewalLetter & "<BR> " & vbCrLf 
RenewalLetter = RenewalLetter & "[$FIRSTNAME$] [$LASTNAME$]<BR> " & vbCrLf 
RenewalLetter = RenewalLetter & "[$SHIPADDRESS$]<BR> " & vbCrLf 
RenewalLetter = RenewalLetter & "</td> " & vbCrLf 
...
RenewalLetter = RenewalLetter & "<BR> " & vbCrLf 
RenewalLetter = RenewalLetter & "<p> " & vbCrLf 
RenewalLetter = RenewalLetter & "Dear [FirstName], " & vbCrLf 
RenewalLetter = RenewalLetter & "</p> " & vbCrLf 
RenewalLetter = RenewalLetter & "<p> " & vbCrLf 
...
RenewalLetter = RenewalLetter & "</tr> " & vbCrLf 
RenewalLetter = RenewalLetter & "</table> " & vbCrLf 
RenewalLetter = RenewalLetter & " " & vbCrLf 
RenewalLetter = RenewalLetter & "</td> " & vbCrLf 
RenewalLetter = RenewalLetter & "</tr> " & vbCrLf 
RenewalLetter = RenewalLetter & "<tr> " & vbCrLf 
RenewalLetter = RenewalLetter & "<td> " & vbCrLf 
...
RenewalLetter = RenewalLetter & "</p> " & vbCrLf 
RenewalLetter = RenewalLetter & "<p style=""font-size:12px;""> " & vbCrLf 
