...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "Music & Art Venue:<BR>" & vbCrLf
			Response.Write "High School of Music & Art<BR>" & vbCrLf
			Response.Write "135th Street and Convent Ave<BR><BR>" & vbCrLf
			Response.Write "LaGuardia Venue:<BR>" & vbCrLf
			Response.Write "LaGuardia High School<BR>" & vbCrLf
			Response.Write "65th Street & Amsterdam Ave.<BR>" & vbCrLf
