...
invoicecomments = "Thank you for purchasing tickets to the Kent/Blossom Music Festival. Please review your order details listed below. If you have questions, please do not hesitate to contact 330-672-2613. All concerts are located in Ludwig Recital Hall at 7:30 PM in the Music and Speech Center (1325 Theatre Drive - Kent, Ohio 44240) at Kent State University.<BR><BR>We thank you for your patronage and look forward to seeing you this summer!"

invoicefooter = "All sales are final, there are no refunds or exchanges."
...
<%
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>" & InvoiceComments & "<BR><BR>" & InvoiceFooter & "<BR><BR>" & vbCrLf  
