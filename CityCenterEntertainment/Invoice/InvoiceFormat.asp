...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><TABLE WIDTH=700><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""300"" VALIGN=""top""><BR>Refuge Golf & Country Club<BR>P O Box 2460<BR>Lake Havasu City, AZ 86405-2460<BR><BR><BR><BR></TD><TD VALIGN=""TOP"" WIDTH=""400""><IMG SRC=/PrivateLabel/CityCenterEntertainment/Invoice/CCELogo.jpg width=300></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from City Center Entertainment.&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us at caldridge@frontiernet.net or call (928) 764-1404.<BR><BR>" & vbCrLf
