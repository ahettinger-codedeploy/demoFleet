...
//alert('adWidth = '+width+ '\n Height = '+height);
   ...
   win.document.writeln('<embed src="'+src+'" loop="'+loop+'" play="'+play+'" width="'+width+'" height="'+height+'" type="application/x-shockwave-flash" pluginspage="https://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" />'); 
...
function viewChat(instance_id, url)
{
   ...
   win.document.writeln('<body>');
   win.document.writeln('<applet archive="multichat.jar" CODE="GUIClient.class" width="562" height="385" align="BOTTOM">');
