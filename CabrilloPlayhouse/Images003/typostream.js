...
var Typostream = {
	...
	replaceElement: function(el, q, hoverQ)
	{
		...
		img.alt = q.text;
		img.src = "http://beta.typostream.com/account/" + Typostream.account + "/" + hex_md5(qJSON) + ".png?q=" + escape(qJSON);
		...
		if(hoverQ)
		{
			...
			hoverImg.alt = q.text;
			hoverImg.src = 'http://beta.typostream.com/account/' + Typostream.account + '/' + hex_md5(hoverQJSON) + '.png?q=' + escape(hoverQJSON);
