		...
		If Request("GroupCount") = "Y" Then
		    If ShipToName <> rsSeat("ShipFirstName") & " " & rsSeat("ShipLastName") Or OrderNo <> rsSeat("OrderNumber") Or _
		       ...
		       Status <> rsSeat("Status") Or SeatType <> rsSeat("SeatType") Or Price <> rsSeat("Price") - rsSeat("Discount") Then 
		        ...
		        Response.Write "<TR BGCOLOR=#EEEEEE ONMOUSEOVER=""bgOn(this,'#e1f0dc');"" ONMOUSEOUT=""bgOn(this,this.className);""><TD NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Section") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Row") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Seat") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("OrderNumber") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("OrderDate") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("ShipFirstName") & " " & rsSeat("ShipLastName") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Status") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("SeatType") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & FormatCurrency(rsSeat("Price")-rsSeat("Discount"),2)  & "</FONT></TD>" & SurveyDetail & OrderNotes & DayPhoneNumber & "<TD NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("ShipType") & "</FONT></TD>"
		    End If
		Else
		    Response.Write "<TR BGCOLOR=#EEEEEE ONMOUSEOVER=""bgOn(this,'#e1f0dc');"" ONMOUSEOUT=""bgOn(this,this.className);""><TD NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Section") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Row") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Seat") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("OrderNumber") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("OrderDate") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("ShipFirstName") & " " & rsSeat("ShipLastName") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("Status") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("SeatType") & "</FONT></TD><TD ALIGN=center NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & FormatCurrency(rsSeat("Price")-rsSeat("Discount"),2)  & "</FONT></TD>" & SurveyDetail & OrderNotes & DayPhoneNumber & "<TD NOWRAP><FONT FACE=verdana,arial,helvetica SIZE=2>" & rsSeat("ShipType") & "</FONT></TD></TR>" & vbCrLf
		End If
