...
Response.Write "</TR><TR><TD></TD><TD></TD><TD></TD><TD></TD></TR>" & vbCrLf

Response.Write "</TABLE>" & vbCrLf
Response.Write "<BR><BR>" & vbCrLf

%>
<INPUT TYPE="hidden" NAME="FormName" VALUE="EmailRequest"><INPUT TYPE="submit" STYLE="width: 11em" VALUE="Send Email" id=submit1 name=submit1><TD ALIGN="center" VALIGN="middle"></FORM>
<% 
	
If OrganizationNumber = 1 Then 
%>
<FORM ACTION="SubOrgReport.asp" METHOD="post"><INPUT TYPE="hidden" NAME="FormName" VALUE="New_Organization"><INPUT TYPE="hidden" NAME="OrganizationNumber" VALUE="NEW"><INPUT TYPE="submit" STYLE="width: 11em" VALUE="Create Sub-Organization" ID=submit2 NAME=submit2></FORM>
<% 
End If
