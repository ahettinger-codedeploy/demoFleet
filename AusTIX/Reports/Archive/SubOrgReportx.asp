...
SQLUserOrg = "SELECT Organization.Organization, Organization.OrganizationNumber FROM Organization (NOLOCK) INNER JOIN Users (NOLOCK) ON Users.OrganizationNumber = Organization.OrganizationNumber WHERE UserNumber = " & Session("UserNumber")&" "
Set rsUserOrg = OBJdbConnection.Execute(SQLUserOrg)	

ParentOrgName = rsUserOrg("Organization")
ParentOrgNumber = rsUserOrg("OrganizationNumber")
...
<BR>
<FONT FACE="verdana, arial, helvetica" COLOR="#008400" SIZE="2"><H3><%=ParentOrgName%></H3></FONT>
...
<TABLE>
  <tr>
    <td align="right"><font size="2">Name:</font></td><td>"<%=ParentOrgName%>"</td>
    <td align="right"><font size="2">Number:</font></td><td>"<%=ParentOrgNumber%>"</td>
  </tr>
  <tr>
...
<BR>
<fieldset style="width:650px">
<legend style="color:#000;font-size:13px;font-weight:bold">SUB ORGANIZATION</legend>
<TABLE CELLSPACING="0">
  <tr>
  ...
  <tr>
    <td align="right"><font size="2">User Password:</font></td>
