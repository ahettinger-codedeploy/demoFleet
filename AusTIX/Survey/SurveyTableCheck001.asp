...
'SurveyJazzCafe. Requires that all seats at a booth be purchased.
...
Do Until rsOrderSeats.EOF
	...
	If OrderSeatCount / Quantity) < SectionSeatCount / Quantity) Then 'Apply the discount to this item
...
<%
If Session("UserNumber") = "" Then
	Response.Write "<TABLE><TR><TD align=center><FONT FACE=""" & FontFace & """ COLOR=""" & FontColor & """ SIZE=2>Partial booths cannot be purchased.  You've selected " & OrderSeatCount & " out of " & SectionSeatCount & ".<BR><BR>You must select all seats at this booth or remove <BR>all the booth seats from your shopping cart and select a table.<BR><BR><CENTER><FORM ACTION=""ShoppingCart.asp"" METHOD=""POST"" id=form1 name=form1><INPUT TYPE=""submit"" VALUE=""Back to Shopping"" id=1 name=1></FORM></CENTER></TD></TR></TABLE></CENTER><BR><BR>" & vbCrLf
Else
	Response.Write "<CENTER><TABLE><TR><TD align=center><FONT FACE=""" & FontFace & """ COLOR=""" & FontColor & """ SIZE=2>Partial booths cannot be purchased.  You've selected " & OrderSeatCount & " out of " & SectionSeatCount & ".<BR><BR>You must select all seats at this booth or remove all the booth seats from your shopping cart and select a table.<BR><BR><CENTER><FORM ACTION=""/Management/ShoppingCart.asp"" METHOD=""POST"" id=form1 name=form1><INPUT TYPE=""submit"" VALUE=""Back to Shopping"" id=1 name=1></FORM></CENTER></TD></TR></TABLE></CENTER><BR><BR>" & vbCrLf
End If
