...
$(document).ready(function ()
{
	...
	$("input#q").live("keyup", function (e)
	{
		...
		$(".searchbox_anchor.google").attr("href", rootPath + "gcsearch.aspx?q=" + encodeURIComponent(qe));
		$(".searchbox_anchor.isys").attr("href", rootPath + "search.aspx?request=" + encodeURIComponent(qe) + "&maxFiles=" + $("input#hdnMaxFiles").val());
		$(".searchbox_anchor.searchblox").attr("href", rootPath + "sbsearch.aspx?query=" + encodeURIComponent(qe) + "&pagesize=" + $("input#hdnMaxFiles").val());
	});
    ...
    $(".depthome_right").appendTo(".content_wrapper");
    $(".blog_right").appendTo(".content_wrapper");
    $(".banner_holder").prependTo(".content_wrapper");
