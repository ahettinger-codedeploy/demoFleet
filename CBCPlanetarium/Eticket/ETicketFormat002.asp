...
'SLM 2/12/13 - JOIN Ticket to OrderLine on both ItemNumber and OrderNumber to correct issues.
%>
...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<TABLE WIDTH=""615"" HEIGHT=""240"" BORDER=""1"" BGCOLOR=""#FFFFFF"" CELLPADDING=""0"" CELLSPACING=""0"">" & vbCrLf
			Response.Write "<TR>" & vbCrLf
			...
			Response.Write "<IMG SRC=""/Clients/CBCPlanetarium/ETicket/Images/Logo-2.jpg"">" & vbCrLf
			...
			Response.Write "<IMG SRC=""/clients/CBCPlanetarium/ETicket/Images/Tix-Bar.jpg"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
		...
		'Begin Body Space
			...
			Response.Write "<B>DIRECTIONS</b>Heading west on I-182, take exit 12B for N. 20th Ave. Turn right onto N. 20th Ave. Turn left onto campus at the light at Sun Willows Blvd.<BR><BR>Heading east on I-182, take exit 12B for N. 20th Ave. Columbia Basin College. Turn left onto N. 20th Ave. Turn left onto campus at the light at Sun Willows Blvd.<BR><BR>Heading north on US-395, take the exit for I-182/US-12/US-395/Spokane/Walla Walla. Take exit 12B for N. 20th Ave. Columbia Basin College. Turn left onto N. 20th Ave. Turn left onto campus at the light at Sun Willows Blvd." & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			...
			Response.Write "<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "<IMG SRC=""/clients/CBCPlanetarium/ETicket/Images/map.jpg"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
			...
			Response.Write "Do not copy this ticket; multiple copies invalid. It may not be possible to seat late arriving patrons. Ticket holder assumes all risks related to attending this event, including the risk of lost, stolen, or damaged property or personal injury. Management reserves the right to refuse admission or eject any person who fails to comply with terms and conditions and/or rules for the event for which this ticket is issued." & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""/Clients/CBCPlanetarium/ETicket/Images/Bottom-logo.jpg"" HEIGHT=""200"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
