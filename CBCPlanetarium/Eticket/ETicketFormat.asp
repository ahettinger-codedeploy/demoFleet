...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<B>DIRECTIONS</b><BR>From Richland/I-182E: <BR>Take exit 12B for N. 20th Ave. and turn left. Turn left onto Argent Rd., and left onto Farm Rd. The planetarium will be on your left.<BR><BR>From Kennewick/395N: <BR>Stay left at the fork and take the Argent Rd. exit. Turn right on Argent Rd., and right onto Farm Rd. The planetarium will be on your left.<BR><BR>From 395S/I-182W:<BR> Take exit 12B for N. 20th Ave., and turn right. Turn left onto Argent Rd., and left onto Farm Rd. The planetarium will be on your left." & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			...
			Response.Write "<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "<IMG SRC=""http://i.imgur.com/j4qFCxV.png"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
