...
<script runat="server">
    'CHANGE LOG
	'SLM 10/18/2016 - Allow purchase of Magic Pass event if customer has previously purchased ticket to the globetrotters or has a globetrotters ticket on their current order
    ...
    Public Sub LoadStep() Implements IWizardStep.LoadStep
        ...
        Dim RequiredEvent As Integer = 907477
        Dim CheckEvents As String = "907545"
...
<asp:Panel ID="pnlWarning" runat="server" Visible="false">
    <asp:Label ID="lblWarning" runat="server" Text="You cannot purchase Magic Pass tickets without purchasing a ticket to The Harlem Globetrotters. Please click on the 'Back To Shopping' button to purchase the required ticket." Font-Bold="true" Font-Size="Small" /><br /><br />
