...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""5""><B>" & UCASE(rsTix("Act")) & "</B></FONT><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""3"">" & rsTix("Venue") & "<BR>" & vbCrLf
		...
		'Begin Body Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">From the North:<BR>" & vbCrLf
			Response.Write "Take Exit 82 South off I-40 onto Highland Ave. and proceed south over 4 miles, through Downtown. Go left on Auditorium Dr., then right into the Civic Center.<BR><BR>" & vbCrLf
		  Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">From the South:<BR>" & vbCrLf
		  Response.Write "Take U.S. Highway 45 (Highland Ave.) North.  As you approach Downtown, take Auditorium Dr. on the right and then rght into the Civic Center.<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			...
			Response.Write "<IMG SRC=""/PrivateLabel/CityofJackson/Images/CivicCtrSite200.jpg""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
...
%>
			...
			<CENTER>
			<B>JACKSON CENTRE</B><BR>
			<b>UPCOMING EVENTS</b><BR><BR>
			<TABLE WIDTH=100%>
				<TR>
					<TD WIDTH=50%><FONT FACE="Verdana,Arial,Helvetica" SIZE=1>
						<b><span style='color:red'>Matt Cordell, ElvisVegas Style Show<Span></b><BR>
						<b>Saturday, June 25<sup>th</sup>, 8 pm</b><BR>
						<B>Ned McWherter Center</b><BR><BR>
						<b>Children’s and Teen Theatre Presents</b><BR>
						<B><span style='color:red'>"ANNIE"</Span></b><BR>
						<B>Thursday, June 30<sup>th</sup>,7:30 pm</b><BR>
						<b>Friday, July 1<sup>st</sup>,7:30 pm</b><BR>
						<b>Saturday, July 2<sup>nd</sup>,7:30 pm</b><BR>
						<b>Ned McWherter Center</b><BR></FONT>
					</TD>
					<TD WIDTH=50%><FONT FACE="Verdana,Arial,Helvetica" SIZE=1>
						<b>Children’s Theatre Presents</b><BR>
						<B><span style='color:red'>"I BELIEVE IN MAKE BELIEVE"</Span></b><BR>
						<B>Thursday, July 28<sup>th</sup>,7:00 pm</b><BR>
						<b>Friday, July 29<sup>th</sup>,7:00 pm</b><BR>
						<b>Ned McWherter Center</b><BR></FONT>
					</TD>
				</TR>
			</TABLE>
