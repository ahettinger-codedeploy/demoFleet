...
OrganizationNumber = 248 'Organization Number
StreetAddress = "400 South Highland" 'Street Address. If this is a 2 line street address use <BR> between the two lines
CityStateZip = "Jackson, TN 38301" 'City State Zip Code
...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">" & OrgName & "<BR>" & StreetAddress & "<BR>" & CityStateZip & "</TD><TD WIDTH=""300""><IMG SRC=""/PrivateLabel/CityofJackson/Invoice/City logo.bmp"" WIDTH=110></TD></TR></TABLE>"
