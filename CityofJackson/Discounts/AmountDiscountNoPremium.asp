...
'JAI 5/9/6 - Added Check for allowed Section
AllowedSectionOK = "Y"
...
If OrderTypeFlag = "Y" And AllowedSeatTypeFlag = "Y" And MaxDiscountsPerOrderPerEventOK = "Y" And MaxDiscountsPerOrderOK = "Y" And MaxDiscountSystemUsageOK = "Y" And AllowedSectionOK = "Y" Then 'It's okay to apply to this order type and seat type.
