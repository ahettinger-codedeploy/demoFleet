...
Question(1) = "How did you hear about the Smash? (check all that apply)"
...
<TABLE WIDTH="70%">
  ...
  <TR>
		<TD>
			...
			<INPUT TYPE="checkbox" NAME="Answer1" VALUE="Direct Mail">&nbsp;Direct Mail<BR>
			<INPUT TYPE="checkbox" NAME="Answer1" VALUE="Ad in publication">&nbsp;Ad in publication<BR>
			</FONT><BR>
    </TD>
  </TR>
  </TABLE>
