    ...
    build: function (options) {
        return this.each(function () {
            ...
            jQuery(document).bind('mousemove', function (e) {
                ...
                var posy = Math.pow(pointer.y - getyscroll() - el.fisheyeCfg.pos.y - el.offsetHeight / 2, 2);
                //console.log('pointer = ' + pointer.y.toString() + ', config = ' + el.fisheyeCfg.pos.y.toString() + ', offset = ' + el.offsetHeight.toString() + ', scroll = ' + getyscroll().toString());
