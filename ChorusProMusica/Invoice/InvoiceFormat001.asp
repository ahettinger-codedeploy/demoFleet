...
OrganizationNumber = 481 'Organization Number
StreetAddress = "645 Boylston Street" 'Street Address. If this is a 2 line street address use <BR> between the two lines
CityStateZip = "Boston, MA 02116" 'City State Zip Code
ClientDirectory = "ChorusProMusica" 'Name of Client Directory where Invoice/InvoiceFormat.asp is located
PhoneNumber = "(617) 267-7442" 'Customer Service Phone Number. If org doesn't have a number, use PhoneNumber = ""
