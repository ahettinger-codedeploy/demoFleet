...
ErrorLog("MaxDiscountsPerEvent: " & SQLDiscCount)	
...
ErrorLog("MaxDiscountsPerOrderPerEvent: " & SQLDiscCount)	
	Set rsDiscCount = OBJdbConnection.Execute(SQLDiscCount)
	TicketCount = rsDiscCount("LineCount")
	rsDiscCount.Close
	Set rsDiscCount = nothing
...
ErrorLog("MaxDiscountsPerOrder: " & SQLDiscCount)	
	Set rsDiscCount = OBJdbConnection.Execute(SQLDiscCount)
	TicketCount = rsDiscCount("LineCount")
	rsDiscCount.Close
	Set rsDiscCount = nothing
...
ErrorLog("MaxDiscountsSystem: " & SQLDiscCount)	
	Set rsDiscCount = OBJdbConnection.Execute(SQLDiscCount)
	TicketCount = rsDiscCount("LineCount")
	rsDiscCount.Close
	Set rsDiscCount = nothing
...
ErrorLog("MaxOrdersPerDiscount: " & SQLOrderCount)	
