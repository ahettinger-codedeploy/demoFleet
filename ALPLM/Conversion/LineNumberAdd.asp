...
SQLOL = "SELECT ID, OrderID FROM ALPLMOrderLineItems (NOLOCK) WHERE LineNumber IS NULL ORDER BY OrderID"
...
Do Until rsOL.EOF Or OrderCount >= 100000
    ...
    SQLLN = "UPDATE ALPLMOrderLineItems WITH (ROWLOCK) SET LineNumber = " & LineNumber & " WHERE ID = " & ID
