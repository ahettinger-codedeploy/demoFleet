...
Do Until rsEP.EOF
    ...
    If Not rsSeat.EOF Then
        ...
        SQLUpdateSeat = "UPDATE Seat WITH (ROWLOCK) SET StatusCode = 'S', StatusDate = '9/22/9', OrderNumber = " & OrderNumber & " WHERE ItemNumber = " & ItemNumber & " AND EventCode = " & EventCode & " AND StatusCode = 'A'"
