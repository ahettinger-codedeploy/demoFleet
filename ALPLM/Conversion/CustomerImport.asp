...
SQLOldCust = "SELECT * FROM " & CustomerTable & "(NOLOCK) WHERE CustomerNumber IS NULL ORDER BY OldCustomerNumber"
...
'	EMailAddress = NULL
	...
	Else 
		...
		SQLUpdateOldCust = "UPDATE " & CustomerTable & " WITH (ROWLOCK) SET CustomerNumber = " & CustomerNumber & " WHERE OldCustomerNumber = " & OldCustomerNumber
