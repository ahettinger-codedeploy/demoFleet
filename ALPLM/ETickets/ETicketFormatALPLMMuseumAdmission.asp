...
<!--CHANGELOG-->
<!--LSP 2/15/12 - Update Ad to rotate via ACTCode-->
<%
...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			'Switch Text Based on Act Code
			'==================================
			Select Case rsTix("ActCode") 
				Case "75227"
			     Advisory = "Ticket may only be used from 4pm to 7pm. <BR>No refunds or exchanges granted"
		...
		'Switch Text Based on Act Code
			'==================================
					Select Case rsTix("ActCode") 
			    Case "75227"
			        AdSpaceImage = "/clients/ALPLM/Etickets/Images/RushHourWednesday.gif"
			    
				Case Else 'Default Advertisting Image
				    AdSpaceImage = "/clients/ALPLM/ETickets/ALPLMeTicketLogo.jpg"	
	        End Select		
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC = " & AdSpaceImage & " "" WIDTH=""200"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
