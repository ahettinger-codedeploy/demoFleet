	...
	If Not rsTix.EOF Then
		...
		'Directions
			Select Case rsTix("EventCode") 
				Case "558151"
			        Directions = "<B>From Route I-55 North or South:</B><BR>To Capitol:   From Clear Lake Avenue Exit, #98 B: Proceed West on Clear Lake. Clear Lake will turn into Jefferson Street (one way West). Proceed West on Jefferson Street to 2nd Street. Turn left on 2nd Street (heading South), go four blocks to the State Capitol Building. <BR><BR>To Street Parking: Continue South on 2nd Street to Edwards Street. Turn right on Edwards Street to College Street. Turn right on College Street and follow to Monroe. Monroe is one way East. "
