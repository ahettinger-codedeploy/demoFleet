...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">From Route I-55 North or South:<BR>" & vbCrLf
			Response.Write "From Springfield's Clear Lake Avenue Exit, #98 B: Proceed West on Clear Lake. Clear Lake will turn into Jefferson Street (one way West).<BR><BR>The Abraham Lincoln Presidential Library & Museum parking ramp is off 6th Street between Madison and Mason streets. The rate is $.75 cents per 1/2 hour or $1.50 per hour. The RV and bus parking lot is a flat rate of $5.00." & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
