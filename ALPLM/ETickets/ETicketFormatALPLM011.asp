...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
            ...
            Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""4""><B>E-TICKET MUST BE SCANNED AT THE MUSEUM'S INFORMATION DESK.</B></FONT>" & vbCrLf 
		...
		'Begin Body Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">" & vbCrLf
			Response.Write "Guests with wheelchairs may be dropped off at the museum's main entrance"
			Response.Write "<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
