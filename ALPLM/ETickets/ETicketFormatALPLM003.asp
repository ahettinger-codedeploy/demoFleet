...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">From Route 95 North or South:<BR>" & vbCrLf
		...
		Select Case rsTix("Act") 
			    Case "75227"
			        AdSpaceImage = "RushHourWednesday.jpg"
			    
				Case Else 'Default Advertisting Image
				    AdSpaceImage = "ALPLMeTicketLogo.jpg"	
	        End Select		
						
			Response.Write "<IMG SRC = ""/Clients/ALPLM/Images/" & AdSpaceImage & " "" WIDTH=""500"">" & vbCrLf
			Response.Write "<TABLE WIDTH=""620"" BORDER=""0"" CELLPADDING=""0"" CELLSPACING=""0"">" & vbCrLf
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
