...
AnswerField(1,10) = "Other, please specify:"
   ...
   <tr>
    ...
    <tr>
        ...
        <td class="data-right" colspan="2" width="50%">
            ...
            <OPTION VALUE="<%= AnswerField(1,10)%>" onChange="showhide('Other');">>&nbsp;<%= AnswerField(1,10)%></OPTION>
            </select>    
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="data-right" colspan="2" width="50%">
		    ...
		    <input type="text" name="Answer2" size="8">   
        </td>
    </tr>
    </div> 
    <tr>
