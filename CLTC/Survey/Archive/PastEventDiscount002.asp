...
'This survey checks to see if there is the purchase of a ticket to one act code in order to determine whether or not a discount can be given on tickets to another act code.
