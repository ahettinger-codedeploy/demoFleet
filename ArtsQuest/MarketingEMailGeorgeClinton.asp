...
EMailText = "The sound of funk is taking over Musikfest 2005!  That’s right- the Grand Master of Funk himself, George Clinton is set to take the Straub Chrysler RiverPlace stage on Saturday, Aug. 13 at 8:30 p.m." & vbCrLf & vbCrLf
EMailText = EMailText & "For limited time only, when you buy one ticket for the George Clinton and Parliament/Funkadelic concert at Musikfest, you will get one FREE!" & vbCrLf & vbCrLf
EMailText = EMailText & "This exclusive offer is valid only for online ticket orders placed using the special promotion code listed below.  Log onto to www.fest.org to place your order today." & vbCrLf & vbCrLf
...
EMailText = EMailText & "Promotion Code: aqgc241" & vbCrLf & vbCrLf
