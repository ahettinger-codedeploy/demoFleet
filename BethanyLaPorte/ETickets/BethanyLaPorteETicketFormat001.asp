...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<BR>" & vbCrLf
			Response.Write "<B>PLEASE NOTE: PARKING LIMITED - PLEASE USE SHUTTLES<BR>SHUTTLE LOCATIONS</B></FONT><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><B></B><BR>" & vbCrLf
			Response.Write "<B>St. Peters Church<BR>1110 Monroe, LaPorte<BR></B>From Hwy2 (Lincolnway) go south on Hwy 4 (Monroe) to church on corner of Monroe and Osborn.<BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">" & vbCrLf
			Response.Write "<B>Bethany Church<BR>102 G Street, LaPorte</B><BR>From Hwy2 (Lincolnway) go south on Hwy 35 (Indiana) to First Street, turn right to the church on corner of First & G Street.<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">" & vbCrLf
			Response.Write "<B>LaPorte High School<BR>602 F Street, LaPorte</B><BR>From Hwy2 (Lincolnway) go east on Sixth Street to school between I and F Street.<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			...
			Response.Write "<IMG WIDTH=200 SRC=""/PrivateLabel/BethanyLaPorte/ETickets/map.jpg""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""/PrivateLabel/BethanyLaPorte/ETickets/adimage.jpg"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
