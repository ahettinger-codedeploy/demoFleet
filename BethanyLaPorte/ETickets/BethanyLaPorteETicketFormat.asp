...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "Hwy 2 (Lincolnway) to Hwy 4 (Monroe Street) to Ridge Street to the Civic Auditorium" & vbCrLf
			Response.Write "<BR><BR>" & vbCrLf
			Response.Write "<B>PLEASE NOTE: PARKING LIMITED - PLEASE USE SHUTTLE LOCATED AT</B></FONT><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1""><B></B><BR>" & vbCrLf
			...
			Response.Write "<IMG WIDTH=200 SRC=""/PrivateLabel/BethanyLaPorte/ETickets/Images/map.gif""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG SRC=""/PrivateLabel/BethanyLaPorte/ETickets/Images/webbanner2_595.jpg"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
