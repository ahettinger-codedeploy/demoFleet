<%
	...
	'SSR 06/17/15 - Updated for use with MemberDiscount.asp script
	'SSR 06/30/15 - Updated survey to bypass the discount if it is a comp order
...
'Verify that Order Number exists.
'Verify that User Number exists
'Verify that Order Type is not Comp
