...
document.open();
document.write('<STYLE TYPE="text/css">#layerbg17540305 {POSITION:absolute; z-index:-1; LEFT:5px; TOP:195px; width:130px; height:270px; }</STYLE>');
...
document.write('<STYLE TYPE="text/css">#DIV17540305 {POSITION:absolute; LEFT:10px; TOP:200px;}</STYLE>');
...
document.write('<tr>');
document.write('<td align=LEFT width="100%" height=20 bgcolor=#000000>');document.write('<a class="MNA17540305" onMouseOver="hideall17540305();" onMouseOut="time17540305();" href="http://www.durangoconcerts.com/tservices.html" target="_self" title="">TICKETS</a></td>');
document.write('</tr>');
document.write('<tr>');
document.write('<td align=LEFT width="100%" height=20 bgcolor=#000000>');document.write('<a class="MNA17540305" onMouseOver="hideall17540305();" onMouseOut="time17540305();" href="http://chronos.fortlewis.edu/wv3b/wv3b_servlet/urd/run/wv_event.MonthList?evfilter=6920,ebdviewmode=grid" target="_blank" title="">CALENDAR</a></td>');
document.write('</tr>');
document.write('<tr>');
