...
function defHdrStyle() {
	...
	dvHdr.style.border='1px solid #000';
	dvHdr.style.padding='3px';
	dvHdr.style.fontSize='11';
	dvHdr.style.color='#FFFFFF';
	dvHdr.style.background='#4A5455';
	dvHdr.style.filter='alpha(opacity=90)'; // IE
	dvHdr.style.opacity='0.90'; // FF
}

function defBdyStyle() {
	dvBdy.style.borderBottom='1px solid #000';
	dvBdy.style.borderLeft='1px solid #000';
	dvBdy.style.borderRight='1px solid #000';
	dvBdy.style.width='200px';
	dvBdy.style.fontFamily='arial';
	dvBdy.style.fontSize='11';
	dvBdy.style.padding='3px';
	dvBdy.style.color='#000000';
	dvBdy.style.background='#9CA09F';
