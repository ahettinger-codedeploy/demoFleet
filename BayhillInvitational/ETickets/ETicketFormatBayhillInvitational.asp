...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<IMG SRC=""/PrivateLabel/BayhillInvitational/ETickets/InvitationalLogo.gif"">" & vbCrLf
			...
			Response.Write "</TD>" & vbCrLf
			Response.Write "<TD VALIGN=""top"">" & vbCrLf
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""2""><I>2007 Arnold Palmer Invitational Presented by MasterCard</I><BR>" & vbCrLf
		...
		'Begin Body Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">From Daytona, Sanford area:<BR>" & vbCrLf
			Response.Write "Take I-4 West to Exit 74A (Sand Lake Rd.); Turn right onto Sand Lake Rd. to Apopka-Vineland Rd; Turn right and follow signs to Gate C for public parking.<BR><BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">From Tampa area:<BR>" & vbCrLf
			Response.Write "Take I-4 East to Exit 74A (Sand Lake Rd.); Turn left onto Sand Lake Rd. to Apopka-Vineland Rd; Turn right and follow signs to Gate C for public parking.<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			...
			Response.Write "<BR>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2"">" & vbCrLf
			Response.Write "<IMG SRC=""/PrivateLabel/BayhillInvitational/ETickets/PGA-logo-big.gif""><BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<IMG WIDTH=500	SRC=""/PrivateLabel/BayhillInvitational/ETickets/ETicketAd.gif"">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
