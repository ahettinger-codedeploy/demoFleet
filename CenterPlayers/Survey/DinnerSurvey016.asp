...
<TABLE WIDTH="400">
<TR><TD ALIGN="right"><INPUT TYPE="radio" NAME="EventCode" VALUE="260545"></TD><TD><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">Fanelli's Italian Grill</FONT></TD><TD ALIGN="right"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">$30.00</FONT></TD></TR>
...
<TR><TD ALIGN="right"><INPUT TYPE="radio" NAME="EventCode" VALUE="222368"></TD><TD><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">Nuova Luna Italian Restaurant</FONT></TD><TD ALIGN="right"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">$30.00</FONT></TD></TR>
...
<TR><TD ALIGN="right"><INPUT TYPE="radio" NAME="EventCode" VALUE="248885"></TD><TD><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">The Taste Restaurant & BBQ</FONT></TD><TD ALIGN="right"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">$30.00</FONT></TD></TR>
</TABLE>
<BR>
<TABLE WIDTH="400">
