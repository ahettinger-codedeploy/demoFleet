...
<TR><TD ALIGN="right"><INPUT TYPE="radio" NAME="EventCode" VALUE="222368"></TD><TD><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">South Street Steak House</FONT></TD><TD ALIGN="right"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">$30.00</FONT></TD></TR>
