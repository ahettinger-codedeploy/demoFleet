...
<TABLE WIDTH="400">
<TR><TD ALIGN="right"><INPUT TYPE="radio" NAME="Event" VALUE="20630"></TD><TD><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">Paci (formerly Portobello)</FONT></TD><TD ALIGN="right"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">$30.00</FONT></TD></TR>
...
<TR><TD ALIGN="right"><INPUT TYPE="radio" NAME="Event" VALUE="55628"></TD><TD><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">Solo Trattoria</FONT></TD><TD ALIGN="right"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">$30.00</FONT></TD></TR>
</TABLE>
<BR>
<BR>
<TABLE WIDTH="400">
