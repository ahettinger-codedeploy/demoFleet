...
'SSR 5/7/2013 - Updated Survey with new price
...
<TR><TD ALIGN="right"><INPUT TYPE="radio" NAME="EventCode" VALUE="572903"></TD><TD><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">Solo Trattoria</FONT></TD><TD ALIGN="right"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">$35.00</FONT></TD></TR>
</TABLE>
<BR>
<TABLE WIDTH="400">
