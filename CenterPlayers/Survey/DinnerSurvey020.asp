...
<TR><TD ALIGN="right"><INPUT TYPE="radio" NAME="EventCode" VALUE="477989"></TD><TD><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">Anima E Cori</FONT></TD><TD ALIGN="right"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">$30.00</FONT></TD></TR>
</TABLE>
<BR>
<TABLE WIDTH="400">
