...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><TABLE WIDTH=750><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top""><BR>J'LaChic Productions, LLC<BR>1511-M Sycamore #275<BR>Hercules, CA 94547<BR></TD><TD WIDTH=300><IMG SRC=/PrivateLabel/DownBroadway/Invoice/logo.jpg height=80><BR><BR><BR></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from J'La Chic Productions.&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us at ltrotman@jlachic.com or call (866) 907-3777.<BR><BR>" & vbCrLf
