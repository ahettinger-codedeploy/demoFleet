...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""3""><I>" & rsTix("Producer") & "</I></FONT><BR><BR>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<TR>" & vbCrLf
			Response.Write "<TD ALIGN=""center"">" & vbCrLf
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""5"">"
			Response.Write "<BR><B>Your Password is:</B><I> Art Sent Me</I><BR><BR>"
