...
;(function($){
	$.fn.superfish = function(op){
		...
		var sf = $.fn.superfish,
			c = sf.c,
			templatepath = $('meta[name=temp_url]').attr('content');
			$arrow = $(['<span class="',c.arrowClass,'"> <img src="' + templatepath + '/clients/charros/images/drop-down-arrow.png" border="0" /></span>'].join('')),
			over = function(){
