...
'CHANGE LOG - Update
'SSR 2/7/2012
'Classic Auto Car Spa
'Updated query to prevent display of parent events which share child events 
'Updated page count query to prevent extra blank page
'Updated query to prevent display of ticket numbers which are not active
...
'===============================================
'| E-Ticket Options - Begin                    |
'===============================================

'Options below can be modified to customize the e-ticket format.

'----------------------

'Option: Logo 
'Default: Set CustomETicketLogo as "" to display TIX default
...
'Option: Ticket Body
'Default: Set CustomETicketBackground as "" to display TIX default
...
'Option: Bottom Bar
'Default: Set CustomETicketBottomBar as "" to display TIX default

CustomETicketBottomBar = "/Clients/ClassicAutoSpa/ETicket/Images/CustomETicketBottomBar.jpg"

'----------------------

'Option: Presents line
'3 possible options: use Producer field, use Organization name, leave blank
...
'Option: Truncate act name
'False = Full Act will display
'True  = Short Act will dispaly

ShowShortAct = False

'----------------------

'Option: Display BarCode on Ticket Body
'False will suppress display

ShowBarCode = False

'----------------------

'Option: Display GA Section Name
'False will display section name on GA events

HideGASection = True
'
'----------------------

'Option: Date Suppress
'If date suppress is turned on for the event, it will be suppressed on E-Ticket
...
'Option: Time Suppress
'If time suppress is turned on for the event, it will be suppressed on E-Ticket
...
'Option: Addtional Ticket Content
'If enabled will pull content from TicketText1
...
'Option: Addtional Ticket Content
'If enabled will pull content from TicketText2
...
'Option: Addtional Ticket Content
'If enabled will pull content from Event Order Confirmation Notes
...
If rsTix("ItemType") = "Seat" Then
			...
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""2""><I>" & ETicketProducer & "</I></FONT><BR>" & vbCrLf
			        ...
			        '---------------------------------------------
                    'Supress GA Section Name Options
                    '----------------------------------------------	

                     ETicketSection = rsTix("Section")

					If HideGASection Then                    
                        If rsTix("Map") = "general" Then
		                    ETicketSection = ""
                        End If
                    End If

                     Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""2""><B>Section: " & ETicketSection & "&nbsp;&nbsp;&nbsp;&nbsp;Row: " & rsTix("Row") & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Seat: " & rsTix("Seat") & "</B></FONT><BR>" & vbCrLf
...
'BarCode 1
 ...
 'Begin Ad Space		   
            ...
            ErrorLog("Ind Page - TotalTix " & TotalTix & " ")
			
			ErrorLog("Ind Page - TixCount " & TixCount & " ")

            ErrorLog("If TixCount < TotalTIX = cut page")
...
ElseIf rsTix("ItemType") = "SubSeat" Then
            ...
            '--------------------
			        ...
			        Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""3""><B>" & rsTix("Venue") & "</B></FONT><br><br>" & vbCrLf
...
'End Order Information
            ...
            ErrorLog("Sub Page - TotalTix " & TotalTix & " ")
			
			ErrorLog("Sub Page - TixCount " & TixCount & " ")
