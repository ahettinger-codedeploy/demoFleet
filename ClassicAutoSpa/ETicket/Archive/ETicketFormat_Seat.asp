...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
        ...
        'Response.Write "border: 1px solid #cccccc;" & vbCrLf
        'Response.Write "padding: 0px;" & vbCrLf
        'Response.Write "opacity: .9;" & vbCrLf
        'Response.Write "}" & vbCrLf	
		'Response.Write "</STYLE>" & vbCrLf
		...
		'Begin Ticket
			...
			Response.Write "<TABLE WIDTH=""615"" HEIGHT=""240"" BORDER=""0"" CELLPADDING=""0"" CELLSPACING=""0"" BACKGROUND=""/Images/ETicketBackground.gif"" BGCOLOR=""#FFD718"" CELLPADDING=""0"" CELLSPACING=""0"">" & vbCrLf
			Response.Write "<TR>" & vbCrLf
...
'-----------------------------------------------------------------------
            ...
            Else
                ETicketPrice = FormatNumber(rsTix("NetPrice"),2)
            End If
			
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""2"">" & rsTix("SeatType") & "  $" & ETicketPrice & "</FONT><BR>" & vbCrLf
			
			
'If general admission seating, only list section name
...
'-------------------------------------------------------------	
		...
		'=================
			...
			Response.Write "</FONT>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""2"">" & vbCrLf
			Response.Write "<B>EXPIRATION DATE</B><BR>" & vbCrLf
						
			
			'Add 1 year to the Order Date
			'For Expiration Date
			'------------------------------------------	
			Response.Write "Voucher expires 1 year from date of purchase"			
			Response.Write "</TD>" & vbCrLf
