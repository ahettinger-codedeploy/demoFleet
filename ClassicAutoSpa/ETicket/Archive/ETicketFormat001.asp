...
'----------------------------
		    ...
		    If rsTix("EventCode") = 420218 OR rsTix("EventCode") = 422313 OR rsTix("EventCode") = 422280 OR rsTix("EventCode") = 422297 OR rsTix("EventCode") = 421953 OR rsTix("EventCode") = 422021 OR rsTix("EventCode") = 421953 OR rsTix("EventCode") = 422289 OR rsTix("EventCode") = 422305 Then
		    ...
		    Select Case CurrentEventCode
		        ...
		        Case 422313    
		            CurrentAct = "Express Details, 2 For The Price Of 1!"
		            CurrentPrice = "$50.00"
		            
		        Case 422280   
		            CurrentAct = "Half Price Basic Wash Pack, 8 Washes For The Price Of 4"
		            CurrentPrice = "$67.80"
		            
		        Case 422297   
		            CurrentAct = "Half Price Classic Wash Pack, 8 Washes For The Price Of 4"
		            CurrentPrice = "$87.80"
		            
		        Case 421953  
		            CurrentAct = "Half Price Exterior Wash Pack, 8 Washes for the Price of 4"
		            CurrentPrice = "$39.80"
		            
		        Case 422021  
		            CurrentAct = "Half Price Full Service Wash Pack, 8 Washes For The Price Of 4"
		            CurrentPrice = "$51.80"
		            
		        Case 422289  
		            CurrentAct = "Half Price Vintage Wash Pack, 8 Washes For The Price Of 4"
		            CurrentPrice = "$75.80"
		            
		       Case 422305 
		            CurrentAct = "Half Price VIP Wash Pack, 8 Washes For The Price Of 4"
		            CurrentPrice = "$111.80"
