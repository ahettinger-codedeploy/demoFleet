...
'----------------------------
		    ...
		    'If rsTix("ItemType") = "SubFixedEvent" Then
...
'---------------------
			...
			Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""2""><I>" & ETicketProducer & "</I></FONT><BR>" & vbCrLf
                  ...
                  '---------------------------	
			        ...
			        Response.Write "<FONT FACE=""Arial,Helvetica"" SIZE=""2"">" & rsTix("SeatType") & "  $" & FormatNumber(CurrentPrice ,2) & "</FONT>" & vbCrLf
