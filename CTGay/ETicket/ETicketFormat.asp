...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Body Space
			...
			Response.Write "<B>On I-95 from points north (New Haven):</b><BR><BR>Take Exit 16. Turn right onto East Avenue. At the Norwalk Town Green, bear to the right (staying on East Avenue) and turn left at the end of the Green onto St. Paul’s Place. Enter the church driveway on the right.<BR><BR><B>On I-95 from points south (NY State and Westchester):</b><br><BR>Take Exit 16. Turn left onto East Avenue. At the Norwalk Town Green, bear to the right (staying on East Avenue) and turn left at the end of the Green onto St. Paul’s Place. Enter the church driveway on the right.<BR><br><B>On the Merritt Parkway from points south (NY State and Westchester):</b><BR><BR>Take Exit 39, Route 7, to I-95 North. Get off at Exit 16. Turn left onto East Avenue. At the Norwalk Town Green, bear to he right (staying on East Avenue) and turn left at the end of the Green onto St. Paul’s Place. Enter the church driveway on the right. " & vbCrLf
		
			Response.Write "</FONT>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			
			'Begin Right Column
			Response.Write "<TD ALIGN=""left"" VALIGN=""top"" WIDTH=""34%"">" & vbCrLf
			Response.Write "<IMG alt=""Barcode Image"" src=""/Barcode.asp?Barcode=" & rsTix("TicketNumber") & """><BR>" & vbCrLf
			Response.Write "<BR>" & vbCrLf
				Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">" & vbCrLf
			Response.Write "<B>On the Merritt Parkway from points north (Hartford/New Haven):</b><BR><BR>Take Exit 40A, Main Avenue, South. The exit ramp curves to the right; at the stop sign, continue to bear right onto Main Avenue, South. Approximately 0.8 miles, Main Avenue becomes Main Street. A Dunkin’ Donuts will be on your right. Continue through the light, bearing slightly to the left onto Main Street and continue approximately 0.8 miles to the intersection with North Avenue / Route 1. Turn left at the traffic light onto Route 1. Follow through two lights and up the hill to East Avenue. (The back of St. Paul’s will be on your right.) Turn right onto East Avenue and then take first right turn onto St. Paul’s Place. Enter the church driveway on the right.<BR>" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""1"">" & vbCrLf
			Response.Write "</FONT>" & vbCrLf
			Response.Write "<BR>" & vbCrLf
		...
		'Begin Ad Space
			...
			Response.Write "<FONT FACE=""Arial, Helvetica"" SIZE=""3"">" & vbCrLf
