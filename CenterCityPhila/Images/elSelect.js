var elSelect = new Class({
	...
	*/
	initialize: function(options){
		...
		//cw - somehow were were losing the custom hidden input field
	...
	onOptionClick : function(e) {
		// do something here to delay any curtain actions for a given amount of time
		flgAllow = false;
		setTimeout("reAllow()", 2000);
