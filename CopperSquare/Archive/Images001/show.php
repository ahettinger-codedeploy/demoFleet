function KMTrackClick()
{
	...
	if(refTest!=urlTest) {
	  ...
	  log='http://keywordmax.com/tracking/log.php?id=834071091&loc=Homepage&enginevar=engine&keywordvar=keyword&blockengines=&blockref='+blockref+'&ref='+ref+'&url='+url+'&vcookie='+getCookie("KMVisitor");
...
function getCookie(name)
{
    ...
    if (begin != 0) return "10710041948180587700";
	}
	else
	{
    begin += 2;
	...
	return "10710041948180587700";
}
if (getCookie("KMVisitor") == null)
{
  setCookie("KMVisitor","10710041948180587700","Thu Oct 05 2017 12:17:57","/", "keywordmax.com",0);
}
KMTrackClick();
