...
Question(2) = "Passport Expiration Date"
Question(3) = "Citizenship"
Question(4) = "Birth Date"
...
<TABLE WIDTH="70%">
  ...
  <TR>
    ...
    <TR>
		<TD><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2"><B><%= Question(4) %></B></FONT></TD>
		<TD><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2"><INPUT TYPE="TEXT" SIZE=30 id=TEXT1 name=Answer4></TD>
  </TR>
  <TR>
		<TD COLSPAN=2><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2"><BR>Passports are required for all travel to the Bahamas</FONT></TD>
  </TR>
</TABLE>
<BR><BR>
