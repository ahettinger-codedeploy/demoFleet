...
<TABLE WIDTH="700" CELLPADDING="0" CELLSPACING="5" BORDER="0"><TR><TD ALIGN="center" COLSPAN="8"><FONT FACE="<%= FontFace %>" COLOR="<%= FontColor %>" SIZE="2">Please enter the passenger information below.<BR><BR></TD></TR>
...
Do Until rsEvent.EOF
	...
	Response.Write "<TR><TD ALIGN=""center"" COLSPAN=""8""><FONT FACE=""" & FontFace & """ COLOR=""" & FontColor & """ SIZE=""2""><B>" & rsEvent("Act") & " for " & FormatDateTime(rsEvent("EventDate"), vbLongDate) & "</B></TD></TR>" & vbCrLf
	
	Response.Write "<TR BGCOLOR=""" & HeadingFontColor & """><TD ALIGN=""center""><FONT FACE=""" & FontFace & """ COLOR=""" & BGColor & """ SIZE=""2""><B>First<BR>Name</B></FONT></TD><TD ALIGN=""center""><FONT FACE=""" & FontFace & """ COLOR=""" & BGColor & """ SIZE=""2""><B>Last<BR>Name</B></FONT></TD><TD ALIGN=""center""><FONT FACE=""" & FontFace & """ COLOR=""" & BGColor & """ SIZE=""2""><B>Date of<BR>Birth</B></FONT></TD><TD ALIGN=""center""><FONT FACE=""" & FontFace & """ COLOR=""" & BGColor & """ SIZE=""2""><B>Citizenship</B></FONT></TD><TD ALIGN=""center""><FONT FACE=""" & FontFace & """ COLOR=""" & BGColor & """ SIZE=""2""><B>Passport<br>Number</B></FONT></TD><TD ALIGN=""center""><FONT FACE=""" & FontFace & """ COLOR=""" & BGColor & """ SIZE=""2""><B>Experation<BR>Date</B></FONT></TD><TD ALIGN=""center""><FONT FACE=""" & FontFace & """ COLOR=""" & BGColor & """ SIZE=""2""><B>Gender</B></FONT></TD><TD ALIGN=""center""><FONT FACE=""" & FontFace & """ COLOR=""" & BGColor & """ SIZE=""2""><B>Residency</B></FONT></TD></TR>" & vbCrLf
    ...
    'Capture First Name Information
		...
		Response.Write "<TD ALIGN=""left""><INPUT TYPE=""text"" NAME=""PassExp" & TotalLines+1 & """ VALUE=""" & PassExp & """ SIZE=""20"" MAXLENGTH=""50""></TD>" & vbCrLf
		...
		If Not rsOrderLineDetail.EOF Then
			Gender = rsOrderLineDetail("FieldValue")
		Else
			Gender = ""
		End If
		...
		Response.Write "<TD ALIGN=""left""><INPUT TYPE=""text"" NAME=""Gender" & TotalLines+1 & """ VALUE=""" & Gender & """ SIZE=""20"" MAXLENGTH=""50""></TD>" & vbCrLf
		
		
		'---------------------------------------------
        'Capture Residency Information
		...
		'Get existing OrderLineDetail values for this order if there are any.
		SQLOrderLineDetail = "SELECT FieldValue FROM OrderLineDetail WITH (ROWLOCK) WHERE OrderNumber = " & Session("OrderNumber") & " AND LineNumber = " & rsOrderLine("LineNumber") & " AND FieldName = '" & FieldName & "'"
		Set rsOrderLineDetail = OBJdbConnection10.Execute(SQLOrderLineDetail)
			
		If Not rsOrderLineDetail.EOF Then
			Residency = rsOrderLineDetail("FieldValue")
		Else
			Residency = ""
		End If
		...
		Response.Write "<TD ALIGN=""left""><INPUT TYPE=""text"" NAME=""Residency" & TotalLines+1 & """ VALUE=""" & Residency & """ SIZE=""20"" MAXLENGTH=""50""></TD>" & vbCrLf
...
If Session("OrderNumber") <> "" Then
	...
	For i = 1 To Request("TotalLines")
		...
		SQLInsertDetail = "INSERT OrderLineDetail (OrderNumber, LineNumber, FieldName, FieldValue) VALUES(" & Session("OrderNumber") & ", " & LineNumber & ", 'Gender', '" & Clean(Request("Gender" & i)) & "')"
		Set rsInsertDetail = OBJdbConnection.Execute(SQLInsertDetail)
		...
		SQLInsertDetail = "INSERT OrderLineDetail (OrderNumber, LineNumber, FieldName, FieldValue) VALUES(" & Session("OrderNumber") & ", " & LineNumber & ", 'Residency', '" & Clean(Request("Residency" & i)) & "')"
		Set rsInsertDetail = OBJdbConnection.Execute(SQLInsertDetail)	
