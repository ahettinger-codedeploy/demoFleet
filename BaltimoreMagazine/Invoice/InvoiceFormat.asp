...
If Not rsCustInfo.EOF Then
	...
	Response.Write "<BR><BR><TABLE WIDTH=""750""><TR><TD WIDTH=""50"">&nbsp;</TD><TD WIDTH=""400"" VALIGN=""top"">Baltimore Magazine<BR>1000 Lancaster Street, Suite 400<BR>Baltimore, MD 21202</TD><TD WIDTH=""300""><IMG SRC=/PrivateLabel/BaltimoreMagazine/Invoice/Logo.png WIDTH=""300"" HEIGHT=""120""></TD></TR></TABLE>"
	...
	Response.Write "<CENTER><TABLE WIDTH=""700""><TR><TD>Dear " & rsCustInfo("ShipFirstName") & " " & rsCustInfo("ShipLastName") & ", <BR><BR>Thank you for purchasing tickets from Baltimore Magazine.&nbsp;&nbsp;The details of your order are listed below.  For questions regarding this order, contact us at (410) 752-4200.<BR><BR>" & vbCrLf
