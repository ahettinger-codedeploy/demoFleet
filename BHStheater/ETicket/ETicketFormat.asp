...
For i = 1 to uBound(ImageName)
	...
	Else
		...
		ImageLocation(i) = "images/"&ImageName(i)
	End If
...
If Not rsOrderNum.EOF Then
	...
	If Not rsTix.EOF Then
		...
		'Begin Ticket
			...
			Response.Write "<TABLE WIDTH=""615"" HEIGHT=""240"" BORDER=""1"" BACKGROUND="""&ImageLocation(1)&""" BGCOLOR=""#FFD718"" CELLPADDING=""0"" CELLSPACING=""0"">" & vbCrLf
			Response.Write "<TR>" & vbCrLf
			...
			Response.Write "<IMG SRC="""&ImageLocation(2)&""">" & vbCrLf
			...
			Response.Write "<IMG SRC="""&ImageLocation(3)&""">" & vbCrLf
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
			Response.Write "</TD>" & vbCrLf
		...
		'Begin Ad Space
            ...
            Else
    			Response.Write "<IMG SRC="""&ImageLocation(4)&""">" & vbCrLf
            End If
			Response.Write "</TD>" & vbCrLf
			Response.Write "</TR>" & vbCrLf
			Response.Write "</TABLE>" & vbCrLf
